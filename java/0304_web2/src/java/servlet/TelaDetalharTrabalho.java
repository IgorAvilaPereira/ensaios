 ...
 * @author iapereira
 */
@WebServlet(name = "TelaDetalharTrabalho", urlPatterns = {"/TelaDetalharTrabalho"})
public class TelaDetalharTrabalho extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("./tela_detalhar_trabalho.jsp");
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet TelaDetalharTrabalho</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet TelaDetalharTrabalho at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
