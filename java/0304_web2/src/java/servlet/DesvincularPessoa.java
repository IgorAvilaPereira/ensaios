 ...
 * @author iapereira
 */
@WebServlet(name = "DesvincularPessoa", urlPatterns = {"/DesvincularPessoa"})
public class DesvincularPessoa extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet DesvincularPessoa</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet DesvincularPessoa at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
