...
public class ControleRemoto extends JFrame {
    ...
    private final JButton[] botoesOn;
    private final JButton[] botoesOff;
    private final JButton undo;
    private final JLabel[] nomes;
    private final JLabel vazio;
    ...
    public ControleRemoto() {
        ...
        super.setTitle("Controle Remoto");
        super.setVisible(true);
        super.setLayout(new GridLayout(8, 3));
        super.setBounds(350, 250, 350, 350);
        super.setResizable(true);
        super.setLocation((dim.width / 2) - 400, (dim.height / 2) - 200);
        ...
        for (int i = 0; i < 7; i++) {
            ...
            super.add(nomes[i]);
            super.add(botoesOn[i]);
            super.add(botoesOff[i]);
