...
--
-- Name: componente; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: diametro; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: grafo; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
Hanafiah Yussof. (Org.). Robot Localization and Map Building. Vienna, Austria		Intech	19	194
		iConcept Press	1	242
			1	243
ROCHA, L. A. O. ,Botelho, S.S.C. ,ADAMATTI, D. F.. (Org.). Simpósio de Modelagem Computacional do Sul		IEEE Xplore	1	244
ROCHA, L. A. O. ,Botelho, S.S.C. ,ADAMATTI, D. F.. (Org.). Simpósio de Modelagem Computacional do Sul			1	245
		IEEE Xplore		246
\.
...
COPY componente (componente, vertice) FROM stdin;
\.
...
627	The Multi-Agent Logics, Languages, and Organisations Federated Workshops (MALLOW 2010)/LAnguages, methodologies and Development tools for multi-agent systemS (LADS 2010), 2010, Lyon. Olivier Boissier, Amal El Fallah Seghrouchni, Salima Hassas and Nicolas Maudet (Eds.), MALLOW 2010 - The Multi-Agent Logics, Languages, and Organisations Federated Workshops, CEUR-WS Workshop Proceedings Series. Aachen : Sun SITE Central Europe/ RWTH Aachen University/Tilburg University	135
	IV Seminário e Workshop em Engenharia Oceânica, 2010. SEMENGO 2010	258
...
Único	The 3rd South Conference on Computational Modeling III MCSUL, 2009, Rio Grande. Anais do III Simpósio de Modelagem Computacional do Sul 3MCSul	225
	XXIX Simpósio Nacional de Educação Física, 2010. XXIX Simpósio Nacional de Educação Física	247
	SIBIGRAPI, 2010. SIBIGRAPI	248
	...
	Congresso Brasileiro de Automática, 2010. CBA 2010	252
	Congresso Brasileiro de Automática, 2010. CBA 2010	253
	IEEE International Conference on Multisensor Fusion and Integration, 2010. IEEE International Conference on Multisensor Fusion and Integration	254
	12th Brazilian Workshop on Real-Time and Embedded Systems, 2010, Gramado. Anais do 12th Brazilian Workshop on Real-Time and Embedded Systems	255
	1st IFAC Workshop on Advanced Maintenance Engineering, Services and Technology - IFAC A-MEST'10, 2010, Lisboa. Proceedings of the 1st IFAC Workshop on Advanced Maintenance Engineering, Services and Technology - IFAC A-MEST'10	256
	IV MCSUL - Southern Conference in Computational Modeling, 2010. IV MCSUL	257
	23 Congresso Nacional de Transporte Aquaviário, Construção Naval e Offshore, 2010. SOBENA 2010	259
	SBGames, 2010. Simpósio Brasileiro de Jogos	260
	Seminário de Pesquisa Qualitativa, 2010. Seminário de Pesquisa Qualitativa	261
	INCOM 2009	262
...
--
-- Data for Name: diametro; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY diametro (posicao, membro) FROM stdin;
0	4
1	17
2	0
3	1
...
--
-- Data for Name: grafo; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY grafo (id, densidade, giant_component) FROM stdin;
1	0.181286544	0.736842096
\.
...
COPY membros (id_membro, nome, id_lattes, centralidade, pagerank, grau, cluster_coefficient) FROM stdin;
3	Antonio Carlos da Rocha Costa	5601943285331545	0	1	1	0
4	Cláudio Dornelles Mello Júnior	5464430592929387	0	1.18045557	6	1
5	Danúbia Bueno Espíndola	9582755594379866	0	0.346509516	1	0
6	Diana Francisca Adamatti	4984043849101331	0	0.889002204	3	0.666666687
7	Eder Mateus Nunes Gonçalves	8560050240967369	0	1.18118668	6	1
8	Eduardo Nunes Borges	5851601274050374	0	0.150000006	0	0
9	Emanuel da Silva Diaz Estrada	3463902649683230	0	1.18187881	6	1
10	Graçaliz Pereira Dimuro	9414212573217453	0	1	1	0
11	Ivete Martins Pinto	8740785327180983	0	0.346509516	1	0
12	Leonardo Ramos Emmendorfer	1129100746134234	0	0.662945509	2	1
13	Nelson Lopes Duarte Filho	5369672706522008	0	1.18253446	6	1
14	Odorico Machado Mendizabal	6058299964884859	0	0.150000006	0	0
15	Paulo Lilles Jorge Drews Junior	5551697165370587	0	1.18315578	6	1
16	Rodrigo Andrade de Bem	3935196239515458	0	0.346509516	1	0
17	Silvia Silva da Costa Botelho	8800859024101679	0	2.55080485	11	0.290909082
18	Vinícius Menezes de Oliveira	9262132256691648	0	1.18424594	6	1
0	Adriano Velasque Werhli	4393367734853964	0	1.22852492	4	0.333333343
1	Alessandro de Lima Bicho	6965119196945931	0	0.411061525	1	0
2	Andre Prisco Vargas	0243625998325831	0	0.150000006	0	0
\.
...
194	CL	Self-Localization and Mapping for Underwater Autonomous Vehicles	BOTELHO, S. S. C. ; OLIVEIRA, G. L. ; DREWS JR, P. L. J. ; FIGUEIREDO, M. ; HAFFELE, C.	2010	365-382	15	\N
...
247	TC	Ambientes virtuais de aprendizagem na Educaçao fisica: uma revisão sobre a utilização de exergames	VAGHETTI, C. A. ; BOTELHO, S. S. C.	2010	1-6	17	\N
250	TC	Sistema de Predição de Alarmes em Plantas Industriais Baseado em Mapas Auto-Organizáveis	Braustein, S. ; A, Lerm ; Lerm, R. ; Werhli, A. ; BOTELHO, S. S. C. ; E, Lippe	2010	1-6	17	\N
253	TC	A Visualização Mista nos Sistemas de Automação de Processos de Manutenção Preditiva de Máquinas da Indústria	ESPÍNDOLA, D. ; pereira, c. e. ; R, Henriques ; BOTELHO, S. S. C.	2010	1-6	17	\N
260	TC	Cultura digital e Educação Física: problematizando a inserção de Exergames no currículo	VAGHETTI, C. A. ; BOTELHO, S. S. C. ; R, Sperotto	2010	1-6	17	\N
261	TC	Cultura digital e Educação Física	VAGHETTI, C. A. ; R, Sperotto ; BOTELHO, S. S. C.	2010		17	\N
...
256	TC	Using Mixed Reality in the Visualization of Maintenance Processes	ESPÍNDOLA, D. ; pereira, c. e. ; HENRIQUES, Renato Ventura Bayan ; BOTELHO, S. S. C.	2010	35-40	17	66
...
255	TC	Uma Proposta para Visualização Aumentada em Tempo_real Aplicada a Indústria	ESPÍNDOLA, D. ; pereira, c. e. ; HENRIQUES, Renato Ventura Bayan ; BOTELHO, S. S. C.	2010	163-168	17	67
...
252	TC	Sistema de Navegação para um Robô de Inspeção de Linhas Subterrâneas de Distribuição	Estrada, E. ; Silveira, L. ; OLIVEIRA, V. ; BOTELHO, S. S. C.	2010	1-6	17	110
...
179	CL	A General Purpose Cave-like System for Visualization of Animated and 4D CAD Modeling	DUARTE FILHO, Nelson Lopes ; CARVALHO, J. ; MARCOS, Pedro ; Maffei, Renan ; OLIVEIRA, Rodrigo Ruas ; HAX, V. ; BOTELHO, Silvia Silva da Costa	2010	82-87	13	179
244	CL	A General Purpose Cave-like System for Visualization of Animated and 4D CAD Modeling	Duarte Filho, Nelson L. ; Tyska, j. ; P. botelho ; R. maffei ; R. Oliveira ; v. hax ; Botelho, Silvia S. C.	2010	82-87	17	179
180	CL	A Framework for Distributed Shared Memory - Case Study in Geoscience Applications on Clusters of Computers	DUARTE FILHO, Nelson Lopes ; VIEIRA, Jeison ; BOTELHO, Silvia Silva da Costa	2010	88-93	13	180
245	CL	A Framework for Distributed Shared Memory - Case Study in Geoscience Applications on Clusters of Computers	DUARTE, N. ; Vieira, J. ; Botelho, Silvia S. C.	2010	88-93	17	180
181	CL	An Automated Platform for Immersive and Collaborative Visualization of Industrial Models. Engineering of Complex Computer Systems. 1 ed	DUARTE FILHO, Nelson Lopes ; BOTELHO, Silvia Silva da Costa ; CARVALHO, J. ; MARCOS, Pedro ; Maffei, Renan ; OLIVEIRA, Rodrigo Ruas ; HAX, V.	2009	258-264	13	181
246	CL	An Automated Platform for Immersive and Collaborative Visualization of Industrial Models. Engineering of Complex Computer Systems	DUARTE, N. ; Botelho, Silvia S. C. ; Tyska, j. ; P. botelho ; R. maffei ; R. Oliveira	2009	258-264	17	181
...
258	TC	SAP-RISCO4D Sistemas de Avaliação 4D para Projetos na Construção Naval	Oliveira, D. P. ; BOTELHO, S. S. C. ; DUARTE, N.	2010	1-6	17	182
...
257	TC	Modelagem de um Sistema de Visualização 4D na Construção Naval	Oliveira, D. P. ; BOTELHO, S. S. C. ; DUARTE, N.	2010	1-6	17	183
...
259	TC	SAP-RISCO4D: UM SISTEMA DE VISUALIZAÇÃO 4D PARA ACOMPANHAMENTO DE PROJETOS NA CONSTRUÇÃO NAVAL	Oliveira, D. P. ; BOTELHO, S. S. C. ; DUARTE, N.	2010	1-6	17	184
...
262	TC	A Multi-Cave Visualization System for Digital Manufacturing	DUARTE, N. ; Tyska, j. ; BOTELHO, S. S. C.	2009	1-6	17	186
...
254	TC	Sensor Fusion based on Multi-Self-Organizing Maps for SLAM	m, figueiredo ; LEIVAS, G ; BOTELHO, S. S. C. ; DREWS, P. ; da Rocha, C.	2010	1-6	17	199
...
249	TC	Fusão sensorial de mapas auto-organizáveis para SLAM	LEIVAS, G ; DREWS, P. ; BOTELHO, S. S. C. ; m, figueiredo ; da Rocha, C.	2010	1-6	17	200
...
248	TC	3D Motion Tracking Based on Probabilistic Volumetric Reconstruction and Optical Flow	SIMAS, G. ; FICKEL, G. ; l, novello ; BEM, R. ; BOTELHO, S. S. C.	2010	1-6	17	223
...
251	TC	Reconstrução Probabilística 3D Aplicada à Análise de Movimento: um Enfoque na Tele-operação	SIMAS, G. ; FICKEL, G. ; l, novello ; BEM, R. DE ; BOTELHO, S. S. C.	2010	1-6	17	224
...
--
-- Name: componente_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY componente
    ADD CONSTRAINT componente_pkey PRIMARY KEY (componente, vertice);
...
--
-- Name: diametro_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY diametro
    ADD CONSTRAINT diametro_pkey PRIMARY KEY (membro);


--
-- Name: diametro_posicao_key; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY diametro
    ADD CONSTRAINT diametro_posicao_key UNIQUE (posicao);


--
-- Name: grafo_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY grafo
    ADD CONSTRAINT grafo_pkey PRIMARY KEY (id);
...
--
-- Name: componente_vertice_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY componente
    ADD CONSTRAINT componente_vertice_fkey FOREIGN KEY (vertice) REFERENCES membros(id_membro);
...
--
-- Name: diametro_membro_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY diametro
    ADD CONSTRAINT diametro_membro_fkey FOREIGN KEY (membro) REFERENCES membros(id_membro);
