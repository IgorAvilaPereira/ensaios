 ...
 */
public class my_radial_view extends Display {

    public static final String DATA_FILE = "/c3_capado.xml";
    ...
    public my_radial_view(Graph g, String label) {
        ...
        fill.add(VisualItem.HIGHLIGHT, ColorLib.rgb(255,200,12));
    ...
    public static JPanel demo(Graph g, final String label) {        
        ...
        final my_radial_view gview = new my_radial_view(g, label);
    ...
    public static class NodeColorAction extends ColorAction {
        public NodeColorAction(String group) {
            super(group, VisualItem.FILLCOLOR, ColorLib.rgba(255,255,0,0));
            add("_hover", ColorLib.gray(220,230));
            add("ingroup('_search_')", ColorLib.rgb(255,190,190));
            add("ingroup('_focus_')", ColorLib.rgb(198,0,0));
        }
