...
public class GraphView extends JPrefuseApplet {
    ...
    public void init() {
        ...
        JComponent graphview = demo("/c3.xml", "name");
    ...
    public static JComponent demo(Graph g, String label) {
        ...
        display.addControlListener(new NeighborHighlightControl()); //'pinta' os vizinhos
        ...
        split.setRightComponent(fpanel); // onde é mostrado o painel direito
