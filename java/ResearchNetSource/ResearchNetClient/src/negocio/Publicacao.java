...
import apresentacao.TelaGrafo;
import java.util.Locale;
import java.util.ResourceBundle;

public class Publicacao {

    public String titulo, autores, ano, localPublicado, tipo, nome_membro;
    public int cluster, id_membro;
    public  Integer id_publicacao;
    public Publicacao replica;
