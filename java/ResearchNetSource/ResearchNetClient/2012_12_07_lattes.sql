...
CREATE TABLE rede (
    ...
    anofim integer,
    grupo integer,
    CONSTRAINT rede_check CHECK ((((anoinicio <= anofim) OR (anoinicio IS NULL)) OR (anofim IS NULL)))
);
...
--
-- Name: membrosgrupo; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE membrosgrupo (
    idgrupo integer NOT NULL,
    idlattes character varying NOT NULL
);


ALTER TABLE public.membrosgrupo OWNER TO postgres;
...
--
-- Name: resumo; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW resumo AS
    SELECT resumo.id_publicacao, resumo.doi, resumo.evento, resumo.volume, resumo.numero FROM versionado.resumo, versao WHERE (resumo.versao = versao.atual);


ALTER TABLE public.resumo OWNER TO postgres;
...
--
-- Name: resumo_exp; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW resumo_exp AS
    SELECT resumo_exp.id_publicacao, resumo_exp.doi, resumo_exp.evento, resumo_exp.volume FROM versionado.resumo_exp, versao WHERE (resumo_exp.versao = versao.atual);


ALTER TABLE public.resumo_exp OWNER TO postgres;
...
SELECT pg_catalog.setval('publicacao_id_publicacao_seq', 4317, true);
...
--
-- Data for Name: membrosgrupo; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY membrosgrupo (idgrupo, idlattes) FROM stdin;
1	4393367734853964
1	6965119196945931
1	8252864210379656
1	0243625998325831
...
COPY rede (id, nome, autor, visibilidade, xml, anoinicio, anofim, grupo) FROM stdin;
1	C3 Geral	1	t	\N	\N	\N	1
2	C3 Geral 2008	1	t	\N	2008	2008	1
3	C3 Geral 2008 - 2009	1	t	\N	2008	2009	1
4	C3 Geral 2008 - 2010	1	t	\N	2008	2010	1
5	C3 Geral 2008 - 2011	1	t	\N	2008	2011	1
\.
...
COPY tipo (id_tipo, descricao) FROM stdin;
AA	Artigo Aceito
AP	Artigo Publicado
...
ROCHA, L. A. O. ,Botelho, S.S.C. ,ADAMATTI, D. F.. (Org.). Simpósio de Modelagem Computacional do Sul			1	3200	3
		IEEE Xplore		3201	3
MPH Stumpf; DJ Balding; M. Girolami. (Org.). Handbook of Statistical Systems Biology. Chichester		John Wiley Sons, Ltd		3322	4
Frank Emmert-Streib; Matthias Dehmer. (Org.). Analysis of Microarray Data - A Network-Based Approach. 1ed.Weinheim		Wiley-VCH Verlag GmbH Co. KGaA	1	3323	4
Daniel Thalmann; Soraia Raupp Musse. (Org.). Crowd Simulation. 2ed.London/UK		Springer London	U.	3339	4
Gustavo Lugo; Jomi Hübner. (Org.). Post-Procedings of the 2011 Workshop and School of Agent Systems, their Environment and Applications (WESAAC). 1ed.New York		IEEE	1	3396	4
G.P. Dimuro; A.C.R. Costa; J. Sichman; P. Tedesco; D. Adamati; J. Balsa; L. Antunes.. (Org.). Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation. 1ed.Los Alamitos		IEEE	1	3397	4
G.P. Dimuro; A.C.R. Costa; J. Sichman; P. Tedesco; D. Adamati; J. Balsa; L. Antunes. (Org.). Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation. 1ed.Los Alamitos		IEEE	1	3398	4
G.P. Dimuro; A.C.R. Costa; J. Sichman; P. Tedesco; D. Adamati; J. Balsa; L. Antunes. (Org.). Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation. 1ed.Los Alamitos		IEEE	1	3399	4
G.P. Dimuro; A.C.R. Costa; J. Sichman; P. Tedesco; D. Adamati; J. Balsa; L. Antunes. (Org.). Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation. 1ed.Los Alamitos		IEEE	1	3400	4
G.P. Dimuro; A.C.R. Costa; J. Sichman; P. Tedesco; D. Adamati; J. Balsa; L. Antunes. (Org.). Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation. 1ed.Los Alamitos		IEEE	1	3401	4
G.P. Dimuro; A.C.R. Costa; J. Sichman; P. Tedesco; D. Adamati; J. Balsa; L. Antunes. (Org.). Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation. 1ed.Los Alamitos		IEEE	1	3402	4
Gustavo Lugo; Jomi Hübner.. (Org.). Post-Procedings of the 2011 Workshop and School of Agent Systems, their Environment and Applications (WESAAC). 1ed.New York		IEEE	1	3403	4
Gustavo Lugo; Jomi Hubner. (Org.). Post-Procedings of the 2011 Workshop and School of Agent Systems, their Environment and Applications (WESAAC). 1ed.New York		IEEE	1	3404	4
D. F. Adamatti. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3405	4
D. F. Adamatti. (Org.). Analisando Trocas Sociais Baseadas em Personalidades Através de Cadeias de Markov Intervalares. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3406	4
D.F. Adamatti. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3407	4
D.F. Adamatti. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. 73ed.Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3408	4
		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3409	4
D.F. Adamatti. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3410	4
D.F. Adamatti. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3411	4
Botelho, S. S. C., Adamatti, D. and Rocha, L. A. O.. (Org.). Third Southern Conference on Computational Modeling (MCSUL), 2009 (Post-Proceedings, Revised Selected Papers). Los Alamitos		IEEE	1	3412	4
R. Trappl. (Org.). Cybernetics and Systems 2010 (Track: From Agent Theory to Agent Implementation AT2AI-7). 1ed.Vienna		OFAI	1	3413	4
Virginia Dignum. (Org.). Multiagent Systems - Semantics and Dynamics of Organization Models. 1ed.Hershey		IGI Global	1	3414	4
Sichman, J.; Noriega, P.; Padget, J.; Ossowski, S.. (Org.). Coordination, Organizations, Institutions and Norms in Multi-Agent Systems III. Revised selected papers of COIN Workshops 2007 (lecture Notes in Artificial Intelilgence). Berlin		Springer-Verlag	4870	3415	4
Matteo Baldoni;Tran Cao Son; M. Birna van Riemsdijk;Michael Winikoff. (Org.). Declarative Agent Languages and Technologies VI - DALT 2008 (LNCS 5397). Berlin		Springer	1	3416	4
Gustavo Gimenez-Lugo. (Org.). Agent Systems, their Environment and Applications (WESAAC), 2011 Workshop and School of. 1ed.Los Alamos		IEEE		3566	4
Graçaliz P. Dimuro; Diana F. Adamatti; Antonio C. R. Costa; Jaime S. Sichman; Helder Coelho; Patricia Tedesco; João Balsa; Gleifer V. Alves. (Org.). Post-Proceedings of the Brazilian Workshop on Social Simulation. 1ed.Los Alamitos		IEEE	1	3567	4
Graçaliz P. Dimuro; Diana F. Adamatti; Antonio C. R. Costa; Jaime S. Sichman; Helder Coelho; Patricia Tedesco; João Balsa; Gleifer V. Alves. (Org.). Post-Proceedings of the Brazilian Workshop on Social Simulation. 1ed.Los Alamitos		IEEE	1	3568	4
		Information Resources Management Association		3569	4
Marcos Gestal Pose; Daniel Rivero Cebrián. (Org.). Soft Computing Methods for Practical Environmental Solutions: Techniques and Studies		Information Science Reference		3570	4
Adamatti, D. .F.. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande / RS		FURG	1	3571	4
Adamatti, D. .F.. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande / RS		FURG	1	3572	4
David R.C. Hill; Alexandre Muzy;Bernard P. Zeigle. (Org.). Activity-Based Modeling and Simulation. 1ed.Paris - France		Presses Universitaires Blaise-Pascal	1	3573	4
J. Mattos, L. Rosa Jr, M. Pilla. (Org.). Desafios e Avanços em Computação: o estado da arte. 1ed.Pelotas RS		Editora e Gráfica Universitária	1	3574	4
Gustavo Lugo; Jomi Hübner. (Org.). Post-Procedings of the 2011 Workshop and School of Agent Systems, their Environment and Applications (WESAAC). 1ed.Los Alamitos		IEEE	1	3726	4
Gustavo Lugo; Jomi Hübner. (Org.). Post-Procedings of the 2011 Workshop and School of Agent Systems, their Environment and Applications (WESAAC). 1ed.Los Alamitos		IEEE	1	3727	4
G.P. Dimuro; A.C.R. Costa; J. Sichman; P. Tedesco; D. Adamati; J. Balsa; L. Antunes. (Org.). Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation. Los Alamitos		IEEE	1	3728	4
G.P. Dimuro; A.C.R. Costa; J. Sichman; P. Tedesco; D. Adamati; J. Balsa; L. Antunes. (Org.). Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation. Los Alamitos		IEEE	1	3729	4
G.P. Dimuro; A.C.R. Costa; J. Sichman; P. Tedesco; D. Adamati; J. Balsa; L. Antunes. (Org.). Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation. Los Alamitos		IEEE	1	3730	4
Simone André da Costa Cavalheiro; Luciana Foss; Marilton Sanchotene de Aguiar;Graçaliz Pereira Dimuro; Antônio Carlos da Rocha Costa. (Org.). Post-Proceedings of the Workshop-School on Theoretical Computer Science. 1ed.Los Alamitos		IEEE	1	3731	4
Simone André da Costa Cavalheiro; Luciana Foss; Marilton Sanchotene de Aguiar;Graçaliz Pereira Dimuro; Antônio Carlos da Rocha Costa. (Org.). Post-Proceedings of the Workshop-School on Theoretical Computer Science. 1ed.Los Alamitos		IEEE	1	3732	4
Simone André da Costa Cavalheiro; Luciana Foss; Marilton Sanchotene de Aguiar;Graçaliz Pereira Dimuro; Antônio Carlos da Rocha Costa. (Org.). Post-Proceedings of the Workshop-School on Theoretical Computer Science. 1ed.Los Alamitos		IEEE	1	3733	4
Simone André da Costa Cavalheiro; Luciana Foss; Marilton Sanchotene de Aguiar;Graçaliz Pereira Dimuro; Antônio Carlos da Rocha Costa. (Org.). Post-Proceedings of the Workshop-School on Theoretical Computer Science. 1ed.Los Alamitos		IEEE	1	3734	4
Simone André da Costa Cavalheiro; Luciana Foss; Marilton Sanchotene de Aguiar;Graçaliz Pereira Dimuro; Antônio Carlos da Rocha Costa. (Org.). Post-Proceedings of the Workshop-School on Theoretical Computer Science. 1ed.Los Alamitos		IEEE	1	3735	4
Simone André da Costa Cavalheiro; Luciana Foss; Marilton Sanchotene de Aguiar;Graçaliz Pereira Dimuro; Antônio Carlos da Rocha Costa. (Org.). Post-Proceedings of the Workshop-School on Theoretical Computer Science. 1ed.Los Alamitos		IEEE	1	3736	4
Simone André da Costa Cavalheiro; Luciana Foss; Marilton Sanchotene de Aguiar;Graçaliz Pereira Dimuro; Antônio Carlos da Rocha Costa. (Org.). Post-Proceedings 2011 Workshop-School on Theoretical Computer Science - WEIT 2011. 1ed.Los Alamitos		IEEE	1	3737	4
Simone André da Costa Cavalheiro; Luciana Foss; Marilton Sanchotene de Aguiar;Graçaliz Pereira Dimuro; Antônio Carlos da Rocha Costa. (Org.). Post-Proceedings of the Workshop-School on Theoretical Computer Science. 1ed.Los Alamitos		IEEE	1	3738	4
Simone André da Costa Cavalheiro; Luciana Foss; Marilton Sanchotene de Aguiar;Graçaliz Pereira Dimuro; Antônio Carlos da Rocha Costa. (Org.). Post-Proceedings of the Workshop-School on Theoretical Computer Science. 1ed.Los Alamitos		IEEE	1	3739	4
D. F. ADAMATTI. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3740	4
D. F. Adamatti. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3741	4
D. F. Adamatti. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3742	4
D. F. Adamatti. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3743	4
D. F. Adamatti. (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande		Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	1	3744	4
Botelho, S. S. C., Adamatti, D. and Rocha, L. A. O.. (Org.). Third Southern Conference on Computational Modeling (MCSUL), 2009 (Post-Proceedings, Revised Selected Papers). Los Alamitos		IEEE	1	3745	4
Virginia Dignum. (Org.). Handbook of Research on Multi-Agent Systems: Semantics and Dynamics of Organizational Models. Hershey		IGI Global	1	3746	4
Sichman, J.; Padget, J.; Ossowski, S.; Noriega, P.. (Org.). Coordination, Organizations, Institutions and Norms in Multi-Agent Systems III. Revised selected papers of COIN Workshops 2007 (Lecture Notes in Artificial Intelligence Series). Springer-Verlag		Berlin	4870	3747	4
Adriano C. Machado Pereira; Gisele Lobo Pappa. Marco Winckler; Roberta Lima Gomes.. (Org.). Tópicos em sistemas colaborativos, multimídia, web e banco de dados.. Porto Alegre		Sociedade Brasileira de Computação	1	3841	4
Adamatti, D. .F... (Org.). Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições.. Rio Grande			1	3863	4
Ying-ping Chen,; Meng-Hiot Lim. (Org.). Linkage in evolutionary computation. Studies in Computational Intelligence. New York		Springer	157	3864	4
ROCHA, L. A. O. (Org.) ; Botelho, S.S.C. (Org.) ; ADAMATTI, D. F. (Org.). (Org.). Simpósio de Modelagem Computacional do Sul. 1ed		IEEE Xplore	1	3892	4
ROCHA, L. A. O. (Org.) ; Botelho, S.S.C. (Org.) ; ADAMATTI, D. F. (Org.). (Org.). Simpósio de Modelagem Computacional do Sul. 1ed		IEEE Xplore	1	3893	4
		IEEE Xplore	1	3894	4
Osvaldo L. L. de Moraes. (Org.). Meteorologia e Poluiçãp Atmosférica: Teoria, Experimentos e Simulação. 1ed.Santa Maria		FACOS-UFSM	1	3922	4
Ricardo Reis. (Org.). Advanced Topics on VLSI Design. 1ed.Porto Alegre		Instituto de Informatica da UFRGS		3968	4
J. Mattos, L. Rosa Jr.; M. Pilla. (Org.). Desafios e Avanços em Computação: o Estado da Arte. Pelotas, RS		Editora e Gráfica Universitária		3969	4
Hanafiah Yussof. (Org.). Robot Localization and Map Building. Vienna, Austria		Intech	19	4010	4
		InTech		4126	4
		InTech		4127	4
		InTech		4128	4
		iConcept Press	1	4174	4
			1	4175	4
ROCHA, L. A. O. ,Botelho, S.S.C. ,ADAMATTI, D. F.. (Org.). Simpósio de Modelagem Computacional do Sul		IEEE Xplore	1	4176	4
ROCHA, L. A. O. ,Botelho, S.S.C. ,ADAMATTI, D. F.. (Org.). Simpósio de Modelagem Computacional do Sul			1	4177	4
		IEEE Xplore		4178	4
ROCHA, L. A. O.; Botelho, S.S.C.; ADAMATTI, D. F.. (Org.). Simpósio de Modelagem Computacional do Sul. 1ed		IEEE Xplore	1	4297	4
		IEEE Xplore	1	4298	4
\.
...
1	IV Southern Conference on Computational Modeling, 2010, Rio Grande, RS, 2010, Rio Grande. IV Southern Conference on Computational Modeling 2010	3289	3
	...
	Simpósio Brasileiro de Redes Neurais, 2012, Curitiba. Proc. of the SBRN 2012	3324	4
	Brazilian Symposium on Artificial Intelligence, 2010, São Bernardo do Campo. Lecture Notes in Artificial Intelligence, subseries of Lecture Notes in Computer Science. Berlim: Springer-Verlag	3325	4
	Brazilian Symposium on Neural network, 2010, São Bernardo do Campo. 2010 Eleventh Brazilian Symposium on Neural Networks (SBRN 2010). California: Conference Publishing Services (CPS)	3326	4
9	Simposio Brasileiro de Automação Inteligente, 2009, Brasília. Anais do IX Simpósio Brasileiro de Automação Inteligente,	3327	4
	Computer Graphics International, 2008, Istanbul. Proceedings of Computer Graphics International	3328	4
U	Brazilian Robotics Symposium and Latin American Robotics Symposium (SBR-LARS), 2012, Fortaleza/CE, Brasil. Proceedings of Brazilian Robotics Symposium and Latin American Robotics Symposium. Piscataway, NJ, EUA: IEEE Computer Society	3340	4
U	Computer Graphics and Imaging - CGIM, 2011, Innsbruck/Austria. Proceedings of the 12th IASTED International Conference on Computer Graphics and Imaging - CGIM. Calgary/Canadá: ACTA Press	3341	4
	VIII Encontro Nacional de Inteligência Artificial - ENIA/CSBC, 2011, Natal/RN, Brasil. Anais do XXXI Congresso da Sociedade Brasileira de Computação - CSBC	3342	4
	X Simpósio Brasileiro de Automação Inteligente - SBAI, 2011, São João del-Rei/MG, Brasil. Anais do X Simpósio Brasileiro de Automação Inteligente - SBAI	3343	4
	26th Computer Graphics International Conference, 2008, Istambul , Turquia. Proceedings of the 26th Computer Graphics International Conference	3344	4
1	I Seminário Diálogos em Educação a Distância, 2012, Rio Grande. Seminário Diálogos em Educação a Distância. Rio Grande: SEAD-FURG	3348	4
	XIV Fórum de Estudos: Leituras de Paulo Freire, 2012, Erechim. Educação Popular e Transformação Social. Erechim: UFFS	3349	4
	XIV Fórum de Estudos: Leituras de Paulo Freire, 2012, Erechim. Educação Popular e Transformação Social. Erechim: UFFS	3350	4
	IX Seminário de Pesquisa em Educação da Região Sul - ANPED Sul, 2012, Caxias do Sul. A Pós-Graduação e as suas Interlocuções com a Educação Básica. Caxias do Sul	3351	4
	IV Congresso Internacional de Educação, Pesquisa e Gestão, 2012, Ponta Grossa. Políticas e Práticas Educacionais. Ponta Grossa	3352	4
	II Fórum Internacional sobre Prática Docente Universitária, 2012, Uberlândia. Planejamento e Avaliação no Contexto Glocal. Uberlandia	3353	4
	VI Seminário Nacional Diálogos com Paulo Freire, 2012, Santa Maria. Educação, cultura e resistências na sociedade contemporânea. Santa Maria	3354	4
	XIII Fórum de Estudos: Leituras de Paulo Freire, 2011, Santa Rosa - RS. XIII Fórum de Estudos: Leituras de Paulo Freire	3355	4
	XIII Fórum de Estudos: Leituras de Paulo Freire, 2011, Santa Rosa - RS. XIII Fórum de Estudos: Leituras de Paulo Freire	3356	4
	V Colóquio Internacional "Educação e Contemporaneidade", 2011, São Cristóvão. A Etnomatemática como Aporte às Práticas de Ensino na Educação de Jovens e Adultos. São Cristóvão	3357	4
	VII Congresso Internacional de Educação, 2011, São Leopoldo. Profissão Docente: Há Futuro para este Ofício?. São Leopoldo	3358	4
	I Fórum Internacional Sobre Prática Docente Universitária, 2011, Uberlânida. Inclusão Social e Tecnologias de Informação e Comunicação. Uberlândia	3359	4
	V Colóquio Internacional "Educação e Contemporaneidade", 2011, São Cristóvão. A Etnomatemática como Aporte às Práticas de Ensino na Educação de Jovens e Adultos. São Cristóvão	3360	4
	X Congresso Nacional de Educação - EDUCERE, 2011, Curitiba. Formação para mudanças no contexto da educação: políticas, representações sociais e práticas. Curitiba	3361	4
	X Congresso Nacional de Educação EDUCERE, 2011, Curitiba. Formação para mudanças no contexto da educação: políticas, representações sociais e práticas. Curitiba	3362	4
	X Congresso Nacional de Educação EDUCERE, 2011, Curitiba. Formação para mudanças no contexto da educação: políticas, representações sociais e práticas. Curitiba	3363	4
	V Seminário Diálogos com Paulo Freire, 2011, Pelotas. Das Práticas Escolares às Pedagogias das Marchas	3364	4
	V Escola Regional de Banco de Dados, 2009, Ijuí - RS. V Escola Regional de Banco de Dados. Ijuí - RS	3365	4
	Seminário de Informática, 2008, Torres - RS. Seminário de Informática	3366	4
	Escola Regional de Banco de Dados, 2012, Curitiba - PR. Anais da VIII Escola Regional de Banco de Dados	3370	4
	Escola Regional de Banco de Dados, 2012, Curitiba - PR. Anais da VIII Escola Regional de Banco de Dados	3371	4
2012	XXXI International Conference of the Chilean Computer Science Society (SCCC), 2012, Valparaíso - Chile. Proceedings of the International Conference of the Chilean Computer Science Society	3372	4
2012	V Conferência Sul em Modelagem Computacional (MCSUL), 2012, Rio Grande - RS. Anais da V Conferência Sul em Modelagem Computacional	3373	4
1	BWSS 2012 - The Third Brazilian Workshop on Social Simulation, 2012, Curitiba. Anais do BWSS 2012. Porto Alegre: SBC	3417	4
1	BWSS 2012 - The Third Brazilian Workshop on Social Simulation, 2012, Curitiba. Anais do BWSS 2012. Porto Alegre: SBC	3418	4
1	BWSS 2012 - The Third Brazilian Workshop on Social Simulation, 2012, Curitiba. Anais do BWSS 2012. Porto Alegre: SBC	3419	4
1	II CBSF - Segundo Congresso Brasileiro de Sistemas Fuzzy, 2012, Natal. Anais do CBSF. Natal: UFRN	3420	4
1	Encontro Nacional de Inteligência Artificial - ENIA 2012, 2012, Curitiba. Anais do ENIA 2012. Porto Alegre: SBC	3421	4
1	WESAAC 2012 - VI Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2012, Florianópolis. Anais do WESAAC 2012. Florianópolis: UFSC	3422	4
1	Workshop on Adaptive and Learning Agents - ALA 2012 / AAMAS 2012 -11th International Conference on Autonomous Agents and Multiagent Systems, 2012, Valencia, Espanha. Proceedings of AAMAS 2012 - ALA Workshop. Richland, South Carolina: IFAMAS	3423	4
1	WESAAC 2012 - Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2012, Florianópolis. Anais do WESAAC 2012. Florianópolis: UFSC	3424	4
1	AMPLE@ECAI 2012 - 2nd International Workshop on Agent-based Modeling for Policy Engineering, European Conference on Artificial Intelligence, 2012, Montpellier, França. Proceedings of AMPLE@ECAI 2012. Montpellier: Université de Montpellier	3425	4
1	V Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2011, Curitiba. Anais do WESAAC 2011. Curitiba: UTFPR	3426	4
1	WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. Anais do WEIT 2011. Rio Grande: FURG	3427	4
1	WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. Anais do WEIT 2011. Pelotas: UFPEL	3428	4
1	V Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2011, Curitiba. Anais do WESAAC 2011. Curitiba: UTFPR	3429	4
1	WESAAC 2010: Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Porto Alegre: FURG	3430	4
1	WESAAC 2010: Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESACC 2010. Rio Grande: FURG	3431	4
1	WESAAC 2010: Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	3432	4
1	WESAAC 2010: Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	3433	4
1	WESAAC 2010: Workshop-Escola de Sistemas Multiagentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	3434	4
627	The Multi-Agent Logics, Languages, and Organisations Federated Workshops (MALLOW 2010)/LAnguages, methodologies and Development tools for multi-agent systemS (LADS 2010), 2010, Lyon. Olivier Boissier, Amal El Fallah Seghrouchni, Salima Hassas and Nicolas Maudet (Eds.), MALLOW 2010 - The Multi-Agent Logics, Languages, and Organisations Federated Workshops, CEUR-WS Workshop Proceedings Series. Aachen: Sun SITE Central Europe/ RWTH Aachen University/Tilburg University	3435	4
627	The Multi-Agent Logics, Languages, and Organisations Federated Workshops (MALLOW 2010)/Workshop on Multi-Agent Systems and Simulation (MASS 2010), 2010, Lyon. Olivier Boissier, Amal El Fallah Seghrouchni, Salima Hassas and Nicolas Maudet (Eds.), MALLOW 2010 - The Multi-Agent Logics, Languages, and Organisations Federated Workshops, CEUR-WS Workshop Proceedings Series. Aachen: Sun SITE Central Europe/ RWTH Aachen University/Tilburg University	3436	4
1	V Workshop on MSc Dissertation and PhD Thesis in Artificial Intelligence, 2010, São Bernardo do Campo. Anais do V Workshop on MSc Dissertation and PhD Thesis in Artificial Intelligence/Joint Conference SBIA/SBRN/JRI 2010. Porto Alegre: SBC	3437	4
1	Second Brazilian Workshop on Social Simulation (BWSS 2010) at Joint Conferences XX SBIA/XI SBRN/IV JRI, 2010, São Bernardo do Campo. (P. T. Aquino Junior, Ed.) Workshop Proceedings/Joint Conference 2010. Porto Alegre: SBC	3438	4
1	Second Brazilian Workshop on Social Simulation - BWSS 2010 at Joint Conference SBIA/SBRN/JRI 2010, 2010, São Bernardo do Campo. (P. T. Aquino Junior, Ed.) Workshop Proceedings/Joint Conference 2010. Porto Alegre: SBC	3439	4
1	Congresso Brasileiro de Sistemas Fuzzy, 2010, Sorocaba. Anais do CBSF 2010. São Carlos: UFSCar	3440	4
1	Second Brazilian Workshop on Social Simulation (BWSS 2010) at Joint Conferences XX SBIA/XI SBRN/IV JRI, 2010, São Bernardo do Campo. (P. T. Aquino Junior, Ed.) Workshop Proceedings/Joint Conference 2010. Porto Alegre: SBC	3441	4
6433	12th Ibero-American Conference on AI, 2010, Bahia Blanca. Angel Morales and Guillerno Simari (Eds.) Advances in Artificial Inteligence - IBERAMIA 2010, Lecture Notes In Artificial Intelligence. Berlin: Springer	3442	4
1	INFORUM - Simpósio de Informática, 2010, Braga. INFORUM Proceedings. Braga: Universidade do Minho	3443	4
1	Computability in Europe 2009: Mathematical Theory and Computational Practice, 2009, Heidelberg. Proceedings of CiE 2009. Heidelberg: Universität Heidelberg	3444	4
1	V Simpósio Brasileiro de Sistemas de Informação, 2009, Brasília. Anais do V Simpósio Brasileiro de Sistemas de Informação. Porto Alegre: SBC	3445	4
1	14th Portuguese Conference on Artificial Intelligence - EPIA'2009/Social Simulation and Modelling - SSM, 2009, 2009, Aveiro. L.S. Lopes, N. Lau, P. Mariano, L.M. Rocha (Eds.) New Trends in Artificial Intelligence. Aveiro: Universidade de Aveiro	3446	4
1	14th Portuguese Conference on Artificial Intelligence - EPIA'2009/Multi-Agent Systems: Theory and Applications - MASTA 2009, 2009, Aveiro. L.S. Lopes, N. Lau, P. Mariano, L.M. Rocha (Eds.) New Trends in Artificial Intelligence. Aveiro: Universidade de Aveiro	3447	4
1	14th Portuguese Conference on Artificial Intelligence - EPIA'2009/Social Simulation and Modelling - SSM 2009, 2009, Aveiro. L.S. Lopes, N. Lau, P. Mariano, L.M. Rocha (Eds.) New Trends in Artificial Intelligence. Aveiro: Universidade de Aveiro	3448	4
1	14th Portuguese Conference on Artificial Intelligence - EPIA'2009/Social Simulation and Modelling - SSM 2009, 2009, Aveiro. Proceedings of EPIA 2009. Aveiro, Portugal: APPIA/Universidade de Aveiro	3449	4
1	3rd Southern Conference on Computational Modeling, 2009, Rio Grande. Proceedings of MCSUL 2009. Rio Grande: FURG	3450	4
1	Fourth Conference on Computability in Europe: Logic and Theory of Algorithms, 2008, Atenas. Logic and Theory of Algorithms, Proceedings of CiE 2008. Atenas: Univ. Athens	3451	4
1	XXXIV Conferência Latinoamericano de Informática, 2008, Buenos Aires. Anales CLEI 2008. Buenos Aires: SADIO	3452	4
1	1st Brazilian Workshop on Social Simulation, 2008, Salvador. Proceedings of the BWSS 2008. Porto Alegre: SBC	3453	4
1	Workshop-Escola de Sistemas de Agentes para Ambientes Colaborativos	3454	4
5249	19th Brazilian Symposium on Artificial Intelligence, 2008, Salvador. G. Zaverucha and A. L. Costa (Eds.) Advances in Artificial Intelligence - SBIA 2008 Proceedings (Lecture Notes in Artificial Intelligence). Berlin: Springer	3455	4
1	Congresso de Matemática Aplicada e Computacional, 2008, 2008, Belém. Anais do CNMAC 2008. Belém: SBMAC	3456	4
1	19th Brazilian Symposium on Artificial Intelligence - Workshop on Social Simulation (SBIA - BWSS 2008), 2008, Salvador. Proceedings of BWSS 2009. Porto Alegre: SBC	3457	4
1	SEGeT 2008 - V Simpósio de Excelência em Gestão e Tecnologia, 2008, Resende, RJ. Anais do SEGeT 2008 - V Simpósio de Excelência em Gestão e Tecnologia. Resende, RJ: Associação Educacional Dom Bosco	3458	4
1	Jornadas Chilenas de Computación 2008 - Workshop en Agentes y Sistemas Colaborativos, 2008, Punta Arenas. Anales de las Jornadas Chilenas de Computación 2008. Santiago, Chile: Sociedad Chilena de Computación	3459	4
1	BWSS 2008 - Brazilian Workshop on Social Simulation, 2008, Salvador. Proceedings of the BWSS 2008 - Brazilian Workshop on Social Simulation. Pelotas: UCPel/SBC	3460	4
	Simpósio Brasileiro de Sistemas Elétricos, 2008, Belo Horizonte. Anais do SBSE 2008	3469	4
	Congresso Brasileiro de Automática, 2008, 2008, Juiz de Fora. Anais eletrônicos do CBA 2008	3470	4
	LARS 2008 - 5º Simpósio Latino-Americano de Robótica, 2008, Salvador/Brasil. Anais do 5º Simpósio Latino-Americano de Robótica	3471	4
	2012 IEEE Third Latin American Symposium on Circuits and Systems (LASCAS), 2012, Playa del Carmen. Proceedings of 2012 IEEE Third Latin American Symposium on Circuits and Systems (LASCAS)	3474	4
	Simposio Sul de Microeletronica - SIM 2012, 2012, Sao Miguel das Missoes. Anais do Simposio Sul de Microeletronica - SIM 2012	3475	4
	Simposio Sul de Microeletronica - SIM 2012, 2012, Sao Miguel das Missoes. Anais do Simposio Sul de Microeletronica - SIM 2012	3476	4
	Simposio Sul de Microeletronica - SIM 2012, 2012, Sao Miguel das Missoes. Anais do Simposio Sul de Microeletronica - SIM 2012	3477	4
	SForum - The 12th Microelectronics Students Forum, 2012, Brasilia. SForum - The 12th Microelectronics Students Forum	3478	4
	SForum - The 12th Microelectronics Students Forum, 2012, Brasilia. SForum - The 12th Microelectronics Students Forum	3479	4
	SIM 2011, 2011, Porto Alegre. SIM 2011	3480	4
	XVI Iberchip Workshop, 2010, Foz do Iguaçu. XVI Iberchip Workshop	3481	4
	SIM 2010, 2010, Porto Alegre. SIM 2010	3482	4
	XXIV CRICTE, 2010, Rio Grande. XXIV CRICTE - Anais	3483	4
	XXIV CRICTE, 2010, Rio Grande. XXIV CRICTE - Anais	3484	4
	XXIV CRICTE, 2010, Rio Grande. XXIV CRICTE - Anais	3485	4
	DATE 2009, 2009, Nice - França. DATE Proceedings	3486	4
	LATW, 2009, Buzios. IEEE Digital Library - IEEE Xplore IEEE Catalog Number: CFP09LAT Library of Congress: 2009901807	3487	4
	24th IEEE International Symposium on Defect and Fault Tolerance in VLSI Systems, 2009, Chicago. Proceeding of 24th IEEE International Symposium on Defect and Fault Tolerance in VLSI Systems	3488	4
	IWS09 Iberchip XV Workshop, 2009, Buenos Aires. Anais of Iberchip XV Workshop 2009	3489	4
	SIM 2009, 2008, Bento Gonçalves. Proceedings of SIM 2009	3490	4
	DECIDE 2008, 2008, Mexico. Proceedings of DECIDE 2008	3491	4
14	Information Control Problems in Manufacturing, 2012, BUCHAREST. 14th IFAC Symposium on Information Control Problems in Manufacturing	3516	4
1	International Conference on Offshore and Marine Technology: Science and Innovation, 2012, Rio Grande. Proceedings of First International Conference on Offshore and Marine Technology: Science and Innovation	3517	4
	Seminário de Extensão Universitária da Região Sul, 2011, Foz do Iguaçu / PR. SEUS 2011. Foz do Iguaçu / PR: Unioeste	3593	4
1	The Sixth International Conference on Mobile Ubiquitous Computing, Systems, Services and Technologies, 2012, Barcelona. The Sixth International Conference on Mobile Ubiquitous Computing, Systems, Services and Technologies. Sao Diego: Elsevier	3518	4
1	IX - Congresso Brasileiro de Ensino Superior a Distância, 2012, Recife. IX - Congresso Brasileiro de Ensino Superior a Distância	3519	4
1	Sixth World Congress on Engineering Asset Management (WCEAM2011), 2011, Cincinnati. Sixth World Congress on Engineering Asset Management (WCEAM2011)	3520	4
	1st IFAC Workshop on Advanced Maintenance Engineering, Services and Technology - IFAC A-MEST'10, 2010, 2010, Lisboa. Proceedings of the 1st IFAC Workshop on Advanced Maintenance Engineering, Services and Technology - IFAC A-MEST'10, 2010	3521	4
	12th Brazilian Workshop on Real-Time and Embedded Systems, 2010, Gramado. . Anais do 12th Brazilian Workshop on Real-Time and Embedded Systems	3522	4
	14º Congresso Internacional e Exposição Sul-Americana de Automação, Sistemas e Instrumentação, 2010, 2010, São Paulo. Anais do Brazil Automation ISA 2010	3523	4
1	World Congress on Engineering Asset Management 2009, 2009, Athens. WCEAM2009 - World Congress on Engineering Asset Management 2009. London: Springer-Verlag London Ltd	3524	4
1	The Modern Information Technology in the Innovation Processes of the Industrial Enterprises - MITIP2009, 2009, Bergamo. 11th International Conference on The Modern Information Technology in the Innovation Processes of the Industrial Enterprises. Bergamo: Università degli Studi di Bergamo	3525	4
	6º Seminário de Eletrônica de Potência e Controle, 2012, Santa Maria. 6. Seminário de Eletrônica de Potência e Controle - SEPOC. Santa Maria	3532	4
	2012 Sixth IEEE/PES Transmission and Distribution: Latin America Conference and Exposition (TD-LA), 2012, Montevideo. Proceedings of the 2012 Sixth IEEE/PES Transmission and Distribution: Latin America Conference and Exposition (TD-LA)	3533	4
	2012 Sixth IEEE/PES Transmission and Distribution: Latin America Conference and Exposition (TD-LA), 2012, Montevideo. Proceedings of the 2012 Sixth IEEE/PES Transmission and Distribution: Latin America Conference and Exposition (TD-LA)	3534	4
	2012 Sixth IEEE/PES Transmission and Distribution: Latin America Conference and Exposition (TD-LA), 2012, Montevideo. Proceedings of the 2012 Sixth IEEE/PES Transmission and Distribution: Latin America Conference and Exposition (TD-LA)	3535	4
	XIX Congresso Brasileiro de Automática, CBA 2012, 2012, Campina Grande. Anais do XIX Congresso Brasileiro de Automática, CBA 2012	3536	4
	XIX Congresso Brasileiro de Automática, CBA 2012, 2012, Campina Grande. Anais do XIX Congresso Brasileiro de Automática, CBA 2012	3537	4
	XIX Congresso Brasileiro de Automática, CBA 2012, 2012, Campina Grande. Anais do XIX Congresso Brasileiro de Automática, CBA 2012	3538	4
01	SBCCI 2010, 2010, São Paulo. SBCCI'10 Proceedings of the 23rd symposium on Integrated circuits and system design. New York: ACM	3539	4
	25th South Symposium on Microelectronics, 2010, Pelotas. Anais do SIM 2010. Porto Alegre: EDIPUCRS	3540	4
01	Fault-Tolerant Distributed Algorithms on VLSI Chips, 2009, Dagstuhl. Dagstuhl Seminar Proceedings. Dagstuhl: Schloss Dagstuhl - Leibniz-Zentrum fuer Informatik, Germany	3541	4
01	3rd International Conference on Design and Technology of Integrated Systems in Nanoscale Era, 2008, DTIS 2008., 2008, Tozeur. Proceedings of DTIS 2008	3542	4
01	Joint 6th International IEEE Northeast Workshop on Circuits and Systems and TAISA Conference, 2008. NEWCAS-TAISA 2008., 2008, Montreal. Proceedins of NEWCAS-TAISA 2008	3543	4
01	51st Midwest Symposium on Circuits and Systems, 2008. MWSCAS 2008., 2008, Knoxville. Proceedings of MWSCAS 2008	3544	4
01	15th International Conference on Electronics, Circuits and Systems, 2008. ICECS 2008., 2008, St. Julien's. Proceedings of ICECS 2008	3545	4
01	15th International Conference on Electronics, Circuits and Systems, 2008. ICECS 2008., 2008, St. Julien's. Proceedings of ICECS 2008	3546	4
	Colloque National du GDR SoC-SiP, 2008, Paris. Colloque National du GDR SoC-SiP	3547	4
	GEOProcessing 2012, 2012, Valência / Espanha. GEOProcessing 2012. Valência / Espanha: IARIA	3575	4
	1o. Seminário Nacional de Inclusão Digital e Software Livre, 2012, Passo Fundo / RS. SENID 2012. Passo Fundo / RS: Editora UPF	3576	4
	Fourth International Conference on Networked Digital Technologies, 2012, Dubai / Emirados Árabes. NDT 2012 - Communications in Computer and Information Science (CCIS 7899) of Springer Lecture Notes Series. Berlin: Springer	3577	4
	Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2012, Florianópolis / SC. WESAAC 2012. Florianópolis / SC: UFSC	3578	4
	Workshop de Desafios da Computação Aplicada à Educação, 2012, Curitiba / PR. Desafie - CSBC 2012. Curitiba / PR: SBC	3579	4
	Congresso Nacional de Diversidade e Inclusão, 2012, São José dos Campos / SP. CONADI 2012. São José dos Campos / SP: CONADI	3580	4
4	Seminário de Extensão Universitária da Região Sul, 2012, Rio Grande / RS. SEURS 2012. Rio Grande / RS: Editora FURG	3581	4
	II Congreso Internacional de Computación e Informática, 2012, Cidad del Carmen. CONACI 2012. Berlin: Springer	3582	4
	Seminário de Extensão Universitária da Região Sul, 2012, Rio Grande / RS. SEURS 2012. Rio Grande / RS: Editora FURG	3583	4
	Conferência Sul-Brasileira de Modelagem Computacional, 2012, Rio Grande / RS. MCSUL 2012. Rio Grande / RS: Editora FURG	3584	4
	Conferência Sul-Brasileira de Modelagem Computacional, 2012, Rio Grande / RS. MCSUL 2012. Rio Grande / RS: Editora FURG	3585	4
	Conferência Sul-Brasileira de Modelagem Computacional, 2012, Rio Grande / RS. MCSUL 2012. Rio Grande / RS: Editora FURG	3586	4
	Conferência Sul-Brasileira de Modelagem Computacional, 2012, Rio Grande / RS. MCSUL 2012. Rio Grande / RS: Editora FURG	3587	4
	Brazilian Workshop on Social Simulation, 2012, Curitiba. BWSS 2012. Los Alamos: IEEE	3588	4
	Brazilian Workshop on Social Simulation, 2012, Curitiba / PR. BWSS 2012. Los Alamos: IEEE	3589	4
	Conferência Sul-Brasileira de Modelagem Computacional, 2012, Rio Grande / RS. MCSUL 2012. Rio Grande / RS: Editora FURG	3590	4
	III Workshop de Computação Aplicada ao Meio Ambiente e ao Recursos Naturais, 2011, Natal / RN. WCAMA 2011. Porto Alegre / RS: CSBC	3591	4
	XI Congreso Iberoamericano de Extensión Universitaria, 2011, Santa Fé / Argentina. XI Congreso Iberoamericano de Extensión Universitaria. Santa Fé / Argentina: La Universidad Nacional del Litoral	3592	4
	5th Latin American Robotics Symposium, 2008, Slavador. IEEE Latin American Robotics Symposium	3700	4
	Congresso Brasileiro de Extesão Universitária, 2011, Porto Alegre RS. CBEU 2011. Porto Alegre / RS: UFRGS	3594	4
	I Simpósio Brasileiro de Educação Inclusiva, 2011, Salvador / BA. I Simpósio Brasileiro de Educação Inclusiva. Salvador / BA: UFBA	3595	4
	II Seminário de Políticas Públicas e Educação: constituindo a cidadania?, 2011, Rio Grande RS. II Seminário de Políticas Públicas e Educação. Rio Grande RS: FURG	3596	4
	The Second International Conference on Networked Digital Technologies, 2010, Praga - República Tcheca. NDT 2010 - LNCS 7899. Heidelberg - Alemanha: Springer	3597	4
	Congresso Regional de Iniciação Científica e Tecnológica em Engenharia, 2010, Rio Grande / RS. CRICTE 2010. Rio Grande	3598	4
	Congresso Regional de Iniciação Científica e Tecnológica em Engenharia, 2010, Rio Grande / RS. CRICTE 2010. Rio Grande	3599	4
	Congresso Regional de Iniciação Científica e Tecnológica em Engenharia, 2010, Rio Grande / RS. CRICTE 2010. Rio Grande	3600	4
	MCSul 2010 - Simpósio de Modelagem Computacional do Sul, 2010, Rio Grande / RS. MCSul 2010. Rio Grande: FURG	3601	4
	MCSul 2010 - Simpósio de Modelagem Computacional do Sul, 2010, Rio Grande / RS. MCSul 2010. Rio Grande: FURG	3602	4
	Cargese Interdisciplinar Seminar 2009, 2009, Cargese. Modeling Simulation of Evolutionary Agents in Virtual Worlds	3603	4
	WCAMA - Workshop de Computação Aplicada ao Meio Ambiente, 2009, Bento Gonçalves. WCAMA	3604	4
02	International Conference on Computer Engineering and Technology, 2009. International Conference on Computer Engineering and Technolog	3605	4
	III Worshop Escola de Sistemas de Agentes para Ambientes Colaborativos, 2009, Caxias do Sul. WESAAC	3606	4
	MDEIS 2008 joint to 10th International Conference on Enterprise Information Systems (ICEIS 2008), 2008, Barcelona. The 4th International Workshop on Model-Driven Enterprise Information Systems	3607	4
	KRRSW 2008 joint to 5th European Semantic Web Conference (ESWC 2008), 2008, Tenerife. 1st International Workshop on Knowledge Reuse and Reengineering over the Semantic Web	3608	4
	SEMISH, 2008, Belém. Seminário Integrado de Software e Hardware (SEMISH 2008)	3609	4
	WESAAC, 2008, Santa Cruz do Sul. Workshop-Escola de Sistemas de Agentes para Ambientes Colaborativos	3610	4
	Seminário de Tecnologia da Informação Aplicada (STIA), 2008, Chapecó / SC. Seminário de Tecnologia da Informação Aplicada	3611	4
	Simpósio Brasileiro de Inteligência Artificial - Concurso de Teses e Dissertações em Inteligência Artificial, 2008, Salvador. SBIA/CTDIA2008	3612	4
	Congresso Sul Brasileiro de Computação, 2008, Criciúma / SC. Sulcomp 2008	3613	4
	Congresso Sul Brasileiro de Computação, 2008, Criciúma / SC. Sulcomp 2008	3614	4
	V Conferência Sul em Modelagem Computacional - MCSul 2012, 2012, Rio Grande. Anais da V Conferência Sul em Modelagem Computacional - VMCSul	3658	4
	Segundo Congresso Brasileiro de Sistemas Fuzzy, 2012, Natal - RN. Recentes Avanços em Sistemas "Fuzzy"	3659	4
	X Simpósio Brasileiro de Automação Inteligentes, 2011, São João del-Rei, MG. Anais do X Simpósio Brasileiro de Automação Inteligente	3660	4
	2010 Fourth International Conference on Network and System Security, 2010, Melbourne. Proceedings of International Conference on Data and Knowledge Engineering 2010	3661	4
	1st International Conference on Applied Robotics for the Power Industry (CARPI), 2010, Montreal. Proceedings of 1st International Conference on Applied Robotics for the Power Industry (CARPI)	3662	4
9	Simpósio Brasileiro de Automação Inteligente - SBAI, 2009, Brasília. ANAIS DO IX SIMPÓSIO BRASILEIRO DE AUTOMAÇÃO INTELIGENTE"	3663	4
	Congresso Brasileiro de Automática, 2008, Juiz de Fora. Anais XVII do Congresso Brasileiro de Automática	3664	4
	Congresso Brasileiro de Automática, 2008, Juiz de Fora. Anais do XVII Congresso Brasileiro de Automática	3665	4
	5th IEEE Latin American Robotics Symposium, 2008, Salvador. Proceedings of 5th Latin American Robotics Symposium	3666	4
	5th IEEE Latin American Robotics Symposium, 2008, Salvador. Proceedings of 5th Latin American Robotics Symposium	3667	4
	Escola Regional de Banco de Dados, 2012, Curitiba. Anais da VIII Escola Regional de Banco de Dados	3670	4
	Escola Regional de Banco de Dados, 2012, Curitiba. Anais da VIII Escola Regional de Banco de Dados	3671	4
	XXXI International Conference of the Chilean Computer Science Society (SCCC), 2012, Valparaíso. Proceedings of the International Conference of the Chilean Computer Science Society	3672	4
	V Conferência Sul em Modelagem Computacional (MCSUL), 2012, Rio Grande. Anais da V Conferência Sul em Modelagem Computacional	3673	4
	XXXVIII Seminário Integrado de Software e Hardware - SEMISH, 2011, Natal. Anais do XXXI Congresso da Sociedade Brasileira de Computação	3674	4
	XXX International Conference of the Chilean Computer Science Society - SCCC, 2011, Curicó. Proceedings of the XXX International Conference of the Chilean Computer Science Society	3675	4
	IADIS International Conference WWW/Internet, 2011, Rio de Janeiro. Proceedings of the IADIS International Conference WWW/Internet 2011	3676	4
	XXIII Simpósio Brasileiro de Bancos de Dados - SBBD, 2008, Campinas. Anais do XXIII Simpósio Brasileiro de Bancos de Dados	3677	4
	IV Escola Regional de Bancos de Dados - ERBD, 2008, Florianópolis. Anais da IV Escola Regional de Bancos de Dados	3678	4
1	Conferência Sul em Modelagem Computacional (MCSUL), 2012, Rio Grande. V MCSUL	3692	4
2	Seminário Internacional de Ciência e Educação, 2012, Rio Grande. II Seminário Internacional de Educação em Ciências	3693	4
2	I Seminário Internacional de Educação em Ciências, 2011, Rio Grande. I SINTEC - Seminário Internacional de Educação em Ciências	3694	4
	1st International Conference on Applied Robotics for the Power Industry (CARPI), 2010, Montreal. 1st International Conference on Applied Robotics for the Power Industry (CARPI)	3695	4
	CBA 2010 - XVIII Congresso Brasileiro de Automática, 2010, Bonito. CBA 2010 - XVIII Congresso Brasileiro de Automática	3696	4
	Latin American Robotics Symposium and Intelligent Robotics Meeting, 2010, São Bernardo do Campo. Latin American Robotics Symposium and Intelligent Robotics Meeting	3697	4
	IX Simpósio Brasileiro de Automação Inteligente, 2009, Brasilia. IX Simpósio Brasileiro de Automação Inteligente	3698	4
	Rio Pipeline 2009 Conference and Exhibition, 2009, Rio de Janeiro. Rio Pipeline 2009 Conference and Exhibition	3699	4
	Simpósio Brasileiro de Sistemas Elétricos, 2008, Belo Horizonte. Simpósio Brasileiro de Sistemas Elétricos	3701	4
	Congresso Brasileiro de Automática, 2008, Juiz de Fora. Congresso Brasileiro de Automática	3702	4
	XXIII ANPET - Congresso de Pesquisa e Ensino em Transportes, 2009, Vitória/ES. Panorama Naconal da Pesquisa em Transportes 2009	3705	4
	III Workshop de Computação Aplicada ao Meio Ambiente e ao Recursos Naturais, 2011, Natal / RN. III Workshop de Computação Aplicada ao Meio Ambiente e ao Recursos Naturais	3706	4
1	Workshop on Adaptive and Learning Agents - ALA 2012 / AAMAS 2012 -11th International Conference on Autonomous Agents and Multiagent Systems, 2012, Valência. Proceedings of AAMAS 2012 - ALA Workshop (Enda Howley, Peter Vrancx and Matt Knudson, eds.). Valência: IFAMAS	3748	4
1	WESAAC 2012 - VI Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2012, Florianópolis. J.F. H ubner; A.A.F. Brandão; R. Silveira; J. Marchi (Eds.) Anais do WESAAC 2012. Florianópolis: UFSC	3749	4
1	WESAAC 2012 - VI Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2012, Florianópolis. J.F. H ubner; A.A.F. Brandão; R. Silveira; J. Marchi (Eds.) Anais do WESAAC 2012. Florianópolis: UFSC	3750	4
1	WESAAC 2012 - VI Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2012, Florianópolis. J.F. H ubner; A.A.F. Brandão; R. Silveira; J. Marchi (Eds.) Anais do WESAAC 2012. Florianópolis: UFSC	3751	4
1	VIII Congresso Nacional de Excelência em Gestão, 2012, Rio de Janeiro. Anais do VIII CNEG. Rio de Janeiro: UFF	3752	4
1	Encontro Nacional de Inteligência Artificial - ENIA 2012, 2012, Curitiba. Anais do ENIA 2012 - Proceedings of the Brazilian Conference on Intelligent Systems. Porto Alegre: SBC	3753	4
1	II CBSF - Segundo Congresso Brasileiro de Sistemas Fuzzy, 2012, Natal. B. C. Bedregal, J. A. F. Roveda, J. Marcos, R. H. N. Santiago, L. C. Barros, W. Seixas (Eds.) Recentes Avanços em Sistemas "Fuzzy". São Carlos: SBMAC	3754	4
1	II CBSF - Segundo Congresso Brasileiro de Sistemas Fuzzy, 2012, Natal. B. C. Bedregal, J. A. F. Roveda, J. Marcos, R. H. N. Santiago, L. C. Barros, W. Seixas (Eds.) Recentes Avanços em Sistemas "Fuzzy". Natal: SBMAC	3755	4
1	II CBSF - Segundo Congresso Brasileiro de Sistemas Fuzzy, 2012, Natal. Anais do CBSF. Natal: UFRN	3756	4
1	II CBSF - Segundo Congresso Brasileiro de Sistemas Fuzzy, 2012, Natal. B. C. Bedregal, J. A. F. Roveda, J. Marcos, R. H. N. Santiago, L. C. Barros, W. Seixas (Eds.) Recentes Avanços em Sistemas "Fuzzy". São Carlos: SBMAC	3757	4
1	BWSS 2012 - The Third Brazilian Workshop on Social Simulation, 2012, Curitiba. Proceedings of BWSS 2012 - Proceedings of the Braziian Conference on Intelligent Systems BRACIS 2012. Porto Alegre: SBC	3758	4
1	BWSS 2012 - The Third Brazilian Workshop on Social Simulation, 2012, Curitiba. Proceedings of BWSS 2012 - Proceedings of the Braziian Conference on Intelligent Systems BRACIS 2012. Porto Alegre: SBC	3759	4
1	BWSS 2012 - The Third Brazilian Workshop on Social Simulation, 2012, Curitiba. Proceedings of BWSS 2012 - Proceedings of the Braziian Conference on Intelligent Systems BRACIS 2012. Porto Alegre: SBC	3760	4
1	BWSS 2012 - The Third Brazilian Workshop on Social Simulation at BRACIS 2012, 2012, Curitiba. Proceedings of BWSS 2012 - Proceedings of the Brazilian Conference on Intelligente Systems - BRACIS 2012 - BWSS 2012. Porto Alegre: SBC	3761	4
1	II CBSF - Segundo Congresso Brasileiro de Sistemas Fuzzy, 2012, Natal. B. C. Bedregal, J. A. F. Roveda, J. Marcos, R. H. N. Santiago, L. C. Barros, W. Seixas (Eds.) Recentes Avanços em Sistemas "Fuzzy". Natal: SBMAC	3762	4
1	V Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2011, Curitiba. Gustavo A. G. Lugo, Jomi F- Hübner, Cesar A. Tacla (Eds.) Anais do WESAAC 2011. Curitiba: UTFPR	3763	4
1	WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. G.P. Dimuro, L. Foss, M.S. Aguiar, S. Costa, A.C.R. Costa (Eds.) Anais do WEIT 2011. Rio Grande: FURG	3764	4
1	WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. G.P. Dimuro, L. Foss, M.S. Aguiar, S. Costa, A.C.R. Costa (Eds.) Anais do WEIT 2011. Rio Grande: FURG	3765	4
1	WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. G.P. Dimuro, L. Foss, M.S. Aguiar, S. Costa, A.C.R. Costa (Eds.) Anais do WEIT 2011. Rio Grande: FURG	3766	4
1	WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. G.P. Dimuro, L. Foss, M.S. Aguiar, S. Costa, A.C.R. Costa (Eds.) Anais do WEIT 2011. Rio Grande: FURG	3767	4
1	WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. G.P. Dimuro, L. Foss, M.S. Aguiar, S. Costa, A.C.R. Costa (Eds.) Anais do WEIT 2011. Rio Grande: FURG	3768	4
1	WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. G.P. Dimuro, L. Foss, M.S. Aguiar, S. Costa, A.C.R. Costa (Eds.) Anais do WEIT 2011. Rio Grande: FURG	3769	4
1	WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. G.P. Dimuro, L. Foss, M.S. Aguiar, S. Costa, A.C.R. Costa (Eds.) Anais do WEIT 2011. Rio Grande: FURG	3770	4
1	Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	3771	4
1	Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	3772	4
627	The Multi-Agent Logics, Languages, and Organisations Federated Workshops (MALLOW 2010)/LAnguages, methodologies and Development tools for multi-agent systemS (LADS 2010), 2010, Lyon. Olivier Boissier, Amal El Fallah Seghrouchni, Salima Hassas and Nicolas Maudet (Eds.), MALLOW 2010 - The Multi-Agent Logics, Languages, and Organisations Federated Workshops, CEUR-WS Workshop Proceedings Series. Aachen: Sun SITE Central Europe/ RWTH Aachen University/Tilburg University	3773	4
627	The Multi-Agent Logics, Languages, and Organisations Federated Workshops (MALLOW 2010)/Workshop on Multi-Agent Systems and Simulation (MASS), 2010, Lyon. Olivier Boissier, Amal El Fallah Seghrouchni, Salima Hassas and Nicolas Maudet (Eds.), MALLOW 2010 - The Multi-Agent Logics, Languages, and Organisations Federated Workshops, CEUR-WS Workshop Proceedings Series. Aachen: Sun SITE Central Europe/ RWTH Aachen University/Tilburg University	3774	4
1	V Workshop on MSc Dissertation and PhD Thesis in Artificial Intelligence/Joint Cinference SBIA/SBRN/JRI 2010, 2010, São Bernardo do Campo. (P. T. Aquino, Ed.) Workshop Proceedings/Joint Conference 2010. Porto Alegre: SBC	3775	4
1	Second Brazilian Workshop on Social Simulation (BWSS 2010) at Joint Conferences XX SBIA/XI SBRN/IV JRI, 2010, São Bernardo do Campos. (P. T. Aquino Junior, Ed.) Workshop Proceedings/Joint Conference 2010. Porto Alegre: SBC	3776	4
1	Congresso Brasileiro de Sistemas Fuzzy, 2010, Sorocaba. Anais do CBSF 2010. São Carlos: UFSCar	3777	4
1	Second Brazilian Workshop on Social Simulation - BWSS 2010 at Joint Conference SBIA/SBRN/JRI 2010, 2010, São Bernardo do Campo. (P. T. Aquino Junior, Ed.) Workshop Proceedings/Joint Conference 2010. Porto Alegre: SBC	3778	4
1	4th Southern Conference on Computational Modeling/IX Encontro Regional de Matemática Aplicada e Computacional, 2010, Rio Grande. Anais do 4 MCSUL/IX ERMAC. Rio Grande: FURG	3779	4
1	4th Southern Conference on Computational Modeling/IX Encontro Regional de Matemática Aplicada e Computacional, 2010, Rio Grande. Anais do 4MCSUL/IX ERMAC. Rio Grande: FURG	3780	4
1	4th Southern Conference on Computational Modeling/IX Encontro Regional de Matemática Aplicada e Computacional, 2010, Rio Grande. Anais do 4MCSUL/IX ERMAC. Rio Grande: FURG	3781	4
1	4th Southern Conference on Computational Modeling/IX Encontro Regional de Matemática Aplicada e Computacional, 2010, Rio Grande. Anais do 4 MCSUL/IX ERMAC. Rio Grande: FURG	3782	4
1	Computability in Europe 2009: Mathematical Theory and Computational Practice, 2009, Heidelberg. Klaus Ambos-Spies, Benedikt Löwe, Wolfgang Merkle (Editors) Mathematical Theory and Computational Practice. Heidelberg: University of Heidelberg	3783	4
1	International Fuzzy Systems Association World Congress/European Society for Fuzzy Logic and Technonoly Conference 2009, 2009, Lisboa. Proceedings of 2009 ISFA World Congress/2009 EUSFLAT Conference. Lisboa: ISFA/EUSFLAT	3784	4
1	14th Portuguese Conference on Artificial Intelligence - EPIA'2009/Social Simulation and Modelling - SSM, 2009, Aveiro. L.S. Lopes, N. Lau, P. Mariano, L.M. Rocha (eds.) New Trends In Artificial Intelligence. Aveiro: Universidade de Aveiro	3785	4
1	14th Portuguese Conference on Artificial Intelligence - EPIA'2009/Multi-Agent Systems: Theory and Applications - MASTA 2009, 2009, Aveiro. L.S. Lopes, N. Lau, P. Mariano, L.M. Rocha (eds.) New Trends In Artificial Intelligence. Aveiro: Universidade de Aveiro	3786	4
2	XXXII Congresso Nacional de Matemática Aplicada e Computacional, 2009, Cuiabá. A. L. Bortoli et al. (Eds.) Anais do CNMAC. São Carlos: SBMAC	3787	4
1	The 3rd Southern Conference on Computational Modeling, 2009, Rio Grande. Proceedings of MCSUL 2009. Rio Grande: FURG	3788	4
1	Fourth Conference on Computability in Europe: Logic and Theory of Algorithms, 2008, Athens. Arnold Beckmann, Costas Dimitracopoulos and Benedikt Löwe (eds.) Logic and Theory of Algorithms, Proceedings of CiE 2008. Athens: University of Athens	3789	4
5110	15th Workshop on Logic, Information, Language and Computation, 2008, Edinburgh. Wilfrid Hodges and Ruy de Queiroz (Eds.) Logic, Language, Information and Computation15th International Workshop, WoLLIC 2008 Edinburgh, UK, July 1-4, 2008 Proceedings (Lecture Notes in Artificial Intelligence). Berlin: Springer-Verlag	3790	4
1	XXXI Congresso Nacional de Matemática Aplicada e Computacional, 2008, Belém. E. C. Abreu et al. Anais do CNMAC. São Carlos: SBMAC	3791	4
1	XXXI Congresso Nacional de Matemática Aplicada e Computacional, 2008, Belém. E. C. Abreu et al. (Eds.) Anais do CNMAC. São Carlos: SBMAC	3792	4
1	II Workshop-Escola de Sistemas de Agentes para Sistemas Colaborativos, 2008, Santa Cruz. R. Frozza e A. A. Kozen (Org.) Anais do WESAAC 2008. Santa Cruz do Sil: EDUNISC	3793	4
1	II Workshop Escola de Sistemas de Agentes para Ambientes Colaborativos, 2008, Santa Cruz. R. Frozza e A. A. Konzen (Org.) Anais do WESAAC 2008. Santa Cruz do Sul: EDUNIISC	3794	4
1	II Workshop-Escola de Sistemas de Agentes para Ambientes Colaborativos, 2008, Santa Cruz. R. Frozza e A. A. Konzen (Org.) Anais do WESAAC 2008. Santa Cruz so Sul: EDUNISC	3795	4
5249	19th Brazilian Symposium on Artificial Intelligence, 2008, Salvador. G. Zaverucha and A. L. Costa (Eds.) Advances in Artificial Intelligence - SBIA 2008 Proceedings (Lecture Notes in Artificial Intelligence). Berlin: Springer	3796	4
1	Third Workshop on Logical and Semantic Frameworks, with Applications, 2008, Salvador. Mario Benevides and Elaine Pimentel (eds.), Pré-Proceedings of LSFA 2008. Porto Alegre: SBC	3797	4
1	(G. P. Henning, M. R. Galli y S. Goneet, eds.) XXXIV Conferência Latinoamericano de Informática, 2008, Santa Fe. Anales CLEI 2008. Buenos Aires: Sadio	3798	4
1	SBIA 2008 / BWSS 2008 - 1st Brazilian Workshop on Social Simulation, 2008, Salvador. Proceedings of SBIA 2008 / BWSS 2008. Porto Alegre: SBC	3799	4
1	VII Simpósio de Informática da Região Centro do RS, 2008, Santa Maria. Anais do SIRC 2008. Santa Maria: UNIFRA	3800	4
1	IV Workshop on MSc Dissertation and PhD Thesis in Artificial Intelligence (WTDIA), 2008, Salvador. Proceedings of IV WTDIA. Porto Alegre: SBC	3801	4
1	VI Best MSc Dissertation/PhD Thesis Contest (CTDIA), 2008, Salvador. Proceedings of VI CTDIA. Porto Alegre: SBC	3802	4
	BTAS '09, 2009, Washington, D.C. IEEE 3rd International Conference on Biometrics: Theory, Applications, and Systems, 2009	3817	4
	XXXI International Conference of the Chilean Computer Science Society (SCCC), 2012, Valparaíso. Proceedings of the International Conference of the Chilean Computer Science Society	3818	4
	V Conferência Sul em Modelagem Computacional (MCSUL), 2012. Anais da V Conferência Sul em Modelagem Computacional	3819	4
	VIII Congreso Internacional sobre Investigación en la Didáctica de las Ciencias, 2009, Barcelona. Enseñanza de las Ciencias - VIII Congreso Internacional sobre Investigación en la Didáctica de las Ciencias	3824	4
	IV Seminário Jogos Eletrônicos, Educação e Comunicação - construindo novas trilhas, 2008, Bahia. IV Seminário Jogos Eletrônicos, Educação e Comunicação - construindo novas trilhas	3825	4
	Simpósio Brasileiro de Jogos e Entretenimento Digital, 2008, Belo Horizonte. SBGAMES 2008	3826	4
	Internet of Things (iThings/CPSCom), 2011 International Conference on and 4th International Conference on Cyber, Physical and Social Computing, 2011, Dalian. Proceedings of iThings/CPSCom	3829	4
	Encontro de Pesquisa em Educação da Região Sul - ANPED SUL, 2010, Londrina. Anais do ANPED SUL	3830	4
	INFORMATION CONTROL PROBLEMS IN MANUFACTURING - INCOM, 2009, Moscow. PREPRINTS OF THE 13th IFAC SYMPOSIUM ON INFORMATION CONTROL PROBLEMS IN MANUFACTURING. Moscow	3831	4
	IEEE International Conference on Engineering of Complex Computer Systems, 2009, Potsdam. Proceedings of the IEEE International Conference on Engineering of Complex Computer Systems - ICECCS. Potsdam: IEEE	3832	4
	The 3rd Southern Conference on Computational Modeling, 2009, Rio Grande. III MCSUL	3833	4
	Simpósio Brasileiro de Games, 2008, Belo Horizonte - MG. Proceedings - SBGames - Computing	3834	4
7409	Brazilian Symposium on Bioinformatics, 2012, Campo Grande. LNBI-LNCS. Advances in Bioinformatics and Computational Biology. Berlin: Springer-Verlag	3842	4
6098	The Twenty Third International Conference on Industrial, Engineering Other Applications of Applied Intelligent Systems, 2010, Córdoba. Trends in Applied Intelligent Systems. IEA/AIE 2010 Part III LNAI-LNCS. Berlin: Springer-Verlag	3843	4
1	IADIS International Conference Applied Computing, 2010, Timisoara. Applied Computing	3844	4
	IADIS International Conference Applied Computing, 2010, Timisoara. Applied Computing	3845	4
5167	III Brazilian Simposium on Bioinformatics, 2008, Santo André. LNBI-LNCS. Advances in Bioinformatics and Computational Biology.. Berlin: Springer-Verlag	3846	4
	IV Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações, 2010, Rio Grande. Anais do IV Wesaac	3865	4
1	Congresso Regional de Iniciação Científica e Tecnológica em Engenharia - CRICTE, 2010, Rio Grande. Anais	3866	4
	IV Conferência Sul de Modelagem Computacional, 2010, Rio Grande. Anais	3867	4
	International Joint Conference on Neural Networks (IJCNN2008), 2008, Hong Kong. International Joint Conference on Neural Networks (IJCNN2008)	3868	4
	SEGeT Simpósio de Excelência em Gestão e Tecnologia, 2012, Resende - RJ. Anais do IX Simpósio de Excelência em Gestão e Tecnologia - SEGeT	3877	4
	XXIII ENANGRAD - AVALIAÇÃO E GESTÃO DO CURSO DE ADMINISTRAÇÃO: Realidades e Perspectivas, 2012, Bento Gonçalves - RS. Anais do XXIII ENANGRAD - AVALIAÇÃO E GESTÃO DO CURSO DE ADMINISTRAÇÃO: Realidades e Perspectivas	3878	4
	WCCA 2011 World Congress on Communication and Arts, 2011, São Paulo. WCCA 2011 World Congress on Communication and Arts. São Paulo	3879	4
	17º CIAED - Congresso Internacional ABED de Educação a Distância, 2011, Manaus. A Grande Conversação: Diferentes Formas de Aprender, Conteúdos Variados e Tecnologias Diferenciadas - Interação com Diversidade	3880	4
XI	XI Colóquio Internacional sobre Gestão Universitária nas Américas, 2011, Florianópolis. Anais XI Colóquio Internacional sobre Gestão Universitária nas Américas	3881	4
1	II Encontro Fluminense de Engenharia de Produção, 2010, Rio das Ostras - RJ. UMA ANÁLISE DAS DIFICULDADES DE INVESTIMENTO NAS MPEs PELA BAIXA UTILIZAÇÃO DE FERRAMENTAS DE GESTÃO	3882	4
	ESUD - Congresso Brasileiro de Ensino Superior a Distância, 2010, Cuiabá. A EaD e sua institucionalização: reflexões e processos	3883	4
	II CONGRESO INTERNACIONAL - CIENCIAS, TECNOLOGÍAS Y CULTURAS. DIÁLOGO ENTRE LAS DISCIPLINAS DEL CONOCIMIENTO. MIRANDO AL FUTURO DE AMÉRICA LATINA Y EL CARIBE, 2010, Santiago. Educação e Tecnologias	3884	4
	I Congresso Internacional de Educação a Distância da UFPel, 2010, Pelotas. Anais do I Congresso Internacional de Educação a Distância da UFPel	3885	4
1	NAVTEC 2012 - Conferência Internacional em Tecnologias Naval e Offshore: Ciência e Inovação, 2012, Rio Grande. Anais NAVTEC 2012	3895	4
1	NAVTEC 2012 - Conferência Internacional em Tecnologias Naval e Offshore: Ciência e Inovação, 2012, Rio Grande. Anais NAVTEC 2012	3896	4
1	The Sixth International Conference on Mobile Ubiquitous Computing, Systems, Services and Technologies, 2012, Barcelona. Anais of The Sixth International Conference on Mobile Ubiquitous Computing, Systems, Services and Technologies. Barcelona: IARIA	3897	4
1	IEEE Latin American Robotic Systems - IEEE LARS, 2012, 2012, Fortaleza. Proceedings of IEEE Latin American Robotic Systems - IEEE LARS, 2012. New York: IEEE Xplore	3898	4
1	IEEE LARS, 2012, 2012, Fortaleza. Proceedings of IEEE Latin American Robotic Systems - IEEE LARS, 2012. New York: IEEE Xplore	3899	4
	ENIA - VIII Encontro Nacional de Inteligência Artificial, 2011, Natal. Anais do VIII Encontro Nacional de Inteligência Artificial	3900	4
	X Simpósio Brasileiro de Automática, 2011, São João del Rey. X Simpósio Brasileiro de Automática	3901	4
	Internet of Things (iThings/CPSCom), 2011 International Conference on and 4th International Conference on Cyber, Physical and Social Computing, 2011, Dalian. Anais Internet of Things (iThings/CPSCom), 2011 International Conference on and 4th International Conference on Cyber, Physical and Social Computing	3902	4
	IV Seminário e workshop em Engenharia Oceânica, 2010, Rio Grande. Anais do IV Seminário e workshop em Engenharia Oceânica	3903	4
	4MCSUL, 2010, Rio Grande. Anais do 4MCSUL	3904	4
	23 Congresso Nacional de Transporte Aquaviário, Construção Naval e Offshore, 2010, Rio de Janeiro. Anais do 23 Congresso Nacional de Transporte Aquaviário, Construção Naval e Offshore	3905	4
	1st International Conference on Applied Robotics for the Power Industry (CARPI), 2010, Montreal. Anais do 1st International Conference on Applied Robotics for the Power Industry (CARPI)	3906	4
	INCOM 2009, 2009, Moscou. Anais di 13th IFAC Symposium on Information Control Problems in Manufacturing	3907	4
CD-ROM	Simpósio Brasileiro de Sistemas Elétricos, 2008, Belo Horizonte. Anais do SBSE 2008. Belo Horizonte: Editora da Universidade Federal de Minas Gerais	3908	4
cd-rom	Simpósio Brasileiro de Redes de Computadores - Salão de Ferramentas, 2008, Rio de Janeiro. Anais do SBRC 2008	3909	4
	VII SBGames, 2008, Belo Horizonte. Anais do Simpósio Brasileial ro de Jogos para Computador e Entretenimento Digital - 2008	3910	4
1	XI Congreso Argentino de Meteorologia, 2012, Mendoza. XI Congremet. Buenos Aires: Centro Argentino de Meteorologos	3923	4
1	XI Congreso Argentino de Meteorologia, 2012, Mendoza. XI Congremet. Buenos Aires: Centro Argentino de Meteorologos	3924	4
1	XI Congreso Argentino de Meteorologia, 2012, Mendoza. XI Congremet. Buenos Aires: Centro Argentino de Meteorologos	3925	4
1	XVII Congresso Brasileiro de Meteorologia, 2012, Gramado, RS. Anais do XVII Congresso Brasileiro de Meteorologia. Rio de Janeiro: SBMet	3926	4
1	XVII Congresso Brasileiro de Meteorologia, 2012, Gramado, RS. Anais do XVII Congresso Brasileiro de Meteorologia. Rio de Janeiro: SBMet	3927	4
1	XVII Congresso Brasileiro de Meteorologia, 2012, Gramado. Anais do XVII Congresso Brasileiro de Meteorologia. Rio de Janeiro: SBMet	3928	4
1	XVII Congresso Brasileiro de Meteorologia, 2012, Gramado. Anais do XVII Congresso Brasileiro de Meteorologia. Rio de Janeiro: SBMet	3929	4
1	XVII Congresso Brasileiro de Meteorologia, 2012, Gramado. Anais do XVII Congresso Brasileiro de Meteorologia. Rio de Janeiro: SBMet	3930	4
1	XVII Congresso Brasileiro de Meteorologia, 2012, Gramado. Anais do XVII Congresso Brasileiro de Meteorologia. Rio de Janeiro: SBMet	3931	4
1	V Conferência Sul em Modelagem Computacional, 2012, Rio Grande. Anais da V Conferência Sul em Modelagem Computacional. Rio Grande: Universidade Federal do Rio Grande	3932	4
1	XIII Congreso Latinoamericano e Ibérico de Meteorología e X Congreso Argentino de Meteorología, 2009, Buenos Aires. Anais. Buenos Aires	3933	4
1	XIII Congreso Latinoamericano e Ibérico de Meteorología e X Congreso Argentino de Meteorología, 2009, Buenos Aires. Anais. Buenos Aires	3934	4
1	XIII Congreso Latinoamericano e Ibérico de Meteorología e X Congreso Argentino de Meteorología, 2009, Buenos Aires. Anais. Buenos Aires	3935	4
1	XIII Congreso Latinoamericano e Ibérico de Meteorología e X Congreso Argentino de Meteorología, 2009, Buenos Aires. Anais. Buenos Aires	3936	4
1	III Simpósio Internacional de Climatologia, 2009, Canela, RS. Anais. Canela, RS	3937	4
1	III Simpósio Internacional de Climatologia, 2009, Canela, RS. Anais. Canela, RS	3938	4
1	II Simpósio de Pesquisa em Ensino e História de Ciências da Terra, 2009, São Paulo. Anais. São Paulo	3939	4
1	XV Congresso Brasileiro de Meteorologia, 2008, São Paulo. Anais. São Paulo: SBMet	3940	4
1	XV Congresso Brasileiro de Meteorologia, 2008, São Paulo. Anais. São Paulo: SBMet	3941	4
1	XV Congresso Brasileiro de Meteorologia, 2008, São Paulo. Anais. São Paulo: SBMet	3942	4
1	XV Congresso Brasileiro de Meteorologia, 2008, São Paulo. Anais. São Paulo: SBMet	3943	4
	Escola Regional de Redes de Computadores, 2012, Pelotas. X Escola Regional de Redes de Computadores	3953	4
	Escola Regional de Redes de Computadores, 2012, Pelotas. X Escola Regional de Redes de Computadores	3954	4
	IEEE International Requirements Engineering Conference (RE), 2012, Chicago. 20th IEEE International Requirements Engineering Conference	3955	4
	SIM 2012 - South Symposium on Microelectronics, 2012, São Miguel das Missões. Proceedings of SIM 2012 - South Symposium on Microelectronics	3970	4
	South Symposium on Microelectronics (SIM 2012), 2012, São Miguel das Missões. Proceedings of South Symposium on Microelectronics (SIM 2012)	3971	4
	South Symposium on Microelectronics (SIM 2012), 2012, São Miguel das Missões. Proceedings of South Symposium on Microelectronics (SIM 2012)	3972	4
	South Symposium on Microelectronics, 2012, São Miguel das Missões. Proceedings of South Symposium on Microelectronics	3973	4
	26th South Symposium on Microelectronics - SIM2011, 2011, Novo Hamburgo. Proceedings of South Symposium on Microelectronics - SIM2011	3974	4
	24th Symposium on Integrated Circuits and Systems Design - SBCCI 2011, 2011, João Pessoa. Proceedings of 24th Symposium on Integrated Circuits and Systems Design - SBCCI 2011	3975	4
	29th IEEE International Conference on Computer Design - ICCD 2011, 2011, Amherst. Proceedings of 29th IEEE International Conference on Computer Design - ICCD 2011	3976	4
	South Symposium on Microelectronics, 2010, Porto Alegre. Proceedings. Porto Alegre: EDIPUCRS	3977	4
	International19th International Workshop on Power And Timing Modeling Optimization and Simulation, 2009, Delft. Lecture Notes in Computer Science	3978	4
	24th South Symposium on Microelectronics, 2009, Pelotas. Proceedings of the 24th South Symposium on Microelectronics. Pelotas: Editora e Gráfica Universitária PREC-UFPel	3979	4
	18th ACM Great Lakes symposium on VLSI (GLSVLSI), 2008, Orlando, Florida. Proceedings of 18th ACM Great Lakes symposium on VLSI (GLSVLSI). New York: ACM	3980	4
	XXIII South Symposium on Microelectronics (SIM), 2008, Bento Gonçalves. Proceedings of XXIII South Symposium on Microelectronics (SIM). Porto Alegre: Evangraf	3981	4
	IEEE Custom Integrated Circuits Conference, 2008. Custom Integrated Circuits Conference	3982	4
	17th ACM/IEEE International Workshop on Logic and Synthesis, 2008, Lake Tahoe. Workshop Notes of the 17th ACM/IEEE International Workshop on Logic and Synthesis	3983	4
	IEEE International Conference on Robotics and Automation - ICRA, 2012, Saint Paul. Proceedings of IEEE International Conference on Robotics and Automation	4011	4
	International Conference on Offshore and Marine Technology: Science and Innovation, 2012, Rio Grande, Brazil. Proceedings of International Conference on Offshore and Marine Technology: Science and Innovation	4012	4
	Brazilian Symposium on Neural Networks, 2012, Curitiba, Brazil. Proceedings of Brazilian Symposium on Neural Networks	4013	4
	XIX Congresso Brasileiro de Automática, 2012, Campina Grande, Brazil. Anais do XIX Congresso Brasileiro de Automática	4014	4
	XIX Congresso Brasileiro de Automática, 2012, Campina Grande, Brazil. Anais do XIX Congresso Brasileiro de Automática	4015	4
	XIX Congresso Brasileiro de Automática, 2012, Campina Grande, Brazil. Anais do XIX Congresso Brasileiro de Automática	4016	4
	XIX Congresso Brasileiro de Automática, 2012, Campina Grande, Brazil. Anais do XIX Congresso Brasileiro de Automática	4017	4
	XIX Congresso Brasileiro de Automática, 2012, Campina Grande, Brazil. Anais do XIX Congresso Brasileiro de Automática	4018	4
	Latin American Robotics Symposium / Brazilian Robotics Symposium (LARS/SBR), 2012, Fortaleza, Brazil. Proceedings of IEEE Latin American Robotics Symposium	4019	4
	Latin American Robotics Symposium / Brazilian Robotics Symposium (LARS/SBR), 2012, Fortaleza, Brazil. Proceedings of IEEE Latin American Robotics Symposium	4020	4
	Latin American Robotics Symposium / Brazilian Robotics Symposium (LARS/SBR), 2012, Fortaleza, Brazil. Proceedings of IEEE Latin American Robotics Symposium	4021	4
	Encontro Nacional de Inteligência Artificial - ENIA, 2012, Curitiba. Anais do IX Encontro Nacional de Inteligência Artificial - ENIA	4022	4
	ENIA - VIII Encontro Nacional de Inteligência Artificial - CSBC, 2011, Natal. ENIA - VIII Encontro Nacional de Inteligência Artificial - CSBC	4023	4
	IEEE 9th International Conference on. Industrial Informatics, 2011, Lisboa. IEEE 9th International Conference on. Industrial Informatics	4024	4
	X Simpósio Brasileiro de Automática - SBAI 2011, 2011, Sao Joao del Rei - Brazil. Anais do X Simpósio Brasileiro de Automática	4025	4
	X Simpósio Brasileiro de Automática - SBAI 2011, 2011, Sao Joao del Rey - Brazil. Anais do X Simpósio Brasileiro de Automática	4026	4
	The 17th International Conference on Systems, Signals and Image Processing (IWSSIP 2010), 2010, Niteroi, Brazil. Proceedings of the 17th International Conference on Systems, Signals and Image Processing. Niteroi, RJ, Brazil: Editora da Universidade Federal Fluminense	4027	4
	IEEE International Conference on Robotics and Automation (ICRA), 2010, Anchorage, USA. Proceedings of the IEEE Int. Conf. on Robotics and Automation	4028	4
	XXII Concurso de Teses e Dissertações da SBC - CSBC, 2010, Belo Horizonte. Anais do Congresso da SBC (CSBC)	4029	4
	13th International Conference on Information Fusion (FUSION), 2010, Edinburgh, UK. Proceedings of 13th International Conference on Information Fusion	4030	4
	IEEE International Conference on Multisensor Fusion and Integration, 2010, Salt Lake, USA. Proceedings of the 2010 IEEE International Conference on Multisensor Fusion and Integration	4031	4
	Congresso Brasileiro de Automática, 2010, Bonito - Brazil. Anais do XVIII Congresso Brasileiro de Automática	4032	4
	Congresso Brasileiro de Automática, 2010, Bonito - Brazil. Anais do XVIII Congresso Brasileiro de Automática	4033	4
	13th International Conference on Information Fusion (FUSION), 2010, Edinburg, UK. Proceedings of 13th International Conference on Information Fusion (FUSION)	4034	4
	IEEE/RSJ International Conference on Intelligent Robots and Systems, 2010, Taipei - Taiwan. Proceedings of IEEE/RSJ International Conference on Intelligent Robots and Systems	4035	4
	Latin American Robotics Symposium, 2010, São Bernardo do Campo - Brazil. Proceedings of VII Latin American Robotics Symposium	4036	4
	I International Conference on Biodental Engineering, 2009, Porto - Portugal. I International Conference on Biodental Engineering	4037	4
	International Congress of Mechanical Engineering (COBEM), 2009, Gramado - Brazil. Anais do COBEM 2009	4038	4
	The 2009 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS), 2009, St. Louis USA. The 2009 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)	4039	4
	European Conference on Mobile Robots, 2009, Dubrovnik. Proceedings of the 4th European Conference on Mobile Robots	4040	4
	European Conference on Mobile Robots, 2009, Dubrovnik. Proceedings of the 4th European Conference on Mobile Robots	4041	4
	IX Simpósio Brasileiro de Automação Inteligente, 2009, Brasilia. Anais do IX Simpósio Brasileiro de Automação Inteligente	4042	4
	IEEE Latin American Robotics Symposium (LARS), 2009, Valparaiso - Chile. Proceedings of IEEE Latin American Robotics Symposium	4043	4
	Simpósio Brasileiro de Automação Inteligente (SBAI), 2009, Brasilia. Anais do Simpósio Brasileiro de Automação Inteligente (SBAI)	4044	4
	III MCSUL - 3rd Southern Conference on Computational Modelling, 2009, Rio Grande - Brazil. Anais do III MCSUL	4045	4
	IEEE/OES Oceans, 2009, Bremen, Germany. Proceedings of IEEE/OES Oceans	4046	4
1	Simposio Brasileiro de Sistemas Elétricos, 2008, Belo Horizonte. Anais do SBSE 2008	4047	4
	Congresso da Sociedade Brasileira de Computação - Concurso de Trabalhos de Iniciação Científica, 2008, Belem. Anais do XXVIII Congresso da Sociedade Brasileira de Computação	4048	4
	XVII Congresso Brasileiro de Automática, 2008, Juiz de Fora - MG - Brazil. Anais do XVII Congresso Brasileiro de Automática	4049	4
1-4	MTS/IEEE Oceans, 2008, Quebec. Proc. of the MTS/IEEE Oceans	4050	4
	Workshop of Undergraduate Work - Brazilian Symposium on Computer Graphics and Image Processing (SIBGRAPI), 2008, Campo Grande. Proceedings of the XXI Brazilian Symposium on Computer Graphics and Image Processing (SIBGRAPI)	4051	4
	III Seminário e Workshop de Engenharia Oceânica, 2008, Rio Grande. Anais do III Seminário e Workshop de Engenharia Oceânica	4052	4
	5th Latin American Robotics Symposium - LARS, 2008, Salvador. Proceedings of the 5th Latin American Robotics Symposium	4053	4
	Internet of Things (iThings/CPSCom), 2011, Dalian. 2011 International Conference on and 4th International Conference on Cyber, Physical and Social Computing	4067	4
	Encontro de Pesquisa em Educação da Região Sul - ANPED SUL, 2010, Londrina. Anais do ANPED SUL	4068	4
V2	Seminário Internacional de Ciência e Educação, 2012, Rio Grande. Anais do II Seminário Internacional de Educação em Ciências	4072	4
	CONFERÊNCIA SUL EM MODELAGEM COMPUTACIONAL - MCSUL, 2012, Rio Grande. Anais da V Conferência Sul em Modelagem Computacional VMCSul	4073	4
	Congresso Brasileiro de Extensão Universitária, 2009, Dourados-MS. Congresso Brasileiro de Extensão Universitária	4074	4
	IV Seminário Jogos Eletrônicos, Educação e Comunicação construindo novas trilhas, 2008, UNEB - Salvador. IV Seminário Jogos Eletrônicos, Educação e Comunicação construindo novas trilhas	4075	4
	VII Brazilian Symposium on Computer Games and Digital Entertainment, 2008, Belo Horizonte MG. VII Brazilian Symposium on Computer Games and Digital Entertainment	4076	4
	Workshop de Desafios da Computação Aplicada à Educação, 2012, Curitiba/PR. Desafie - CSBC 2012, SBC	4089	4
	Congresso Nacional de Diversidade e Inclusão, 2012, São José dos Campos / SP. CONADI 2012	4090	4
	II Congreso Internacional de Computación e Informática, 2012, Ciudad del Carmen. CONACI 2012. Berlin: Springer	4091	4
	Seminário de Extensão Universitária da Região Sul, 2012, Rio Grande. SEURS 2012. Rio Grande: Editora FURG	4092	4
	III Congresso Baiano de Educação Inclusiva: Práticas, Formação e Lugares, 2011, Salvador. III Congresso Baiano de Educação Inclusiva: Práticas, Formação e Lugares	4093	4
	II Seminário de Políticas Públicas e Educação: constituindo a cidadania?, 2011, Rio Grande, RS. II Seminário de Políticas Públicas e Educação	4094	4
	1º Congresso Internacional de Educação à Distância da UFPEL, 2010, Pelotas. 1º Congresso Internacional de Educação à Distância da UFPEL	4095	4
	XV II - CIESC Iberian American Conference on High Education in Computer Science, 2009, Pelotas. CLEI 2009	4096	4
	Robotics in Education, 2012, Praga. Proceedings of the 3rd International Conference on Robotics in Education	4106	4
	International Biometric Performance Testing Conference, 2010, Washington, D.C.. NIST Special Publication 500-283	4107	4
	Biometrics: Theory, Applications, and Systems, 2010, Washington, D.C.. IEEE 4th International Conference on Biometrics: Theory, Applications, and Systems, 2010. BTAS '10	4108	4
	International Conference on Frontiers in Handwriting Recognition, 2010, Kolkata, India. Proceedings of the 12th International Conference on Frontiers in Handwriting Recognition	4109	4
	Simpósio Brasileiro de Telecomunicações, 2009, Blumenau, SC. Anais do XXVII Simpósio Brasileiro de Telecomunicações	4110	4
	Biometrics: Theory, Applications, and Systems, 2009, Washington, D.C.. IEEE 3rd International Conference on Biometrics: Theory, Applications, and Systems, 2009. BTAS '09	4111	4
	Simposio Brasileiro de Telecomunicacoes, 2008, Recife. Anais do XXVI Simpósio Brasileiro de Telecomunicações	4112	4
1	IEEE 9th International Conference on Industrial Informatics, 2011, Lisboa. Proceedings of 2011 IEEE 9th International Conference on Industrial Informatics	4113	4
Único	2010 17th IEEE International Conference and Workshops on Engineering of Computer Based Systems (ECBS), 2010, Rio de Janeiro. Proceeding of 2010 17th IEEE International Conference and Workshops on Engineering of Computer Based Systems (ECBS). Oxfor, England: IEEE	4114	4
	2010 23rd SIBGRAPI Conference on Graphics, Patterns and Images (SIBGRAPI), 2010, Gramado, Brazil. Proceedings 23rd SIBGRAPI Conference on Graphics, Patterns and Images. Los Alamitos, California: IEEE Computer Society	4115	4
	XVIII Congresso Brasileiro de Automática, 2010, Bonito, Brasil. Anais do XVIII Congresso Brasileiro de Automática	4116	4
Único	The 3rd South Conference on Computational Modeling III MCSUL, 2009, Rio Grande. Anais do III Simpósio de Modelagem Computacional do Sul 3MCSul	4117	4
	IECON 2011 - 37th Annual Conference on IEEE Industrial Electronics Society, 2011, Melbourne. IECON 2011 - 37th Annual Conference on IEEE Industrial Electronics Society	4129	4
	Power Electronics Conference (COBEP), 2011, Natal. Congresso Brasileiro de Eletrônica de Potência	4130	4
	International Conference on Electrical Machines ICEM, 2010, Roma. XIX International Conference on Electrical Machines ICEM-2010	4131	4
	International Conference on Electrical Machines, 2010, Roma. XIX International Conference on Electrical Machines ICEM-2010	4132	4
	International Conference on Electrical Machines, 2010, Roma. XIX International Conference on Electrical Machines ICEM-2010	4133	4
	International Conference on Electrical Machines, 2010, Roma. XIX International Conference on Electrical Machines ICEM-2010	4134	4
	Congresso Brasileiro de Automática, 2010, Bonito. XVIII Congresso Brasileiro de Automática CBA2010	4135	4
	Congresso Brasileiro de Automática, 2010, Bonito. XVIII Congresso Brasileiro de Automática CBA2010	4136	4
	International Electric Machines and Drives Conference - IEMDC, 2009, Miami. Renewable Energy Systems for Today Tomorrow	4137	4
	International Electric Machines and Drives Conference - IEMDC, 2009, Miami. Renewable Energy Systems for Today Tomorrow	4138	4
	Congresso Brasileiro de Eletrônica de Potência - Cobep'09, 2009, Bonito, Mato Grosso do Sul. Congresso Brasileiro de Eletrônica de Potência - Cobep'09	4139	4
	Congresso Brasileiro de Eletrônica de Potência - Cobep'09, 2009, Bonito, Mato Grosso do Sul. Congresso Brasileiro de Eletrônica de Potência - Cobep'09	4140	4
	Congresso Brasileiro de Eletrônica de Potência - Cobep'09, 2009, Bonito, Mato Grosso do Sul. Congresso Brasileiro de Eletrônica de Potência - Cobep'09	4141	4
	IECON 2009, 2009, Porto. 35th Annual Conference of the IEEE Industrial Electronics Society	4142	4
	XVII Congresso Brasileiro de Automática, 2008, Juiz de Fora. Anais do XVII Congresso Brasileiro de Automática	4143	4
	XVII Congresso Brasileiro de Automática, 2008, Juiz de Fora. Anais do XVII Congresso Brasileiro de Automática	4144	4
1	NAVTEC 2012, 2012. Conferência Internacional em Tecnologias Naval e Offshore: Ciência e Inovação	4179	4
1	NAVTEC 2012, 2012. Conferência Internacional em Tecnologias Naval e Offshore: Ciência e Inovação	4180	4
1	NAVTEC 2012, 2012. Conferência Internacional em Tecnologias Naval e Offshore: Ciência e Inovação	4181	4
1	Congresso Brasileiro de Automática, 2012, Natal. Congresso Brasileiro de Automática CBA 2012	4182	4
1	Congresso Brasileiro de Automática, 2012, Natal. Congresso Brasileiro de Automática CBA 2012	4183	4
1	Congresso Brasileiro de Automática, 2012, Natal. Congresso Brasileiro de Automática CBA 2012	4184	4
1	Congresso Brasileiro de Automática, 2012, Natal. Congresso Brasileiro de Automática CBA 2012	4185	4
1	The Sixth International Conference on Mobile Ubiquitous Computing, Systems, Services and Technologies, 2012, Barcelona. The Sixth International Conference on Mobile Ubiquitous Computing, Systems, Services and Technologies	4186	4
1	Ciclo de Palestras Novas Tecnologias na Educação, 2012. Ciclo de Palestras Novas Tecnologias na Educação	4187	4
1	IEEE Latin American Robotic Systems - IEEE LARS, 2012. IEEE Latin American Robotic Systems - IEEE LARS	4188	4
1	IEEE Latin American Robotic Systems - IEEE LARS, 2012. IEEE Latin American Robotic Systems - IEEE LARS	4189	4
1	IEEE Latin American Robotic Systems - IEEE LARS, 2012. IEEE Latin American Robotic Systems - IEEE LARS	4190	4
1	Workshop em Robótica Educacional, 2012. Workshop em Robótica Educacional	4191	4
1	SBGames, 2012. SBGames	4192	4
1	Simpósio Brasileiro de Redes Neurais, 2012. Simpósio Brasileiro de Redes Neurais	4193	4
1	SIBIGRAPH - Workshop de Teses e Dissertações, 2012. SIBIGRAPH - Workshop de Teses e Dissertações	4194	4
1	3 rd International Conference on Robotic and Education, 2012. Conference Proceedings 3 rd International Conference on	4195	4
	Encontro Nacional de Inteligência Artificial, 2011, Natal. ENIA 2011	4196	4
	SINTEC - SEMINÁRIO INTERNACIONAL DE EDUCAÇÃO EM CIÊNCIAS, 2011, Rio Grande. SINTEC - SEMINÁRIO INTERNACIONAL DE EDUCAÇÃO EM CIÊNCIAS	4197	4
	X Simpósio Brasileiro de Automática, 2011, Sao Joao del Rei. X Simpósio Brasileiro de Automática	4198	4
	X Simpósio Brasileiro de Automática, 2011, Sao Joao del Rey. X Simpósio Brasileiro de Automática	4199	4
	2011 International Conference on and 4th International Conference on Cyber, Physical and Social Computing, 2011, Dalian. Internet of Things (iThings/CPSCom)	4200	4
	XXIX Simpósio Nacional de Educação Física, 2010. XXIX Simpósio Nacional de Educação Física	4201	4
	SIBIGRAPI, 2010. SIBIGRAPI	4202	4
	Congresso Brasileiro de Automática, 2010. CBA 2010	4203	4
	Congresso Brasileiro de Automática, 2010. CBA 2010	4204	4
	Congresso Brasileiro de Automática, 2010. CBA 2010	4205	4
	Congresso Brasileiro de Automática, 2010. CBA 2010	4206	4
	Congresso Brasileiro de Automática, 2010. CBA 2010	4207	4
	IEEE International Conference on Multisensor Fusion and Integration, 2010. IEEE International Conference on Multisensor Fusion and Integration	4208	4
	12th Brazilian Workshop on Real-Time and Embedded Systems, 2010, Gramado. Anais do 12th Brazilian Workshop on Real-Time and Embedded Systems	4209	4
	1st IFAC Workshop on Advanced Maintenance Engineering, Services and Technology - IFAC A-MEST'10, 2010, Lisboa. Proceedings of the 1st IFAC Workshop on Advanced Maintenance Engineering, Services and Technology - IFAC A-MEST'10	4210	4
	IV MCSUL - Southern Conference in Computational Modeling, 2010. IV MCSUL	4211	4
	IV Seminário e Workshop em Engenharia Oceânica, 2010. SEMENGO 2010	4212	4
	23 Congresso Nacional de Transporte Aquaviário, Construção Naval e Offshore, 2010. SOBENA 2010	4213	4
	SBGames, 2010. Simpósio Brasileiro de Jogos	4214	4
	Seminário de Pesquisa Qualitativa, 2010. Seminário de Pesquisa Qualitativa	4215	4
	INCOM 2009	4216	4
	IEEE Oceans 2009, 2009, Bremem. CD IEEE Oceans 2009	4217	4
	VIII Congreso Internacional sobre Investigación en Didáctica de las Ciencias, 2009	4218	4
	Simposio Brasileiro de Automação Inteligente, 2009, Brasilia. Simposio Brasileiro de Automação Inteligente	4219	4
	Simpósio Brasileiro de Automação Inteligente, 2009, Brasília. Simpósio Brasileiro de Automação Inteligente	4220	4
	Simpósio Brasileiro de Automação Inteligente, 2009, Brasilia. Simpósio Brasileiro de Automação Inteligente	4221	4
	Simposio Brasileiro de Automação Inteligente, 2009, Brasilia. Simposio Brasileiro de Automação Inteligente	4222	4
	IEEE Latin American Robotic Symposium, 2009. IEEE LARS	4223	4
1	Simposio Brasileiro de Sistemas Elétricos, 2008, Belo Horizonte. Simposio Brasileiro de Sistemas Elétricos	4224	4
	Congresso Brasileiro de Automática, 2008, Jiuz de Fora. Congresso Brasileiro de Automática	4225	4
	Congresso Brasileiro de Automática, 2008, Jiuz de Fora. Congresso Brasileiro de Automática	4226	4
	Latin American Robotic System - LARS, 2008, Salvador. Latin American Robotic Systems	4227	4
	Latin American Robotic System - LARS, 2008, Salvador. Latin American Robotic Systems	4228	4
	Congresso da Sociedade Brasileira de Computação, 2008. Concurso de Iniciação Científica	4229	4
	Workshop in Under-graduated Work, 2008. SIBGRAPI 2008	4230	4
	IEEE Oceans, 2008, Quebec. IEEE Oceans	4231	4
	IEEE Latin American Robotic Symposium, 2008, Salvador. IEEE Latin American Robotic Symposium	4232	4
	IEEE Latin American Robotic Symposium, 2008, Salvador. IEEE Latin American Robotic Symposium	4233	4
	SBGames, 2008, Belo Horizionte. SBGames	4234	4
	IV Seminário Jogos Eletrônicos, Educação e Comunicação construindo novas trilhas, 2008. IV Seminário Jogos Eletrônicos, Educação e Comunicação construindo novas trilhas	4235	4
	VIII Southern Programmable Logic Conference - SPL 2012, 2012, Bento Gonçalves. VIII Southern Programmable Logic Conference - SPL 2012	4243	4
	VIII Southern Programmable Logic Conference - SPL 2012 - Designer Forum, 2012, Bento Gonçalves. Southern Programmable Logic Conference - SPL 2012 - Designer Forum	4244	4
1	Mostra Nacional de Robótica MNR, 2011, São João Del Rey / MG. Mostra Nacional de Robótica	4245	4
	Workshop IBERCHIP, 2010, Foz do Iguaçu, PR, Brasil. XVI Workshop IBERCHIP	4246	4
1	Electronics, Circuits, and Systems (ICECS), 2010 17th IEEE International Conference on, 2010, Atenas. Proceedings of 17th International Conference on Electronic Circuits and Systems	4247	4
	International Conference on Electronic Circuits and Systems, 2010, Atenas. Proceedings of the 17th International Conference on Electronic Circuits and Systems	4248	4
1	IEEE Latin American Symposium on Circuits and Systems, 2010, Foz do Iguaçu. IEEE Latin American Symposium on Circuits and Systems	4249	4
	4th Southern Conference on Computational Modeling - 4º MCSUL, 2010, RIo Grande. 4th Southern Conference on Computational Modeling - 4º MCSUL	4250	4
	4th Southern Conference on Computational Modeling - 4º MCSUL, 2010, Rio Grande. 4th Southern Conference on Computational Modeling - 4º MCSUL	4251	4
	The 3rd Pacific-Rim Symposium on Image and Video Technology, 2009, Tóquio, Japão. Pacific-Rim Symposium on Image and Video Technology	4252	4
1	24o Simpósio Sul de Microeletrônica - SIM2009, 2009, Pelotas, RS. 24º simpósio sul de microeletrônica	4253	4
1	24o Simpósio Sul de Microeletrônica - SIM2009, 2009, Pelotas, RS. 24º simpósio sul de microeletrônica	4254	4
1	24o Simpósio Sul de Microeletrônica - SIM2009, 2009, Pelotas, RS. 24º simpósio sul de microeletrônica	4255	4
1	24º simpósio sul de microeletrônica, 2009, Pelotas, RS. 24º simpósio sul de microeletrônica	4256	4
	2nd International Conference on Signals, Circuits and Systems. SCS 2008., 2008, Tunísia. 2nd International Conference on Signals, Circuits and Systems	4257	4
	IFIP International Conference on Very Large Scale Integration. VLSI - SoC 2008., 2008, Rodes, Grécia. IFIP International Conference on Very Large Scale Integration	4258	4
	XIV Workshop Iberchip, 2008, Puebla, México. XIV Workshop Iberchip	4259	4
	XIV Workshop Iberchip, 2008. XIV Workshop Iberchip	4260	4
	21st Symposium on Integrated Circuits and Systems Design, 2008, Gramado, Brasil. 21st Symposium on Integrated Circuits and Systems Design	4261	4
1	III Seminário e Workshop em Engenharia Oceânica, Semengo'08, 2008, Rio Grande. III Seminário e Workshop em Engenharia Oceânica	4262	4
1	III Seminário e Workshop em Engenharia Oceânica, 2008, Rio Grande. III Seminário e Workshop em Engenharia Oceânica	4263	4
1	IV Southern Conference on Computational Modeling, 2010, Rio Grande, RS, 2010, Rio Grande. IV Southern Conference on Computational Modeling 2010	4266	4
	III Seminário e Workshop em Engenharia Oceânica, 2008, Rio Grande. III Seminário e Workshop em Engenharia Oceânica	4267	4
	III Seminário e Workshop em Engenharia Oceânica, 2008, Rio Grande. III Seminário e Workshop em Engenharia Oceânica	4268	4
	Congresso Brasileiro de Automática, 2008, Juiz de Fora. Congresso Brasileiro de Automática	4269	4
	Congresso Brasileiro de Automática, 2008, Juiz de Fora. Congresso Brasileiro de Automática	4270	4
	Congresso Nacional de Engenharia Mecânica, 2008, Salvador. Congresso Nacional de Engenharia Mecânica	4271	4
	Congresso Nacional de Engenharia Mecânica, 2008, Salvador. Congresso Nacional de Engenharia Mecânica	4272	4
	XVIII Congresso Brasileiro de Automática - CBA 2010, 2010, Bonito / MS. Anais do XVIII Congresso Brasileiro de Automática - CBA 2010	4277	4
	The 2010 1st International Conference on Applied Robotics for the Power Industry, 2010, Montreal. Proceedings of The 2010 1st International Conference on Applied Robotics for the Power industry	4278	4
	The 2010 1st International Conference on Applied Robotics for the Power industry, 2010, Montreal. Proceedings of The 2010 1st International Conference on Applied Robotics for the Power industry	4279	4
	14th IEEE International Conference on Emerging Technology and Factory Automation, 2009, Palma de Mallorca. Proceedings of the 14th IEEE International Conference on Emerging Technologies and Factory Automation (ETFA)	4280	4
	IX Simpósio Brasileiro de Automação Inteligente, 2009, Brasília. Anais do IX Simpósio Brasileiro de Automação Inteligente	4281	4
	IX Simpósio Brasileiro de Automação Inteligente, 2009, Brasília. Anais do IX Simpósio Brasileiro de Automação Inteligente	4282	4
	Rio Pipeline 2009 Conference and Exhibition, 2009, Rio de Janeiro. Anais do Rio Pipeline 2009 Conference and Exhibition	4283	4
	Simpósio Brasileiro de Sistemas Elétricos, 2008, Belo Horizonte. Anais do Simpósio Brasileiro de Sistemas Elétricos 2008	4284	4
	Congresso Brasileiro de Automática, 2008, Juiz de Fora. Anais do XVII Congresso Brasileiro de Automática	4285	4
	Simpósio Latino-Americano de Robótica, 2008, Salvador. Anais do 5o. Simpósio Latino-Americano de Robótica	4286	4
	1o. Seminário Nacional de Inclusão Digital e Software Livre, 2012, Passo Fundo. Experiências de Inclusão Digital em Escolas Municipais de Rio Grande.. Passo Fundo: Editora UPF	4299	4
	XI Congreso Iberoamericano de Extensión Universitaria, 2011, Santa Fé, Argentina. Inclusão Digital em Escola de Ensino Básico em Rio Grande (RS)	4300	4
	Seminário de Extensão Universitária da Região Sul, 2011, Foz do Iguaçu. Inclusão Digital em Escola de Ensino Básico em Rio Grande (RS)	4301	4
	Congresso Brasileiro de Extesão Universitária, 2011, Porto Alegre. Atividades para Inclusão Digital em Ensino Básico: Uma Experiência em Escola de Rio Grande (RS)	4302	4
	INCOM, 2009, Moscow. A Multi-Cave Visualization System for Digital Manufacturing	4303	4
	International Conference on Engineering of Complex Computer Systems, 2009. An Automated Platform for Immersive and Collaborative Visualization of Industrial Models	4304	4
	Simpósio Brasileiro de Games, 2008, Belo Horizonte. Using Game Engines in Digital Manufacturing through Immersive and Collaborative Visualization Systems	4305	4
\.
...
0	Adriano Velasque Werhli	4393367734853964	0	0.856831431	3	0.333333343	3	0.306306303
1	Alessandro de Lima Bicho	6965119196945931	0	0.905667067	4	0.666666687	3	0.297297299
2	André Luis Castro de Freitas	8252864210379656	0	0.150000006	0	0	3	-111
3	Andre Prisco Vargas	0243625998325831	0	0.150000006	0	0	3	-111
4	Antonio Carlos da Rocha Costa	5601943285331545	0	0.840353191	2	1	3	0.205855861
5	Celso Luiz Lopes Rodrigues	2264555408583001	0	0.150000006	0	0	3	-111
6	Cláudio Dornelles Mello Júnior	5464430592929387	0	1.15094709	6	1	3	0.308558553
7	Cristina Meinhardt	6816603089210442	0	1	1	0	3	0.0270270277
8	Danúbia Bueno Espíndola	9582755594379866	0	0.498266369	2	1	3	0.254504502
9	Denis Teixeira Franco	5184930755123241	0	0.150000006	0	0	3	-111
10	Diana Francisca Adamatti	4984043849101331	0	2.33838964	6	0.0666666701	3	0.295045048
11	Eder Mateus Nunes Gonçalves	8560050240967369	0	1.1515125	6	1	3	0.308558553
12	Eduardo André de Lima Carneiro	0889307239698374	0	0.150000006	0	0	3	-111
13	Eduardo Nunes Borges	5851601274050374	0	0.150000006	0	0	3	-111
14	Emanuel da Silva Diaz Estrada	3463902649683230	0	1.15204597	6	1	3	0.308558553
15	Geralcy Carneiro da Silva	2251297387859499	0	0.150000006	0	0	3	-111
16	Gerson Alberto Leiria Nunes	0354617883280818	0	0.481271863	1	0	3	0.192342341
17	Glauber Acunha Goncalves	2814370196736373	0	0.150000006	0	0	3	-111
18	Graçaliz Pereira Dimuro	9414212573217453	0	0.838421941	2	1	3	0.205855861
19	Greyce Nogueira Schroeder	6398615776166771	0	0.454924792	1	0	3	0.182432428
20	Ivete Martins Pinto	8740785327180983	0	0.332142293	1	0	3	0.240990996
21	Karina dos Santos Machado	3528633359332021	0	0.150000006	0	0	3	-111
22	Leonardo Ramos Emmendorfer	1129100746134234	0	0.481271863	1	0	3	0.192342341
23	Luciano Maciel Ribeiro	0119381103799648	0	0.150000006	0	0	3	-111
24	Nelson Lopes Duarte Filho	5369672706522008	0	1.76483774	9	0.527777791	3	0.3490991
25	Nisia Krusche	1606080164385644	0	0.150000006	0	0	3	-111
26	Odorico Machado Mendizabal	6058299964884859	0	0.150000006	0	0	3	-111
27	Paulo Francisco Butzen	1952072482347004	0	1	1	0	3	0.0270270277
28	Paulo Lilles Jorge Drews Junior	5551697165370587	0	1.55448771	8	0.642857134	3	0.335585594
29	Rafael Augusto Penna dos Santos	2765008024136365	0	0.498821437	2	1	3	0.254504502
30	Regina Barwaldt	2017770059745262	0	0.481271863	1	0	3	0.192342341
31	Ricardo Nagel Rodrigues	8456023041589649	0	0.71882838	2	0	3	0.259009004
32	Rodrigo Andrade de Bem	3935196239515458	0	0.497306615	2	1	3	0.254504502
33	Rodrigo Zelir Azzolin	0985488148768235	0	0.150000006	0	0	3	-111
34	Silvia Silva da Costa Botelho	8800859024101679	0	2.7923615	13	0.269230783	3	0.423423409
35	Vagner Santos da Rosa	4599170539959463	0	1	1	0	3	0.0270270277
36	Vitor Irigon Gervini	2056380331247057	0	1	1	0	3	0.0270270277
37	Vinícius Menezes de Oliveira	9262132256691648	0	1.15380919	6	1	3	0.308558553
0	Adriano Velasque Werhli	4393367734853964	0	0	0	0	4	0
1	Alessandro de Lima Bicho	6965119196945931	0	0	0	0	4	0
2	André Luis Castro de Freitas	8252864210379656	0	0	0	0	4	0
3	Andre Prisco Vargas	0243625998325831	0	0	0	0	4	0
4	Antonio Carlos da Rocha Costa	5601943285331545	0	0	0	0	4	0
5	Celso Luiz Lopes Rodrigues	2264555408583001	0	0	0	0	4	0
6	Cláudio Dornelles Mello Júnior	5464430592929387	0	0	0	0	4	0
7	Cristina Meinhardt	6816603089210442	0	0	0	0	4	0
8	Danúbia Bueno Espíndola	9582755594379866	0	0	0	0	4	0
9	Denis Teixeira Franco	5184930755123241	0	0	0	0	4	0
10	Diana Francisca Adamatti	4984043849101331	0	0	0	0	4	0
11	Eder Mateus Nunes Gonçalves	8560050240967369	0	0	0	0	4	0
12	Eduardo André de Lima Carneiro	0889307239698374	0	0	0	0	4	0
13	Eduardo Nunes Borges	5851601274050374	0	0	0	0	4	0
14	Emanuel da Silva Diaz Estrada	3463902649683230	0	0	0	0	4	0
15	Geralcy Carneiro da Silva	2251297387859499	0	0	0	0	4	0
16	Gerson Alberto Leiria Nunes	0354617883280818	0	0	0	0	4	0
17	Glauber Acunha Goncalves	2814370196736373	0	0	0	0	4	0
18	Graçaliz Pereira Dimuro	9414212573217453	0	0	0	0	4	0
19	Greyce Nogueira Schroeder	6398615776166771	0	0	0	0	4	0
20	Igor Avila Pereira	7701563839009909	0	0	0	0	4	0
21	Ivete Martins Pinto	8740785327180983	0	0	0	0	4	0
22	Jônata Tyska Carvalho	9494364044256921	0	0	0	0	4	0
23	Karina dos Santos Machado	3528633359332021	0	0	0	0	4	0
24	Leonardo Ramos Emmendorfer	1129100746134234	0	0	0	0	4	0
25	Luciano Maciel Ribeiro	0119381103799648	0	0	0	0	4	0
26	Nelson Lopes Duarte Filho	5369672706522008	0	0	0	0	4	0
27	Nisia Krusche	1606080164385644	0	0	0	0	4	0
28	Odorico Machado Mendizabal	6058299964884859	0	0	0	0	4	0
29	Paulo Francisco Butzen	1952072482347004	0	0	0	0	4	0
30	Paulo Lilles Jorge Drews Junior	5551697165370587	0	0	0	0	4	0
31	Rafael Augusto Penna dos Santos	2765008024136365	0	0	0	0	4	0
32	Raphael Leite Campos	5143374374213533	0	0	0	0	4	0
33	Regina Barwaldt	2017770059745262	0	0	0	0	4	0
34	Ricardo Nagel Rodrigues	8456023041589649	0	0	0	0	4	0
35	Rodrigo Andrade de Bem	3935196239515458	0	0	0	0	4	0
36	Rodrigo Zelir Azzolin	0985488148768235	0	0	0	0	4	0
37	Silvia Silva da Costa Botelho	8800859024101679	0	0	0	0	4	0
38	Vagner Santos da Rosa	4599170539959463	0	0	0	0	4	0
39	Vitor Irigon Gervini	2056380331247057	0	0	0	0	4	0
40	Vinícius Menezes de Oliveira	9262132256691648	0	0	0	0	4	0
41	Vinícius Alves Hax	6993820717354912	0	0	0	0	4	0
\.
...
3318	AP	Comparing the reconstruction of regulatory pathways with distinct Bayesian networks inference methods	WERHLI, A. V.	2012	S2	0	\N	4
...
3319	AP	GENE REGULATORY NETWORK RECONSTRUCTION BY BAYESIAN INTEGRATION OF PRIOR KNOWLEDGE AND/OR DIFFERENT EXPERIMENTAL CONDITIONS	WERHLI, ADRIANO V. ; HUSMEIER, DIRK	2008	543	0	\N	4
...
3321	LP	IV MCSUL Southern Conference on Computational Modeling / IX ERMAC Encontro regional de Matemática Aplicada e Computacional	WERHLI, A. V. (Org.) ; Emmendorfer, L. R. (Org.) ; COSTA, A. C. R. (Org.) ; Retamoso, M. (Org.)	2010		0	\N	4
...
3322	CL	Advanced Applications of Bayesian Networks in Systems Biology	Husmeier, D. ; WERHLI, A. V. ; Grzegorczyk, Marco	2011	270-289	0	\N	4
3323	CL	Reverse Engineering Gene Regulatory Networks with Various Machine	Grzegorczyk, Marco ; Husmeier, D. ; WERHLI, A. V.	2008	101-142	0	\N	4
...
3324	TC	An epsilon-greedy mutation operator based on prior knowledge for GA convergence and accuracy improvement: an application to networks inference	Mendoza, M. R. ; WERHLI, A. V. ; BAZZAN, A. L. C.	2012		0	\N	4
...
3325	TC	Bayesian Network Structure Inference with an Hierarchical Bayesian Model	WERHLI, A. V.	2010	92-101	0	\N	4
...
3326	TC	Inferring Genetic Regulatory Networks with an Hierarchical Bayesian Model and a Parallel Sampling Algorithm	Mendoza, M. R. ; WERHLI, A. V.	2010	91-96	0	\N	4
...
3329	RE	DESCOBERTA DE CONHECIMENTO EM BANCOS DE DADOS: APLICADO AO CASO DE ALUNOS COM SUBSÍDIO NO NÚCLEO DE ASSITÊNCIA ESTUDANTIL NAE DA UNIVERSIDADE FEDERAL DO RIO GRANDE - FURG	WAGNER, A. ; Emmendorfer, L. R. ; WERHLI, A. V.	2011	1-5. CD-ROM	0	\N	4
...
3330	RC	Inferência de Redes Genéticas Regulatórias Utilizando Redes Booleanas	BARRETO, N. M. ; WERHLI, A. V.	2011		0	\N	4
3331	RC	Inferência de Estrutura de Redes Biológicas com a Combinação de Métricas de Redes Bayesianas	DUARTE, K. P. ; WERHLI, A. V.	2011		0	\N	4
...
3332	RC	Data Mining: Aplicado ao Caso de Alunos com Subsídio no Núcleo de Assistência Estudantil - NAE da Universidade Federal do Rio Grande - FURG	LORENZ, W. G. ; WERHLI, A. V.	2011		0	\N	4
...
3333	RC	Comparison of Bayesian networks and its extensions applied to the inference of regulatory networks	WERHLI, A. V.	2010		0	\N	4
3334	RC	Inferring genetic regulatory networks with an hierarchical Bayesian model and a parallel sampling algorithm	Mendoza, M. R. ; WERHLI, A. V.	2010		0	\N	4
1868	TC	Design of 16nm SRAM Architecture	GOMES, I. A. C. ; Meinhardt, Cristina ; BUTZEN, P. F.	2012	1-4	7	1868	2
3335	AP	Simulating crowds based on a space colonization algorithm	BICHO, A. L. ; RODRIGUES, R. A. ; MUSSE, S. R. ; JUNG, C. R. ; PARAVISI, M. ; MAGALHÃES, L. P.	2012	70-79	1	\N	4
...
3337	AP	An Interactive Model for Steering Behaviors of Groups of Characters	RODRIGUES, R. A. ; BICHO, A. L. ; PARAVISI, M. ; JUNG, C. R. ; MAGALHÃES, L. P. ; MUSSE, S. R.	2010	594-616	1	\N	4
...
3338	AP	Tree Paths: A New Model for Steering Behaviors. Proceedings of the 9th International Conference on Intelligent Virtual Agents	RODRIGUES, R. A. ; BICHO, A. L. ; PARAVISI, M. ; JUNG, C. R. ; MAGALHÃES, L. P. ; MUSSE, S. R.	2009	358-371	1	\N	4
3339	CL	Behavioral Animation of Crowds	BARROS, L. M. ; BICHO, A. L. ; GRILLON, H. ; JUNG, C. R. ; MAGALHÃES, L. P. ; MAIM, J. ; MUSSE, S. R. ; PARAVISI, M. ; PETTRÉ, J. ; RODRIGUES, R. A. ; THALMANN, D. ; YERSIN, B.	2012	111-168	1	\N	4
...
3341	TC	Simulation of Autonomous Agents using Terrain Reasoning	CASSOL, V. J. ; MARSON, F. P. ; VENDRAMINI, M. ; PARAVISI, M. ; MUSSE, S. R. ; BICHO, A. L. ; JUNG, C. R.	2011	101-108	1	\N	4
...
3345	RC	Consultoria em Legalização de Software	RAMOS, R. C. ; BICHO, A. L. ; CARVALHO, J. T. ; HAX, V. A.	2011	1-1. CD-ROM	1	\N	4
...
3346	RC	Computing Agents Motion using Terrain Reasoning	CASSOL, V. J. ; MARSON, F. P. ; VENDRAMINI, M. ; PARAVISI, M. ; BICHO, A. L. ; JUNG, C. R. ; MUSSE, S. R.	2010	10-11	1	\N	4
...
3347	AP	Estudo de Caso sobre Programação Orientada a Aspectos Utilizando RMI. Hífen (Uruguaiana	BORGES, F.S. ; FREITAS, A. L. C.	2008	1	2	\N	4
3348	TC	O Exercício, em Freire, da Conscientização Apoiado no Uso de Tecnologias na Educação	FREITAS, A. L. C. ; FREITAS, L.A.A.	2012	48-60	2	\N	4
3349	TC	A Conscientização em Espaços Menores: o inacabamento do professor	FREITAS, A. L. C. ; FREITAS, L.A.A.	2012		2	\N	4
3350	TC	A Conscientização, em Freire, Apoiada no Uso de Tecnologias na Educação a Distância	FREITAS, L.A.A. ; FREITAS, A. L. C.	2012		2	\N	4
...
3351	TC	Experienciações no Espaço Tempo da Sala de Aula: Em que condições são possíveis integrar os saberes?	FREITAS, A. L. C. ; FREITAS, L.A.A. ; SPEROTTO, R. I.	2012		2	\N	4
3352	TC	Experienciações no Espaço Tempo da Sala de Aula:A tecnologia a favor da integração dos saberes	FREITAS, A. L. C. ; FREITAS, L.A.A.	2012		2	\N	4
3353	TC	Da Educação Bancária a Educação Problematizadora: Os espaços menores entre esse extremos e a sua contribuição para o ensinar e o aprender. Em que medida isso é possível?	FREITAS, A. L. C. ; FREITAS, L.A.A.	2012		2	\N	4
...
3354	TC	Da Educação Bancária a Educação Problematizadora: Desvelando os espaços menores entre esses extremos e as contribuições para o ensinar e o aprender	FREITAS, A. L. C. ; FREITAS, L.A.A.	2012		2	\N	4
...
3355	TC	Há, em Freire, Espaços na Educação a Distância para a Possibilidade de Conscientização?	FREITAS, L.A.A. ; FREITAS, A. L. C.	2011		2	\N	4
...
3356	TC	Problematizando a Educação Conscientizadora na Promoção da Atividade de Integração Curricular	FREITAS, A. L. C. ; FREITAS, L.A.A.	2011		2	\N	4
...
3357	TC	Refletindo Sobre as Verdades no Espaço Tempo da Sala de Aula	FREITAS, A. L. C. ; FREITAS, L.A.A.	2011		2	\N	4
3358	TC	A Promoção da Atividade de Integração Curricular no Espaço Tempo Sala de Aula	FREITAS, A. L. C. ; FREITAS, L.A.A.	2011		2	\N	4
3359	TC	A Produção de Recursos Tecnológicos na Atividade de Integração Curricular	FREITAS, A. L. C. ; FREITAS, L.A.A.	2011		2	\N	4
...
3360	TC	As Práticas Educativas a Serviço da Transformação Social: pela Sustentabilidade da Vida	FREITAS, L.A.A. ; FREITAS, A. L. C.	2011		2	\N	4
3361	TC	Ressignificando as Atividades no Espaço Tempo da Sala de Aula	FREITAS, A. L. C. ; FREITAS, L.A.A.	2011		2	\N	4
...
3362	TC	A Atividade de Integração Curricular no Espaço Tempo da Sala de Aula	FREITAS, A. L. C. ; FREITAS, L.A.A.	2011		2	\N	4
3363	TC	A Prática Docente a Serviço da Transformação Social	FREITAS, L.A.A. ; FREITAS, A. L. C.	2011		2	\N	4
...
3364	TC	Compreendendo a Atividade de Integração Curricular no Espaço Tempo da Sala de Aula	FREITAS, A. L. C. ; FREITAS, L.A.A.	2011		2	\N	4
...
3365	TC	TUNING - Técnicas de Otimização de Banco de Dados. Um Estudo Comparativo: Mysql e Postgresql	CARNEIRO, A.P. ; MOREIRA, J.L. ; FREITAS, A. L. C.	2009		2	\N	4
3366	TC	Um Estudo sobre Técnicas de Otimização de Banco de Dados	CARNEIRO, A.P. ; MOREIRA, J.L. ; FREITAS, A. L. C.	2008		2	\N	4
...
3367	RC	Re-significando as Atividades em Sala de Aula	FREITAS, A. L. C. ; FREITAS, L.A.A.	2011		2	\N	4
...
3368	RC	AXUL - Um framework PHP para a geração de interfaces XUL	MADSEN, C. A. B. W. ; FREITAS, A. L. C.	2009		2	\N	4
...
3369	LP	Caderno de Atividades Práticas Supervisionadas. Anhanguera Publicações e Comércio de Material Didático Ltda	CAVALHEIRO, Rafael Fagundes ; VARGAS, A. P. ; DEVINCENZI, Sam da Silva	2008		3	\N	4
...
3374	RC	Suprte a Comunicação em Grupo para Dispositivos Móveis Utilizando Wi-F	GIL, J. P. S ; MENDIZABAL, O. M. ; VARGAS, A. P.	2012		3	\N	4
...
3375	RC	Módulo de critérios de relevância para o ARGOsearch	TOMASINI, C. ; PEREIRA, Igor A. ; VARGAS, A. P. ; Borges, Eduardo N.	2012		3	\N	4
...
3376	RC	Um componente de software para análise de redes de colaboração acadêmica	FARIAS, Lucas R. ; Borges, Eduardo N. ; VARGAS, A. P. ; LOPES, G. R. ; LUCCA, G.	2012		3	\N	4
...
3377	RC	Validação do mecanismo de busca ARGOsearch para o sistema de gerenciamento de bibliotecas da FURG	TOMASINI, C. ; Borges, Eduardo N. ; PEREIRA, Igor A. ; VARGAS, A. P.	2012		3	\N	4
3378	RC	Uma ferramenta para visualização e análise de redes de pesquisa	FARIAS, Lucas R. ; Borges, Eduardo N. ; VARGAS, A. P. ; LOPES, G. R.	2012		3	\N	4
...
3379	RC	Uma arquitetura para pesquisa por relevância baseada em critérios	VARGAS, A. P. ; PEREIRA, Igor A. ; Borges, Eduardo N.	2011		3	\N	4
...
3380	RC	Rede de pesquisa da FURG	FARIAS, Lucas R. ; VARGAS, A. P. ; Borges, Eduardo N.	2011		3	\N	4
...
3381	RC	Uma ferramenta para coleta e análise de dados do segmento naval	OTERO, Tiago F. ; Borges, Eduardo N. ; VARGAS, A. P. ; Adamatti, Diana	2011		3	\N	4
3382	AP	Usando CSP, RSL e o Modelo PopOrg na Especificação Formal de Organizações de SMAs	BARBOSA, R. M. ; COSTA, A. C. R.	2011	389-411	4	\N	4
...
3383	AP	Aplicação de Agentes BDI com Percepção Fuzzy no Modelo Presa-Predador	Farias, G. P. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2011	299-324	4	\N	4
...
3385	AP	Exchange Values and Social Power Supporting the Choice of Partners	FRANCO, M. H. I. ; COSTA, A. C. R. ; COELHO, H.	2010	art_02	4	\N	4
...
3386	AP	Interpretações do Interferômetro de Mach-Zehnder no Modelo qMG. TEMA	AMARAL, R. B. ; REISER, Renata Hax Sander ; COSTA, A. C. R.	2009	111-124	4	\N	4
...
3388	AP	Capacitação de Gestores de Universidades através da Utilização de Jogos de Empresas Baseados em Instituições Eletrônicas	BERNARDI, Giliane ; COSTA, A. C. R.	2008	53-59	4	\N	4
...
3389	AP	Quantum Arrows in Haskell	VIZZOTO, Juliana Kaiser ; COSTA, A. C. R. ; Sabry, A.	2008	139-152	4	\N	4
3390	AA	Situated Normative Infra-structures: The Normative Objects Approach	OKUYAMA, Fabio Yoshimitsu ; COSTA, A. C. R. ; BORDINI, Rafael Heitor	2011		4	\N	4
...
3631	RC	Um Modelo Para Comunicação de Agentes Tratando Informações Imprecisas Baseado em Sinônimos	SPEROTTO, F. A. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
...
3394	LP	Advance in Artificial Intelligence - SBIA 2010	COSTA, A. C. R. (Org.) ; Vicari, R. M. (Org.) ; Tonidandel, F. (Org.)	2010		4	\N	4
...
3395	LP	Proceedings of BWSS - Brazilian Workshop on Social Simulation. Porto Alegre: SBC	COSTA, A. C. R. (Org.)	2008		4	\N	4
...
3400	CL	On the Operationality of Moral-Sense Decision Making	COELHO, H. ; TRIGO, P. ; COSTA, A. C. R.	2011	15-20	4	\N	4
...
2748	LP	Introdução à Educação a Distância	GONÇALVES, E. M. N. ; Vieira, Suzane R	2011		11	\N	3
3401	CL	Simulating Argumentation about Exchange Values in Multi-agent Interactions	FRANCO, M. H. I. ; COSTA, A. C. R. ; COELHO, H.	2011	103-110	4	\N	4
3402	CL	Equation-Based Models as Formal Specifications of Agent-Based Models for Social Simulation: Preliminary Issues	COSTA, A. C. R. ; JEANNES, F. M. ; CAVA, U. A.	2011	119-126	4	\N	4
3403	CL	Towards the Modeling of the Social Organization of an Experiment of Social Management of Urban Vegetable Gardens	SANTOS, I. A. S. ; RODRIGUES, T. F. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; DIMURO, G. ; MANUEL, E.	2011	98-101	4	\N	4
3404	CL	The Cultural Level of Agent Societies	COSTA, A. C. R.	2011	1-19	4	\N	4
...
3409	CL	Uso de CSP na Especificação Formal do Nível Micro-Organizacional de SMAs. Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande	BARBOSA, R. M. ; COSTA, A. C. R. ; TEDESCO, P. ; Mota, A.	2010	86-94	4	\N	4
3410	CL	Modelo de Agente Econômico Cognitivo com Base no Conceito de Agentes BDI	JEANNES, F. M. ; COSTA, A. C. R.	2010	126-137	4	\N	4
3411	CL	Teoria dos Jogos aplicada à coordenação de agentes, utilizando Teoria dos Valores de Troca	Pereira, D. R. ; COSTA, A. C. R.	2010	150-161	4	\N	4
3413	CL	Using CSP in the Formal Specification of the Micro-organizational level of Multiagent Systems	BARBOSA, R. M. ; COSTA, A. C. R.	2010	459-464	4	\N	4
...
3416	CL	A Distributed Normative Infrastructure for Situated Multi-Agent Organisations	OKUYAMA, Fabio Yoshimitsu ; BORDINI, Rafael Heitor ; COSTA, A. C. R.	2008	29-46	4	\N	4
...
3424	TC	Simulando a Execução de Políticas Públicas através de Jason e CArtAgO	SANTOS, I. A. S. ; COSTA, A. C. R.	2012	81-92	4	\N	4
3425	TC	Toward a Framework for Simulating Agent-Based Models of Public Policy Processes on the Jason-CArtAgO Platform	COSTA, A. C. R. ; SANTOS, I. A. S.	2012	1-15	4	\N	4
...
3429	TC	Um Modelo Multiagente para Carregamento Compartilhado com Prioridades em um Terminal de Conêineres: Combinando o Problema da Mochila com PDMs	Rodrigues, L. M. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; EMMENDORFER, L.	2011	51-62	4	\N	4
3432	TC	Uso de CSP na Especificação Formal do Nível Micro-Organizacional de Sistemas Multiagentes	BARBOSA, R. M. ; COSTA, A. C. R.	2010	13-21	4	\N	4
3433	TC	Um Modelo de Agente Econômico Cognitivo com Base no Conceito de Agentes BDI	JEANNES, F. M. ; COSTA, A. C. R.	2010	53-64	4	\N	4
...
3434	TC	Teoria dos Jogos aplicada à coordenação de agentes, utilizando Teoria dos Valores de Troca	Pereira, D. R. ; COSTA, A. C. R.	2010	77-88	4	\N	4
...
3441	TC	On the Operationality of Moral-Sense Decision Making	COELHO, H. ; COSTA, A. C. R. ; TRIGO, P.	2010	11-22	4	\N	4
3442	TC	Moral Minds as Multiple-Layer Organizations	COELHO, H. ; COSTA, A. C. R. ; TRIGO, P.	2010	254-263	4	\N	4
...
3443	TC	Decision Making for Agent Moral Conducts	COELHO, H. ; COSTA, A. C. R. ; TRIGO, P.	2010	1-12	4	\N	4
3445	TC	Aprendizagem Organizacional através de Simulação baseada em Instituições Eletrônicas e Agentes de Software	BERNARDI, Giliane ; COSTA, A. C. R.	2009		4	\N	4
3448	TC	A Critical Study of the Coherence between EBMs and ABMs in the Simulation of the Hawks-Doves-LawAbiders Society	JEANNES, F. M. ; COSTA, A. C. R.	2009	475-486	4	\N	4
3449	TC	On the Intelligence of Moral Agency	COELHO, H. ; COSTA, A. C. R.	2009	439-450	4	\N	4
4197	TC	TOPOBO: UMA NOVA FERRAMENTA PEDAGÓGICA PARA A EXPERIMENTAÇÃO EM CIÊNCIAS	M, Santin ; BOTELHO, S. S. C.	2011		37	\N	4
...
3454	TC	Capacitação de Gestores de Instituições de Ensino Superior através da Simulação de Processos Administrativos utilizando a Abordagem de Instituições Eletrônicas	BERNARDI, Giliane ; COSTA, A. C. R.	2008	1-12	4	\N	4
...
3456	TC	Interpretações do Interferômetro de Mach-Zehnder no Modelo qMG	AMARAL, R. B. ; REISER, Renata Hax Sander ; COSTA, A. C. R.	2008	1-10	4	\N	4
3457	TC	Simulating Argumentation about Exchange Values in Multi-Agents Interactions	ISLABÃO, Márcia Hafelle ; COSTA, A. C. R.	2009	1-12	4	\N	4
...
3458	TC	Jogos de Empresa e Aprendizagem Organizacional: um Estudo de Caso de Simulação de Processos Organizacionais de uma Instituição de Educação Superior	BERNARDI, Giliane ; COSTA, A. C. R.	2008		4	\N	4
...
3459	TC	Jogo de Empresa baseado em Agentes de Software e Instituições Eletrônicas para Aprendizagem Organizacional de Gestores de Instituições de Educação Superior	BERNARDI, Giliane ; COSTA, A. C. R.	2008		4	\N	4
3460	TC	Equation based Models as Formal Specifications of Agent-based Models for Social Simulation: preliminary issues	COSTA, A. C. R. ; JEANNES, F. M. ; CAVA, U. A.	2008	1-12	4	\N	4
...
3461	RE	Modelando a Organização Social de um Experimento de Gestão Social de Hortas Urbanas	RODRIGUES, T. F. ; SANTOS, I. A. S. ; DIMURO, G. ; COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2011	163-166	4	\N	4
2934	LP	Anais do IV Workshop- Escola de Sistemas de Agentes, seus Ambientes e apliCações	ADAMATTI, D. F. ; WERHLI, A. V. ; LUGO. G. G. ; EMMENDORFER, L. R.	2010		22	2434	3
3462	RE	Estendendo o Modelo de Organização de Sistemas Multiagentes PopOrg com Unidades Organizacionais Recursivas	ROSA, S. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	143-146	4	\N	4
...
3463	RE	Simulação Baseada em Agentes de Processos de Gestão Social de Ecossistemas Urbanos: o caso das hortas urbanas da cidade de Sevilla	RODRIGUES, T. F. ; DIMURO, G. ; VON GROL, C. ; PINHEIRO, T. V. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	257-260	4	\N	4
...
3464	RE	Introducing Social Groups and Group Exchanges in the PopOrg Model	COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2009	1297-1298	4	\N	4
3465	RE	Um Modelo de Percepção Fuzzy para Agentes BDI	Farias, G. P. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2009	1-4	4	\N	4
...
3466	RE	A Distributed Normative Infrastructure for Situated Multi-Agent Organisations	OKUYAMA, Fabio Yoshimitsu ; BORDINI, R. H. ; COSTA, A. C. R.	2008	1501-1504	4	\N	4
...
3467	RC	Especificando Rotinas Organizacionais de Sistemas Multiagentes: Detecção de Desvios com Base no Conceito de Expectativas	SILVA, C. E. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	139-142	4	\N	4
3468	RC	Um Modelo Híbrido de Agente BDI-Fuzzy	Farias, G. P. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	147-150	4	\N	4
3473	AP	A Low-Cost Solution for Deploying Processor Cores in Harsh Environments. IEEE Transactions on Industrial Electronics (1982	Violante, Massimo ; MEINHARDT, Cristina ; REIS, R. A. L. ; Reis, Ricardo ; Sonza Reorda, Matteo	2011	2617-2626	7	\N	4
3474	TC	Evaluation of Process Variability on Current for Nanotechnologies Devices	MEINHARDT, Cristina ; REIS, Ricardo	2012	1-4	7	\N	4
3478	TC	Energy Evaluation of Nanometer CMOS Technologies	NUNES, C. S. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2012	1-4	7	\N	4
3479	TC	Full Adder Cells Evaluation for Subthreshold Operation on 32nm CMOS Technology	SILVA, A. N. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2012		7	\N	4
3480	TC	Impact of Process Variability considering Transistor Networks Delay	GUEX, Jerson P. ; MEINHARDT, Cristina ; REIS, Ricardo	2011	1-4	7	\N	4
3481	TC	Estudo do impacto da variabilidade em um conjunto de blocos básicos para composição de leiautes regulares	MEINHARDT, Cristina ; GUEX, Jerson P. ; REIS, Ricardo	2010	1-6	7	\N	4
3482	TC	A Case Study about Variability Impact in a Set of Basic Blocks Designed to Regular Layouts	GUEX, Jerson P. ; MEINHARDT, Cristina ; REIS, Ricardo	2010	71-74	7	\N	4
3483	TC	ESTUDO DA INFLUÊNCIA DA TEMPERATURA NO COMPORTAMENTO ELÉTRICO DE TRANSISTORES EM TECNOLOGIAS NANOMÉTRICAS	Diones Fischer ; Marcio Macedo ; Matheus Muller Korb ; MEINHARDT, Cristina	2010	1-4	7	\N	4
3484	TC	IMPLEMENTAÇÃO DE UM SIMULADOR DE SISTEMA DE MEMÓRIA CACHE	Christian Silva ; Eduardo Teixeira ; Mauro Barbat ; MEINHARDT, Cristina	2010		7	\N	4
...
3485	TC	UMA IMPLEMENTAÇÃO DO ALGORITMO BOOTH USANDO MANIPULAÇÃO DE BITS	Matheus Machado ; MEINHARDT, Cristina	2010		7	\N	4
3486	TC	A Low-Cost SEE Mitigation Solution for Soft-Processors Embedded in Systems on Programmable Chips	VIOLANTE, M. ; MEINHARDT, Cristina ; REIS, Ricardo ; REORDA, M. S.	2009	352-358	7	\N	4
3487	TC	Recovery Scheme for Hardening System on Programmable Chips	MEINHARDT, Cristina ; VIOLANTE, M. ; REORDA, M. S. ; REIS, Ricardo	2009	1-6	7	\N	4
3488	TC	An On-Board Data-Handling Computer for Deep-Space Exploration Built Using Commercial-Of-The-Shelf SRAM-Based FPGAs	VIOLANTE, M. ; REORDA, M. S. ; MEINHARDT, Cristina ; REIS, Ricardo	2009	254-262	7	\N	4
3489	TC	Leiautes Regulares Baseados em Matrizes de Células	MEINHARDT, Cristina ; REIS, Ricardo ; TAVARES, Reginaldo da Nobrega	2009	127-132	7	\N	4
...
3490	TC	An Experimental Analysis of the Lockstep Architecture	MEINHARDT, Cristina ; VIOLANTE, M. ; REORDA, M. S. ; REIS, Ricardo	2008	89-93	7	\N	4
...
3491	TC	Recovery Scheme for Hardening System on Programmable Chips	MEINHARDT, Cristina ; VIOLANTE, M. ; REIS, Ricardo ; REORDA, M. S.	2008	1-4	7	\N	4
3492	RC	Caracterização temporal de Flip-Flops D	BRUN, J. V. F. ; BUTZEN, P. F. ; Meinhardt, Cristina ; AZZOLIN, R. Z.	2012	1-1	7	\N	4
3493	RC	SIMULADOR DE FALHAS STUCK-OPEN PARA PORTAS LÓGICAS CMOS	ZIMPECK, A. L. ; Meinhardt, Cristina ; BUTZEN, P. F.	2012	1-1	7	\N	4
...
3494	RC	PROJETO DE SOMADORES DE 1 BIT EM TECNOLOGIAS NANOMÉTRICAS	SILVA, F. G. R. G. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2012	1-1	7	\N	4
3495	RC	DESENVOLVIMENTO DE UMA FERRAMENTA EDUCACIONAL PARA O ESTUDO DE FAMÍLAS LÓGICAS MOS ESTÁTICAS	ULLOA, G. ; BUTZEN, P. F. ; MEINHARDT, Cristina	2012	1-1	7	\N	4
3496	RC	DESENVOLVIMENTO DE UMA FERRAMENTA PARA A CARACTERIZAÇÃO TEMPORAL DE PORTAS LÓGICAS CMOS	MACHADO, I. ; BUTZEN, P. F. ; MEINHARDT, Cristina	2012	1-1	7	\N	4
3497	RC	EMPREGO DE REDUNDÂNCIA PARA AUMENTAR A CONFIABILIDADE DE CIRCUITOS CMOS	WIECZORECK, I. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2012	1-1	7	\N	4
3498	RC	MECANISMO DE INJEÇÃO DE FALHAS DO TIPO SET EM CIRCUITOS COMBINACIONAIS	PEREIRA, L. A. ; BUTZEN, P. F. ; MEINHARDT, Cristina	2012	1-1	7	\N	4
...
3499	RC	Automatização da caracterização do consumo de potência estática em circuitos CMOS	SCHIVITTZ, R. B. ; BUTZEN, P. F. ; MEINHARDT, Cristina	2012	1-1	7	\N	4
3065	TC	Controlling a Inspection ROV Using Low Cost Sensors	KUHN, V. N. ; DREWS JR, P. L. J. ; GOMES, S. C. P.	2012		28	\N	3
3500	RC	AVALIAÇÃO ELÉTRICA DE LATCHES EM TECNOLOGIA CMOS NANOMÉTRICA	AFONSO, R. M. ; BUTZEN, P. F. ; MEINHARDT, Cristina	2012	1-1	7	\N	4
3501	RC	AVALIAÇÃO DE TRÊS ARQUITETURAS DE SOMADORES PROJETADOS EM TECNOLOGIAS CMOS NANOMÉTRICAS	TOLEDO, S. P. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2012	1-1	7	\N	4
3502	RC	PROJETO DE UM SOMADOR TOLERANTE A FALHAS COM BAIXO CONSUMO DE POTÊNCIA	ZIMPECK, A. L. ; AGUIAR, Y. Q. ; MACIEL, B. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2011	1-1	7	\N	4
...
3503	RC	ELICITAÇÃO DE REQUISITOS PARA O DESENVOLVIMENTO DE FERRAMENTAS EDUCACIONAIS PARA O ENSINO DE ORGANIZAÇÃO E ARQUITETURA DE COMPUTADORES	WIECZORECK, I. ; MENDIZABAL, Odorico Machado ; MEINHARDT, Cristina	2011	1-1	7	\N	4
3504	RC	AVALIAÇÃO DO DESEMPENHO E CONSUMO DE POTÊNCIA DE PORTAS LÓGICAS CMOS EM TECNOLOGIAS NANOMÉTRICAS	STERZ, A. P. ; NUNES, C. S. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2011	1-1	7	\N	4
...
3505	RC	PROJETO DE UM BLOCO DE MÉMORIA SRAM NA TECNOLOGIA DE 16NM	GOMES, I. A. C. ; BUTZEN, P. F. ; MEINHARDT, Cristina	2011	1-1	7	\N	4
3506	RC	Projeto de flip-flops tipo D com baixo consumo de potência	BRUN, J. V. F. ; BUTZEN, P. F. ; MEINHARDT, Cristina	2011	1-1	7	\N	4
3507	RC	OTIMIZAÇÃO DO DIMENSIONAMENTO DOS TRANSISTORES DE UM CIRCUITO SOMADOR PARA REDUÇÃO DE ATRASOS E CONSUMO DE POTÊNCIA	AGUIAR, Y. Q. ; MACIEL, B. ; ZIMPECK, A. L. ; BUTZEN, P. F. ; MEINHARDT, Cristina	2011	1-1	7	\N	4
3508	RC	Avaliação de Famílias Lógicas para Circuitos com Baixo Consumo de Potência	NUNES, C. S. ; SILVA, A. N. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2011	1-1	7	\N	4
...
3509	RC	AVALIAÇÃO DA EFICÁCIA DE MODELOS DE TRANSISTORES NO PROJETO DE CIRCUITOS COM BAIXO CONSUMO DE ENERGIA	SILVA, A. N. ; NUNES, C. S. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2011	1-1	7	\N	4
3510	RC	ESTUDO DOS ATRASOS CAUSADOS PELA TEMPERATURA EM TRANSISTORES DE NOVAS TECNOLOGIAS	Diones Fischer ; Marcio Macedo ; MEINHARDT, Cristina	2010	1-2	7	\N	4
...
3511	RC	COMPARAÇÃO ENTRE OS EFEITOS DA TEMPERATURA EM TRANSISTORES DE NOVAS TECNOLOGIAS NANOMÉTRICAS	Marcio Macedo ; Diones Fischer ; MEINHARDT, Cristina	2010	1-2	7	\N	4
3512	RC	ESTUDO DA INFLUÊNCIA DA TENSÃO VGS NO COMPORTAMENTO DA CORRENTE DE TRANSISTORES EM 16 NANÔMETROS	Matheus Muller Korb ; MEINHARDT, Cristina	2010	1-2	7	\N	4
...
3513	RC	OrBDD Logic Synthesis: Improving Timing Through Fan out Managing	MEINHARDT, Cristina ; TAVARES, Reginaldo da Nobrega ; REIS, Ricardo	2008	1-4	7	\N	4
2540	TC	Sobre Números Fuzzy Intervalares	DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; MUSSI, R. L.	2010	162-169	4	2540	3
3515	AA	A Model-based Integration of Data to Improve Maintenance Management by Mixed Reality	ESPÍNDOLA, Danúbia Bueno ; FUMAGALLI, L. ; GARETTI, M. ; PEREIRA, Carlos Eduardo ; BOTELHO, Silvia S da C ; HENRIQUES, Renato Ventura Bayan	2012		8	\N	4
3516	TC	Integrating Intelligent Maintenance Systems and Spare Parts Supply Chains	ESPÍNDOLA, Danúbia Bueno ; FRAZZON, E. M. ; HELLINGRATH, B. ; PEREIRA, Carlos Eduardo	2012		8	\N	4
...
3519	TC	Um caso de uso do ambiente virtual de aprendizagem (SLOODLE) no ensino à distância	Mota, F. ; ESPÍNDOLA, Danúbia Bueno ; TUSNSKI, L. F. M. ; Pinto, I. M.	2012	1-12	8	\N	4
...
3520	TC	Visualization Management of Industrial Maintenance Data Using Augmented Reality	ESPÍNDOLA, Danúbia Bueno ; PEREIRA, Carlos Eduardo ; HENRIQUES, Renato Ventura Bayan ; BOTELHO, Silvia S da C	2011	1-8	8	\N	4
...
3523	TC	Detecção de falhas em atuadores nas linhas de transporte de petróleo e/ou derivados	HENRIQUES, Renato Ventura Bayan ; PEREIRA, Carlos Eduardo ; SCHNEIDER, Eduardo Luis ; GONÇALVES, Luiz Fernando ; ESPÍNDOLA, Danúbia Bueno	2010		8	\N	4
3524	TC	IM:MR - A Tool for integration of data from different formats	ESPÍNDOLA, Danúbia Bueno ; PEREIRA, Carlos Eduardo ; PINHO, Marcio	2009	620-626	8	\N	4
3525	TC	A solution for integration of IM and MR data	ESPÍNDOLA, Danúbia Bueno ; PEREIRA, Carlos Eduardo	2009	423-430	8	\N	4
3526	RE	Rastreamento e imersão 3d para visualização de estruturas navais e offshore	SCHROEDER, Greyce N ; ESPÍNDOLA, Danúbia Bueno ; BOTELHO, Silvia S da C ; DUARTE, Nelson	2012		8	\N	4
...
3527	RE	O uso de Realidade Aumentada em Sistemas de Manutenção Inteligente	ESPÍNDOLA, Danúbia Bueno ; PEREIRA, Carlos Eduardo	2008	54-58	8	\N	4
...
3627	RC	Multiplicadores de Conhecimento Para Continuidade de Projeto de Inclusão Digital	MARTINAZZO, L. A. ; GRILLO, T. ; CARVALHO, J. T. ; HAX, V. A. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
...
3528	RC	A Visualização Mista nos Sistemas de Automação de Processos de Manutenção Preditiva de Máquinas da Indústria	ESPÍNDOLA, Danúbia Bueno ; PEREIRA, Carlos Eduardo ; HENRIQUES, Renato Ventura Bayan ; BOTELHO, Silvia Silva da Costa	2010	3021-3027	8	\N	4
3529	RC	Visualization of Intelligent Maintenance Systems Through Mixed Reality	ESPÍNDOLA, Danúbia Bueno ; PEREIRA, Carlos Eduardo ; PINHO, Marcio	2008	203-204	8	\N	4
...
3530	AP	Signal probability for reliability evaluation of logic circuits	FRANCO, D ; VASCONCELOS, M ; NAVINER, L ; NAVINER, J	2008	1586-1591	9	\N	4
3531	AP	Relevant metrics for evaluation of concurrent error detection schemes	DEVASCONCELOS, M ; FRANCO, D ; NAVINER, L ; NAVINER, J	2008	1601-1603	9	\N	4
...
3532	TC	Uma nova técnica para análise HEPWM baseada na aplicação de multiplicadores de Lagrange	OBADOWSKI, V. N. ; RIECHEL, T. L. ; CRUZ, M. F. ; UGOSKI, P. E. M. ; RICHTER, C. M. ; SEVERO, S. L. S. ; A. P. Lerm ; FRANCO, D. T. ; CIARELLI, W. F.	2012		9	\N	4
...
3533	TC	A Supervisory System for Real-Time Oscillography of Synchronous Generators	CRUZ, M. F. ; RIECHEL, T. L. ; OBADOWSKI, V. N. ; UGOSKI, P. E. M. ; RICHTER, C. M. ; SEVERO, S. L. S. ; A. P. Lerm ; OLIVEIRA, M. O. ; PAZ, M. C. R. ; BRETAS, A. S. ; FRANCO, D. T. ; CIARELLI, W. F.	2012		9	\N	4
...
3534	TC	A New Method to Minimize Harmonic Components on PWM Signals Based on Lagrange Multipliers	OBADOWSKI, V. N. ; RIECHEL, T. L. ; CRUZ, M. F. ; UGOSKI, P. E. M. ; RICHTER, C. M. ; SEVERO, S. L. S. ; A. P. Lerm ; OLIVEIRA, M. O. ; PAZ, M. C. R. ; BRETAS, A. S. ; FRANCO, D. T. ; CIARELLI, W. F.	2012		9	\N	4
...
3535	TC	Active Power Regulation of Auxiliary Generation Units in Hydroelectric Power Plants Using Power Electronic Switching	PAZ, M. C. R. ; OLIVEIRA, M. O. ; BRETAS, A. S. ; CRUZ, M. F. ; RIECHEL, T. L. ; OBADOWSKI, V. N. ; UGOSKI, P. E. M. ; RICHTER, C. M. ; A. P. Lerm ; SEVERO, S. L. S. ; FRANCO, D. T. ; CIARELLI, W. F.	2012		9	\N	4
3536	TC	Controle de Potência Ativa em Geradores Auxiliares de Usinas Hidrelétricas Através de sua Compensação Série	OLIVEIRA, M. O. ; PAZ, M. C. R. ; BRETAS, A. S. ; CRUZ, M. F. ; RIECHEL, T. L. ; OBADOWSKI, V. N. ; UGOSKI, P. E. M. ; RICHTER, C. M. ; SEVERO, S. L. S. ; A. P. Lerm ; FRANCO, D. T. ; CIARELLI, W. F.	2012		9	\N	4
...
3537	TC	Sistema Supervisório Voltado para Oscilografia em Tempo Real de Geradores Síncronos	CRUZ, M. F. ; RIECHEL, T. L. ; OBADOWSKI, V. N. ; UGOSKI, P. E. M. ; RICHTER, C. M. ; SEVERO, S. L. S. ; A. P. Lerm ; OLIVEIRA, M. O. ; PAZ, M. C. R. ; BRETAS, A. S. ; FRANCO, D. T. ; CIARELLI, W. F.	2012		9	\N	4
...
3538	TC	Um Novo Método para Minimização de Componentes Harmônicos em Sinais PWM Baseado em Multiplicadores de Lagrange Aplicados a HEPWM	OBADOWSKI, V. N. ; RIECHEL, T. L. ; CRUZ, M. F. ; UGOSKI, P. E. M. ; RICHTER, C. M. ; SEVERO, S. L. S. ; A. P. Lerm ; OLIVEIRA, M. O. ; PAZ, M. C. R. ; BRETAS, A. S. ; FRANCO, D. T. ; CIARELLI, W. F.	2012		9	\N	4
3539	TC	On evaluating the signal reliability of self-checking arithmetic circuits	FRANCO, D. T. ; VASCONCELOS, M ; NAVINER, L ; NAVINER, J	2010	109-114	9	\N	4
3540	TC	A Software Tool for the Analysis of Reliability in Combinational Logic Circuits	BORGES, M. T. ; OLIVEIRA, R. F. ; FRANCO, D. T.	2010	83-86	9	\N	4
...
3541	TC	Methods and Metrics for Reliability Assessment	NAVINER, L ; NAVINER, J ; FRANCO, D. T. ; VASCONCELOS, M	2009	1-14	9	\N	4
...
3542	TC	Efficient computation of logic circuits reliability based on Probabilistic Transfer Matrix	NAVINER, L ; VASCONCELOS, M ; FRANCO, D. T. ; NAVINER, J	2008	01-04	9	\N	4
3543	TC	Reliability analysis of combinational circuits based on a probabilistic binomial model	VASCONCELOS, M ; FRANCO, D. T. ; NAVINER, L ; NAVINER, J	2008	310-313	9	\N	4
3544	TC	Reliability of logic circuits under multiple simultaneous faults	FRANCO, D. T. ; VASCONCELOS, M ; NAVINER, L ; NAVINER, J	2008	265-268	9	\N	4
...
3545	TC	Reliability analysis of logic circuits based on signal probability	FRANCO, D. T. ; VASCONCELOS, M ; NAVINER, L ; NAVINER, J	2008	670-673	9	\N	4
3546	TC	On the output events in concurrent error detection schemes	VASCONCELOS, M ; FRANCO, D. T. ; NAVINER, L ; NAVINER, J	2008	978-981	9	\N	4
3547	TC	Evaluating signal reliability of logic circuits by signal probability	FRANCO, D. T. ; VASCONCELOS, M ; NAVINER, L ; NAVINER, J	2008	01-02	9	\N	4
...
3548	RE	A Dedicated Hardware Solution for the HEVC Interpolation Unit	AFONSO, V. ; CORREA, M. M. ; AGOSTINI, Luciano ; FRANCO, D. T.	2012		9	\N	4
3549	RE	Reliability Estimation Methods:Trade-Offs Between Complexity and Accuracy	PAGLIARINI, S. N. ; FRANCO, D. T. ; Lirida Naviner ; Jean-François Naviner	2012		9	\N	4
...
3550	RC	SPR Tool: Signal Reliability Analysis of Logic Circuits	FRANCO, D. T. ; VASCONCELOS, M ; NAVINER, L ; NAVINER, J	2009	01-02	9	\N	4
...
3551	AP	Utilização de Autômatos Celulares para Simulação de Impactos Ambientais	SILVA, F. N. ; ADAMATTI, D. F.	2012	1-10	10	\N	4
3552	AP	FURG Smart Games: a development enviroment to NPC decisions in games	MADSEN, C. ; LUCCA, G. ; DANIEL, G. B. ; ADAMATTI, D. F.	2012	47-61	10	\N	4
3220	TC	TOPOBO: UMA NOVA FERRAMENTA PEDAGÓGICA PARA A EXPERIMENTAÇÃO EM CIÊNCIAS	M, Santin ; BOTELHO, S. S. C.	2011		34	\N	3
3553	AP	Usando a Metodologia Prometheus para Modelagem de um Sistema Multiagente	RODRIGUES, T. ; ADAMATTI, D. F.	2012	1-15	10	\N	4
3554	AP	Um Jogo de Estratégia Aplicando Técnicas de Inteligência Artificial	SILVA, F. V. ; ADAMATTI, D. F.	2012	1-10	10	\N	4
3555	AP	NeuroFURG: uma ferramenta de apoio ao ensino de Redes Neurais Artificiais	MADSEN, C. ; ADAMATTI, D. F.	2011	14-24	10	\N	4
...
3556	AP	Simulação Baseada em Multiagentes como Ferramenta em Estudos Interdisciplinares. RENOTE	ADAMATTI, D. F.	2011	1-9	10	\N	4
3557	AP	Using Artificial Intelligence in Computational Games	MADSEN, C. ; ADAMATTI, D. F.	2011	60-67	10	\N	4
...
3558	AP	Uso de Árvores de Decisão para Captura de Comportamentos de Agentes	SILVEIRA, J. A. ; PAES, T. L. ; ADAMATTI, D. F. ; EMMENDORFER, L. R.	2011	1-21	10	\N	4
3559	AP	An analysis of the insertion of virtual players in GMABS methodology using the Vip-JogoMan prototype. JASSS	ADAMATTI, D. F. ; SICHMAN, Jaime Simão ; COELHO, Helder	2009	1-40	10	\N	4
...
3560	AP	Inserção de Jogadores Virtuais em Jogos de Papeis para uso em sistemas de apoio a decisão em Grupos: um Experimento no Domínio da Gestão dos Recursos Naturais. IP	ADAMATTI, D. F.	2008	115-116	10	\N	4
3561	LP	V Conferência Sul em Modelagem Computacional	SOUZA, J. A. (Org.) ; ADAMATTI, D. F. (Org.) ; RODRIGUES, R. G. (Org.) ; KRUSCHE, N. (Org.) ; EMMENDORFER, L. R. (Org.)	2012		10	\N	4
3562	LP	Advances in Social Simulation, 2010 Second Brazilian Workshop on Social Simulation, BWSS 2010, Post-Proceedings. Los Alamitos: IEEE	DIMURO, G. P. (Org.) ; COSTA, A. C. R. (Org.) ; SICHMAN, Jaime Simão (Org.) ; Tedesco, P. C. A. R. (Org.) ; ADAMATTI, D. F. (Org.) ; BALSA, J. (Org.) ; ANTUNES, L. (Org.)	2011		10	\N	4
3565	LP	Anais do Simpósio de Modelagem Computacional do Sul	ROCHA, L. A. O. (Org.) ; BOTELHO, S.S.C. (Org.) ; ADAMATTI, D. F. (Org.)	2009		10	\N	4
...
3566	CL	An Agent-Based Decision Support System to Simulate Generated Impacts by Industries Installation	NUNES, G. ; THOMASI, C. D. ; JUGUEIRO, M. ; ADAMATTI, D. F.	2012	95	10	\N	4
3567	CL	A Proposal for Interoperability to Agent Communication Using Synonyms	SPEROTTO, F. A. ; ADAMATTI, D. F.	2012	1-5	10	\N	4
3568	CL	Modeling Role Interactions in a Social Organization for the Simulation of the Social Production and Management of Urban Ecosystems: the case of San Jernimo Vegetable Garden of Seville, Spain	SANTOS, F. C. P. ; RODRIGUES, T. ; ADAMATTI, D. F. ; DIMURO, G. ; DIMURO, G. P. ; COSTA, A. C. R. ; JEREZ, E. M.	2012	1-4	10	\N	4
3569	CL	Artificial Intelligence Applied to Natural Resources Management. Machine Learning: Concepts, Methodologies, Tools and Applications. New York	ADAMATTI, D. F. ; AGUIAR, M. S.	2011	1566-1582	10	\N	4
3243	TC	Odometry and Mapping for Underwater Autonoumous Vehicles	BOTELHO, S. S. C. ; LEIVAS, G ; DREWS, P.	2009	1-6	34	\N	3
3570	CL	Artificial Intelligence Applied to Natural Resources Management	ADAMATTI, D. F. ; AGUIAR, M. S.	2010	313-330	10	\N	4
3571	CL	Simulação Baseada em Multiagentes em Atividades de Graduação	ADAMATTI, D. F.	2010	208-211	10	\N	4
3573	CL	Design of an Artificial Decision Maker for a Human-Based Social Simulation - Experience of the SIMPARC ProjectDesign of an Artificial Decision Maker for a Human-Based Social Simulation - Experience of the SIMPARC Project	BRIOT, J. ; SORDONI, A. ; VASCONCELOS FILHO, J. E. ; PATTO, V. S. ; ADAMATTI, D. F. ; IRVING, M. ; MELLO, G. ; Lucena, C.	2010	17-35	10	\N	4
...
3574	CL	A Inteligência Artificial e o Gerenciamento de Recursos Naturais	ADAMATTI, D. F. ; AGUIAR, M. S.	2009	67-86	10	\N	4
3575	TC	Using GIS for Impact Analysis from Industries Installation	THOMASI, C. D. ; NUNES, G. ; JUGUEIRO, M. ; ADAMATTI, D. F.	2012		10	\N	4
3577	TC	FURG Smart Games: a Propose for a Environment to Game Development With Software Reuse and Artificial Intelligence	MADSEN, C. ; LUCCA, G. ; DANIEL, G. B. ; ADAMATTI, D. F.	2012	1-15	10	\N	4
3581	TC	Inclusão Digital como Ferramenta para Mudanças Sociais	ADAMATTI, D. F. ; CARVALHO, J. T. ; HAX, V. A. ; KLUMB, A. ; DUARTE, B. T. ; MIRAPALHETA, B. ; SILVA, D. ; FLORES, E. ; ROCHANO, E. L. ; LUCCA, G. ; LINDENAU, G. ; MARTINAZZO, L. A. ; DJALO, M. ; GRILLO, T. ; LEAL, T.	2012	1-6	10	\N	4
...
3584	TC	Um Modelo para Comunicação de Agentes Tratando Informações Imprecisas Baseado em Sinônimos	SPEROTTO, F. A. ; ADAMATTI, D. F.	2012	1-6	10	\N	4
...
3585	TC	FSG-ANNBack: Proposal of an Environment to Insert Artificial Neural Networks to Game Development Using Software Reuse	MADSEN, C. ; LUCCA, G. ; DANIEL, G. B. ; ADAMATTI, D. F.	2012	1-6	10	\N	4
...
2434	LP	Anais do IV Workshop- Escola de Sistemas de Agentes, seus Ambientes e apliCações. Rio Grande: FURG	Adamatti, D. F. (Org.) ; LUGO, G.G (Org.) ; Emmendorfer, L. R. (Org.) ; WERHLI, A. V. (Org.)	2010		0	2434	3
3303	TC	Real-Time Predictive Control of a Brachiation Robot	OLIVEIRA, V. M. ; LAGES, W. F.	2009	1-6	37	\N	3
2653	LP	Anais do IV Workshop- Escola de Sistemas de Agentes, seus Ambientes e apliCações. Rio Grande: FURG	ADAMATTI, D. F. (Org.) ; LUGO, G. G. (Org.) ; EMMENDORFER, L. R. (Org.) ; WERHLI, A. V. (Org.)	2010		10	2434	3
3305	TC	Controle em Tempo Real de um Robô Bracejador Utilizando MPC	OLIVEIRA, V. M. ; LAGES, W. F.	2009		37	\N	3
3586	TC	Definição de sistema de apoio à decisão baseado em agentes para simulação de impactos gerados pela instalação de indústrias	BASTOS, N. ; MARQUES, B. ; ADAMATTI, D. F.	2012	1-6	10	\N	4
3587	TC	Processamento e Classificação de Sinais Cerebrais para o Uso em Sistemas BCI	SILVEIRA, J. A. ; ADAMATTI, D. F.	2012	1-6	10	\N	4
3588	TC	A Model for Agent Communication Based on Imprecise Information Using Synonyms	SPEROTTO, F. A. ; ADAMATTI, D. F.	2012	1-6	10	\N	4
...
3590	TC	Utilização do Simulador SUMO para Simulação de Dispersão de Poluentes	BORN, M. B. ; ADAMATTI, D. F.	2012	1-6	10	\N	4
3628	RC	Inclusão Digital nas Universidades	BENEVIDES, L. ; FELIX, D. ; RODRIGUES, A. S. P. ; OLIVEIRA, B. A. ; FIORI, D. ; FERNANDES, L. ; LINDENAU, G. ; GUEDES, R. C. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
...
3629	RC	Dispersão de Poluentes utlizando o Simulador SUMO	BORN, M. B. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
...
3630	RC	Alocação Dinâmica e Descentralizada de Tarefas em Sistemas Multiagente	GULARTE, A. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
...
3597	TC	A Framework for Intelligent Games	ADAMATTI, D. F.	2010	376-380	10	\N	4
3599	TC	Problemas de Sincronização em Massively Multiplayer Online Games: Um Experimento Sobre a Plataforma SIM3D	FELSKE, M. S. ; ADAMATTI, D. F.	2010	1-4 - CDROM	10	\N	4
3600	TC	Um Overview sobre a Utilização de Técnicas de Inteligência Artificial em Gerenciamento de Recursos Naturais	GULARTE, A. ; THOMASI, C. D. ; NUNES, G. ; ADAMATTI, D. F.	2010	1-4 - CDROM	10	\N	4
3602	TC	UMA FERRAMENTA DE SIMULAÇÃO PARA IMPACTOS AMBIENTAIS	NUNES, G. ; THOMASI, C. D. ; GULARTE, A. ; ADAMATTI, D. F.	2010		10	\N	4
3603	TC	Design of an Artificial Decision Maker for a Human-based Social Simulation - Experience of the SimParc Project	BRIOT, J. ; SORDONI, A. ; VASCONCELOS FILHO, J. E. ; PATTO, V. S. ; ADAMATTI, D. F. ; IRVING, M.	2009	1-16.CDROM	10	\N	4
3604	TC	A Computer-based Support for Participatory Management of Protected Areas: The SimParc Project	BRIOT, J. ; PATTO, V. S. ; VASCONCELOS FILHO, J. E. ; ADAMATTI, D. F. ; SORDONI, A. ; MELLO, G.	2009	1337-1346	10	\N	4
3605	TC	An Overview of the MABS and RPG Techniques in Natural Resources Management	ADAMATTI, D. F.	2009	538-542	10	\N	4
3606	TC	Desenvolvimento de agentes: Uma análise da utilização da metodologia Prometheus	BERNY, V. M. ; ADAMATTI, D. F. ; COSTA, A. C. R.	2009	1-10.CDROM	10	\N	4
3607	TC	A Framework to combine MDA and Ontology Learning	CANTELE, R. C. ; FERREIRA, M. A. G. V. ; ADAMATTI, D. F. ; ARAUJO, M.	2008	1-12.CDROM	10	\N	4
3608	TC	An Experiment on Knowledge Reuse: Standards Applied	CANTELE, R. C. ; FERREIRA, M. A. G. V. ; ADAMATTI, D. F. ; ARAUJO, M.	2008	1-12.CDROM	10	\N	4
3609	TC	A Computer-based Support for Participatory Management of Protected Areas: The SimParc Project	BRIOT, J. ; VASCONCELOS FILHO, J. E. ; ADAMATTI, D. F. ; PATTO, V. S. ; BARBOSA, S. ; FURTADO, V. ; IRVING, M. ; Lucena, C.	2008	1-15.CDROM	10	\N	4
3610	TC	Uso de Agentes e Ontologias na Integração de Sistemas de Informação em Saúde	WEBBER, C. G. ; ADAMATTI, D. F. ; SALVADORI, J. ; RIBEIRO, A. M. ; PINTO, L. F. ; FERLA, A.	2008	1-10.CDROM	10	\N	4
3611	TC	ExML: um Curso de Nivelamento na Modalidade EAD	Falavigna, M.R. ; ADAMATTI, D. F. ; Kuyven, N. L.	2008	1-6.CDROM	10	\N	4
3612	TC	Inserção de Jogadores Virtuais em Jogos de Papéis para Uso em Sistemas de Apoio a Decisão em Grupos: Um Experimento no Domínio da Gestão de Recursos Naturais	ADAMATTI, D. F. ; SICHMAN, Jaime Simão	2008	1-10.CDROM	10	\N	4
3613	TC	Construção de Ontologias Iniciais a partir de Sistemas Legados	ADAMATTI, D. F.	2008	1-10.CDROM	10	\N	4
3614	TC	A Web Semântica e a Eduação	CANTELE, R. C. ; ADAMATTI, D. F. ; FERREIRA, M. A. G. V.	2008	1-1.CDROM	10	\N	4
3615	RE	Multiplicadores de Conhecimento em Projeto de Inclusão Digital	MARTINAZZO, L. A. ; GRILLO, T. ; CARVALHO, J. T. ; HAX, V. A. ; ADAMATTI, D. F.	2012	1-4	10	\N	4
3616	RE	Inclusão Digital Dentro da Universidade	BENEVIDES, L. ; RODRIGUES, A. S. P. ; OLIVEIRA, B. A. ; FERNANDES, L. ; GARCEZ, A. ; FIORI, D. ; CARVALHO, J. T. ; HAX, V. A. ; ADAMATTI, D. F.	2012	1-4	10	\N	4
3617	RE	Redes Sociais em Projeto de Inclusão Digital	LUCCA, G. ; KLUMB, A. ; CARVALHO, J. T. ; HAX, V. A. ; ADAMATTI, D. F.	2012	1-4	10	\N	4
3618	RE	Classification of Brain Signals in BCI Systems	SILVEIRA, J. A. ; ADAMATTI, D. F.	2012	1-4	10	\N	4
3619	RE	Pressupostos da Educação Básica na Formação Continuada do Professor no Atendimento Educacional Especializado para as Salas de Recursos Multifuncionais - Tecnologia Assistiiva	FELIPE, C. I. M. ; ADAMATTI, D. F. ; BARWALDT, R.	2012	1-10	10	\N	4
3620	RE	Um sistema de apoio à decisão baseado em agentes para simulação de impactos gerados pela instalação de indústrias	NUNES, G. ; THOMASI, C. D. ; JUGUEIRO, M. ; ADAMATTI, D. F.	2011	1-4 - CDROM	10	\N	4
3621	RE	Desenvolvimento de Técnicas de Classificação de Sinais em Sistemas BCI	SILVEIRA, J. A. ; DE BEM, R. A. ; ADAMATTI, D. F.	2011		10	\N	4
3622	RE	NeuroFURG: uma ferramenta de apoio ao ensino de Redes Neurais Artificiais	MADSEN, C. ; ADAMATTI, D. F.	2011		10	\N	4
3623	RE	Modelo para Virtualização de Ambientes Robóticos com Software Livre	AMARAL, M. ; ADAMATTI, D. F.	2011		10	\N	4
3624	RE	Simulação Baseada em Multiagentes em Atividades de Graduação	ADAMATTI, D. F.	2010	135-138	10	\N	4
3625	RE	Detectando Padrões Comportamentais de Agentes Através de Árvores de Decisão	SILVEIRA, J. A. ; PAES, T. L. ; EMMENDORFER, L. R. ; ADAMATTI, D. F.	2010	131-134	10	\N	4
3626	RC	Assistive Technologies: Accessibility to People with Disabilities	ADAMATTI, D. F. ; BARWALDT, R. ; FELIPE, C. I. M.	2012	1-2	10	\N	4
3632	RC	Definição de Sistema de Apoio à Decisão Baseado em Agentes para Simulação de Impactos Gerados pela Instalação de Indústrias	BASTOS, N. ; MARQUES, B. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
3633	RC	Jogo Animal	PETTER, L. C. ; ADAMATTI, D. F. ; KRUSCHE, N.	2012	1-1	10	\N	4
3634	RC	Sistemas Multiagentes Baseados em Modelagem por Redes de Petri: Um Estudo de Caso	ROSA, A. M. ; SPEROTTO, F. A. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
3635	RC	Inclusão Digital em Comunidades Carentes de Rio Grande	ROCHANO, E. L. ; LUCCA, G. ; SILVA, D. ; FLORES, E. ; KLUMB, A. ; DJALO, M. ; DUARTE, B. T. ; LEAL, T. ; CARVALHO, J. T. ; HAX, V. A. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
3636	RC	Implementação de um Protocolo de Roteamento Usando ACO	PEREIRA, L. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
3637	RC	Criação de um Software para Reserva de Salas da FURG	SILVEIRA, G. ; BACELAR, E. ; SEUS, V. ; FERREIRA, D. ; CASSALES, V. ; OTERO, T. F. ; TREVISAN, G. ; CHAVES, T. ; ADAMATTI, D. F. ; BARWALDT, R.	2012	1-1	10	\N	4
3638	RC	Uma Proposta para Melhoria da Aquisição e Desenvolvimento de Habilidades em Disciplinas Básicas da Ciência da Computação	CUNHA, S. ; SILVEIRA, G. ; ADAMATTI, G. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
3639	RC	Modelagem De Interações Em Uma Organização Social Para Simulação De Gestão E Produção Social De Ecosistemas Urbanos: O Caso Da Horta Urbana De San Jeronimo Em Sevilha, Espanha	SANTOS, F. C. P. ; RODRIGUES, T. ; DIMURO, G. ; ADAMATTI, D. F. ; DIMURO, G. P. ; JEREZ, E. M.	2012	1-1	10	\N	4
3640	RC	FURG Smart Games: Um ambiente para o Estudo e Desenvolvimento de de IA para Personagens em Jogos Eletrônicos	DANIEL, G. B. ; MADSEN, C. ; ADAMATTI, D. F.	2012	1-1	10	\N	4
3641	RC	Um Simulador para Previsão de Impactos Gerados pela Instalação de Indústrias	JUGUEIRO, M. ; THOMASI, C. D. ; NUNES, G. ; ADAMATTI, D. F.	2011		10	\N	4
3642	RC	Recuperação de Imagens Baseada em Conteúdo Utilizando Dispositivos Móveis	GULARTE, A. ; THOMASI, C. D. ; DE BEM, R. A. ; ADAMATTI, D. F.	2011		10	\N	4
3643	RC	Inclusão Digital em Escola de Ensino Básico em Rio Grande (RS)	DJALO, M. ; KLUMB, A. ; SILVA, D. ; FLORES, E. ; CAMACHO, P. M. ; CARVALHO, J. T. ; HAX, V. A. ; ADAMATTI, D. F.	2011		10	\N	4
3644	RC	Uma ferramenta para coleta e análise de dados do segmento naval	OTERO, T. F. ; BORGES, E. N. ; ADAMATTI, D. F.	2011		10	\N	4
3645	RC	SACI Sistema Avançado de Supervisão, Inspeção e Diagnóstico de Sistemas Elétricos: Geração, Transmissão e Distribuição Módulo de Interface e Visualização	COSTA, M. M. ; ADAMATTI, D. F.	2011		10	\N	4
3646	RC	Framework para Desenvolvimento de Jogos Inteligentes	LUCCA, G. ; MADSEN, C. ; ADAMATTI, D. F.	2011		10	\N	4
3647	RC	Proposta de Modelagem Baseada em Agentes de um Caso de Gestão Social de Ecossistemas Urbanos	RODRIGUES, T. ; SANTOS, F. C. P. ; SANTOS, I. ; DIMURO, G. ; ADAMATTI, D. F. ; DIMURO, G. P. ; COSTA, A. C. R.	2011		10	\N	4
3648	RC	Tecnologias Assistivas: Recursos e Serviços Utilizados para a Inclusão Sócio-Digital de Pessoas com Deficiências	SALOMAO, H. L. R. ; BARWALDT, R. ; ADAMATTI, D. F. ; FELIPE, C. I. M.	2011		10	\N	4
3649	RC	Modelagem do Sistema Multiagente para Simulação de Processos de Gestão Social de Ecossistemas Urbanos	SANTOS, F. C. P. ; ADAMATTI, D. F. ; DIMURO, G. P.	2011		10	\N	4
3650	RC	Árvores de Decisão para Descoberta de Detectando Padrões Comportamentais de Agentes Através de Árvores de Decisão	SILVEIRA, J. A. ; PAES, T. L. ; EMMENDORFER, L. R. ; ADAMATTI, D. F.	2010	1-1 - CDROM	10	\N	4
3651	RC	Modelagem da Dinâmica do Fluxo Granular Através de Autômatos Celulares e Simulação Baseada em Agentes	SILVEIRA, J. A. ; PAES, T. L. ; EMMENDORFER, L. R. ; ADAMATTI, D. F.	2010	1-1 - CDROM	10	\N	4
3652	RC	Sistemas Inteligentes no Gerenciamento de Recursos Naturais	GULARTE, A. ; THOMASI, C. D. ; NUNES, G. ; ADAMATTI, D. F.	2010	1-1 - CDROM	10	\N	4
3653	RC	Desenvolvimento da interface gráfica para um Framework de jogos inteligentes	PERRONE, F. R. ; ADAMATTI, D. F.	2010	1-1 - CDROM	10	\N	4
3654	RC	Identificação de Registros Duplicados nos Cadastros da ONIP	OTERO, T. F. ; BORGES, E. N. ; ADAMATTI, D. F.	2010	1-1 - CDROM	10	\N	4
3655	RC	Desenvolvimento de uma Interface Gráfica 3D para um RPG no domínio da Gestão dos Recursos Naturais	LEONARDI, L. ; ROCHA, M. ; ADAMATTI, D. F.	2008	1-2.CDROM	10	\N	4
3656	AP	Specifying Knowledge in Cognitive Multiagent Systems using a Class of Hierarchical Petri Nets	GONÇALVES, E. M. N.	2012	2405-2414	11	\N	4
3658	TC	Modelagem de Função Avaliação para o Domínio de Futebol de Robôs em Simulação 2D	GONÇALVES, E. M. N. ; FOGAÇA, Mateus	2012	184-187	11	\N	4
3659	TC	Cálculo de parâmetros de chute para simulações de futebol de robôs 2D utilizando controle fuzzy	GONÇALVES, E. M. N. ; FOGAÇA, Mateus	2012	386-393	11	\N	4
3660	TC	Gerando Bases de Conhecimento no Formato XML para Sistemas Multiagentes utilizando Redes de Petri	GONÇALVES, E. M. N. ; SANTOS, M. M.	2011		11	\N	4
3661	TC	An Approach to Specify Knowledge in Multi-agent Systems using Petri Nets	GONÇALVES, E. M. N.	2010	456-461	11	\N	4
3667	TC	TATUBOT - Robotic System for Inspection of Undergrounded Cable System	MELLO, C. ; GONÇALVES, E. M. N. ; ESTRADA, E. ; ALMEIDA, Renan Rosado de ; BOTELHO, S. S. C. ; OLIVEIRA, V. M.	2008	170-175	11	\N	4
3668	RE	NLMAP - Localização e Navegação de Robôs Cooperativos para Inspeção	GONÇALVES, E. M. N. ; ESTRADA, E. ; LEIVAS, G. ; BOTELHO, S. S. C.	2008	243-249	11	\N	4
3669	AP	An unsupervised heuristic-based approach for bibliographic metadata deduplication	Borges, Eduardo N. ; de Carvalho, Moisés G. ; Galante, Renata ; GONÇALVES, Marcos André ; Laender, Alberto H.F.	2011	706-718	13	\N	4
3657	LP	Introdução à Educação a Distância	GONÇALVES, E. M. N. ; Vieira, Suzane R	2011		11	\N	4
3674	TC	CiênciaBrasil - The Brazilian Portal of Science and Technology	LAENDER, Alberto H. F. ; Moro, Mirella M. ; Silva, Altigran S. ; Davis Jr., Clodoveu A. ; GONÇALVES, Marcos André ; Galante, Renata ; Silva, Allan J. C. ; Bigonha, Carolina A. S. ; Dalip, Daniel Hasan ; Barbosa, Eduardo M. ; Borges, Eduardo N. ; Cortez, Eli ; Procópio Jr., Peterson ; de Alencar, Rafael Odon ; Cardoso, Thiago N. C. ; Salles, Thiago	2011	1366-1379	13	\N	4
3675	TC	An Automatic Approach for Duplicate Bibliographic Metadata Identification Using Classification	Borges, Eduardo N. ; Becker, Karin ; HEUSER, Carlos A. ; Galante, Renata	2011	1-7	13	\N	4
3676	TC	A Classification-based Approach for Bibliographic Metadata Deduplication	Borges, Eduardo N. ; Becker, Karin ; HEUSER, Carlos A. ; GALANTE, Renata de Matos	2011	221-228	13	\N	4
3677	TC	Uma Abordagem Efetiva e Eficiente para Deduplicação de Metadados Bibliográficos de Objetos Digitais	BORGES, Eduardo Nunes ; GALANTE, Renata de Matos ; GONÇALVES, Marcos André	2008	76-90	13	\N	4
3678	TC	XSimilarity : Uma Ferramenta para Consultas por Similaridade embutidas na Linguagem XQuery	SILVA, Maria Estela Vieira da ; BORGES, Eduardo Nunes ; GALANTE, Renata de Matos	2008	148-157	13	\N	4
3679	RE	Manutenção das Aplicações Web de Acesso e Gerência do Banco de Dados Meteorológicos da FURG	da Silva, Rafael S. ; BORGES, Eduardo Nunes ; Krusche, Nisia	2010		13	\N	4
3680	RE	Atualização do Sistema de Gerenciamento do Banco de Dados Meteorológicos da FURG	da Silva, Rafael S. ; BORGES, Eduardo Nunes ; Krusche, Nisia	2010		13	\N	4
3681	RE	Identificação de Registros Duplicados nos Cadastros da ONIP	Otero, Tiago F. ; BORGES, Eduardo Nunes ; Adamatti, Diana Francisca	2010		13	\N	4
3682	RC	Módulo de critérios de relevância para o ARGOsearch	TOMASINI, C. ; PEREIRA, Igor A. ; Borges, Eduardo N. ; Vargas, André P.	2012		13	\N	4
3683	RC	Um componente de software para análise de redes de colaboração acadêmica	Lucca, G. ; FARIAS, Lucas R. ; LOPES, G. R. ; Vargas, André P. ; Borges, Eduardo N.	2012		13	\N	4
3684	RC	Validação do mecanismo de busca ARGOsearch para o sistema de gerenciamento de bibliotecas da FURG	PEREIRA, Igor A. ; TOMASINI, C. ; Borges, Eduardo N. ; Vargas, André P.	2012		13	\N	4
3685	RC	Uma ferramenta para visualização e análise de redes de pesquisa	FARIAS, Lucas R. ; Lucca, G. ; LOPES, G. R. ; Vargas, André P. ; Borges, Eduardo N.	2012		13	\N	4
3686	RC	Uma arquitetura para pesquisa por relevância baseada em critérios	PEREIRA, Igor A. ; Borges, Eduardo N. ; Vargas, André P.	2011		13	\N	4
3687	RC	Rede de pesquisa da FURG	FARIAS, Lucas R. ; Vargas, André P. ; Borges, Eduardo N.	2011		13	\N	4
3688	RC	Uma ferramenta para coleta e análise de dados do segmento naval	Otero, Tiago F. ; FARIAS, Lucas R. ; da Silva, Rafael S. ; Borges, Eduardo N. ; Vargas, André P. ; Adamatti, Diana Francisca	2011		13	\N	4
3689	RC	BorbRS 2: aperfeiçoamento de uma base de dados de borboletas (Lepidoptera: Papilionoidea e Hesperioidea) do Rio Grande do Sul	Scholem, Tyron Wittee Neetzow ; BORGES, Eduardo Nunes ; Marchiori, Maria Ostilia ; Romanowski, Helena Piccoli	2009		13	\N	4
3691	AA	Comparative Study of Genetic Algorithm and Exhaustive Search for Constructal Design Optimization of Y-Shaped Cavities	ESTRADA, E. S. D. ; Santos, E. D. ; Isoldi, L. A. ; ROCHA, L. A. O.	2012		14	\N	4
3692	TC	Genetic Algorithm and Constructal Design for Geometric Optimization of Y‐Shaped Cavities	ESTRADA, E. S. D. ; Santos, E. D. ; Isoldi, L. A. ; ROCHA, L. A. O.	2012	45-50	14	\N	4
3694	TC	Projeto Reuni: uma proposta da utilização de Modelagem Computacional no Ensino de Engenharia	LOPES, N. R. ; MACHADO, B. N. ; ESTRADA, E. S. D. ; Isoldi, L. A. ; Santos, E. D.	2011	252-264	14	\N	4
3697	TC	Navigation system for an underground distribution inspection platform using simulation	ESTRADA, E. S. D. ; Silveira, L. ; OLIVEIRA, V. M. ; BOTELHO, S. S. C.	2010	109-114	14	\N	4
3703	RE	Arquitetura de Navegação Autônoma para Ambientes Reais e Virtuais de Inspeção de Linhas Subterrâneas de Distribuição de Energia	ESTRADA, E. S. D. ; Silveira, L. ; CORREA, U. B. ; BOTELHO, S. S. C. ; OLIVEIRA, V. M.	2009		14	\N	4
3704	RC	SIMULAÇÃO COMPUTACIONAL DO COMPORTAMENTO MECÂNICO DE UMA TRELIÇA	BRUM, R. S. ; CORREIA, A. L. G. ; ESTRADA, E. S. D. ; OLIVEIRA, C. G. ; Santos, E. D. ; Isoldi, L. A.	2011		14	\N	4
3705	TC	Predição espacial de monóxido de carbono gerado pelo tráfego veicular urbano	SILVA, G. C. ; GOLDNER, L. G. ; Ridley, Ian ; Dalotto, Roque	2009		15	\N	4
3707	RE	Um sistema de apoio à decisão baseado em agentes para simulação de impactos gerados pela instalação de indústrias	NUNES, G. A. L. ; THOMASI, C. D. ; JUGUEIRO, M. M. ; ADAMATTI, D. F.	2011	1-4	16	\N	4
3708	RE	Um Overview sobre a Utilização de Técnicas de Inteligência Artificial em Gerenciamento de Recursos Naturais	GULARTE, A. R. ; THOMASI, C. D. ; NUNES, G. A. L. ; ADAMATTI, D. F.	2010		16	\N	4
3709	RE	UMA FERRAMENTA DE SIMULAÇÃO PARA IMPACTOS AMBIENTAIS	NUNES, G. A. L. ; THOMASI, C. D. ; GULARTE, A. R. ; ADAMATTI, D. F.	2010		16	\N	4
3710	RE	Análise do Desempenho de Sistemas de Comunicação Cooperativa em Canais SUI	NUNES, G. A. L. ; Melgarejo, Dick Carrillo ; Vargas, C. H. V.	2010		16	\N	4
3711	RC	Sistemas Inteligentes no Gerenciamento de Recursos Naturais	GULARTE, A. R. ; THOMASI, C. D. ; NUNES, G. A. L. ; ADAMATTI, D. F.	2010		16	\N	4
3712	AP	Interval Additive Generators of Interval T-Norms and Interval T-Conorms	Dimuro, Graçaliz Pereira ; Bedregal, Benjamín Callejas ; Santiago, Regivan Hugo Nunes ; Reiser, Renata Hax Sander	2011	3898-3916	18	\N	4
3714	AP	On interval fuzzy S-implications	BEDREGAL, B. R. C. ; Dimuro, G.P. ; Santiago, R.H.N. ; Reiser, R.H.S.	2010	1373-1389	18	\N	4
3715	AP	Analyzing the relationship between interval-valued D-Implications and interval-valued QL-Implications. TEMA	REISER, R. H. S. ; BEDREGAL, B. R. C. ; SANTIAGO, R. H. N. ; DIMURO, G. P.	2010	89-100	18	\N	4
3716	AP	Aplicação de Agentes BDI com Percepção Fuzzy no Modelo Presa-Predador	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	299-324	18	\N	4
3717	AP	Xor-Implications and E-Implications: Classes of Fuzzy Implications Based on Fuzzy Xor	BEDREGAL, B. R. C. ; REISER, R. H. S. ; DIMURO, G. P.	2009	5-18	18	\N	4
3718	AP	Interval-Valued D-Implications. TEMA	REISER, R. H. S. ; BEDREGAL, B. R. C. ; SANTIAGO, R. H. N. ; DIMURO, G. P.	2009	63-74	18	\N	4
3720	AP	S-Implications on Bounded Lattices and the Interval Constructor. TEMA	REISER, R. H. S. ; DIMURO, G. P. ; BEDREGAL, B. R. C. ; SANTIAGO, R. H. N.	2008	143-154	18	\N	4
3721	AP	Incerteza de Dados em Fluxo de Potência: Uma abordagem com a Matemática Intervalar do C-XSC. TEMA	Vargas, R. ; FARIAS, C. M. ; BARBOZA, L. V. ; DIMURO, G. P.	2008	491-502	18	\N	4
3723	LP	ENIA - VIII Encontro Nacional de Inteligência Artificial/CSBC 2011 - XXXI Congresso da Sociedade Brasileira de Computação	PRATI, R. (Org.) ; DIMURO, G. P. (Org.) ; CAMPOS, A. (Org.)	2011		18	\N	4
3727	CL	Towards the Modeling of the Social Organization of an Experiment of Social Management of Urban Vegetable Gardens	SANTOS, I. ; RODRIGUES, T. F. ; DIMURO, G. P. ; COSTA, A. C. R. ; DIMURO, G. ; Jerez, E. de M.	2012	98-101	18	\N	4
3731	CL	On Interval Fuzzy Numbers	DIMURO, G. P.	2011	1-6	18	\N	4
3732	CL	On Fuzzy Probabilities in Bayesian Games	ASMUS, T. C. ; DIMURO, G. P.	2011	20-26	18	\N	4
3733	CL	On Vector and Matrices of Fuzzy Numbers	RIBES, J. L. B. ; DIMURO, G. P. ; AGUIAR, M. S.	2011	34-40	18	\N	4
3734	CL	Measuring the Quality of Internet Shopping: An Experiment Using Fuzzy Logic	RODRIGUES, L. M. ; DIMURO, G. P.	2011	55-61	18	\N	4
3735	CL	Hand Skill Programming: Using Fuzzy Sets to Program Topobo Kinectis Memory Devices	SANTINI, M.M. ; BOTELHO, S. S. C. ; DIMURO, G. P. ; RODRIGUES, C. L. L.	2011	62-68	18	\N	4
3736	CL	Modeling Uncertainty and Decision Making in Strategic Interactions in Multiagent Systems: An Overview	BRIÃO, S. L. ; DIMURO, G. P. ; COSTA, A. C. R.	2011	115-121	18	\N	4
3737	CL	A Fuzzy-BDI Agent Model for Exchanges of Non-economic Services, Based on the Social Exchange Theory	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2011	129-132	18	\N	4
3738	CL	Hybrid Intelligent Systems: A Study on Genetic Algorithms and Fuzzy Approaches	MACEDO, L. F. K. ; DIMURO, G. P. ; AGUIAR, M. S.	2011	133-139	18	\N	4
3739	CL	Towards Developmental Turing Machines	COSTA, S. A. ; COSTA, A. C. R. ; DIMURO, G. P.	2011	151-157	18	\N	4
3741	CL	Construção de Planos BDI a partir de Políticas Ótimas de POMDPs, com Aplicação na Programação em AgentSpeak usando o Jason	PEREIRA, D. R. ; GONÇALVES, L. V. ; DIMURO, G. P.	2010	24-30	18	\N	4
3749	TC	Simulação Multiagente de uma Abordagem Evolutiva e Espacial para o Jogo do Ultimato	MACEDO, L. F. K. ; RIBEIRO, M. ; BRIÃO, S. L. ; AGUIAR, M. S. ; DIMURO, G. P. ; FONSECA, C. N.	2012	35-46	18	\N	4
3751	TC	Planejamento de Rotas de Robôs Móveis: Estudo da Viabilidade de Uma Abordagem Baseada em Algoritmos Genéticos em um Ambiente Multiagente	CABREIRA, T. M. ; AGUIAR, M. S. ; DIMURO, G. P.	2012	253-264	18	\N	4
3752	TC	Proposta de modelo de avaliação da satisfação de usuários de transporte público usando lógica fuzzy	MATTOS, V. L. D. ; ROSA, S. E. ; Dimuro, G.P.	2012	1-10	18	\N	4
3754	TC	Uma Ordem Total para Números Fuzzy Intervalares Triangulares Simétricos	ASMUS, T. C. ; DIMURO, G. P.	2012	47-64	18	\N	4
3756	TC	Planejamento de Rotas de Robôs Móveis em Ambientes Dinâmicos: Uma Abordagem Utilizando Algoritmos Genéticos e Lógica Fuzzy	CABREIRA, T. M. ; DIMURO, G. P. ; AGUIAR, M. S.	2012	1-12	18	\N	4
3757	TC	Método de Ordenação de Números Fuzzy Intervalares: uma proposta	BRIÃO, S. L. ; DIMURO, G. P.	2012	102-112	18	\N	4
3761	TC	An Evolutionary Learning Approach for Robot Path Planning with Fuzzy Obstacle Detection and Avoidance in a Multi-agent Environment	CABREIRA, T. M. ; AGUIAR, M. S. ; DIMURO, G. P.	2012	1-16	18	\N	4
3762	TC	Um Modelo Conceitual Fuzzy para Análise do Risco da Avaliação de Cursos de Graduação	ROSA, S. E. ; MATTOS, V. L. D. ; DIMURO, G. P.	2012	852-862	18	\N	4
3764	TC	Interface Experimental de Fuzificação para o TOPOBO	SANTINI, M.M. ; BOTELHO, S. S. C. ; MOTA, F. P. ; RODRIGUES, C. L. L. ; DIMURO, G. P.	2011	74-82	18	\N	4
3765	TC	Probabilidade Fuzzy em Jogos Bayesianos	ASMUS, T. C. ; DIMURO, G. P.	2011	109-121	18	\N	4
3766	TC	Sobre Sistemas Híbridos: Algoritmos Genéticos e Abordagens Fuzzy	MACEDO, L. F. K. ; AGUIAR, M. S. ; DIMURO, G. P.	2011	140-151	18	\N	4
3769	TC	Um Estudo Sobre Vetores e Matrizes de Números Fuzzy	RIBES, J. L. B. ; DIMURO, G. P. ; AGUIAR, M. S.	2011	201-210	18	\N	4
3770	TC	Utilizando Lógica Fuzzy para Avaliar a Qualidade de uma Compra Via Internet	RODRIGUES, L. M. ; DIMURO, G. P.	2011	254-265	18	\N	4
3779	TC	Agentes Compartilhando Recursos Utilizando Processos de Decisão de Markov	RODRIGUES, L. M. ; DIMURO, G. P.	2010	107-110	18	\N	4
3746	CL	A Minimal Dynamical MAS Organization Model	COSTA, A. C. R. ; DIMURO, G. P.	2009	419-445	18	3414	4
3780	TC	Simulação Baseada em Agentes de Processos de Gestão Social de Ecossistemas Urbanos: o caso das hortas urbanas da cidade de Sevilla	RODRIGUES, T. F. ; DIMURO, G. ; VON GROL, C. ; Pinheiro, T. V. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	257-260	18	\N	4
3781	TC	Uma Proposta de Modelo Híbrido com Agentes Evolutivos BDI-Fuzzy-Intervalares	MACEDO, L. F. K. ; DIMURO, G. P. ; AGUIAR, M. S. ; COSTA, A. C. R. ; MATTOS, V. L. D.	2010	274-289	18	\N	4
3782	TC	Tomando Decisões em um Ambiente de Informação Imperfeita: introdução de probabilidades fuzzy (intervalares) em um modelo híbrido de agente BDI-MDP	RIBES, J. L. B. ; DIMURO, G. P. ; AGUIAR, M. S. ; COSTA, A. C. R. ; MATTOS, V. L. D.	2010	280-285	18	\N	4
3784	TC	An Approach to Interval-Valued R-Implications and Automorphisms	BEDREGAL, B. R. C. ; DIMURO, G. P. ; REISER, R. H. S.	2009	1-6	18	\N	4
3787	TC	Analyzing the Relations between Interval-valued D-Implications and Interval-valued QL-Implications	REISER, R. H. S. ; DIMURO, G. P. ; BEDREGAL, B. R. C. ; SANTIAGO, R. H. N.	2009	190-196	18	\N	4
3790	TC	Interval Additive Generators of Interval T-Norms	DIMURO, G. P. ; BEDREGAL, B. R. C. ; REISER, R. H. S. ; SANTIAGO, R. H. N.	2008	123-135	18	\N	4
3791	TC	Interval Valued D-Implications	REISER, R. H. S. ; DIMURO, G. P. ; BEDREGAL, B. R. C. ; SANTIAGO, R. H. N.	2008	203-209	18	\N	4
3792	TC	Avaliação Fuzzy de Trocas Sociais entre Agentes Baseados em Personalidades	SANTOS, A. V. ; DIMURO, G. P. ; BEDREGAL, B. R. C.	2008	176-182	18	\N	4
3793	TC	Avaliação Fuzzy de Trocas Sociais em Sistemas Multiagentes baseados em Personalidades	SANTOS, A. V. ; DIMURO, G. P. ; BEDREGAL, B. R. C.	2008	1-10	18	\N	4
3794	TC	Construção de Planos BDI a partir de Políticas Ótimas de POMDPs, com Aplicação na Programação em AgentSpeak usando o Jason	PEREIRA, D. R. ; GONÇALVES, L. V. ; DIMURO, G. P.	2008	1-10	18	\N	4
3795	TC	Auto-Regulação de Trocas Sociais Baseadas em Personalidades em Sistemas Multiagentes	GONÇALVES, L. V. ; PEREIRA, D. R. ; DIMURO, G. P.	2008	1-10	18	\N	4
3797	TC	Xor-Implications and E-Implications: Classes of fuzzy implications based on fuzzy Xor	BEDREGAL, B. R. C. ; REISER, R. H. S. ; DIMURO, G. P.	2008	8-20	18	\N	4
3800	TC	Valores de Trocas Sociais Fuzzy em Agentes com Personalidades	SANTOS, A. V. ; DIMURO, G. P. ; BEDREGAL, B. R. C.	2008	1-6	18	\N	4
3801	TC	Avaliação Fuzzy de Trocas Sociais em Sistemas Multiagentes baseados em Personalidades	SANTOS, A. V. ; DIMURO, G. P.	2008	1-10	18	\N	4
3802	TC	Building BDI Plans from POMDPs Optimal Policies, with an Application to the Self-Regulation of Social Exchanges in Multi-Agent Systems	PEREIRA, D. R. ; DIMURO, G. P.	2008	1-10	18	\N	4
3803	RE	Uma Ordem Total para Números Fuzzy Triangulares Simétricos	ASMUS, T. C. ; DIMURO, G. P.	2012	1-4	18	\N	4
3804	RE	Sobre Probabilidades Fuzzy Intervalares	RIBES, J. L. B. ; ASMUS, T. C. ; DIMURO, G. P.	2012	1-4	18	\N	4
3805	RE	Um Modelo de Agentes BDI-Fuzzy para Trocas de Serviços Não-Econômicos com Base na Teoria das Trocas Sociais	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2012	1-6	18	\N	4
3806	RE	Modelando a Organização Social de um Experimento de Gestão Social de Hortas Urbanas	RODRIGUES, T. F. ; SANTOS, I. ; DIMURO, G. ; COSTA, A. C. R. ; DIMURO, G. P.	2011	163-166	18	\N	4
3807	RE	Um Modelo de Agentes BDI-Fuzzy para Trocas de Serviços Não-Econômicos com Base na Teoria das Trocas Sociais	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2011	211-216	18	\N	4
3808	RE	Especificando Rotinas Organizacionais de Sistemas Multiagentes: Detecção de Desvios com Base no Conceito de Expectativas	SILVA, C. E. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	139-142	18	\N	4
3809	RE	Estendendo o Modelo de Organização de Sistemas Multiagentes PopOrg com Unidades Organizacionais Recursivas	ROSA, S. E. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	143-146	18	\N	4
3810	RE	Um Modelo Híbrido de Agente BDI-Fuzzy	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	147-150	18	\N	4
3811	RE	Introducing Social Groups and Group Exchanges in the PopOrg Model	COSTA, A. C. R. ; DIMURO, G. P.	2009	1297-1298	18	\N	4
3812	RE	A Integração de HMMs e POMDPs, com aplicação na Simulação de Trocas Sociais em Sistemas Multiagentes	GONÇALVES, L. V. ; DIMURO, G. P. ; COSTA, A. C. R.	2009	1-2	18	\N	4
3813	RE	Números Fuzzy Intervalares	MUSSI, R. L. ; DIMURO, G. P. ; BEDREGAL, B. R. C.	2009	223-224	18	\N	4
3814	RE	Um Sistema Fuzzy para Auxílio ao Diagnóstico da Densidade Mineral Óssea	SILVA, F. ; DIMURO, G. P. ; AGUIAR, M. S.	2009	295-298	18	\N	4
3815	RE	Um Modelo de Percepção Fuzzy para Agentes BDI	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2009	254-257	18	\N	4
3816	RE	Analyzing the Relations between Interval-valued D-Implications, QL-Implications and Automorphisms	DIMURO, G. P. ; REISER, R. H. S. ; BEDREGAL, B. R. C. ; SANTIAGO, R. H. N.	2008	1-2	18	\N	4
3820	RC	VALIDAÇÃO DO MECANISMO DE BUSCA ARGOsearch PARA O SISTEMA DE GERENCIAMENTO DE BIBLIOTECAS DA FURG	PEREIRA, I. A. ; TOMASINI, C ; Eduardo N. ; VARGAS, A. P.	2012		20	\N	4
3821	RC	Módulo de Critérios de Relevância para o ARGOsearch	TOMASINI, C. ; PEREIRA, I. A. ; VARGAS, A. P. ; Eduardo N.	2012		20	\N	4
3822	RC	TICAST	HAX, V. A. ; Tyska, J. C ; PEREIRA, I. A. ; CAMACHO, P. M. ; ALVES, R. M.	2011		20	\N	4
3823	RC	Uma arquitetura para pesquisa por relevância baseada em critérios	PEREIRA, I. A. ; Eduardo N. ; VARGAS, A. P.	2011		20	\N	4
3833	TC	A General Purpose Cave-like System for Visualization of Animated and 4D CAD Modeling	BOTELHO, S. S. C. ; DUARTE FILHO, Nelson Lopes ; Tyska Carvalho, Jonata ; Ruas, R. R. ; Maffei, R. Q. ; Marcos, P. B. ; Hax, V. A.	2009	141-146	22	\N	4
3835	RE	H-Env: An architecture to create intelligent hyper-environments using ubiquitous computing and virtual reality	Tyska, Jônata Carvalho ; BOTELHO, S. S. C. ; Ruas, R. R. ; SANTOS, R. A. P. ; dos Santos, E. B.	2010		22	\N	4
3836	AP	Mining flexible-receptor molecular docking data	MACHADO, K. S. ; WINCK, A. T. ; RUIZ, D. D. A. ; NORBERTO DE SOUZA, O	2011	n/a-n/a	23	\N	4
3837	AP	FReDoWS: a method to automate molecular docking simulations with explicit receptor flexibility and snapshots selection	MACHADO, K. S. ; Schroeder, Evelyn K ; Ruiz, Duncan D ; Cohen, Elisângela ML ; Norberto de Souza, Osmar	2011	S6	23	\N	4
3838	AP	Effect of the explicit flexibility of the InhA enzyme from Mycobacterium tuberculosis in molecular docking simulations	Cohen, Elisangela ML ; MACHADO, K. S. ; Cohen, Marcelo ; Norberto de Souza, Osmar	2011	S7	23	\N	4
3839	AP	Mining flexible-receptor docking experiments to select promising protein receptor snapshots	MACHADO, K. S. ; WINCK, A. T. ; RUIZ, D. D. A. ; NORBERTO DE SOUZA, O	2010	S6	23	\N	4
3840	AA	Automatic Design of Decision-Tree Induction Algorithms Tailored to Flexible-Receptor Docking Data	Barros, R. C. ; WINCK, A. T. ; MACHADO, K. S. ; BASGALUPP, M. P. ; CARVALHO, A. C. P. F. L. ; RUIZ, D. D. A. ; NORBERTO DE SOUZA, O	2012		23	\N	4
3841	CL	Processo de KDD aplicado à bioinformática	WINCK, A. T. ; MACHADO, K. S. ; RUIZ, D. D. A. ; NORBERTO DE SOUZA, O	2010	159-180	23	\N	4
3842	TC	A Comparative Analysis of Public Ligand Databases Based on Molecular Descriptors	WINCK, A. T. ; QUEVEDO, C. V. ; MACHADO, K. S. ; NORBERTO DE SOUZA, O ; RUIZ, D. D. A.	2012	156-167	23	\N	4
3843	TC	Association Rules to Identify Receptor and Ligands Structures thourgh Named Entities Recognition	Winck, A. ; MACHADO, K. S. ; RUIZ, D. D. A. ; STRUBE de LIMA, V. L.	2010	119-128	23	\N	4
3844	TC	Comparison of Discretization Methods of Flexible-Receptor Docking Data for Analyses by Decision Trees	MACHADO, K. S. ; WINCK, A. T. ; RUIZ, D. D. A. ; NORBERTO DE SOUZA, O	2010	223-229	23	\N	4
3845	TC	Supporting Intermolecular Interaction Analyses of Flexible-Receptor Docking Simulations	WINCK, A. T. ; MACHADO, K. S. ; NORBERTO DE SOUZA, O ; RUIZ, D. D. A.	2010	183-190	23	\N	4
3846	TC	Extracting Information from Flexible Receptor-Flexible Ligand Docking Experiments	MACHADO, K. S. ; SCHROEDER, E. K. ; RUIZ, D. D. A. ; Winck, A. ; NORBERTO DE SOUZA, O	2008	104-114	23	\N	4
3847	RE	Análise de Profilers para Programas em Java: Estudo de Caso Aplicado ao Algoritmo M5P do Software Weka	BERNARDI, C. A. C. ; MADALOSSO, O. M. ; CHARAO, A. S. ; WINCK, A. T. ; MACHADO, K. S.	2012		23	\N	4
3848	RE	Discretization of Flexible-Receptor Docking Data	MACHADO, K. S. ; WINCK, A. T. ; RUIZ, D. D. A. ; NORBERTO DE SOUZA, O	2010	75-79	23	\N	4
3849	RE	FReDD: supporting mining strategies though a flexible-receptor docking database	Winck, A. ; MACHADO, K. S. ; NORBERTO DE SOUZA, O ; RUIZ, D. D. A.	2009	143-146	23	\N	4
3850	RC	Application Of Data Mining To Select Promising Compounds Based on Molecular Descriptors	PERAZZO, G. X. ; WINCK, A. T. ; MACHADO, K. S.	2012		23	\N	4
3851	RC	A Scientific Workflow for Performing Molecular Dynamics Simulation	Cornetet, L. R. ; WERHLI, A. V. ; MACHADO, K. S.	2011	152-152	23	\N	4
3852	RC	Workflow Científico para Dinâmica Molecular	Cornetet, L. R. ; MACHADO, K. S.	2011		23	\N	4
3853	RC	A Context-Based Preprocessing on Flexible-Receptor Docking Data	WINCK, A. T. ; MACHADO, K. S. ; NORBERTO DE SOUZA, O ; RUIZ, D. D. A.	2010	68-68	23	\N	4
3854	RC	A Study of Molecular Descriptor to Rank Candidate Ligands to Inhibit the InhA Receptor	QUEVEDO, C. V. ; WINCK, A. T. ; MACHADO, K. S. ; NORBERTO DE SOUZA, O ; RUIZ, D. D. A.	2010	79-79	23	\N	4
3855	RC	Applying Model Trees on Flexible-Receptor Docking Experiments to select promising protein receptor snapshots	MACHADO, K. S. ; WINCK, A. T. ; RUIZ, D. D. A. ; NORBERTO DE SOUZA, O	2010	66-66	23	\N	4
3856	RC	The effect of InhA flexibility in docking simulations with ethionamide and triclosan	COHEN, E. M. L. ; MACHADO, K. S. ; NORBERTO DE SOUZA, O	2010	73-73	23	\N	4
3857	RC	FREDOWS: A METHOD TO AUTOMATE MOLECULAR DOCKING SIMULATIONS WITH EXPLICIT RECEPTOR FLEXIBILITY AND SNAPSHOTS SELECTION	MACHADO, K. S. ; SCHROEDER, E. K. ; RUIZ, D. D. A. ; COHEN, E. M. L. ; NORBERTO DE SOUZA, O	2010	90-90	23	\N	4
3858	RC	EFFECT OF THE EXPLICIT FLEXIBILITY OF THE INHA ENZYME FROM MYCOBACTERIUM TUBERCULOSIS IN MOLECULAR DOCKING SIMULATIONS	COHEN, E. M. L. ; MACHADO, K. S. ; COHEN, M. ; NORBERTO DE SOUZA, O	2010	44-44	23	\N	4
3859	AP	Uma Estratégia Híbrida para o Problema de Empacotamento	SANTOS, R. ; EMMENDORFER, L. R.	2011	1-7	24	\N	4
3860	AP	Modelagem Ambiental: Perspectivas e Contribuições	NEVES, C. ; BRUM, R. S. ; KIRINUS, E. ; SANTOS, R. ; EMMENDORFER, L. R.	2011	15-20	24	\N	4
3861	AP	Effective Linkage Learning Using Low-Order Statistics and Clustering	Emmendorfer, Leonardo Ramos ; POZO, Aurora Trinidad Ramirez	2009	1233-1246	24	\N	4
3864	CL	A Clustering-based Approach for Linkage Learning Applied to Multimodal Optimization	EMMENDORFER, L. R. ; POZO, Aurora Trinidad Ramirez	2008	225-248	24	\N	4
3865	TC	Detectando Padrões Comportamentais de Agentes Através de Árvores de Decisão	EMMENDORFER, L. R. ; ADAMATTI, D. F. ; SILVEIRA, J. ; PAES, T.	2010		24	\N	4
3868	TC	Selecting Software Reliability Models with a Neural Network Meta Classifier	CAIUTA, R. ; POZO, Aurora Trinidad Ramirez ; EMMENDORFER, L. R. ; VERGILIO, S.	2008	201-209	24	\N	4
3869	RE	Descoberta de conhecimento em bancos de dados aplicada ao caso de alunos com subsídio	LORENZ, W. ; WERHLI, A. V. ; EMMENDORFER, L. R.	2011		24	\N	4
3870	RE	On the design of populational clustering	EMMENDORFER, L. R.	2010		24	\N	4
3871	RC	Uma estratégia híbrida para o problema de empacotamento de duas elipses	SANTOS, R. ; EMMENDORFER, L. R.	2011		24	\N	4
3872	RC	Data Mining aplicado ao caso de alunos com subsídio do núcleo de assistência estudantil da Universidade Federal do Rio Grande - FURG	LORENZ, W. ; WERHLI, A. V. ; EMMENDORFER, L. R.	2011		24	\N	4
3873	RC	Modelagem da Dinâmica do Fluxo Granular Através de Autômatos Celulares e Simulação Baseada em Agentes	SILVEIRA, J. ; PAES, T. ; ADAMATTI, D. F. ; EMMENDORFER, L. R.	2010		24	\N	4
3874	AP	EXPLORATION E EXPLOITATION: UM OLHAR NO SETOR DE REFINO DE PETRÓLEO SOB A DIMENSÃO DO APRENDIZADO ORGANIZACIONAL	SATT, Sergio ; RIBEIRO, Luciano Maciel	2012	25-35	25	\N	4
3875	AP	Gestão de projetos ambientais: responsabilidade social transformada em diferencial competitivo	PINTO, D. C. D. ; RIBEIRO, Luciano Maciel	2009	9-28	25	\N	4
3876	AP	A importância da TI para a competitividade das micro e pequenas empresas	RIBEIRO, Luciano Maciel ; SATT, Sergio	2008	11-24	25	\N	4
3877	TC	AVALIANDO A ESTRATÉGIA DO PARQUE TECNOLÓGICO OCEANTEC A PARTIR DA UTILIZAÇÃO DA FERRAMENTA ESTRATEGIGRAMA	RIBEIRO, Luciano Maciel ; BOTELHO, S. S. C. ; DUARTE FILHO, N. L.	2012		25	\N	4
3878	TC	REVISÃO DOS CONCEITOS DE EXPLORATION E EXPLOITATION ASSOCIADOS AO SETOR DE REFINO DE PETRÓLEO	RIBEIRO, Luciano Maciel ; SATT, Sergio	2012		25	\N	4
3879	TC	JAZZ E EDUCAÇÃO A DISTÂNCIA: OS DESAFIOS E RESPOSTAS NOS POLOS PRESENCIAIS. In:	RIBEIRO, Luciano Maciel ; Sperotto, Rosária Ilgenfritz	2011		25	\N	4
3880	TC	Analisando as interações realizas no Fórum de um curso ministrado na modalidade Educação a Distância	RIBEIRO, Luciano Maciel ; IRIONDO, WALTER RUBEN OTERO	2011		25	\N	4
3881	TC	JAZZ E EDUCAÇÃO A DISTÂNCIA: OS DESAFIOS E RESPOSTAS NOS POLOS PRESENCIAIS	RIBEIRO, Luciano Maciel ; Sperotto, Rosária Ilgenfritz	2011		25	\N	4
3882	TC	UMA ANÁLISE DAS DIFICULDADES DE INVESTIMENTO NAS MPEs PELA BAIXA UTILIZAÇÃO DE FERRAMENTAS DE GESTÃO	RIBEIRO, Luciano Maciel ; SATT, Sergio	2010		25	\N	4
3883	TC	Avaliação de interações assíncronas baseadas em texto em Ambientes Virtuais de Ensino Aprendizagem	IRIONDO, WALTER RUBEN OTERO ; RIBEIRO, Luciano Maciel	2010		25	\N	4
3884	TC	Avaliação de Fóruns de discussão nos cursos de Educação a Distância: desafios metodológicos e resultados empíricos	IRIONDO, WALTER RUBEN OTERO ; RIBEIRO, Luciano Maciel	2010		25	\N	4
3885	TC	Educação a Distância: resultados empíricos da avaliação de Fóruns de discussão	IRIONDO, WALTER RUBEN OTERO ; RIBEIRO, Luciano Maciel	2010		25	\N	4
3886	AP	Space D*	Silveira, Luan ; Maffei, Renan Q. ; Botelho, Silvia S. C. ; Drews, Paulo L. ; Bicho, Alessandro de L. ; DUARTE FILHO, Nelson Lopes	2012	1-11	26	\N	4
3927	TC	A Utilização de Sistemas Multiagentes para a Modelagem de Mudanças Climáticas	Gonçalves, G. I. P. ; KRUSCHE, N. ; COSTA, A. C. R.	2012	1 CD-ROM-5 CD-ROM	27	\N	4
3862	LP	Anais do IV Workshop- Escola de Sistemas de Agentes, seus Ambientes e apliCações	ADAMATTI, D. F. ; WERHLI, A. V. ; LUGO. G. G. ; EMMENDORFER, L. R.	2010		24	3320	4
3909	TC	Estimando Atrasos em Redes de Computadores Através de Sistemas de Coordenadas - A Ferramenta Euclideana	MADRUGA, Felipe ; DUARTE FILHO, Nelson Lopes ; COELHO, Rafael ; PIAS, Marcelo	2008	51-58	26	\N	4
3911	RE	Rastreamento e imersão 3d para visualização de estruturas navais e offshore	SCHROEDER, G. ; ESPINDOLA, Danubia ; BOTELHO, Silvia Silva ; DUARTE FILHO, Nelson Lopes	2012	1-4	26	\N	4
3912	RE	Rastreamento em Tempo Real em Ambientes de Construção e Montagem: o Caso da Indústria Naval	Santos, E. ; Duarte Filho, Nelson L. ; Botelho, Silvia S. C.	2012	1-4	26	\N	4
3913	RE	Interactive Virtual Worlds in Brazilian Digital Television	Tavares, D.C. ; BOTELHO, Silvia Silva ; Marube, N.N. ; DUARTE FILHO, Nelson Lopes	2010	1-4	26	\N	4
3914	RE	DSMDB: A Distributed Shared Memory Approach for Building Replicated Database Systems	DUARTE FILHO, Nelson Lopes ; PEDONE, Fernando Lopes	2008	41-44	26	\N	4
3915	RC	RFID in Shipbuilding - Proposed Case Study Involving Shipyard in Brazil	DUARTE FILHO, Nelson Lopes ; BOTELHO, Silvia Silva da Costa	2011	50-51	26	\N	4
3916	AP	Effects of RegCM3 parameterizations on simulated rainy season over South America	da Rocha, RP ; Cuadra, SV ; Reboita, MS ; Kruger, LF ; Ambrizzi, T ; KRUSCHE, N.	2012	253-265	27	\N	4
3917	AP	Entendendo o Tempo e o Clima na América do Sul	REBOITA, M. S. ; KRUSCHE, N. ; REBOITA, M. S. ; Ambrizzi, T ; DA ROCHA, R. P.	2012	18-29	27	\N	4
3918	AP	Diagnóstico Qualitativo da Poluição Atmosferica em Rio Grande -RS, 2000 a 2002	NÓBREGA, M. R. ; KRUSCHE, N.	2011	129-150	27	\N	4
3919	AP	Estimativa da altura da camada limite na região de Rio Grande, RS	SARAIVA, L. B. ; KRUSCHE, N.	2011	55-58	27	\N	4
3920	AP	Simulação de nevoeiros no litoral sul do Brasil	GOMES, C.S. ; KRUSCHE, N. ; ROCHA, R. P. da	2011	235-237	27	\N	4
3921	AP	Extreme Storm Surges in the south of Brazil: Atmospheric Conditions and shore erosion	PARISE, C. K. ; CALLIARI, L. J. ; KRUSCHE, N.	2009	175-188	27	\N	4
3922	CL	A Camada Limite Planetária	MORAES, O. L. L. ; Zimermann, H. R. ; TIECHRIEB, C. A. ; MAGNAGO, R. O. ; CARNEIRO, J. V. ; KRUSCHE, N. ; ALVES, R. ; DEGRAZIA, G. A. ; ACEVEDO, O. ; FISCH, G.	2010	7-238	27	\N	4
3923	TC	Aquecimento Global avaliado pela Comparação entre Modelo Climático Global Educacional e Reanálise NCEP/NCAR no período 1958 a 2010	Gambetá-Leite, M. R. S. ; Gomes, C. S. ; Krusche, N	2012	1-4 CDROM	27	\N	4
3924	TC	Estudo de Caso: Simulação Numérica das alterações causadas pelas Mudanças na Excentricidade e Obliquidade da Terra	SPOLAVORI, A. ; Krusche, N	2012	1-5-CDROM	27	\N	4
3925	TC	Simulação de Nevoeiros de Advecção em Rio Grande, RS, Brasil: Análise das Condições Iniciais e de Fronteira em Modelo de Mesoescala	Gomes, C. S. ; Gambetá-Leite, M. R. S. ; SPOLAVORI, A. ; Krusche, N ; ROCHA, R. P. da	2012	1-5-CDROM	27	\N	4
3926	TC	Caracterização da Precipitação de Rio Grande, RS, entre 1991 a 2010	KRUSCHE, N. ; Reboita, MS	2012	1 CD-ROM-5 CD-ROM	27	\N	4
3928	TC	Modelos Numéricos da Atmosfera: Otimização com Processamento em Unidades Gráficas e Visualização Científica	SPOLAVORI, A. ; Krusche, N ; BOTELHO, S. S. C. ; GOMES, C.S.	2012	1-5 CD-ROM	27	\N	4
3929	TC	Simulação da Brisa Marítima na Região Sul do Rio Grande do Sul utilizando o Modelo WRF	Gambetá-Leite, M. R. S. ; Krusche, N ; GOMES, C.S.	2012	1-5 CD-ROM	27	\N	4
3930	TC	Estudo sobre a Acurácia da Previsão Numérica gerada pelo WRF para a Cidade de Rio Grande	GOMES, C.S. ; Gambetá-Leite, M. R. S. ; SPOLAVORI, A. ; Krusche, N	2012	1-5 CD-ROM	27	\N	4
3931	TC	Eventos de Precipitação Extrema na Cidade de Rio Grande	Madruga, J. ; Krusche, N	2012	1-5 CD-ROM	27	\N	4
3932	TC	Estudo de caso sobre o acoplamento de um modelo de previsão numérica ao planejamento de alocação de berços no Porto de Rio Grande	Gambetá-Leite, M. R. S. ; VALENTE, R. ; SPOLAVORI, A. ; Krusche, N ; EMMENDORFER, L.	2012	248-252	27	\N	4
3933	TC	Padrões de Precipitação no Sul do Brasil: Comparação entre Observação e Reanálise	SANTOS, M. B. ; KRUSCHE, N.	2009	1-7	27	\N	4
3934	TC	Sistema Integrado de Monitoramento do Tempo e do Clima do Sul do Brasil	KRUSCHE, N. ; ALVES, R. ; MORAES, O. L. L.	2009	1-7	27	\N	4
3935	TC	Avaliação das Brisas Marítimas na região de Rio Grande, RS, na Primavera de 2006	SARAIVA, L. B. ; KRUSCHE, N.	2009	1-7	27	\N	4
3936	TC	Nevoeiros na Região Litorânea do Sul do Brasil	GOMES, C.S. ; KRUSCHE, N.	2009	1-7	27	\N	4
3937	TC	Simulação Climática para o Sul do Brasil com Diferentes Projeções Cartográficas	GOMES, C.S. ; REBOITA, M. S. ; KRUGER, L. F. ; KRUSCHE, N.	2009	1-7	27	\N	4
3938	TC	Validação de Simulação Climática da Camada Limite Planetária na Região Costeira do Sul do Brasil	KRUSCHE, N. ; ROCHA, R. P. da	2009	1-7	27	\N	4
3939	TC	Concepções dos Estudantes sobre Conceitos que embasam a Compreensão de Mudanças Climáticas	KRUSCHE, N. ; CAPPELLETTO, E. ; PEREIRA, N.	2009	1-7	27	\N	4
3940	TC	Previsão Climática de Ensemble utilizando o Modelo EDGCM	FRANZEN, M. ; MAIER, É. L. B. ; KRUSCHE, N.	2008	1-6	27	\N	4
3941	TC	Padrões Atmosféricos Sinóticos geradores de Marés Meteorológicas Intensas na Praia do Cassino, RS	PARISE, C. K. ; CALLIARI, L. J. ; KRUSCHE, N.	2008	1-6	27	\N	4
3942	TC	Estrutura e Manutenção do Banco de Dados Meteorológicos da Universidade Federal do Rio Grande	MENDOZA, M. ; KRUSCHE, N. ; LANAU, L.	2008	1-6	27	\N	4
3943	TC	Influência Climática na Safra de Penaeus (Farfantepenaeus) Paulensis Perez-Farfante, no períodoentre 1971 e 1972 no Estuário da Lagoa do Patos, Rio Grande do Sul, Brasil	MOREIRA, R. P. ; KRUSCHE, N.	2008	1-6	27	\N	4
3944	RC	Simulações de Mudanças Climáticas usando Sistemas Multiagentes	Gonçalves, G. I. P. ; ROCHA COSTA, A. C. ; Krusche, N	2012	1-1-CDROM	27	\N	4
3945	RC	Influência das oscilações sul sobre o perfil subaéreo da praia do Cassino, Rio Grande, RS	GUIMARAES, P. ; PEREIRA, P. S. ; CALLIARI, L. J. ; Krusche, N	2011	1-1-CDROM	27	\N	4
3946	RC	Rocks, Rain, and Climate: a GIFT Workshop for Teachers in Brazil	PASSOW, M. ; KRUSCHE, N. ; CARNEIRO, C. D. R.	2010	1-1	27	\N	4
3947	RC	Predictability of Precipitation in Southern Brazil, a non-linear approach	dos Santos Albuquerque, P. E. ; KRUSCHE, N. ; BOTELHO, S. S. C.	2010	A13C-24-A13C-24	27	\N	4
3948	RC	Fog in the coastal region of southern Brazil: seasonal	KRUSCHE, N. ; Gomes, C. S.	2009	GC23B-05-GC23B-05	27	\N	4
3949	RC	Atmospheric Wind Spectral Gap: Comparison between Fourier and Wavelet Spectra	KRUSCHE, N.	2009	A13B-08-A13B-08	27	\N	4
3950	RC	Nevoeiros de Advecção em Rio Grande, de 2005 a 2007	GOMES, C.S. ; GUIMARAES, P. ; KRUSCHE, N. ; CALLIARI, L. J. ; PEREIRA, P. S.	2009	1-7	27	\N	4
3951	RC	O Intervalo Espectral em uma Região Homogênea	KRUSCHE, N.	2009	1-7	27	\N	4
3952	AA	O Modelo de Computação em Nuvem e sua Aplicabilidade	JACOBI, E. B. ; POPIOLEK, P. ; HAX, V. A. ; Tyska, J. C ; DUARTE FILHO, Nelson Lopes ; MENDIZABAL, O. M.	2012		28	\N	4
3953	TC	Monitoramento e Análise do Impacto no Desempenho em Ambientes Virtualizados	POPIOLEK, P. ; MENDIZABAL, O. M.	2012		28	\N	4
3954	TC	Estudo da Viabilidade do ROS como Plataforma para IoT	HAX, V. A. ; BOTELHO, S. ; DUARTE FILHO, Nelson Lopes ; MENDIZABAL, O. M.	2012		28	\N	4
3955	TC	Log-Based Approach for Performance Requirements Elicitation and Prioritization	MENDIZABAL, O. M. ; SPIER, M. ; SAAD, R.	2012	297-302	28	\N	4
3956	RC	Geração de Carga para Processamento de Transações Online Usando TPC-C	MULLER, R. H. ; MENDIZABAL, O	2012		28	\N	4
3957	RC	Suprte a Comunicação em Grupo para Dispositivos Móveis Utilizando Wi-Fi	GIL, J. P. S. ; VARGAS, André Prisco ; MENDIZABAL, O	2012		28	\N	4
3958	RC	Virtualização de Servidores: Monitoramento de Recursos e Análise de Desempenho	POPIOLEK, P. ; MENDIZABAL, O	2012		28	\N	4
3959	RC	Gerência Dinâmica de Máquinas Virtuais para Computação em Nuvem	POPIOLEK, P. ; MENDIZABAL, O. M.	2011		28	\N	4
3960	RC	Implementação de uma Infraestrutura para Nuvem Computacional	JACOBI, E. B. ; HAX, V. A. ; Tyska, J. C ; DUARTE FILHO, Nelson Lopes ; MENDIZABAL, O. M.	2011		28	\N	4
3961	RC	Elicitação de Requisitos para o Desenvolvimento de Ferramentas Educacionais para o Ensino de Organização e arquitetura de Computadores	WIECZOREK, I. A. ; MENDIZABAL, O. M. ; MEINHARDT, Cristina	2011		28	\N	4
3963	AP	Design of CMOS logic gates with enhanced robustness against aging degradation	REIS, A. I. ; BUTZEN, P. F. ; Dal BEM, V. ; REIS, A. I. ; RIBAS, Renato Perez	2012	1822-1826	29	\N	4
3964	AP	An Array-Based Test Circuit for Fully Automated Gate Dielectric Breakdown Characterization	Keane, John ; Venkatraman, Shrinivas ; BUTZEN, P. F. ; KIM, C. H.	2011	787-895	29	\N	4
3965	AP	Leakage Analysis Considering the Effect of Inter-Cell Wire Resistance for Nanoscaled CMOS Circuits	BUTZEN, P. F. ; DAL BEM, V. ; REIS, A. I. ; RIBAS, R. P.	2010	192-200	29	\N	4
3966	AP	Standby Power Consumption Estimation by Interacting Leakage Current Mechanisms in Nanoscaled CMOS Digital Circuits	BUTZEN, P. F. ; ROSA JR, L. S. ; CHIAPPETTA F., E.J.D. ; REIS, A. I. ; REIS, A. I. ; RIBAS, R. P.	2010	247-255	29	\N	4
3967	AP	Transistor Network Restructuring Against NBTI Degradation	BUTZEN, P. F. ; Dal BEM, V. ; REIS, A. I. ; REIS, A. I. ; RIBAS, R. P.	2010	1298-1303	29	\N	4
3968	CL	Leakage Current in Sub-Micrometer CMOS Gates	BUTZEN, P. F. ; RIBAS, R. P.	2009	211-240	29	\N	4
3969	CL	Efeitos Físicos Nanométricos em Circuitos Integrados Digitais	BUTZEN, P. F. ; DAL BEM, V. ; REIS, A. I. ; RIBAS, R. P.	2009	225-244	29	\N	4
3973	TC	Logic Gates Design for Aging Enhancement	BUTZEN, P. F. ; DAL BEM, V. ; REIS, A. I. ; RIBAS, R. P.	2011	1-4	29	\N	4
3974	TC	Area Overhead and Performance Impact of Regular Transistor Layout Design in Digital Integrated Circuit	DAL BEM, V. ; BUTZEN, P. F. ; MARRANGHELLO, F. S. ; REIS, A. I. ; RIBAS, R. P.	2011	67-70	29	\N	4
3975	TC	Area impact analysis of via-configurable regular fabric for digital integrated circuit design	DAL BEM, V. ; BUTZEN, P. F. ; KLOCK, C. E. ; CALLEGARO, V. ; REIS, A. I. ; RIBAS, R. P.	2011	103-108	29	\N	4
3976	TC	Impact and optimization of lithography-aware regular layout in digital circuit design	DAL BEM, V. ; BUTZEN, P. F. ; MARRANGHELLO, F. S. ; REIS, A. I. ; RIBAS, R. P.	2011	279-284	29	\N	4
3977	TC	Designing NBTI Robust Gates	BUTZEN, P. F. ; DAL BEM, V. ; REIS, A. I. ; RIBAS, R. P.	2010	193-196	29	\N	4
3978	TC	Routing Resistance Influence in Loading Effect on Leakage Analysis	BUTZEN, P. F. ; REIS, A. I. ; RIBAS, R. P.	2009		29	\N	4
3979	TC	Loading Effect Analysis Considering Routing Resistance	BUTZEN, P. F. ; REIS, A. I. ; RIBAS, R. P.	2009		29	\N	4
3980	TC	Simple and Accurate Method for Fast Static Current Estimation in CMOS Complex Gates with Interaction of Leakage Mechanisms	BUTZEN, P. F. ; DA ROSA JUNIOR, L. S. ; CHIAPPETTA FILHO, E. J. D. ; MOURA, D. S. ; REIS, A. I. ; RIBAS, R. P.	2008	407-410	29	\N	4
3981	TC	Accurate Method for Subthreshold and Gate Leakage Current Estimation in CMOS Complex Gates	BUTZEN, P. F. ; DA ROSA JUNIOR, L. S. ; CHIAPPETTA FILHO, E. J. D. ; MOURA, D. S. ; REIS, A. I. ; RIBAS, R. P.	2008	23-26	29	\N	4
3982	TC	An array-based test circuit for fully automated gate dielectric breakdown characterization	Keane, John ; Venkatraman, Shrinivas ; BUTZEN, P. F. ; KIM, C. H.	2008		29	\N	4
3983	TC	Subthreshold and Gate Leakage Estimation in Complex Gates	BUTZEN, P. F. ; ROSA JR, L. S. ; CHIAPPETTA F., E.J.D. ; MOURA, D. S. ; REIS, A. I. ; RIBAS, R. P.	2008		29	\N	4
3984	RC	Caracterização temporal de Flip-Flops D	BRUN, J. V. ; BUTZEN, P. F. ; MEINHARDT, C. ; AZZOLIN, R.	2012		29	\N	4
3985	RC	SIMULADOR DE FALHAS STUCK-OPEN PARA PORTAS LÓGICAS CMOS	ZIMPECK, A. L. ; MEINHARDT, C. ; BUTZEN, P. F.	2012		29	\N	4
3986	RC	PROJETO DE SOMADORES DE 1 BIT EM TECNOLOGIAS NANOMÉTRICAS	SILVA, F. G. R. G. ; MEINHARDT, C. ; BUTZEN, P. F.	2012		29	\N	4
3987	RC	DESENVOLVIMENTO DE UMA FERRAMENTA EDUCACIONAL PARA O ESTUDO DE FAMÍLAS LÓGICAS MOS ESTÁTICAS	ULLOA, G. ; BUTZEN, P. F. ; MEINHARDT, C.	2012		29	\N	4
3988	RC	DESENVOLVIMENTO DE UMA FERRAMENTA PARA A CARACTERIZAÇÃO TEMPORAL DE PORTAS LÓGICAS CMOS	MACHADO, I. ; BUTZEN, P. F. ; MEINHARDT, C.	2012		29	\N	4
3989	RC	EMPREGO DE REDUNDÂNCIA PARA AUMENTAR A CONFIABILIDADE DE CIRCUITOS CMOS	WIECZORECK, I. ; MEINHARDT, C. ; BUTZEN, P. F.	2012		29	\N	4
3990	RC	MECANISMO DE INJEÇÃO DE FALHAS DO TIPO SET EM CIRCUITOS COMBINACIONAIS	PEREIRA, L. A. ; BUTZEN, P. F. ; MEINHARDT, C.	2012		29	\N	4
3991	RC	Automatização da caracterização do consumo de potência estática em circuitos CMOS	SCHIVITTZ, R. ; BUTZEN, P. F. ; MEINHARDT, C.	2012		29	\N	4
3992	RC	AVALIAÇÃO ELÉTRICA DE LATCHES EM TECNOLOGIA CMOS NANOMÉTRICA	AFONSO, R. M. ; BUTZEN, P. F. ; MEINHARDT, C.	2012		29	\N	4
3993	RC	AVALIAÇÃO DE TRÊS ARQUITETURAS DE SOMADORES PROJETADOS EM TECNOLOGIAS CMOS NANOMÉTRICAS	TOLEDO, S. P. ; MEINHARDT, C. ; BUTZEN, P. F.	2012		29	\N	4
3994	RC	Avaliação Elétrica de Diferentes Portas Lógicas XOR CMOS	STERZ, A. P. ; BUTZEN, P. F. ; MEINHARDT, C. ; ROSA, V. S.	2012		29	\N	4
3995	RC	Projeto de um Somador Tolerante a Falhas com Baixo Consumo de Potência	ZIMPECK, A. L. ; AGUIAR, Y. Q. ; MACIEL, B. ; MEINHARDT, C. ; BUTZEN, P. F.	2011	1-1	29	\N	4
3996	RC	Avaliação do Desempenho e Consumo de Potência de Portas Lógicas CMOS em Tecnologias Nanométricas	STERZ, A. P. ; NUNES, C. S. ; MEINHARDT, C. ; BUTZEN, P. F.	2011	1-1	29	\N	4
3997	RC	Projeto de Flip-Flops tipo D com Baixo Consumo de Potência	BRUN, J. V. ; BUTZEN, P. F. ; MEINHARDT, C.	2011	1-1	29	\N	4
3998	RC	Otimização do Dimensionamento dos Transistores de um Circuito Somador para Redução de Atrasos e Consumo de Potência	AGUIAR, Y. Q. ; MACIEL, B. ; ZIMPECK, A. L. ; BUTZEN, P. F. ; MEINHARDT, C.	2011	1-1	29	\N	4
3999	RC	Avaliação de Famílias Lógicas para Circuitos com Baixo Consumo de Potência	NUNES, C. S. ; SILVA, A. N. ; MEINHARDT, C. ; BUTZEN, P. F.	2011	1-1	29	\N	4
4000	RC	Avaliação da Eficácia de Modelos de Transistores no Projeto de Circuitos com Baixo Consumo de Energia	SILVA, A. N. ; NUNES, C. S. ; MEINHARDT, C. ; BUTZEN, P. F.	2011	1-1	29	\N	4
4001	RC	Projeto de um Bloco de Memória SRAM na Tecnologia de 16nm	GOMES, I. A. C. ; BUTZEN, P. F. ; MEINHARDT, C.	2011	1-1	29	\N	4
4002	RC	Evaluation of Standard Cell Libraries with Different Templates and Gate design approaches	SILVA, D. C. ; BUTZEN, P. F. ; REIS, A. I. ; RIBAS, R. P.	2009		29	\N	4
4003	RC	A Simple Model to Estimate Intrinsic Power Consumption in CMOS Logic Gates	CHIAPPETTA F., E.J.D. ; BUTZEN, P. F. ; ROSA JR, L. S. ; REIS, A. I. ; RIBAS, R. P.	2008		29	\N	4
4004	RC	Fast Algorithm to Leakage Power Reduction by Input Vector Control	MOURA, D. S. ; BUTZEN, P. F. ; ROSA JR, L. S. ; REIS, A. I. ; RIBAS, R. P.	2008		29	\N	4
4010	CL	Self-Localization and Mapping for Underwater Autonomous Vehicles	BOTELHO, S. S. C. ; OLIVEIRA, G. L. ; DREWS JR, P. L. J. ; FIGUEIREDO, M. ; HAFFELE, C.	2010	365-382	30	\N	4
4011	TC	Efficient Change Detection in 3D Environment for Autonomous Surveillance Robots based on Implicit Volume	VIEIRA, A. W. ; DREWS JR, P. L. J. ; CAMPOS, M. F. M.	2012		30	\N	4
4012	TC	Tracking System for Underwater Inspection Using Computer Vision	DREWS JR, P. L. J. ; KUHN, V. N. ; GOMES, S. C. P.	2012		30	\N	4
4014	TC	Controlling a Inspection ROV Using Low Cost Sensors	KUHN, V. N. ; DREWS JR, P. L. J. ; GOMES, S. C. P.	2012		30	\N	4
4018	TC	Filtragem e Estimação de Estados com Restrições Aplicado ao SLAM Visual	OLIVEIRA, V. M. ; DREWS JR, P. L. J. ; OLIVEIRA	2012		30	\N	4
4019	TC	A Terrain-Based Path Planning for Mobile Robots with Bounded Curvature	DREWS JR, P. L. J. ; MACHARET, D. G. ; CAMPOS, M. F. M.	2012		30	\N	4
4022	TC	Aprendizado Ativo e Semi-Supervisionado na Classificacao de Microalgas	DREWS JR, P. L. J. ; COLARES, R. G. ; MACHADO, P. N. ; FARIA, M. F. ; DETONI, A. M. S. ; TAVANO, V. M.	2012		30	\N	4
4027	TC	Computer Vision Algorithm for Detecting Wear in Teeth	MEIRELES, A. B. ; CASAS, E. B. L ; CORNACCHIA, T. M. ; CAMPOS, M. F. M. ; ALVES NETO,A. ; DREWS JR, P. L. J.	2010	1-4	30	\N	4
4028	TC	Novelty Detection and 3D Shape Retrieval using Superquadrics and Multi-Scale Sampling for Autonomous Mobile Robots	DREWS JR, P. L. J. ; NUNEZ, P. ; ROCHA, R. P. P. ; CAMPOS, M. F. M. ; DIAS, J.	2010	3635-3640	30	\N	4
4029	TC	Detecção de Mudanças e Recuperação de Forma em Mapas 3D Baseados em Nuvens de Pontos	DREWS JR, P. L. J. ; CAMPOS, M. F. M.	2010	1-8	30	\N	4
4030	TC	Crowd Behavior Analysis under Cameras Network Fusion using Probabilistic Methods	DREWS JR, P. L. J. ; QUINTAS, J. ; DIAS, J. ; ANDERSSON, M. ; NYG RDS, J. ; RYDELL, J.	2010	1-8	30	\N	4
4033	TC	Detecção de Mudanças e Recuperação de Forma em Mapas 3D Baseados em Nuvens de Pontos	DREWS JR, P. L. J. ; ROCHA, R. P. P. ; DIAS, J. ; CAMPOS, M. F. M.	2010	1-7	30	\N	4
4034	TC	Probabilistic LMA-Based Classification of Human Behaviour Understanding Using Power Spectrum Techinique	KHOSHHAL, K. ; ALIAKBARPOUR, H. ; QUINTAS, J. ; DREWS JR, P. L. J. ; DIAS, J.	2010	1-7	30	\N	4
4035	TC	Change Detection in 3D Environments Based on Gaussian Mixture Model and Robust Structural Matching for Autonomous Robotic Applications	NUNEZ, P. ; DREWS JR, P. L. J. ; BANDERA, A. ; ROCHA, R. P. P. ; CAMPOS, M. F. M. ; DIAS, J.	2010	2633-2638	30	\N	4
4036	TC	Growing Cell Structures applied to Sensor Fusion and SLAM	BOTELHO, S. S. C. ; HAFFELE, C. ; FIGUEIREDO, M. ; DREWS JR, P. L. J. ; OLIVEIRA, G. L.	2010		30	\N	4
4037	TC	Methods for Assessing Dental Wear in Bruxism	MEIRELES, A. B. ; CORNACCHIA, T. M. ; CASAS, E. B. L ; BASTOS, F. S. ; GODOY, G. C. ; MARQUES, F. S. ; DREWS JR, P. L. J. ; ALVES NETO,A. ; CAMPOS, M. F. M.	2009	1-6	30	\N	4
4038	TC	Multidisciplinary Approach In Tooth Wear: Biomechanical Aspects And Computational View	MEIRELES, A. B. ; CORNACCHIA, T. M. ; CASAS, E. B. L ; GODOY, G. C. ; MARQUES, F. S. ; DREWS JR, P. L. J. ; ALVES NETO,A. ; CAMPOS, M. F. M.	2009	1-10	30	\N	4
4039	TC	Novelty Detection and 3D Shape Retrieval based on Gaussian Mixture Models for Autonomous Surveillance Robotics	NUNEZ, P. ; DREWS JR, P. L. J. ; ROCHA, R. P. P. ; CAMPOS, M. F. M. ; DIAS, J.	2009	4724-4730	30	\N	4
4040	TC	Data Fusion Calibration for a 3D Laser Range Finder and a Camera using Inertial Data	NUNEZ, P. ; DREWS JR, P. L. J. ; ROCHA, R. P. P. ; DIAS, J.	2009	1-6	30	\N	4
4041	TC	Object Shape Retrieval through Grasp Exploration	FARIA, D. R. ; PRADO, J. A. S. ; DREWS JR, P. L. J. ; DIAS, J.	2009	1-6	30	\N	4
4044	TC	Visual Odometry and Mapping for Underwater Autonomous Vehicles	BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; OLIVEIRA, G. L. ; FIGUEIREDO, M. ; HAFFELE, C.	2009	1-6	30	\N	4
4045	TC	Self Organizing Maps for AUVs Mapping	BOTELHO, S. S. C. ; HAFFELE, C. ; OLIVEIRA, G. L. ; FIGUEIREDO, M. ; DREWS JR, P. L. J.	2009	1-5	30	\N	4
4052	TC	Controle em Profundidade de um Veículo Subaquático do Tipo ROV	CENTENO, M. L. ; GOMES, S. C. P. ; PEREIRA, I. M. ; DINIZ, Claudio Machado ; DREWS JR, P. L. J. ; BOTELHO, S. S. C.	2008	1-6	30	\N	4
4054	RC	The spatial change detection problem in robotics: A probabilistic approach based on Mixture of Gaussians	GUTIERREZ, M. A. ; MANSO, L. J. ; SILVA FILHO, S. C. ; DREWS JR, P. L. J. ; NUNEZ, P.	2012		30	\N	4
4055	RC	Self-Organizing Mapping of Robotic Environments Based on Neural Networks	FIGUEIREDO, M. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; HAFFELE, C.	2012		30	\N	4
4056	RC	Modelando Nuvens de Pontos 3D com Misturas de Gaussianas	SILVA FILHO, S. C. ; MARCOLINO, L. F. V. ; DREWS JR, P. L. J.	2012		30	\N	4
4057	RC	Células Neuronais e a Localização de Ambientes uma alternativa para aplicações de SLAM em robótica	GUTH, F. A. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J.	2012		30	\N	4
4058	RC	Aprendizado Semi-supervisionado na Classificação de Microalgas	FARIA, M. F. ; DREWS JR, P. L. J. ; MACHADO, P. N.	2012		30	\N	4
4059	RC	Restauração de Imagens Subaquáticas	VEBER, L. ; DREWS JR, P. L. J.	2012		30	\N	4
4060	RC	Manipulação de Nuvem Pontos Utilizando Point Cloud Library	MARCOLINO, L. F. V. ; SILVA FILHO, S. C. ; DREWS JR, P. L. J.	2012		30	\N	4
4061	RC	Instrumentação Subaquática Utilizando Sonar	MORITA, L. Y. ; DREWS JR, P. L. J.	2011		30	\N	4
4062	RC	Inspeção de Cabos Subaquáticos Utilizando Visão Computacional	TURRA, T. A. ; DREWS JR, P. L. J.	2011		30	\N	4
4063	RC	Detecção de Mudanças em Nuvens de Pontos Tridimensionais	SILVA FILHO, S. C. ; DREWS JR, P. L. J.	2011		30	\N	4
4064	RC	Aprendizado Semi-Supervisionado na Classificação de Algas	MACHADO, P. N. ; DREWS JR, P. L. J.	2011		30	\N	4
4065	RC	Filtragem de Estados Com Restrições de Igualdade Seguindo a Técnica de Projeção Estimativa aplicada sobre o Filtro de KalmanTENDIDO	OLIVEIRA ; DREWS JR, P. L. J. ; OLIVEIRA, V. M.	2011		30	\N	4
4066	AP	Lossless and near-lossless digital angiography coding using a two-stage motion compensation approach	SANTOS, Rafael Augusto Penna dos ; SCHARCANSKI, J	2008	379-387	31	\N	4
4069	RE	H-Env: An architecture to create intelligent hyper-environments using ubiquitous computing and virtual reality	CARVALHO, J. T. ; BOTELHO, S. S. C. ; OLIVEIRA, R. R. ; DOSSANTOS, R ; SANTOS, E.	2010		31	\N	4
4073	TC	Movimentos Socioterritoriais sob a luz da Teoria Constructal	CAMPOS, R. L. ; BOTELHO, S. S. C. ; Rocha, L. A. O.	2012	283-288	32	\N	4
4074	TC	Uma proposta de i nclusão digital social no projeto rondon operação centro-norte	CAMPOS, R. L. ; GOMES, V. dos S. ; KAIZER, S. ; JOSÉ, A. R. ; PASCOAL, V. ; SANTORUM, J. A. ; CONCEIÇÃO, R. A.	2009		32	\N	4
4077	RE	Robótica Educacional como proposta de Ensino	CAMPOS, R. L. ; BOTELHO, S. S. C. ; ANTIQUEIRA, Liliane Silva ; OLIVEIRA, Suvânia Acosta de	2011	404-406	32	\N	4
4078	RE	Jogo Eletrônico EJA: Provocando a Organização Social	CAMPOS, R. L. ; MACHADO, R. N. ; Silva, GMF Da ; REGO, E. P. ; KISNER, S. S.	2011		32	\N	4
4079	RE	Jogo Eletrônico Educativo: Educação em Prol da Cidadania	Silva, GMF Da ; CAMPOS, R. L.	2011		32	\N	4
4080	RE	JOGO ELETRÔNICO EDUCATIVO: INOVAÇÃO PARA PROMOÇÃO DA CIDADANIA	CAMPOS, R. L. ; Silva, GMF Da ; BOTELHO, S. S. C.	2011		32	\N	4
4081	RE	Jogo Eletrônico Educativo: Visitando a Dimensão Social da EJA	Silva, GMF Da ; CAMPOS, R. L. ; BOTELHO, S. S. C.	2010		32	\N	4
4082	RE	Simulação Presa-Predador: Sistemas Dinâmicos e Multi-agentes Probabilísticos	CAMPOS, R. L. ; FARIAS, Giovani ; SIMAS, Gisele ; ROSA, Simone ; SILVA, Carlos	2010		32	\N	4
4083	RE	Uma proposta para a inclusão digital social no Projeto Rondon Operação Centro-Norte	CAMPOS, R. L. ; CONCEIÇÃO, R. A. ; GOMES, V. dos S. ; KAIZER, S. ; PASCOAL, V. ; SANTORUM, J. A.	2009		32	\N	4
4084	RE	Projeto Rondon: A Interface de Vozes Na Busca Pelo Conhecimento do Outro	CAMPOS, R. L. ; CONCEIÇÃO, R. A. ; GOMES, V. dos S.	2009		32	\N	4
4085	RC	Consolidação da Formação Universitária Por Meio da Extensão no Projeto Rondon - Um Relato de Experiência de Estudantes da FURG	CAMPOS, R. L. ; SANTORUM, J. A. ; PAIVA, R. B. de ; VALENÇA, M. S. ; SILVA JR., S. D. V. da ; ROLÃO, C. G.	2009		32	\N	4
4086	RC	Uma Abordagem de Suporte a Vida para Leigos	CAMPOS, R. L. ; CONCEIÇÃO, R. A. ; GOMES, V. dos S. ; KAIZER, S. ; PASCOAL, V.	2009		32	\N	4
4216	TC	A Multi-Cave Visualization System for Digital Manufacturing	DUARTE, N. ; Tyska, j. ; BOTELHO, S. S. C.	2009	1-6	37	3831	4
4087	RC	SABERLÂNDIA: Plataforma Lúdica Integrando Robótica e Multimídia para Educação	BOTELHO, S. S. C. ; PINTO, I. M. ; COLARES, R. G. ; GOULART, T. S. ; CAMPOS, R. L. ; SOUZA, R. S.	2008		32	\N	4
4088	AP	Uma ferramenta de autoria síncrona acessível para cegos: estudo de caso no curso PROINESP. RENOTE	BARWALDT, Regina ; SANTAROSA, Lucila Maria Conti ; PASSERINO, Liliana Maria	2009	01-10	33	\N	4
4095	TC	Recursos Acessíveis: uma alternativa para as PNEEs em EAD	BARWALDT, Regina ; SANTAROSA, Lucila Maria Costi	2010		33	\N	4
4096	TC	EVOC: uma solução para incluir as PNEEs em um curso na modalidade à distância	BARWALDT, Regina ; SANTAROSA, Lucila Maria Conti	2009		33	\N	4
4097	RE	Proposta de um Modelo Fisioterápico para Ambientes Assistivos por Computação	JUNG, M. O. ; BARBOSA, R. M. ; BARWALDT, Regina	2012		33	\N	4
4098	RE	Pressupostos da Educação Básica na Formação Continuada do Professor no Atendimento Educacional Especializado para as Salas de Recursos Multifuncionais - Tecnologia Assistiiva	FELIPPE, C. I. M. ; BARWALDT, Regina ; ADAMATTI, D. F.	2012	1-10	33	\N	4
4099	RC	Assistive Technologies: Accessibility to People with Disabilities	ADAMATTI, D. F. ; BARWALDT, Regina ; FELIPPE, C. I. M.	2012	1-2	33	\N	4
4100	RC	Criação de um Software para Reserva de Salas da FURG	SILVEIRA, G. ; BASCELAR, E. ; SEUS, V. ; FERREIRA, D. ; OTERO, T. F. ; TREVISAN, G. ; CHAVES, T. ; BARWALDT, Regina ; ADAMATTI, D.	2012		33	\N	4
4101	RC	Acessibilidade: Inclusão de Alunos com necessidades Auditivas na FURG	SIEDERSBERGER, D. ; RODRIGUES, F. ; CASSALES, V. ; BARWALDT, Regina ; ADAMATTI, D. F.	2012		33	\N	4
4102	RC	PROPOSTA DE UM MODELO FISIOTERÁPICO PARA AMBIENTES ASSISTIVOS	JUNG, M. O. ; BARBOSA, R. M. ; BARWALDT, Regina	2012		33	\N	4
4103	RC	ACESSIBILIDADE WEB: UMA NOVA PROPOSTA PARA O SITE DA UNIVERSIDADE FEDERAL DO RIO GRANDE	TREVISAN, G. ; BARWALDT, Regina	2012		33	\N	4
4104	RC	Tecnologias Assistivas: Recursos e Serviços Utilizados para a Inclusão Sócio-Digital de Pessoas com Deficiências	BARWALDT, Regina ; ADAMATTI, D. F. ; FELIPPE, C. I. M. ; SALOMAO, H. L. R.	2011		33	\N	4
4105	AP	Robustness of multimodal biometric fusion methods against spoof attacks	Rodrigues, Ricardo N. ; Ling, Lee Luan ; Govindaraju, Venu	2009	169-179	34	\N	4
4107	TC	Assessment of Biometric Robustness Against Spoof Attacks	Rodrigues, Ricardo N. ; Govindaraju, Venu	2010		34	\N	4
4108	TC	Evaluation of Biometric Spoofing in a Multimodal System	Rodrigues, Ricardo N. ; Niranjan Kamat ; Govindaraju, Venu	2010		34	\N	4
4109	TC	Generation of Handwriting by Active Shape Modeling and Global Local Approximation (GLA) Adaptation	CHOWRIAPPA, A. ; Rodrigues, Ricardo N. ; KESAVADAS, T. ; Govindaraju, Venu ; BISANTZ, A.	2010		34	\N	4
4110	TC	Uma Nova Abordagem Robusta de Fusão Biométrica	Ling, Lee Luan ; Rodrigues, Ricardo N. ; LEE, J. C.	2009		34	\N	4
4112	TC	Fusão biométrica com lógica nebulosa	RODRIGUES, Ricardo Nagel ; LING, L. L.	2008		34	\N	4
4114	TC	Visual Tracking Based on 3D Probabilistic Reconstruction	SIMAS, Gisele ; DE BEM, Rodrigo Andrade ; NOVELO, Lucas ; FICKEL, G. ; BOTELHO, Silvia Silva da Costa	2010	403-409	35	\N	4
4117	TC	Utilizando Visão Computacional para Reconstrução Probabilística 3D e Rastreamento de Movimentos	SIMAS, Gisele ; FICKEL, G. ; NOVELO, Lucas ; BOTELHO, Silvia Silva da Costa ; DE BEM, Rodrigo Andrade	2009	135-140	35	\N	4
4118	RE	Projeto de um Sistema de Gerenciamento de Laboratórios de Ensino	CAMACHO, PABLO ; BIAZZI, M. ; Chaves, Talles ; FRAZON, Jesuane ; GOMES, Janine ; PARULLA, Bianca ; SCHOLLMEIER, Daniele ; SOUZA, Rosemery ; HAX, Vinícius ; DE BEM, Rodrigo Andrade	2010	1-3	35	\N	4
4119	RE	Remasterização do Sistema Operacional Ubuntu para Laboratórios de Ensino	MÜLLER, Rodrigo ; SILVEIRA, Gabriel ; PEREIRA, Lázaro ; AFONSO, Renato ; WEBER, Felipe ; DELEVEDOVE, Glauco ; DE BEM, Rodrigo Andrade	2010	1-2	35	\N	4
4120	RE	Utilizando Visão Computacional para Reconstrução Probabilística 3D e Rastreamento de Movimento	SIMAS, Gisele ; FICKEL, G. ; NOVELO, Lucas ; DE BEM, Rodrigo Andrade ; BOTELHO, Silvia Silva da Costa	2009	1-1	35	\N	4
4121	RE	Captura de Movimento Humano em Ambientes Sensoriados por Múltiplas Câmeras	SIMAS, Gisele ; BOTELHO, Silvia Silva da Costa ; DE BEM, Rodrigo Andrade ; NOVELO, Lucas ; SILVEIRA, L.	2008	1-1	35	\N	4
4122	RC	Recuperação de Imagens Baseada em Conteúdo Utilizando Dispositivos Móveis	GULARTE, A. ; THOMASI, C. ; DE BEM, Rodrigo Andrade ; ADAMATTI, D. F.	2011	1-1	35	\N	4
4123	RC	Rastreamento Visual baseado em Reconstrução Probabilística 3D	GOULART, M. G. ; DE BEM, Rodrigo Andrade ; SIMAS, Gisele ; BOTELHO, Silvia Silva da Costa	2011	1-1	35	\N	4
4124	AP	Abordagem Geométrica para Modulação de Conversores três Braços no Acionamento de Máquinas de Indução Bifásicas Simétricas e Assimétricas	VIEIRA, R. P. ; GASTALDINI, Cristiane ; AZZOLIN, Rodrigo Zelir ; PINHEIRO, Humberto ; GRÜNDLING, Hilton Abílio	2012	14-24	36	\N	4
4125	AP	Discrete-time Sliding Mode Speed Observer for Sensorless Control of Induction Motor Drives	VIEIRA, R. P. ; GASTALDINI, Cristiane ; AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2012	1-8	36	\N	4
4126	CL	Electrical Parameter Identification of Single-Phase Induction Motor by RLS Algorithm. Induction Motor. Vienna	VIEIRA, R. P. ; AZZOLIN, Rodrigo Zelir ; GASTALDINI, Cristiane ; GRÜNDLING, Hilton Abílio	2012		36	\N	4
4127	CL	A RMRAC Parameter Identification Algorithm Applied to Induction Machines. Electric Machines and Drives. Vienna	AZZOLIN, Rodrigo Zelir ; GASTALDINI, Cristiane ; VIEIRA, R. P. ; GRÜNDLING, Hilton Abílio	2011		36	\N	4
4128	CL	Feedback Linearization of Speed-Sensorless Induction Motor Control with Torque Compensation. Electric Machines and Drives. Vienna	GASTALDINI, Cristiane ; AZZOLIN, Rodrigo Zelir ; VIEIRA, R. P. ; GRÜNDLING, Hilton Abílio	2011		36	\N	4
4129	TC	Discrete-time sliding mode approach for speed estimation of symmetrical and asymmetrical induction machines	VIEIRA, R. P. ; GASTALDINI, Cristiane ; AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2011	1819-1824	36	\N	4
4130	TC	Discrete-time sliding mode speed observer for induction machine drives	VIEIRA, R. P. ; GASTALDINI, Cristiane ; AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2011	213-218	36	\N	4
4131	TC	Simple PWM Approach for Modulation of Three-leg Inverters Driving Two-phase Symmetrical and Asymmetrical Machines	VIEIRA, R. P. ; AZZOLIN, Rodrigo Zelir ; GASTALDINI, Cristiane ; PINHEIRO, Humberto ; GRÜNDLING, Hilton Abílio	2010		36	\N	4
4132	TC	Electrical Parameters Identification of Hermetic Refrigeration Compressors with Single-Phase Induction Machines using RLS Algorithm	VIEIRA, R. P. ; AZZOLIN, Rodrigo Zelir ; GASTALDINI, Cristiane ; GRÜNDLING, Hilton Abílio	2010		36	\N	4
4133	TC	A RMRAC Parameter Identification Algorithm applied to SPIM	AZZOLIN, Rodrigo Zelir ; GASTALDINI, Cristiane ; VIEIRA, R. P. ; GRÜNDLING, Hilton Abílio	2010		36	\N	4
4134	TC	An Adaptive Feedback Linearization Control for Induction Motor	GASTALDINI, Cristiane ; AZZOLIN, Rodrigo Zelir ; VIEIRA, R. P. ; GRÜNDLING, Hilton Abílio	2010		36	\N	4
4135	TC	Uma Abordagem Geométrica para Modulação de Conversores Três Braços Acionando Máquinas de Duas Fases Simétricas e Assimétricas	VIEIRA, R. P. ; AZZOLIN, Rodrigo Zelir ; GASTALDINI, Cristiane ; PINHEIRO, Humberto ; GRÜNDLING, Hilton Abílio	2010		36	\N	4
4136	TC	Algoritmo RMRAC Aplicado na Identificação dos Parâmetros Elétricos de Motores de Indução Monofásicos	AZZOLIN, Rodrigo Zelir ; GASTALDINI, Cristiane ; VIEIRA, R. P. ; GRÜNDLING, Hilton Abílio	2010		36	\N	4
4137	TC	A MRAC Parameter Identification Algorithm for Three-Phase Induction Motors	AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2009	273-278	36	\N	4
4138	TC	A Comparison of Speed-Sensorless Induction Motor Control with Torque Compensation	GASTALDINI, Cristiane ; AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2009	1480-1485	36	\N	4
4139	TC	Parameter Identification of a Single-phase Induction Motor Using Rls Algorithm	VIEIRA, R. P. ; AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2009	517-523	36	\N	4
4140	TC	A RMRAC parameter identification algorithm for induction motors	AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2009	1171-1176	36	\N	4
4141	TC	A speed-sensorless induction motor servomechanism using feedback linearization control	GASTALDINI, Cristiane ; AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2009	493-497	36	\N	4
4142	TC	A Sensorless Single-Phase Induction Motor drive with a MRAC Controller	VIEIRA, R. P. ; AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2009		36	\N	4
4143	TC	Identificação dos Parâmetros Elétricos e Mecânicos de Motores de Indução Trifásicos para Acionamento Encoderless	EINLOFT, Diego ; AZZOLIN, Rodrigo Zelir ; GRÜNDLING, Hilton Abílio	2008		36	\N	4
4144	TC	Nova Modulação Space Vector para o Controle da Tensão do Ponto Central do Divisor Capacitivo do NPC	GRIGOLETTO, Felipe Bovolini ; GASTALDINI, Cristiane ; TOMM, Fabio ; BELTRAME, Fernando ; SARTORI, Hamilton ; MARTINS, Matheus ; DIAS, Milena ; AZZOLIN, Rodrigo Zelir ; BERNARDES, Thiago ; PINHEIRO, Humberto	2008		36	\N	4
4146	AP	Sistema baseado em Inteligência Artificial para Agrupamento e Classificação de Dados na Construção Naval	Souza, K ; Botelho, Silvia S. C.	2012	60-67	37	\N	4
4148	AP	Artefatos educacionais com memória cinética Topobo: uma abordagem para o currículo dos anos iniciais. RENOTE	M, Santin ; da Silva Costa Botelho, S.	2012	1-9	37	\N	4
4150	AP	Exergames no ciberespaço: uma possibilidade para a educação física	VAGHETTI, C. A. O. ; MUSTARO, P. N. ; BOTELHO, S. S. C.	2011	32	37	\N	4
4152	AP	Ambientes virtuais de aprendizagem na educação física: uma revisão sobre a utilização de Exergames	VAGHETTI, C. A. ; BOTELHO, S. S. C.	2010	1-6	37	\N	4
4153	AP	Forecasting Electric Energy Demand using a Predictor Model based on Liquid State Machine	grando, n. ; CENTENO, T. M. ; BOTELHO, S. S. C. ; fontoura, f.	2010	40-53	37	\N	4
4154	AP	PRINCÍPIOS ERGONÔMICOS E USABILIDADE DE INTERFACES DE REALIDADE AUMENTADA EM AMBIENTES VIRTUAIS DE APRENDIZAGEM: VISÃO GERAL E TENDENCIAS	VAGHETTI, C. A. ; BOTELHO, S. S. C.	2010	1-6	37	\N	4
4161	AP	Sistema de predição de alarmes em processos industriais por classificação não-supervisionada	Braustein, S. ; A, Lerm ; Lerm, R. ; Werhli, A. ; BOTELHO, S. S. C. ; E, Lippe	2009	37-42	37	\N	4
4162	AP	Dimensional Reduction in the Protein Secondary Structure Prediction Nonlinear Method Improvements	SIMAS, G. ; BOTELHO, S. S. C. ; grando, n. ; COLARES, R.	2008	425-432	37	\N	4
4166	AA	TOPOBO: Aspectos motivacionais do uso da robótica com crianças. RENOTE	M, Santin ; Botelho, Silvia S. C. ; SILVA, J.	2012		37	\N	4
4167	AA	Internet of Things in Product-Service Systems - A Trend in Service Engineering	ESPÍNDOLA, D. ; DUARTE, N. ; BOTELHO, S. S. C. ; pereira, c. e.	2011		37	\N	4
4168	AA	Dimensional Reduction in the Protein Secondary Structure Prediction: Nonlinear Method Improvements	BOTELHO, S. S. C. ; SIMAS, G. ; COLARES, R.	2009		37	\N	4
4171	LP	Third Southern Conference on Computational Modeling	BOTELHO, S. S. C. (Org.) ; ROCHA, L. (Org.) ; D, Adamatti (Org.)	2010		37	\N	4
4172	LP	Simpósio de Modelagem Computacional do Sul	ROCHA, L. (Org.) ; BOTELHO, S. S. C. (Org.) ; D, Adamatti (Org.)	2009		37	\N	4
4173	LP	CONFERÊNCIA EM MODELAGEM COMPUTACIONAL DO SUL	BOTELHO, S. S. C. (Org.) ; ROCHA, L. (Org.) ; D, Adamatti (Org.)	2009		37	\N	4
4174	CL	Nonlinear Dimensional Reduction in Protein Secondary Structure Prediction. Forecasting Models - Methods and Applications	SIMAS, G. ; BOTELHO, S. S. C. ; COLARES, R. ; CORREA, U. B.	2010	65-81	37	\N	4
4175	CL	Using augmented state Kalman filter to localize multi autonomous underwater vehicles. Robot Localization and Map Building	BOTELHO, S. S. C. ; LEIVAS, G ; DREWS, P.	2010	33-41	37	\N	4
4180	TC	Estaleiros Virtuais Imersivos - A Realidade Virtual a serviço da Indústria Naval e Offshore	Botelho, Silvia S. C. ; Amaral, M.	2012		37	\N	4
4182	TC	Utilizando Máquinas de Estado Líquido para Reconhecimento de Padrões Temporais	NOVELLO, L. ; Botelho, Silvia S. C.	2012	1-6	37	\N	4
4187	TC	Artefatos educacionais com memória cinética Topobo: uma abordagem para o currículo dos anos iniciais	M, Santin ; Botelho, Silvia S. C. ; SILVA, J.	2012	1-6	37	\N	4
4191	TC	ADA-TOPOBO: Um Ambiente Dual de Aprendizagem Utilizando Kits Educacionais	MOTA, F. ; SANTOS, I. ; ROSA, V. ; Botelho, Silvia S. C. ; Amaral, M.	2012	1-6	37	\N	4
4192	TC	Using Exergames as Social Networks: Testing the Flow Theory in the Teaching of Physical Education	VAGHETTI, C. A. O. ; SOUZA, P. O. ; DUARTE, M. A. ; da Silva Costa Botelho, S.	2012	1-6	37	\N	4
4194	TC	Utilizando Propagação de Crença Não Paramétrica para Rastreamento de Movimento com Mínimo Uso de Informação a Priori	SIMAS, G. ; Botelho, Silvia S. C.	2012	1-6	37	\N	4
4201	TC	Ambientes virtuais de aprendizagem na Educaçao fisica: uma revisão sobre a utilização de exergames	VAGHETTI, C. A. ; BOTELHO, S. S. C.	2010	1-6	37	\N	4
4204	TC	Sistema de Predição de Alarmes em Plantas Industriais Baseado em Mapas Auto-Organizáveis	Braustein, S. ; A, Lerm ; Lerm, R. ; Werhli, A. ; BOTELHO, S. S. C. ; E, Lippe	2010	1-6	37	\N	4
4207	TC	A Visualização Mista nos Sistemas de Automação de Processos de Manutenção Preditiva de Máquinas da Indústria	ESPÍNDOLA, D. ; pereira, c. e. ; R, Henriques ; BOTELHO, S. S. C.	2010	1-6	37	\N	4
4214	TC	Cultura digital e Educação Física: problematizando a inserção de Exergames no currículo	VAGHETTI, C. A. ; BOTELHO, S. S. C. ; R, Sperotto	2010	1-6	37	\N	4
4215	TC	Cultura digital e Educação Física	VAGHETTI, C. A. ; R, Sperotto ; BOTELHO, S. S. C.	2010		37	\N	4
4220	TC	Odometry and Mapping for Underwater Autonoumous Vehicles	BOTELHO, S. S. C. ; LEIVAS, G ; DREWS, P.	2009	1-6	37	\N	4
4225	TC	Técnicas para redução de perturbações em imagens subaquáticas destinadas ao controle de AUVS	DUCHINSKI, M. ; CENTENO, T. M. ; BOTELHO, S. S. C.	2008	1-6	37	\N	4
4236	RE	Estudo da viabilidade do ROS como plataforma para IoT	Hax, V. A. ; Botelho, Silvia S. C. ; DUARTE FILHO, N. L. ; MENDIZABAL, O.	2012	1-6	37	\N	4
4237	RE	RFID in Shipbuilding - Proposed Case Study Involving Shipyard in Brazil	DUARTE, N. ; BOTELHO, S. S. C.	2011	1-4	37	\N	4
4238	RE	Robótica Educacional como proposta de Ensino	CAMPOS, R. L. ; BOTELHO, S. S. C. ; ANTIQUEIRA, L. ; ACOSTA, S.	2011	404-406	37	\N	4
4239	RE	JOGO ELETRÔNICO EDUCATIVO: INOVAÇÃO PARA PROMOÇÃO DA CIDADANIA	CAMPOS, R. L. ; SILVA, G. ; BOTELHO, S. S. C.	2011	1-4	37	\N	4
4240	RE	Interactive Virtual Worlds in Brazilian Digital Television	Tavares, D. ; Nyamasege, N ; BOTELHO, S. S. C. ; DUARTE, N.	2010	1-4	37	\N	4
4241	RE	Jogo Eletrônico Educativo: Visitando a Dimensão Social da EJA	SILVA, G. ; CAMPOS, R. L. ; BOTELHO, S. S. C.	2010	1-4	37	\N	4
4242	AP	A hardware DC motor emulator	ROSA, V. S. ; GERVINI, V. I. ; GOMES, S. C. P. ; BAMPI, S.	2008	5-16	38	\N	4
4243	TC	HW/SW FPGA Design for Active Control of Flexible Structures	SOARES, L. B. ; TERRES, M. A. S. M. ; GOMES, S. C. P. ; GERVINI, V. I. ; ROSA, V. S.	2012	1-6	38	\N	4
4244	TC	Emulador de Motor DC em Hardware	SCHUCH, L. W. ; ROSA, V. S.	2012	1-4	38	\N	4
4245	TC	TANQUE BATEDOR: UM ROBÔ TELEOPERADO PARA INSPEÇÃO EM AMBIENTES INÓSPITOS	Nunez, A. F. ; VEIGA, F. F. ; LONGHI, J. P. C. ; ROSA, V. S. ; OLIVEIRA, V. M.	2011	1-6	38	\N	4
4246	TC	An H.264 Deblocking Filter in FPGA with RGB Video Output	ROSA, V. S. ; Silva, L. M. ; BAMPI, S.	2010		38	\N	4
4247	TC	A low-cost hardware architecture binarizer design for the H.264/AVC CABAC entropy coding	Martins, A. L. M. ; ROSA, V. S. ; BAMPI, S.	2010	392-396	38	\N	4
4248	TC	High Performance Architectures for the Arithmetic Encoder of the H.264/AVC CABAC Entropy Coder	ROSA, V. S. ; Silva, L. M. ; BAMPI, S.	2010		38	\N	4
4249	TC	A hardware DC Motor emulator	ROSA, V. S. ; GERVINI, V. I. ; GOMES, S. C. P. ; BAMPI, S.	2010		38	\N	4
4250	TC	Uma Análise sobre Leis de Controle para Veículos Subaquáticos Não Tripulados	GOMES, S. C. P. ; ZEILMANN, A. P ; TERRES, M. A. S. M. ; SOARES, L. B. ; ROSA, V. S.	2010	1-4	38	\N	4
4252	TC	A high performance H.264 Deblocking Filter	ROSA, V. S. ; Altamiro A. Susin ; BAMPI, S.	2009		38	\N	4
4253	TC	Data storage using Compact Flash card and Hardware/Software Interface for FPGA Embedded Systems	SOARES, L. B. ; GERVINI, V. I. ; GOMES, S. C. P. ; ROSA, V. S.	2009	153-156	38	\N	4
4254	TC	Design of Electronic Interfaces to Control Robotic Systems Using FPGA	ROSA, A. L. M. ; TADEO, G. ; GERVINI, V. I. ; GOMES, S. C. P. ; ROSA, V. S.	2009	91-94	38	\N	4
4255	TC	A High Performance H.264 Deblocking Filter Hardware Architecture	ROSA, V. S. ; Altamiro A. Susin ; BAMPI, S.	2009	255-258	38	\N	4
4256	TC	Design of Hardware/Software board for the Real Time Control of Robotic Systems	Cassel, D. ; GERVINI, V. I. ; GOMES, S. C. P. ; ROSA, V. S.	2009	157-160	38	\N	4
4257	TC	VHDL generation of optimized FIR filters	DAITX, F. F. ; ROSA, V. S. ; COSTA, E. ; BAMPI, S. ; FLORES, P. F.	2008	1-5	38	\N	4
4258	TC	A Novel Hardware Architecture Dedicated to Binary Arithmetic Decoder Engines for the H.264/AVC CABAD	DEPRA, D. A. ; ROSA, V. S. ; BAMPI, S.	2008		38	\N	4
4259	TC	Design and Implementation of a High-Performance Architecture for Binarization Methods of Defined by H.264/AVC Standard	DEPRA, D. A. ; ROSA, V. S. ; BAMPI, S.	2008		38	\N	4
4260	TC	FPGA Implementation of a AC Motor Controller with a hardware/software codesign approach	MOREIRA, T. G. ; GUIMARAES JR., D. S. ; DINIZ, C. M. ; ROSA, V. S. ; GOMES, S. C. P.	2008		38	\N	4
4261	TC	A Novel Hardware Architecture Design for Binary Arithmetic Decoder Engines Based on Bitstream Flow Analysis	DEPRA, D. A. ; ROSA, V. S. ; BAMPI, S.	2008		38	\N	4
4262	TC	Construção de um canal de testes para estudo de interação fluido-estrutura	COELHO, J. F. L. ; PINTO, W. T. ; GOMES, S. C. P. ; ROSA, V. S. ; GERVINI, V. I. ; ROSA, A. L. M. ; Cassel, D. ; HARTMANN, E.	2008		38	\N	4
4263	TC	Desenvolvimento de Controladores para uma Plataforma Móvel Destinada ao Estudo da Interação Fluido-Estrutura	Cassel, D. ; ROSA, A. L. M. ; HARTMANN, E. ; PEREIRA, I. M. ; MOREIRA, T. G. ; GUIMARAES JR., D. S. ; GERVINI, V. I. ; ROSA, V. S. ; GOMES, S. C. P. ; COELHO, J. F. L. ; PINTO, W. T.	2008		38	\N	4
4264	AA	A Hardware DC Motor Emulator	ROSA, V. S. ; GERVINI, V. I. ; GOMES, S.C.P. ; BAMPI, S.	2010		39	\N	4
4265	AA	Desenvolvimento de interfaces para operação de uma plataforma de ensaios de embarcações	MEDEIROS, M. M. ; GERVINI, V. I. ; ROSA, V. S. ; GOMES, S.C.P.	2010		39	\N	4
4267	TC	Controle de Alto Desempenho para uma Plataforma Móvel Destinada ao Estudo da Interação Fluido Estrutura	ROSA, A. L. R. ; CASSEL, D. P. ; MEDEIROS, M. M. ; PEREIRA, I. M. ; TADEU, G. ; SOARES, L. B. ; GERVINI, V. I. ; ROSA, V. S. ; GOMES, S.C.P. ; PINTO, W. T. ; Coelho, J. F. L.	2008		39	\N	4
4268	TC	Construção de um Canal de Testes para a Interação Fluido Estrutura	Coelho, J. F. L. ; PINTO, W. T. ; GOMES, S.C.P. ; ROSA, V. S. ; GERVINI, V. I. ; ROSA, A. L. R. ; CASSEL, D. P. ; HARTMANN, E.	2008		39	\N	4
4269	TC	CONTROLE DE ROBÔ COM UM ELO FLEXÍVEL USANDO REDES WAVELETS NEURAIS	GERVINI, V. I. ; HEMERLY, E. M. ; GOMES, S.C.P.	2008		39	\N	4
4270	TC	CONTROLE Hinf DE UM MANIPULADOR FLEXÍVEL COM COMPENSAÇÃO DE ATRITO	MACHADO, C. C. ; GOMES, S.C.P. ; GUIMARAES JR, D. S. ; GERVINI, V. I. ; BORTOLI, A. L.	2008		39	\N	4
4271	TC	FRICTION COMPENSATION IN ROBOTIC ACTUATORS	GOMES, S.C.P. ; MACHADO, C. C. ; GERVINI, V. I. ; DINIZ, C. M. ; ROSA, V. S.	2008		39	\N	4
4272	TC	A NEW SIMULATOR TO FLEXIBLE MANIPULATORS	HARTMANN, E. ; SHULTZ, T. P. ; CASTELLUBER, W. ; GERVINI, V. I. ; GOMES, S.C.P.	2008		39	\N	4
4273	RE	Controle em Tempo Real de uma Plataforma de Manobras através de um Dispositivo FPGA	CASSEL, D. P. ; GERVINI, V. I. ; ROSA, V. S. ; GOMES, S.C.P.	2009		39	\N	4
4274	RE	Interfaces Eletrônicas para o Controle de um Sistema Robótico	ROSA, A. L. R. ; TADEU, G. ; GERVINI, V. I. ; ROSA, V. S. ; GOMES, S.C.P.	2009		39	\N	4
4275	AP	Redução do Tempo de Execução de Métodos Numéricos utilizando GNU/OCTAVE e GPGPU	Tibola, A. L. ; OLIVEIRA, V. M.	2010	59-66	40	\N	4
4277	TC	Sistema de Navegação para um Robô de Inspeção de Linhas Subterrâneas de Distribuição	Estrada, E. ; Silveira L. ; OLIVEIRA, V. M. ; BOTELHO, S. S. C.	2010		40	\N	4
4278	TC	Control of a Brachiating Robot for Inspection of Aerial Power Lines	OLIVEIRA, V. M. ; LAGES, W. F.	2010		40	\N	4
4266	TC	Aquisição e Análise de Modos de Vibração em Estruturas Flexíveis	SOARES, L. B. ; GOMES, S.C.P. ; GERVINI, V. I. ; ROSA, V. S.	2010	1-6	39	4251	4
4280	TC	Real-Time Predictive Control of a Brachiation Robot	OLIVEIRA, V. M. ; LAGES, W. F.	2009	1-6	40	\N	4
4282	TC	Controle em Tempo Real de um Robô Bracejador Utilizando MPC	OLIVEIRA, V. M. ; LAGES, W. F.	2009		40	\N	4
4287	RE	PARALELIZAÇÃO DA BLAS UTILIZANDO GPGPU	Tibola, A. L. ; OLIVEIRA, V. M.	2010		40	\N	4
4288	RE	MODELAGEM MATEMÁTICA E AUTOMAÇÃO DO PROCESSO DE BIOFIXAÇÃO DE CO2	SANTOS, J. V. ; CAMERINI, F. ; OLIVEIRA, V. M. ; COSTA, J. A. V.	2010		40	\N	4
4289	RE	DESENVOLVIMENTO E CONSTRUÇÃO DE UM ROBÔ PARA INSPEÇÃO DE LINHAS DE ALTA-TENSÃO	VEIGA, F. ; OLIVEIRA, V. M.	2010		40	\N	4
4290	RE	Comparação entre métodos para representação cinemática de robôs bracejadores	RODRIGUES, F. ; OLIVEIRA, V. M.	2010		40	\N	4
4291	RE	HARDWARE MULTICAMADAS PARA AUTOMAÇÃO RESIDENCIAL	CORREA, L. S. ; OLIVEIRA, V. M.	2010		40	\N	4
4292	RE	Redução do Tempo de Execução de Métodos Numéricos Utilizando GNU/Octave e GPGPU	Tibola, A. L. ; OLIVEIRA, V. M.	2009		40	\N	4
4293	RC	FILTRAGEM DE ESTADOS COM RESTRIÇÕES DE IGUALDADE SEGUINDO A TÉCNICA DE PROJEÇÃO DE ESTIMATIVA APLICADA SOBRE O FILTRO DE KALMAN ESTENDIDO	Oliveira, R. ; LILLES, P. D. ; OLIVEIRA, V. M.	2011		40	\N	4
4294	RC	Otimização de Tempo de Execução de Métodos Numéricos usando GNU/Octave com GPGPU e NVIDIA CUDA	Tibola, A. L. ; OLIVEIRA, V. M.	2009		40	\N	4
4306	RE	Multiplicadores de Conhecimento em Projeto de Inclusão Digital	Martinazzo, L. A. ; GRILLO, T. P. ; Adamatti, D. F. ; TYSKA, J. C. ; HAX, V. A.	2012	1-4	41	\N	4
4307	RE	Inclusão Digital Dentro da Universidade	Benevides, L. ; Rodrigues, A. ; Oliveira, B. A. ; Fernandes, L. ; Garcez, A. V. ; Fiori, D. ; TYSKA, J. C. ; HAX, V. A. ; Adamatti, D. F.	2012	1-4	41	\N	4
4308	RE	Redes Sociais em Projeto de Inclusão Digital	Lucca, G. ; Klumb, A. ; HAX, V. A. ; TYSKA, J. C. ; Adamatti, D. F.	2012	1-4	41	\N	4
4309	RC	MANUTENÇÃO E SUPORTE DO C3	Frozza, E. T. ; Boito, A. ; Martins, M. ; HAX, V. A. ; TYSKA, J. C. ; Flores, E. S. ; Pessoa, M. S.	2011		41	\N	4
4310	RC	INCLUSÃO DIGITAL EM ESCOLA DE ENSINO BÁSICO EM RIO GRANDE (RS)	Djalo, M. ; Flores, E. ; Silva, D. ; Klumb, A. ; Camacho, P. M. ; Adamatti, D. F. ; TYSKA, J. C. ; HAX, V. A.	2011		41	\N	4
4311	RC	PROGRAMA DE CAPACITAÇÃO EM TI VOLTADO PARA SOLUÇÕES APLICADAS À ÁREA NAVAL E OFFSHORE	Gonçalves, C. R. ; HAX, V. A. ; TYSKA, J. C. ; BOTELHO, S. S. C. ; DUARTE FILHO, N. L. ; Borges, E. N. ; Penna, R. ; Bem, R. A.	2011		41	\N	4
4312	RC	CONSULTORIA EM LEGALIZAÇÃO DE SOFTWARE	Ramos, Rodrigo ; HAX, V. A. ; TYSKA, J. C. ; Bicho, A. L.	2011		41	\N	4
4313	RC	TICast	Alves, R. M. ; HAX, V. A. ; TYSKA, J. C. ; Pereira, I. A. ; Camacho, P. M.	2011		41	\N	4
4314	RC	IMPLEMENTAÇÃO DE UMA INFRAESTRUTRA PARA NUVEM COMPUTACIONAL	Jacobi, E. B. ; Popiolek, P. F. ; MENDIZABAL, O. M. ; HAX, V. A. ; TYSKA, J. C. ; DUARTE FILHO, N. L.	2011		41	\N	4
4315	RC	Gerência Dinâmica de Máquinas Virtuais para Computação em Nuvem	Popiolek, P. F. ; Jacobi, E. B. ; MENDIZABAL, O. M. ; HAX, V. A. ; TYSKA, J. C. ; DUARTE FILHO, N. L.	2011		41	\N	4
4316	RC	Projeto de um Sistema de Gerenciamento de Laboratórios de Ensino	Camacho, P. M. ; Biazzi, M. ; Chaves, T. ; Frazon, J. ; Gomes, J. ; Parulla, B. ; Schollmeier, D. ; Souza, R. ; HAX, V. A. ; Bem, R. A.	2010		41	\N	4
4317	RC	Realismo em ambientes virtuais de manufatura usando RayTracing	DUARTE FILHO, N. L. ; HAX, V. A. ; MARCOS, P. B.	2008		41	\N	4
3327	TC	Análise Exploratória de Dados para o Desenvolvimento de Sistemas de Previsão de Alarmes em Plantas Industriais	Botelho, S. S. C. ; BRAUNSTEI, S. H. ; WERHLI, A. V.	2009		0	3327	4
4222	TC	Análise Exploratória de Dados para o Desenvolvimento de Sistemas de Previsão de Alarmes em Plantas Industriais	BOTELHO, S. S. C. ; Werhli, A. ; Braustein, S.	2009	1-6	37	3327	4
3328	TC	Continuum Crowds with Local Control	Marcelo Paravisi ; WERHLI, A. V. ; Julio C. S. Jaques Jr. ; RODRIGUES, R. ; BICHO, A. ; JUNG, C. R. ; MUSSE, S. R.	2008	108-115	0	3328	4
3344	TC	Continuum Crowds with Local Control	PARAVISI, M. ; WERHLI, A. V. ; JACQUES JUNIOR, J. C. S. ; RODRIGUES, R. A. ; BICHO, A. L. ; JUNG, C. R. ; MUSSE, S. R.	2008	108-115	1	3328	4
3336	AP	Space D*: A Path-Planning Algorithm for Multiple Robots in Unknown Environments	SILVEIRA, L. ; MAFFEI, R. Q. ; BOTELHO, S. S. C. ; DREWS JUNIOR, P. L. J. ; BICHO, A. L. ; DUARTE FILHO, N. L.	2012	1-11	1	3336	4
4005	AP	Space D* - A path-planning algorithm for multiple robots in unknown environments	SILVEIRA, Luan ; MAFFEI, R. Q. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; BICHO, A. L. ; DUARTE FILHO, N. L.	2012	363-373	30	3336	4
3340	TC	Using Space D* for Crowded Real Robots Environments	SILVEIRA, L. ; MAFFEI, R. Q. ; ALMEIDA, F. R. ; LONGARAY, M. M. ; BOTELHO, S. S. C. ; DREWS JUNIOR, P. L. J. ; BICHO, A. L. ; DUARTE FILHO, N. L.	2012	273-278	1	3340	4
3898	TC	Using Space D* for Crowded Real Robots Environments	ALMEIDA, F. ; BOTELHO, Silvia Silva da Costa ; Silveira, L. ; DREWS, Paulo ; Maffei, Renan ; DUARTE FILHO, Nelson Lopes ; BICHO, A. ; LONGARAY, M.	2012	1-6	26	3340	4
3342	TC	Space D*: Um Algoritmo para Path Planning Multi-Robôs	MAFFEI, R. Q. ; BOTELHO, S. S. C. ; SILVEIRA, L. ; DREWS JUNIOR, P. L. J. ; DUARTE FILHO, N. L. ; BICHO, A. L. ; ALMEIDA, F. R. ; LONGARAY, M. M.	2011	607-618	1	3342	4
3900	TC	Space D*: Um Algoritmo para Path Planning Multi-Robôs	Silveira, L. ; Maffei, Renan ; BOTELHO, Silvia Silva ; Drews, Paulo Lilles ; DUARTE FILHO, Nelson Lopes ; BICHO, A.	2011	51-62	26	3342	4
3343	TC	D*-space: Planejando Caminhos para Sistemas Multi-robôs	MAFFEI, R. Q. ; BOTELHO, S. S. C. ; SILVEIRA, L. ; DREWS JUNIOR, P. L. J. ; DUARTE FILHO, N. L. ; BICHO, A. L. ; LONGARAY, M. M. ; ALMEIDA, F. R.	2011	1-6 CDROM	1	3343	4
3901	TC	D*-Space: planejando caminhos para sistemas multi-robôs	Silveira, L. ; Maffei, Renan ; BOTELHO, Silvia Silva da Costa ; DREWS, Paulo ; DUARTE FILHO, Nelson Lopes ; BICHO, A. ; LONGARAY, M.	2011		26	3343	4
3370	TC	Um sistema para análise de redes de pesquisa baseado na Plataforma Lattes	FARIAS, Lucas R. ; VARGAS, A. P. ; Borges, Eduardo N.	2012	1-10	3	3370	4
3670	TC	Um sistema para análise de redes de pesquisa baseado na Plataforma Lattes	FARIAS, Lucas R. ; Vargas, André P. ; Borges, Eduardo N.	2012	1-10 CD-ROM	13	3370	4
3371	TC	Uma ferramenta para coleta e análise de dados do segmento naval	OTERO, Tiago F. ; VARGAS, A. P. ; FARIAS, Lucas R. ; Borges, Eduardo N.	2012	1-14	3	3371	4
3671	TC	Uma ferramenta para coleta e análise de dados do segmento naval	Otero, Tiago F. ; FARIAS, Lucas R. ; Vargas, André P. ; Borges, Eduardo N.	2012	1-4 CD-ROM	13	3371	4
3372	TC	ARGOsearch: an information retrieval system based on text similarity and extensible relevance criteria	Borges, Eduardo N. ; VARGAS, A. P. ; PEREIRA, Igor A. ; TOMASINI, C.	2012	1-8	3	3372	4
3672	TC	ARGOsearch: an information retrieval system based on text similarity and extensible relevance criteria	Borges, Eduardo N. ; PEREIRA, Igor A. ; TOMASINI, C. ; Vargas, André P.	2012	1-8	13	3372	4
3373	TC	Um mecanismo de busca para sistemas de gerenciamento de bibliotecas baseado em critérios de relevância extensíveis	PEREIRA, Igor A. ; VARGAS, A. P. ; Borges, Eduardo N. ; TOMASINI, C.	2012	7-12	3	3373	4
3673	TC	Um mecanismo de busca para sistemas de gerenciamento de bibliotecas baseado em critérios de relevância extensíveis	PEREIRA, Igor A. ; TOMASINI, C. ; Borges, Eduardo N. ; Vargas, André P.	2012	7-12	13	3373	4
3384	AP	Recognizing and learning models of social exchange strategies for the regulation of social interactions in open agent societies	DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; Gonçalves, L. V. ; Pereira, D. R.	2011	1-19	4	3384	4
3713	AP	Recognizing and learning models of social exchange strategies for the regulation of social interactions in open agent societies	DIMURO, G. P. ; COSTA, A. C. R. ; GONÇALVES, L. V. ; PEREIRA, D. R.	2011	143-161	18	3384	4
3387	AP	Interval-Valued Hidden Markov Models for Recognizing Personality Traits in Social Exchanges in Open Multiagent Systems. TEMA	DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; Gonçalves, L. V. ; Hübner, A.	2008	83-93	4	3387	4
3719	AP	Interval-Valued Hidden Markov Models for Recognizing Personality Traits in Social Exchanges in Open Multiagent Systems. TEMA	DIMURO, G. P. ; COSTA, A. C. R. ; GONÇALVES, L. V. ; HÜBNER, A.	2008	83-93	18	3387	4
3391	LP	Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation	DIMURO, Graçaliz Pereira (Org.) ; COSTA, A. C. R. (Org.) ; SICHMAN, J. S. (Org.) ; TEDESCO, P. (Org.) ; Adamatti, D. (Org.) ; BALSA, J. (Org.) ; Antunes, L. (Org.)	2011		4	3391	4
3722	LP	Advances in Social Simulation, Post-Proceedings of the Brazilian Workshop on Social Simulation	DIMURO, G. P. (Org.) ; COSTA, A. C. R. (Org.) ; Sichman, J. (Org.) ; TEDESCO, P. (Org.) ; ADAMATTI, D. F. (Org.) ; BALSA, J. (Org.) ; Antunes, L. (Org.)	2011		18	3391	4
3392	LP	Anais do WEIT 2011 - I Workshop-Escola de Informática Teórica	DIMURO, Graçaliz Pereira (Org.) ; FOSS, L. (Org.) ; AGUIAR, Marilton Sanchotene de (Org.) ; COSTA, S. A. (Org.) ; COSTA, A. C. R. (Org.)	2011		4	3392	4
3724	LP	Anais do WEIT 2011 - I Workshop-Escola de Informática Teórica	DIMURO, G. P. (Org.) ; FOSS, L. (Org.) ; AGUIAR, M. S. (Org.) ; COSTA, S. A. (Org.) ; COSTA, A. C. R. (Org.)	2011		18	3392	4
3393	LP	Post-Proceedings 2011 Workshop-School on Theoretical Computer Science - WEIT 2011	COSTA, S. A. (Org.) ; FOSS, L. (Org.) ; AGUIAR, Marilton Sanchotene de (Org.) ; DIMURO, Graçaliz Pereira (Org.) ; COSTA, A. C. R. (Org.)	2011		4	3393	4
3725	LP	Post-Proceedings 2011 Workshop-School on Theoretical Computer Science - WEIT 2011	CAVALHEIRO, S. A. C. (Org.) ; FOSS, L. (Org.) ; AGUIAR, M. S. (Org.) ; DIMURO, G. P. (Org.) ; COSTA, A. C. R. (Org.)	2011		18	3393	4
3396	CL	A Multiagent System-Based Solution for Shipment Operations with Priorities in a Container Terminal	Rodrigues, L. M. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2012	28-36	4	3396	4
3726	CL	A Multiagent System-Based Solution for Shipment Operations with Priorities in a Container Terminal	RODRIGUES, L. M. ; DIMURO, G. P. ; COSTA, A. C. R. ; EMMENDORFER, L.	2012	28-36	18	3396	4
3397	CL	On the Problem of Recognizing and Learning Observable Social Exchange Strategies in Open Societies	DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; Gonçalves, L. V.	2011	66-73	4	3397	4
3728	CL	On the Problem of Recognizing and Learning Observable Social Exchange Strategies in Open Societies	DIMURO, G. P. ; COSTA, A. C. R. ; GONÇALVES, L. V.	2011	66-73	18	3397	4
3398	CL	An Interactional Characterization of Social Functions	COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2011	74-81	4	3398	4
3729	CL	An Interactional Characterization of Social Functions	COSTA, A. C. R. ; DIMURO, G. P.	2011	74-81	18	3398	4
3399	CL	An Analysis of Two Regulation Mechanisms for Personality-Based Social Exchange Processes	Pereira, D. R. ; Gonçalves, L. V. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2011	96-102	4	3399	4
3730	CL	An Analysis of Two Regulation Mechanisms for Personality-Based Social Exchange Processes	PEREIRA, D. R. ; GONÇALVES, L. V. ; DIMURO, G. P. ; COSTA, A. C. R.	2011	96-102	18	3399	4
3405	CL	Agentes BDI com Percepção Fuzzy na Simulação de um Modelo Presa-Predador Fuzzy	Farias, G. P. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	74-85	4	3405	4
3743	CL	Agentes BDI com Percepção Fuzzy na Simulação de um Modelo Presa-Predador Fuzzy	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	74-85	18	3405	4
3406	CL	Analisando Trocas Sociais Baseadas em Personalidades Através de Cadeias de Markov Intervalares	Farias, G. P. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	13-23	4	3406	4
3740	CL	Analisando Trocas Sociais Baseadas em Personalidades Através de Cadeias de Markov Intervalares	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	13-23	18	3406	4
3407	CL	Introdução da Dimensão Dialógica no Moise+, com Aplicação na Modelagem de Processos de Gestão em uma Universidade Comunitária	Hübner, A. ; COSTA, A. C. R. ; DIMURO, Graçaliz Pereira ; MATTOS, V. ; HERNANDES, S.	2010	138-149	4	3407	4
3744	CL	Introdução da Dimensão Dialógica no Moise+, com Aplicação na Modelagem de Processos de Gestão em uma Universidade Comunitária	HÜBNER, A. ; COSTA, A. C. R. ; DIMURO, G. P. ; MATTOS, V. L. D. ; HERNANDES, S.	2010	138-149	18	3407	4
3408	CL	Uma arquitetura de Agentes BDI Híbridos para Auto-regulação de Trocas Sociais em Sistemas Multiagentes Abertos	Gonçalves, L. V. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	-60	4	3408	4
3742	CL	Uma arquitetura de Agentes BDI Híbridos para Auto-regulação de Trocas Sociais em Sistemas Multiagentes Abertos	GONÇALVES, L. V. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	60-73	18	3408	4
3412	CL	Extending the MOISE+ Organizational Model with the Dialogic Dimension	Hübner, A. ; COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2010	130-135	4	3412	4
3745	CL	Extending the MOISE+ Organizational Model with the Dialogic Dimension	HÜBNER, A. ; COSTA, A. C. R. ; DIMURO, G. P.	2010	130-135	18	3412	4
3414	CL	A Minimal Dynamical MAS Organization Model	COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2009	419-445	4	3414	4
3415	CL	Semantical Concepts for a Formal Structural Dynamics of Situated Multiagent Systems	COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2008	139-154	4	3415	4
3747	CL	Semantical Concepts for a Formal Structural Dynamics of Situated Multiagent Systems	COSTA, A. C. R. ; DIMURO, G. P.	2008	139-154	18	3415	4
3417	TC	Modeling Role Interactions in a Social Organization for the Simulation of the Social Production and Management of Urban Ecosystems: the case of San Jerónimo Vegetable Garden of Seville, Spain	SANTOS, F. P. ; RODRIGUES, T. F. ; DIMURO, G. ; Adamatti, D. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; MANUEL, E.	2012	1-16	4	3417	4
3589	TC	Modeling Role Interactions in a Social Organization for the Simulation of the Social Production and Management of Urban Ecosystems: the case of San Jeronimo Vegetable Garden of Seville, Spain	SANTOS, F. C. P. ; RODRIGUES, T. ; DIMURO, G. ; ADAMATTI, D. F. ; DIMURO, G. P. ; COSTA, A. C. R. ; JEREZ, E. M.	2012	1-6	10	3417	4
3418	TC	Analyzing the Evolution of Social Exchange Strategies in Social Preference-based MAS through an Evolutionary Spatial Approach of the Ultimatum Game	MACEDO, L. F. ; DIMURO, Graçaliz Pereira ; AGUIAR, Marilton Sanchotene de ; COSTA, A. C. R. ; COELHO, H. M. F. ; MATTOS, V.	2012	1-16	4	3418	4
3759	TC	Analyzing the Evolution of Social Exchange Strategies in Social Preference-based MAS through an Evolutionary Spatial Approach of the Ultimatum Game	MACEDO, L. F. K. ; DIMURO, G. P. ; AGUIAR, M. S. ; COSTA, A. C. R. ; COELHO, H. ; MATTOS, V. L. D.	2012	1-16	18	3418	4
3419	TC	Elementary Social Functions: Concept and Interrelation to Social Dependence Relations	COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2012	1-16	4	3419	4
3758	TC	Elementary Social Functions: Concept and Interrelation to Social Dependence Relations	COSTA, A. C. R. ; DIMURO, G. P.	2012	1-16	18	3419	4
3420	TC	Um Modelo de Agente BDI-Fuzzy para Trocas de Serviços Não-Econômicos Baseado na Teoria das Trocas Sociais de Piaget	Farias, G. P. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2012	1-12	4	3420	4
3755	TC	Um Modelo de Agente BDI-Fuzzy para Trocas de Serviços Não-Econômicos Baseado na Teoria das Trocas Sociais de Piaget	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2012	367-380	18	3420	4
3421	TC	Um framework para simulação de Políticas Públicas aplicado ao caso da Piracema, sob o olhar da Teoria dos Jogos	SANTOS, I. A. S. ; MOTA, F. P. ; COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2012	1-12	4	3421	4
3753	TC	Um framework para simulação de Políticas Públicas aplicado ao caso da Piracema, sob o olhar da Teoria dos Jogos	COSTA, A. C. R. ; MOTA, F. P. ; DIMURO, G. P. ; SANTOS, I.	2012	1-12	18	3421	4
3422	TC	Modelando a Organização Social de um SMA para Simulação dos Processos de Produção e Gestão Social de um Ecossistema Urbano: o caso da Horta San Jerónimo da cidade de Sevilla, Espanha	SANTOS, F. P. ; DIMURO, G. ; RODRIGUES, T. F. ; Adamatti, D. ; DIMURO, Graçaliz Pereira ; MANUEL, E. ; COSTA, A. C. R.	2012	93-104	4	3422	4
3578	TC	Modelando a Organização Social de um SMA para Simulação dos Processos de Produção e Gestão Social de um Ecossistema Urbano: o caso da Horta San Jerónimo da cidade de Sevilla, Espanha	SANTOS, F. C. P. ; RODRIGUES, T. ; DIMURO, G. ; ADAMATTI, D. F. ; JEREZ, E. M. ; DIMURO, G. P. ; COSTA, A. C. R.	2012	1-12	10	3422	4
3423	TC	Regulation of Social Exchanges in Open MAS: the problem of reciprocal conversions between POMDPs and HMMs	DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2012	1-8	4	3423	4
3748	TC	Regulation of Social Exchanges in Open MAS: the problem of reciprocal conversions between POMDPs and HMMs	DIMURO, G. P. ; COSTA, A. C. R.	2012	1-8	18	3423	4
3426	TC	Um Modelo Multiagente para Carregamento Compartilhado com Prioridades em um Terminal de Contêineres: Combinando o Problema da Mochila com PDMs	Rodrigues, L. M. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2011	51-62	4	3426	4
3763	TC	Um Modelo Multiagente para Carregamento Compartilhado com Prioridades em um Terminal de Conêineres: Combinando o Problema da Mochila com PDMs	RODRIGUES, L. M. ; DIMURO, G. P. ; COSTA, A. C. R. ; EMMENDORFER, L.	2011	51-62	18	3426	4
3427	TC	Um Estudo para uma Proposta de Modelos de Tomada de Decisão em Interações Estratégicas para Sistemas Multiagentes em Ambientes de Informação Imperfeita	BRIAO, S. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2011	190-200	4	3427	4
3768	TC	Um Estudo para uma Proposta de Modelos de Tomada de Decisão em Interações Estratégicas para Sistemas Multiagentes em Ambientes de Informação Imperfeita	BRIÃO, S. L. ; DIMURO, G. P. ; COSTA, A. C. R.	2011	190-200	18	3427	4
3428	TC	Towards Developmental Turing Machines	COSTA, S. A. ; COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2011	152-163	4	3428	4
3767	TC	Towards Developmental Turing Machines	COSTA, S. A. ; COSTA, A. C. R. ; DIMURO, G. P.	2011	152-163	18	3428	4
3430	TC	Agentes BDI com Percepção Fuzzy na Simulação de um Modelo Presa-Predador Fuzzy	Farias, G. P. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	1-12	4	3430	4
3771	TC	Agentes BDI com Percepção Fuzzy na Simulação de um Modelo Presa-Predador Fuzzy	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	1-12	18	3430	4
3431	TC	Introdução da Dimensão Dialógica no Moise+, com Aplicação na Modelagem de Processos de Gestão em uma Universidade Comunitária	Hübner, A. ; COSTA, A. C. R. ; DIMURO, Graçaliz Pereira ; MATTOS, V. ; HERNANDES, S. ; MAILANGE, M.	2010	65-76	4	3431	4
3772	TC	Introdução da Dimensão Dialógica no Moise+, com Aplicação na Modelagem de Processos de Gestão em uma Universidade Comunitária	HÜBNER, A. ; COSTA, A. C. R. ; DIMURO, G. P. ; MATTOS, V. L. D. ; HERNANDES, S. ; Mailange, M.	2010	65-76	18	3431	4
3435	TC	A Dialogic Dimension for the MOISE+ Organizational Model	Hübner, A. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; MATTOS, V.	2010	23/21-23/26	4	3435	4
3773	TC	A Dialogic Dimension for the MOISE+ Organizational Model	HÜBNER, A. ; DIMURO, G. P. ; COSTA, A. C. R. ; MATTOS, V. L. D.	2010	23/21-23/26	18	3435	4
3436	TC	BDI Agents with Fuzzy Perception for Simulating Decision Making in Environments with Imperfect Information	Farias, G. P. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	41/23-41/30	4	3436	4
3774	TC	BDI Agents with Fuzzy Perception for Simulating Decision Making in Environments with Imperfect Information	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	41/23-41/30	18	3436	4
3437	TC	BDI Agents with Fuzzy Perception	Farias, G. P. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2010	742-751	4	3437	4
3775	TC	BDI Agents with Fuzzy Perception	FARIAS, G. P. ; DIMURO, G. P. ; COSTA, A. C. R.	2010	742-751	18	3437	4
3438	TC	On the Problem of Recognizing and Learning Observable Social Exchange Strategies in Open Societies	DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; Gonçalves, L. V.	2010	140-152	4	3438	4
3776	TC	Recognizing and Learning Observable Social Exchange Strategies in Open Societies	DIMURO, G. P. ; COSTA, A. C. R. ; GONÇALVES, L. V.	2010	140-152	18	3438	4
3439	TC	An Interactional Characterization of Social Functions	COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2010	105-117	4	3439	4
3778	TC	An Interactional Characterization of Social Functions	COSTA, A. C. R. ; DIMURO, G. P.	2010	105-117	18	3439	4
3440	TC	Sobre Números Fuzzy Intervalares	DIMURO, Graçaliz Pereira ; COSTA, A. C. R. ; MUSSI, R. L.	2010	162-169	4	3440	4
3777	TC	Sobre Números Fuzzy Intervalares	DIMURO, G. P. ; COSTA, A. C. R. ; MUSSI, R. L.	2010	162-169	18	3440	4
3444	TC	Toward a Semantical Model of Organization Growth for Multiagent Systems	DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2009	120-129	4	3444	4
3783	TC	Toward a Semantical Model of Organization Growth for Multiagent Systems	DIMURO, G. P. ; COSTA, A. C. R.	2009	120-129	18	3444	4
3446	TC	Fuzzy Evaluation of Social Exchanges Between Personality-based Agents	DIMURO, Graçaliz Pereira ; SANTOS, André Vinícius dos ; BEDREGAL, Benjamin René Callejas ; COSTA, A. C. R.	2009	451-462	4	3446	4
3785	TC	Fuzzy Evaluation of Social Exchanges Between Personality-based Agents	DIMURO, G. P. ; SANTOS, A. V. ; BEDREGAL, B. R. C. ; COSTA, A. C. R.	2009	451-462	18	3446	4
3447	TC	A Formal Notion of Objective Expectations in the Context of Multiagent Systems Routines	COSTA, A. C. R. ; DIMURO, Graçaliz Pereira ; DUGDALE, J. ; DEMAZEAU, Y.	2009	367-378	4	3447	4
3786	TC	A Formal Notion of Objective Expectations in the Context of Multiagent Systems Routines	COSTA, A. C. R. ; DIMURO, G. P. ; DUGDALE, J. ; DEMAZEAU, Y.	2009	367-378	18	3447	4
3450	TC	Estendendo o Modelo Organizacional MOISE+ com a Dimensão Dialógica	Hübner, A. ; COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2009	1-6	4	3450	4
3788	TC	Estendendo o Modelo Organizacional MOISE+ com a Dimensão Dialógica	HÜBNER, A. ; COSTA, A. C. R. ; DIMURO, G. P.	2009	18-23	18	3450	4
3451	TC	Introducing Service Schemes and Systems Organization in the Theory of Interactive Computation	COSTA, A. C. R. ; DIMURO, Graçaliz Pereira	2008	87-96	4	3451	4
3789	TC	Introducing Service Schemes and Systems Organization in the Theory of Interactive Computation	COSTA, A. C. R. ; DIMURO, G. P.	2008	87-96	18	3451	4
3452	TC	Constructing BDI Plans from Optimal POMDP Policies, with an Application to AgentSpeak Programming	Pereira, D. R. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2008	240-249	4	3452	4
3798	TC	Constructing BDI Plans from Optimal POMDP Policies, with an Application to AgentSpeak Programming	PEREIRA, D. R. ; GONÇALVES, L. V. ; DIMURO, G. P. ; COSTA, A. C. R.	2008	240-249	18	3452	4
3453	TC	Contrasting Two Regulation Mechanisms for Personality-based Social Exchange Processes	Pereira, D. R. ; Gonçalves, L. V. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2008	1-12	4	3453	4
3799	TC	Contrasting Two Regulation Mechanisms for Personality-based Social Exchange Processes	PEREIRA, D. R. ; GONÇALVES, L. V. ; DIMURO, G. P. ; COSTA, A. C. R.	2008	1-12	18	3453	4
3455	TC	Towards the Self-regulation of Personality-based Social Exchange Processes in Multiagent Systems	Pereira, D. R. ; Gonçalves, L. V. ; DIMURO, Graçaliz Pereira ; COSTA, A. C. R.	2008	113-123	4	3455	4
3796	TC	Towards the Self-regulation of Personality-based Social Exchange Processes in Multiagent Systems	PEREIRA, D. R. ; GONÇALVES, L. V. ; DIMURO, G. P. ; COSTA, A. C. R.	2008	113-123	18	3455	4
3469	TC	TATUBOT Sistema Robótico de Inspeção para Linhas de Distribuição Elétrica Subterrâneas	BOTELHO, S. S. C. ; V. Oliveira ; N. D. Lopes Fº ; MELLO JÚNIOR, C. D. ; E. Estrada ; M. P. Galeriano ; U. B. Correa ; P. Drews Jr.	2008		6	3469	4
3701	TC	Tatubot - Sistema Robótico de Inspeção para Linhas de Distribuição Elétrica Subterrâneas	BOTELHO, S. S. C. ; DUARTE Filho, N. L. ; OLIVEIRA, V. M. ; MELLO JR., C. D. ; ESTRADA, E. S. D. ; GALERIANO, M. P. ; CORREA, U. B. ; DREWS JR., P.	2008		14	3469	4
3470	TC	TATUBOT ROBOTIC SYSTEM FOR INSPECTION OF UNDERGROUNDED CABLE SYSTEM	BOTELHO, S. S. C. ; GONÇALVES, E. M. N. ; MELLO JÚNIOR, C. D. ; ESTRADA, E. S. D. ; SOUTO Jr., H. D. ; SANTOS, T. S.	2008		6	3470	4
3665	TC	TATUBOT Robotic System for Inspection of Undergrounded Cable System	GONÇALVES, E. M. N. ; BOTELHO, S. S. C. ; OLIVEIRA, V. M. ; MELLO, C. ; ESTRADA, E.	2008		11	3470	4
3471	TC	TATUBOT Robotic System for Inspection of Undergrounded Cable	GONÇALVES, E. M. N. ; ESTRADA, E. S. D. ; SOUTO Jr., H. D. ; V. Oliveira ; BOTELHO, S. S. C. ; MELLO JÚNIOR, C. D.	2008		6	3471	4
3702	TC	TATUBOT ROBOTIC SYSTEM FOR INSPECTION OF UNDERGROUNDED CABLE SYSTEM	BOTELHO, S. S. C. ; Gonçalves, E. M. N. ; MELLO JR., C. D. ; ESTRADA, E. S. D. ; SOUTO JR., H. D. ; ALMEIDA, R. ; SANTOS, T. S.	2008		14	3471	4
3472	AP	Projeto de um Bloco de Memória SRAM em Tecnologias CMOS Nanométricas de 16nm	GOMES, I. A. C. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2012	31-40	7	3472	4
3962	AP	Projeto de um Bloco de Memória SRAM em Tecnologias CMOS Nanométricas de 16nm	GOMES, I. A. C. ; MEINHARDT, C. ; BUTZEN, P. F.	2012	31-40	29	3472	4
3475	TC	Design of 16nm SRAM Architecture	GOMES, I. A. C. ; Meinhardt, Cristina ; BUTZEN, P. F.	2012	1-4	7	3475	4
3970	TC	Design of 16nm SRAM Architecture	GOMES, I. A. C. ; MEINHARDT, C. ; BUTZEN, P. F.	2012	1-4	29	3475	4
3476	TC	Full Adders Architectures Evaluation for 32nm Technology	SILVA, A. N. ; MACHADO, I. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2012	1-4	7	3476	4
3971	TC	Full Adders Architectures Evaluation for 32nm Technology	SILVA, A. N. ; MACHADO, I. ; MEINHARDT, C. ; BUTZEN, P. F.	2012	1-4	29	3476	4
3477	TC	Evaluating the Efficacy of Low Power Process to Design Low Power Circuits	NUNES, C. S. ; SILVA, A. N. ; GOMES, I. A. C. ; MEINHARDT, Cristina ; BUTZEN, P. F.	2012	1-4	7	3477	4
3972	TC	Evaluating the Efficacy of Low Power Process to Design Low Power Circuits	NUNES, C. S. ; SILVA, A. N. ; GOMES, I. A. C. ; MEINHARDT, C. ; BUTZEN, P. F.	2012	1-4	29	3477	4
3514	AP	An Adaption of OSA-CBM Architecture for Human-Computer Interaction through Mixed Interface	ESPÍNDOLA, Danúbia Bueno ; FUMAGALLI, L. ; GARETTI, M. ; BOTELHO, Silvia Silva da Costa ; PEREIRA, Carlos Eduardo	2011	485-490	8	3514	4
4149	AP	An Adaption of OSA-CBM Architecture for Human-Computer Interaction through Mixed Interface.	ESPÍNDOLA, D. ; FUMAGALLI ; GARETTI ; Carlos Eduardo ; BOTELHO, S. S. C.	2011	485-490	37	3514	4
3517	TC	A Engenharia de Serviço na Indústria Naval	BOTELHO, Silvia S da C ; DUARTE, Nelson ; ESPÍNDOLA, Danúbia Bueno ; Carvallho, J. T.	2012		8	3517	4
3895	TC	A Engenharia de Serviço na Indústria Naval	BOTELHO, Silvia Silva ; DUARTE FILHO, Nelson Lopes ; ESPINDOLA, Danubia ; OLIVEIRA, D. P. ; CARVALHO, J.	2012	1-6	26	3517	4
3518	TC	Internet of Things to Provide Scalability in Product-Service Systems	ESPÍNDOLA, Danúbia Bueno ; DUARTE, Nelson ; BOTELHO, Silvia S da C ; Carvallho, J. T. ; PEREIRA, Carlos Eduardo	2012	32-40	8	3518	4
3897	TC	Internet of Things to Provide Scalability in Product-Service Systems	ESPINDOLA, Danubia ; DUARTE FILHO, Nelson Lopes ; BOTELHO, Silvia Silva da Costa ; CARVALHO, J. ; PEREIRA, C. E.	2012	1-6	26	3518	4
3521	TC	Using Mixed Reality in the Visualization of Maintenance Processes	ESPÍNDOLA, Danúbia Bueno ; PEREIRA, Carlos Eduardo ; HENRIQUES, Renato Ventura Bayan ; BOTELHO, Silvia Silva da Costa	2010	35-40	8	3521	4
4210	TC	Using Mixed Reality in the Visualization of Maintenance Processes	ESPÍNDOLA, D. ; pereira, c. e. ; HENRIQUES, Renato Ventura Bayan ; BOTELHO, S. S. C.	2010	35-40	37	3521	4
3522	TC	Uma Proposta para Visualização Aumentada em Tempo_real Aplicada a Indústria. In:	ESPÍNDOLA, Danúbia Bueno ; PEREIRA, Carlos Eduardo ; HENRIQUES, Renato Ventura Bayan ; BOTELHO, Silvia Silva da Costa	2010	163-168	8	3522	4
4209	TC	Uma Proposta para Visualização Aumentada em Tempo_real Aplicada a Indústria	ESPÍNDOLA, D. ; pereira, c. e. ; HENRIQUES, Renato Ventura Bayan ; BOTELHO, S. S. C.	2010	163-168	37	3522	4
3564	LP	Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações - Artigos Selecionados das quatro primeiras edições. Rio Grande / RS: Edigraf- Editora e Gráfica da Universidade Federal do Rio Grande	ADAMATTI, D. F. (Org.)	2010		10	3564	4
4071	LP	Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações	CAMPOS, R. L. ; FARIAS, Giovani ; ROSA, Simone ; SIMAS, Gisele ; SILVA, Carlos	2010		32	3564	4
3572	CL	Detectando Padrões Comportamentais de Agentes Através de Árvores de Decisão	SILVEIRA, J. A. ; PAES, T. L. ; EMMENDORFER, L. R. ; ADAMATTI, D. F.	2010	204-208	10	3572	4
3863	CL	Detectando Padrões Comportamentais de Agentes Através de Árvores de Decisão	PAES, T. ; SILVEIRA, J. ; ADAMATTI, D. F. ; EMMENDORFER, L. R.	2010	204-208	24	3572	4
3576	TC	Experiências de Inclusão Digital em Escolas Municipais de Rio Grande	ADAMATTI, D. F. ; SILVA, D. ; FELIX, D. ; FLORES, E. ; ROCHANO, E. L. ; LINDENAU, G. ; CARVALHO, J. T. ; HAX, V. A. ; DJALO, M.	2012	1-10	10	3576	4
4299	TC	Experiências de Inclusão Digital em Escolas Municipais de Rio Grande	Adamatti, D. F. ; TYSKA, J. C. ; HAX, V. A. ; Silva, D. ; Flores, E. ; Djalo, M. ; Rochano, E. L. ; Félix, D. ; Lindenau, G.	2012	1-10	41	3576	4
3750	TC	Modelando a Organização Social de um SMA para Simulação dos Processos de Produção e Gestão Social de um Ecossistema Urbano: o caso da Horta San Jerónimo da cidade de Sevilla, Espanha	SANTOS, F. C. P. ; DIMURO, G. ; RODRIGUES, T. F. ; ADAMATTI, D. F. ; DIMURO, G. P. ; Jerez, E. de M. ; COSTA, A. C. R.	2012	93-104	18	3422	4
3579	TC	Um Modelo de Ferramenta Computacional Aplicada ao Processo de Aprendizagem Especial: As Tecnologias Assistivas	LUZ JUNIOR, D. M. ; GUIMARAES, M. ; ADAMATTI, D. F. ; BARWALDT, R. ; FELIPE, C. I. M.	2012	1-10	10	3579	4
4089	TC	Um Modelo de Ferramenta Computacional Aplicada ao Processo de Aprendizagem Especial: As Tecnologias Assistivas	BARWALDT, Regina ; ADAMATTI, D. F. ; FELIPPE, C. I. M. ; GUIMARAES, M. ; LUZ JUNIOR, D. M.	2012	1-10	33	3579	4
3580	TC	Formação Continuada: Preparando Professores para o Atendimento Educacional Especializado Através das Salas de Recursos Multifuncionais	BARWALDT, R. ; ADAMATTI, D. F. ; FELIPE, C. I. M.	2012	1-10	10	3580	4
4090	TC	Formação Continuada: Preparando Professores para o Atendimento Educacional Especializado Através das Salas de Recursos Multifuncionais	FELIPPE, C. I. M. ; BARWALDT, Regina ; ADAMATTI, D. F.	2012	1-2	33	3580	4
3582	TC	The Accessibility at University by Assistive Technologies	ADAMATTI, D. F. ; BARWALDT, R. ; FELIPE, C. I. M.	2012	1-8	10	3582	4
4091	TC	The Accessibility at University by Assistive Technologies	ADAMATTI, D. ; BARWALDT, Regina ; FELIPPE, C. I. M.	2012		33	3582	4
3583	TC	Tecnologias Assistivas: Recursos e Serviços Utilizados para a Inclusão Sócio-Digital de Pessoas com Deficiências	LUZ JUNIOR, D. M. ; HECKLER, I. R. ; ADAMATTI, D. F. ; BARWALDT, R. ; FELIPE, C. I. M.	2012	1-6	10	3583	4
4092	TC	Tecnologias Assistivas: Recursos e Serviços Utilizados para a Inclusão Sócio-Digital de Pessoas com Deficiências	LUZ JUNIOR, D. M. ; SALOMAO, H. L. R. ; BARWALDT, Regina ; ADAMATTI, D. F. ; FELIPPE, C. I. M.	2012		33	3583	4
3760	TC	Modeling Role Interactions in a Social Organization for the Simulation of the Social Production and Management of Urban Ecosystems: the case of San Jerónimo Vegetable Garden of Seville, Spain	SANTOS, F. C. P. ; RODRIGUES, T. F. ; DIMURO, G. ; ADAMATTI, D. F. ; DIMURO, G. P. ; COSTA, A. C. R. ; Jerez, E. de M.	2012	1-16	18	3417	4
3591	TC	Um sistema para previsão de impactos gerados pela instalação de indústrias e sua influência sobre ecossistemas costeiros no extremo sul do Brasil	THOMASI, C. D. ; NUNES, G. ; TOLEGO, R. ; JUGUEIRO, M. ; TEIXEIRA, P. ; ADAMATTI, D. F. ; TAGLIANI, C.	2011	1-10	10	3591	4
3706	TC	Um sistema para previsão de impactos gerados pela instalação de indústrias e sua influência sobre ecossistemas costeiros no extremo sul do Brasil	THOMASI, C. D. ; NUNES, G. A. L. ; TOLEDO, R. G. A. ; JUGUEIRO, M. M. ; TEIXEIRA, P. S. ; TAGLIANI, C. R. A. ; ADAMATTI, D. F.	2011		16	3591	4
3592	TC	Inclusão Digital em Escola de Ensino Básico em Rio Grande (RS)	ADAMATTI, D. F. ; CARVALHO, J. T. ; HAX, V. A. ; KLUMB, A. ; SILVA, D. ; FLORES, E. ; CAMACHO, P. M. ; DJALO, M.	2011		10	3592	4
4300	TC	Inclusão Digital em Escola de Ensino Básico em Rio Grande (RS)	Adamatti, D. F. ; TYSKA, J. C. ; HAX, V. A. ; Klumb, A. ; Silva, D. ; Flores, E. ; Camacho, P. M. ; Djalo, M.	2011		41	3592	4
3593	TC	Inclusão Digital em Escola de Ensino Básico em Rio Grande (RS)	ADAMATTI, D. F. ; CARVALHO, J. T. ; HAX, V. A. ; KLUMB, A. ; SILVA, D. ; FLORES, E. ; CAMACHO, P. M. ; DJALO, M.	2011		10	3593	4
4301	TC	Inclusão Digital em Escola de Ensino Básico em Rio Grande (RS)	Adamatti, D. F. ; TYSKA, J. C. ; HAX, V. A. ; Klumb, A. ; Silva, D. ; Flores, E. ; Camacho, P. M. ; Djalo, M.	2011		41	3593	4
3594	TC	Atividades para Inclusão Digital em Ensino Básico: Uma Experiência em Escola de Rio Grande (RS)	ADAMATTI, D. F. ; CARVALHO, J. T. ; HAX, V. A. ; KLUMB, A. ; SILVA, D. ; CAMACHO, P. M. ; DJALO, M.	2011		10	3594	4
4302	TC	Atividades para Inclusão Digital em Ensino Básico: Uma Experiência em Escola de Rio Grande (RS)	Adamatti, D. F. ; HAX, V. A. ; TYSKA, J. C. ; Klumb, A. ; Silva, D. ; Flores, E. ; Camacho, P. M. ; Djalo, M.	2011		41	3594	4
3595	TC	Tecnologias Assistivas e Pessoas com Necessidades Especiais: Desenvolvimento Sustentável	BARWALDT, R. ; ADAMATTI, D. F. ; FELIPE, C. I. M.	2011		10	3595	4
4093	TC	Tecnologias Assistivas e Pessoas com Necessidades Especiais: Desenvolvimento Sustentável	BARWALDT, Regina ; ADAMATTI, D. F. ; FELIPPE, C. I. M.	2011		33	3595	4
3596	TC	Tecnologias Assistivas e Acessibilidade para Pessoas com Necessidade Especiais em Rio Grande	BARWALDT, R. ; ADAMATTI, D. F. ; FELIPE, C. I. M.	2011		10	3596	4
4094	TC	Tecnologias Assistivas e Acessibilidade para Pessoas com Necessidade Especiais em Rio Grande	BARWALDT, Regina ; ADAMATTI, D. F. ; FELIPPE, C. I. M.	2011		33	3596	4
3598	TC	Poder de Captura das Árvores de Decisão para o Comportamento de Agentes	SILVEIRA, J. A. ; PAES, T. L. ; EMMENDORFER, L. R. ; ADAMATTI, D. F.	2010	1-4 - CDROM	10	3598	4
3866	TC	Poder de Captura das Árvores de Decisão para o Comportamento de Agentes	PAES, T. ; SILVEIRA, J. ; ADAMATTI, D. F. ; EMMENDORFER, L. R.	2010	1-6	24	3598	4
3601	TC	Effectiveness of Decision Trees for Detecting the Behavior of Agents	ADAMATTI, D. F. ; SILVEIRA, J. A. ; PAES, T. L. ; EMMENDORFER, L. R.	2010		10	3601	4
3867	TC	Effectiveness of Decision Trees for Detecting the Behavior of Agents	ADAMATTI, D. F. ; PAES, T. ; SILVEIRA, J. ; EMMENDORFER, L. R.	2010	1-6	24	3601	4
3662	TC	Autonomous navigation for underground energy line inspection robot	BOTELHO, S. S. C. ; ESTRADA, E. ; GONÇALVES, E. M. N. ; OLIVEIRA, V. M.	2010	1-6	11	3662	4
3695	TC	Autonomous navigation for underground energy line inspection robot	ESTRADA, E. S. D. ; Silveira, L. ; Gonçalves, E. M. N. ; OLIVEIRA, V. M. ; BOTELHO, S. S. C.	2010	1-6	14	3662	4
3663	TC	Uma Arquitetura para Navegação Autônoma de Robôs Reais e Simulados para Inspeção de Linhas de Distribuição de Energia Subterrâneas	GONÇALVES, E. M. N. ; ESTRADA, E. ; ALMEIDA, Renan Rosado de ; BOTELHO, S. S. C.	2009		11	3663	4
3698	TC	Uma arquitetura para navegação autônoma de robôs reais e simulados para inspeção de linhas de distribuição de energia subterrâneas	ESTRADA, E. S. D. ; ALMEIDA, R. ; BOTELHO, S. S. C. ; GULES, R. ; OLIVEIRA, V. M. ; Silveira, L. ; Gonçalves, E. M. N.	2009		14	3663	4
3664	TC	SIFT and Topologic Maps applied to robotic SLAM in Underwater Environment	DREWS JR., P. ; MEDEIROS, Mariane ; BOTELHO, S. S. C. ; GONÇALVES, E. M. N.	2008		11	3664	4
4049	TC	SIFT and Topologic Maps applied to robotic SLAM in Underwater Environment	DREWS JR, P. L. J. ; BOTELHO, S. S. C. ; MEDEIROS, M. M. ; GONCALVES, E. M. N.	2008	1-6	30	3664	4
3700	TC	TATUBOT - Robotic System for Inspection of Undergrounded Cable System	ESTRADA, E. S. D. ; MELLO JR., C. D. ; Gonçalves, E. M. N. ; Oliveira, G. L. ; ALMEIDA, R. ; BOTELHO, S. S. C.	2008		14	3470	4
3666	TC	Mixed Reality RoboCup Category - An Overview of FURGBOL-PV Contributions	MEDEIROS, Mariane ; COLARES, Rafael Gonçalves ; ALMEIDA, Renan Rosado de ; SIMAS, G. M. ; GONÇALVES, E. M. N. ; BOTELHO, S. S. C.	2008	3-7	11	3666	4
4233	TC	Mixed Reality RoboCup Category - An overview of FURGBOL-PV Contributions	MEDEIROS, M. M. ; COLARES, R. ; ALMEIDA, R. R. ; SIMAS, G. ; GONCALVES, E. ; BOTELHO, S. S. C.	2008	1-6	37	3666	4
3818	TC	ARGOsearch: an information retrieval system based on text similarity and extensible relevance criteria	Eduardo N. ; PEREIRA, I. A. ; TOMASINI, C ; VARGAS, A. P.	2012	1-8	20	3372	4
3819	TC	Um mecanismo de busca para sistemas de gerenciamento de bibliotecas baseado em critérios de relevância extensíveis	PEREIRA, I. A. ; TOMASINI, C ; Eduardo N. ; VARGAS, A. P.	2012	7-12	20	3373	4
3690	AP	Arquitetura de navegação autônoma de linhas subterrâneas de distribuição de energia	ESTRADA, E. S. D. ; Silveira, L. ; CORREA, U. B. ; OLIVEIRA, V. M. ; BOTELHO, S. S. C.	2008	32-45	14	3690	4
4164	AP	Arquitetura de navegação autônoma de linhas subterrâneas de distribuição de energia	Estrada, E. ; ALMEIDA, R. R. ; CORREA, U. B. ; OLIVEIRA, V. ; BOTELHO, S. S. C.	2008	32-45	37	3690	4
3693	TC	UMA METODOLOGIA DE ENSINO COM O AUXÍLIO DA ROBÓTICA EDUCACIONAL	OLIVEIRA, S. A. ; ANTIQUEIRA, L. S. ; CAMPOS, R. L. ; ESTRADA, E. S. D.	2012	834-841	14	3693	4
4072	TC	UMA METODOLOGIA DE ENSINO COM O AUXÍLIO DA ROBÓTICA EDUCACIONAL	CAMPOS, R. L. ; OLIVEIRA, Suvânia Acosta de ; ANTIQUEIRA, Liliane Silva ; Estrada, E.	2012	834-841	32	3693	4
3906	TC	Autonomous navigation for underground energy line inspection robot	ESTRADA, Emanuel ; Silveira, L. ; Gonçalves, E. ; DUARTE FILHO, Nelson Lopes ; OLIVEIRA, V. ; BOTELHO, Silvia Silva	2010	1-6	26	3662	4
3696	TC	Sistema de Navegação para um Robô de Inspeção de Linhas Subterrâneas de Distribuição	ESTRADA, E. S. D. ; Silveira, L. ; OLIVEIRA, V. M. ; BOTELHO, S. S. C.	2010	2698-2705	14	3696	4
4206	TC	Sistema de Navegação para um Robô de Inspeção de Linhas Subterrâneas de Distribuição	Estrada, E. ; Silveira, L. ; OLIVEIRA, V. ; BOTELHO, S. S. C.	2010	1-6	37	3696	4
4221	TC	Uma arquitetura para navegação autônoma de robôs reais e simulados para inspeção de linhas de distribuição de energia subterrâneas	GONCALVES, E. ; Estrada, E. ; Gules, R. ; BOTELHO, S. S. C. ; Silveira, L. ; OLIVEIRA, V.	2009	1-6	37	3663	4
3699	TC	A Mobile System for Duct Inspection	BOTELHO, S. S. C. ; ESTRADA, E. S. D. ; Gonçalves, E. M. N. ; GULES, R. ; MELLO JR., C. D. ; OLIVEIRA, V. M. ; SANTOS, T. S. ; SOUTO JR., H. D. ; ALMEIDA, R.	2009		14	3699	4
4283	TC	A Mobile System for Duct Inspection	BOTELHO, S. S. C. ; Estrada, E. ; SOUTO JR., H. ; ALMEIDA, R. ; OLIVEIRA, V. M. ; Gonçalves, E. N. ; Mello Jr., C. D. ; Santos, T. ; Gules R.	2009		40	3699	4
4228	TC	Robotic System for Inspection of Undergrounded Cable System	Estrada, E. ; MELLO, C. ; GONCALVES, E. ; LEIVAS, G ; ALMEIDA, R. R. ; BOTELHO, S. S. C.	2008	1-6	37	3470	4
3908	TC	TATUBOT - Sistema Robótico de Inspeção para Linhas de Distribuição Elétrica Subterrâneas	BOTELHO, Silvia Silva ; DUARTE FILHO, Nelson Lopes ; OLIVEIRA, Vinícius Menezes de ; MELLO JR, Claudio Dornelles ; ESTRADA, Emanuel ; GALERIANO, Marcelo ; CORREA, Ulisses ; DREWS, Paulo	2008	100-105	26	3469	4
4232	TC	TATUBOT Robotic System for Inspection of Undergrounded Cable System	MELLO, C. ; GONÇALVES, L. ; Estrada, E. ; LEIVAS, G ; ALMEIDA, R. R. ; BOTELHO, S. S. C. ; THIAGO,S.	2008	1-6	37	3471	4
3817	TC	Unconstrained face recognition using MRF priors and manifold traversing	RODRIGUES, R. N. ; SCHROEDER, Greyce Nogueira ; Corso, J.J ; Govindaraju, Venu	2009		19	3817	4
4111	TC	Unconstrained face recognition using MRF priors and manifold traversing	Rodrigues, Ricardo N. ; Greyce N. Schroeder ; Corso, J.J ; Govindaraju, Venu	2009		34	3817	4
3824	TC	Desenvolvimento de uma Plataforma Multidisciplinar para Autoria de Jogos 3D Interativos e Educativos	PINTO, I. M. ; BOTELHO, Silvia da Costa ; SOUZA, R. C. ; GOULART, T. S. ; COLARES, R. ; CAMPOS, R. L.	2009		21	3824	4
4218	TC	DESENVOLVIMENTO DE UMA PLATAFORMA MULTIDISCIPLINAR PARA AUTORIA DE JOGOS 3D INTERATIVOS E EDUCATIVOS	PINTO, Ivete ; Sonego, T. ; Souza, R. ; COLARES, R. ; BOTELHO, S. S. C.	2009	1-6	37	3824	4
3825	TC	SABERLÂNDIA: Plataforma Lúdica integrando robótica e multimídia para educação	PINTO, I. M. ; BOTELHO, Silvia da Costa ; SOUZA, R. C. ; GOULART, T. S. ; COLARES, R. ; CAMPOS, R. L.	2008		21	3825	4
4075	TC	Saberlândia:plataforma lúdica integrando robótica e multimídia para educação	BOTELHO, S. S. C. ; PINTO, I. M. ; GOULART, T. S. ; COLARES, R. G. ; CAMPOS, R. L. ; SOUZA, R. S.	2008		32	3825	4
3826	TC	Plataforma Saberlândia: Integrando Robótica e Multimídia no Desenvolvimento de Jogos Educacionais	PINTO, I. M. ; BOTELHO, Silvia da Costa ; SOUZA, R. C. ; GOULART, T. S. ; COLARES, R. ; CAMPOS, R. L.	2008		21	3826	4
4076	TC	Plataforma Saberlândia: Integrando Robótica e Multimídia no Desenvolvimento de Jogos Educacionais	PINTO, I. M. ; BOTELHO, S. S. C. ; SOUZA, R. S. ; GOULART, T. S. ; COLARES, R. G. ; CAMPOS, R. L.	2008	177-186	32	3826	4
3827	AP	An immersive and collaborative visualization system for digital manufacturing	Duarte Filho, Nelson ; Costa Botelho, Silvia ; Tyska Carvalho, Jonata ; Botelho Marcos, Pedro ; Queiroz Maffei, Renan ; Remor Oliveira, Rodrigo ; Ruas Oliveira, Rodrigo ; Alves Hax, Vinicius	2010	1	22	3827	4
3887	AP	An immersive and collaborative visualization system for digital manufacturing	Duarte Filho, Nelson ; Costa Botelho, Silvia ; Tyska Carvalho, Jonata ; Botelho Marcos, Pedro ; Queiroz Maffei, Renan ; Remor Oliveira, Rodrigo ; Ruas Oliveira, Rodrigo ; Alves Hax, Vinicius ; DUARTE FILHO, Nelson Lopes	2010	1253-1261	26	3827	4
3828	AP	General Purpose Cave-like System for Visualization of Animated and 4D CAD Modeling	BOTELHO, S. S. C. ; DUARTE FILHO, Nelson Lopes ; Hax, V. A. ; Maffei, R. Q. ; Marcos, P. B. ; Ruas, R. R. ; Tyska Carvalho, Jonata	2010	1	22	3828	4
3888	AP	A general purpose cave-like system for visualization of animated and 4D cad modeling	DUARTE FILHO, Nelson Lopes ; BOTELHO, Silvia Silva ; CARVALHO, J. ; MARCOS, Pedro ; Maffei, Renan ; OLIVEIRA, Rodrigo Ruas ; HAX, V.	2010	5-19	26	3828	4
3829	TC	Hyper-Environments: A Different Way to Think about IoT	Tyska, Jônata Carvalho ; BOTELHO, S. S. C. ; DUARTE FILHO, Nelson Lopes ; SANTOS, R. A. P. ; dos Santos, E. B. ; Ruas, R. R.	2011	25-32	22	3829	4
3902	TC	Hyper-Environments: A Different Way to Think about IoT	CARVALHO, J. ; SANTOS, Rafael ; BOTELHO, Silvia Silva ; Duarte Filho, Nelson L. ; OLIVEIRA, Rodrigo Ruas ; Santos, E.	2011	25-32	26	3829	4
3830	TC	Educação Ubíqua: A Tecnologia dando Suporte ao Processo de Ensino-aprendizagem em Qualquer Lugar, em Qualquer Instante	IAHNKE, S. L. P. ; BOTELHO, S. S. C. ; SANTOS, R. A. P. ; Ruas, R. R. ; Tyska, Jônata Carvalho	2010		22	3830	4
4068	TC	Educação Ubíqua: A Tecnologia dando Suporte ao Processo de Ensino-aprendizagem em Qualquer Lugar, em Qualquer Instante	IAHNKE, S. L. P. ; BOTELHO, S. S. C. ; SANTOS, Rafael Augusto Penna dos ; OLIVEIRA, R. R. ; CARVALHO, J. T.	2010		31	3830	4
3831	TC	A Multi-Cave Visualization System for Digital Manufacturing	Tyska, J. ; DUARTE FILHO, Nelson Lopes ; BOTELHO, S. S. C. ; Ruas, R. R. ; Marcos, P. B. ; Maffei, R. Q. ; Hax, V. A.	2009	1160-1165	22	3831	4
3907	TC	A Multi-Cave Visualization System for Digital Manufacturing	DUARTE FILHO, Nelson Lopes ; BOTELHO, Silvia Silva da Costa ; Tyska, J ; MARCOS, Pedro ; Maffei, Renan ; OLIVEIRA, R. R. ; OLIVEIRA, Rodrigo Ruas ; HAX, V.	2009	201-207	26	3831	4
3832	TC	An Automated Platform for Immersive and Collaborative Visualization of Industrial Models	Tyska, J. ; BOTELHO, S. S. C. ; DUARTE FILHO, Nelson Lopes ; Ruas, R. R. ; Marcos, P. B. ; Maffei, R. Q. ; Hax, V. A.	2009	258-264	22	3832	4
4304	TC	An Automated Platform for Immersive and Collaborative Visualization of Industrial Models	BOTELHO, S. S. C. ; DUARTE FILHO, N. L. ; HAX, V. A. ; MAFFEI, R. Q. ; MARCOS, P. B. ; OLIVEIRA, R. R. ; TYSKA, J. C.	2009		41	3832	4
3834	TC	Using Game Engines in Digital Manufacturing through Immersive and Collaborative Visualization Systems	BOTELHO, S. S. C. ; DUARTE FILHO, Nelson Lopes ; Tyska, J. C ; Marcos, P. B. ; Maffei, R. Q. ; Oliveira, R. R. ; Ruas, R. R. ; Hax, V. A.	2008	121-125	22	3834	4
3910	TC	Using Game Engines in Digital Manufacturing through Immersive and Collaborative Visualization Systems	BOTELHO, Silvia Silva da Costa ; DUARTE FILHO, Nelson Lopes ; Tyska, J ; MARCOS, Pedro ; Maffei, Renan ; OLIVEIRA, Rodrigo Ruas ; OLIVEIRA, R. R. ; HAX, V.	2008	101-105	26	3834	4
4151	AP	An Immersive and Collaborative Visualization Systems for Digital Manufacturing	DUARTE, N. ; BOTELHO, S. S. C. ; Tyska, j. ; P. botelho ; R. maffei ; R. Oliveira ; v. hax	2010	1	37	3827	4
4156	AP	General Purpose Cave-like System for Visualization of Animated and 4D CAD Modeling	BOTELHO, S. S. C. ; DUARTE FILHO, Nelson Lopes ; Hax, V. A. ; Maffei, R. Q. ; Marcos, P. B. ; Ruas, R. R. ; Tyska, J. C ; Tyska Carvalho, Jonata	2010	1	37	3828	4
3889	AP	Um Framework para Memória Compartilhada Distribuída e Eestudo de Caso em Aplicações de Geociências sobre Clusters de Computadores	VIEIRA, Jeison ; BOTELHO, Silvia Silva ; DUARTE FILHO, Nelson Lopes	2010	1-17	26	3889	4
4155	AP	Um Framework para Memória Compartilhada Distribuída e Eestudo de Caso em Aplicações de Geociências sobre Cluster de Computadores	Vieira, J. ; BOTELHO, S. S. C. ; DUARTE, N.	2010	1-6	37	3889	4
3890	LP	Conferência Internacional em Tecnologia Naval e Offshore: Ciência e Inovação	PINTO, E.C. (Org.) ; GIROLDO, D. (Org.) ; DUARTE FILHO, Nelson Lopes (Org.) ; BOTELHO, Silvia Silva da Costa (Org.)	2012		26	3890	4
4169	LP	Conferência Internacional em Tecnologia Naval e Offshore: Ciência e Inovação	DUARTE, N. (Org.) ; Botelho, Silvia S. C. (Org.) ; ESTEFEN, S. (Org.) ; E. C. PINTO (Org.) ; Giroldo, D (Org.)	2012		37	3890	4
3891	LP	Offshore and Marine Technology: Science and Innovation	DUARTE FILHO, Nelson Lopes (Org.) ; BOTELHO, Silvia Silva da Costa (Org.) ; ESTEFEN, S. (Org.) ; PINTO, E. C. (Org.) ; GIROLDO, D. (Org.)	2012		26	3891	4
4170	LP	Offshore and Marine Technology: Science and Innovation	DUARTE FILHO, N. L. (Org.) ; Botelho, Silvia S. C. (Org.) ; ESTEFEN, S. (Org.) ; E. C. PINTO (Org.) ; Giroldo, D (Org.)	2012		37	3891	4
3892	CL	A General Purpose Cave-like System for Visualization of Animated and 4D CAD Modeling	DUARTE FILHO, Nelson Lopes ; CARVALHO, J. ; MARCOS, Pedro ; Maffei, Renan ; OLIVEIRA, Rodrigo Ruas ; HAX, V. ; BOTELHO, Silvia Silva da Costa	2010	82-87	26	3892	4
4176	CL	A General Purpose Cave-like System for Visualization of Animated and 4D CAD Modeling	Duarte Filho, Nelson L. ; Tyska, j. ; P. botelho ; R. maffei ; R. Oliveira ; v. hax ; Botelho, Silvia S. C.	2010	82-87	37	3892	4
3893	CL	A Framework for Distributed Shared Memory - Case Study in Geoscience Applications on Clusters of Computers	DUARTE FILHO, Nelson Lopes ; VIEIRA, Jeison ; BOTELHO, Silvia Silva da Costa	2010	88-93	26	3893	4
4177	CL	A Framework for Distributed Shared Memory - Case Study in Geoscience Applications on Clusters of Computers	DUARTE, N. ; Vieira, J. ; Botelho, Silvia S. C.	2010	88-93	37	3893	4
3894	CL	An Automated Platform for Immersive and Collaborative Visualization of Industrial Models. Engineering of Complex Computer Systems. 1ed	DUARTE FILHO, Nelson Lopes ; BOTELHO, Silvia Silva da Costa ; CARVALHO, J. ; MARCOS, Pedro ; Maffei, Renan ; OLIVEIRA, Rodrigo Ruas ; HAX, V.	2009	258-264	26	3894	4
4178	CL	An Automated Platform for Immersive and Collaborative Visualization of Industrial Models. Engineering of Complex Computer Systems	DUARTE, N. ; Botelho, Silvia S. C. ; Tyska, j. ; P. botelho ; R. maffei ; R. Oliveira	2009	258-264	37	3894	4
4179	TC	A Engenharia de Serviço na Indústria Naval	Botelho, Silvia S. C. ; DUARTE, N. ; ESPÍNDOLA, D. ; Oliveira, D. P. ; Tyska, j.	2012		37	3517	4
3896	TC	Um Sistema Integrado para Controle de Projetos na Construção Naval com Análise de Risco	PIRES, F. ; ASSIS, L. F. ; DUARTE FILHO, Nelson Lopes ; BOTELHO, S.	2012	1-4	26	3896	4
4181	TC	Um Sistema Integrado para Controle de Projetos na Construção Naval com Análise de Risco	Pires, F. ; Assis, L. F. ; DUARTE, N. ; Botelho, Silvia S. C.	2012		37	3896	4
4186	TC	Internet of Things to Provide Scalability in Product-Service Systems	ESPÍNDOLA, D. ; DUARTE FILHO, N. L. ; BOTELHO, S. S. C. ; Tyska, j. ; pereira, c. e.	2012	1-6	37	3518	4
4021	TC	Using Space D* for Crowded Real Robots Environments	ALMEIDA, F. R. ; BOTELHO, S. S. C. ; SILVEIRA, Luan ; DREWS JR, P. L. J. ; MAFFEI, R. Q. ; DUARTE FILHO, N. L. ; BICHO, A. L. ; LONGARAY, M. M.	2012		30	3340	4
3899	TC	Parallel High Dimensional Self Organizing Maps Using CUDA	MORAES, F. ; BOTELHO, Silvia Silva da Costa ; DUARTE FILHO, Nelson Lopes	2012	1-6	26	3899	4
4190	TC	Parallel High Dimensional Self Organizing Maps Using CUDA	MORAES, F. ; Botelho, Silvia S. C. ; DUARTE, N.	2012	1-6	37	3899	4
4023	TC	Space D*: Um Algoritmo para Path Planning Multi-Robôs	SILVEIRA, Luan ; MAFFEI, R. Q. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; BICHO, A. L. ; DUARTE FILHO, N. L. ; LONGARAY, M. M. ; ALMEIDA, F. R.	2011		30	3342	4
4026	TC	D*-Space: planejando caminhos para sistemas multi-robôs	SILVEIRA, Luan ; MAFFEI, R. Q. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; DUARTE FILHO, N. L. ; BICHO, A. L. ; LONGARAY, M. M. ; ALMEIDA, F. R.	2011		30	3343	4
4067	TC	Hyper-Environments: A Different Way to Think about IoT	CARVALHO, J. T. ; DOSSANTOS, R ; BOTELHO, S. S. C. ; DUARTE FILHO, Nelson Lopes ; OLIVEIRA, R. R. ; SANTOS, E.	2011	25-32	31	3829	4
3903	TC	SAP-RISCO4D Sistemas de Avaliação 4D para Projetos na Construção Naval	OLIVEIRA, D. P. ; BOTELHO, Silvia Silva ; DUARTE FILHO, Nelson Lopes	2010	1-6	26	3903	4
4212	TC	SAP-RISCO4D Sistemas de Avaliação 4D para Projetos na Construção Naval	Oliveira, D. P. ; BOTELHO, S. S. C. ; DUARTE, N.	2010	1-6	37	3903	4
3904	TC	Modelagem de um Sistema de Visualização 4D na Construção Naval	OLIVEIRA, D. P. ; BOTELHO, Silvia Silva ; DUARTE FILHO, Nelson Lopes	2010	1-6	26	3904	4
4211	TC	Modelagem de um Sistema de Visualização 4D na Construção Naval	Oliveira, D. P. ; BOTELHO, S. S. C. ; DUARTE, N.	2010	1-6	37	3904	4
3905	TC	SAP-RISCO4D: UM SISTEMA DE VISUALIZAÇÃO 4D PARA ACOMPANHAMENTO DE PROJETOS NA CONSTRUÇÃO NAVAL	OLIVEIRA, D. P. ; BOTELHO, Silvia Silva ; DUARTE FILHO, Nelson Lopes	2010	1-6	26	3905	4
4213	TC	SAP-RISCO4D: UM SISTEMA DE VISUALIZAÇÃO 4D PARA ACOMPANHAMENTO DE PROJETOS NA CONSTRUÇÃO NAVAL	Oliveira, D. P. ; BOTELHO, S. S. C. ; DUARTE, N.	2010	1-6	37	3905	4
4279	TC	Autonomous Navigation for Underground Energy Line Inspection Robot	Estrada, E. ; Silveira L. ; Gonçalves, E. N. ; DUARTE FILHO, N. L. ; BOTELHO, S. S. C. ; OLIVEIRA, V. M.	2010		40	3662	4
4047	TC	Sistema Robótico de Inspeção para Linhas de Distribuição Elétrica Subterrâneas	BOTELHO, S. S. C. ; OLIVEIRA, V. M. ; DUARTE FILHO, N. L. ; MELLO JÚNIOR, C. D. ; ESTRADA, E. D. ; GALERIANO, M. P. ; DREWS JR, P. L. J. ; CORREA, U. B.	2008	100-106	30	3469	4
4305	TC	Using Game Engines in Digital Manufacturing through Immersive and Collaborative Visualization Systems	BOTELHO, S. S. C. ; DUARTE FILHO, N. L. ; HAX, V. A. ; MAFFEI, R. Q. ; MARCOS, P. B. ; OLIVEIRA, R. R. ; TYSKA, J. C.	2008		41	3834	4
4147	AP	Space D*: A Path-Planning Algorithm for Multiple Robots in Unknown Environments	SILVEIRA, L. ; MAFFEI, R. Q. ; BOTELHO, S. S. C. ; DREWS JUNIOR, P. L. J. ; BICHO, A. L. ; DUARTE FILHO, N. L.	2012	1-11	37	3336	4
4006	AP	Mapas auto-organizáveis em veículos autônomos subaquáticos	BOTELHO, S. S. C. ; HAFFELE, C. ; FIGUEIREDO, M. ; OLIVEIRA, G. L. ; DREWS JR, P. L. J.	2010	45-55	30	4006	4
4157	AP	Mapas auto-organizáveis em veículos autônomos subaquáticos	BOTELHO, S. S. C. ; HAFFELE, C. ; FIGUEIREDO, M. ; OLIVEIRA, G. L. ; DREWS JR, P. L. J. ; DREWS JR, P. L. J.	2010	45-55	37	4006	4
4007	AP	A Visual System For Distributed Mosaics Using AUV Fleets	DREWS JR, P. L. J. ; BOTELHO, S. S. C.	2009	8-10	30	4007	4
4158	AP	A VISUAL SYSTEM FOR DISTRIBUTED MOSAICS USING AUV FLEETS	DREWS, P. ; BOTELHO, S. S. C.	2009	1-8	37	4007	4
4008	AP	Appearance-based odometry and mapping with feature descriptors for underwater robots	BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; FIGUEIREDO, M. ; HAFFELE, C. ; OLIVEIRA, G. L.	2009	47-54	30	4008	4
4160	AP	Appearance-based odometry and mapping with feature descriptors for underwater robots	BOTELHO, S. S. C. ; DREWS, P. ; m, figueiredo ; da Rocha, C. ; LEIVAS, G	2009	47-54	37	4008	4
4009	AP	Uma Abordagem Baseada em Visão Computacional para Localização e Mapeamento Simultâneos de Robôs Subaquáticos. REIC	DREWS JR, P. L. J. ; BOTELHO, S. S. C.	2008	6	30	4009	4
4165	AP	Uma Abordagem Baseada em Visão Computacional para Localização e Mapeamento Simultâneos de Robôs Subaquáticos. REIC	DREWS JR, P. L. J. ; BOTELHO, S. S. C.	2008	6	37	4009	4
4013	TC	Self-organizing mapping of robotic environments based on neural networks	FIGUEIREDO, M. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; HAFFELE, C.	2012		30	4013	4
4193	TC	Self-organizing mapping of robotic environments based on neural networks	FIGUEIREDO, M. ; Botelho, Silvia S. C. ; DREWS, P. ; HAFFELE, C.	2012	1-6	37	4013	4
4015	TC	Modelando Nuvens de Pontos Tridimensionais como Misturas de Gaussianas	SILVA FILHO, S. C. ; DREWS JR, P. L. J. ; BOTELHO, S. S. C. ; NUNEZ, P.	2012		30	4015	4
4183	TC	Modelando Nuvens de Pontos Tridimensionais como Misturas de Gaussianas	SILVA FILHO, S. ; Drews, Paulo L. ; Botelho, Silvia S. C. ; NUNEZ, P.	2012	1-6	37	4015	4
4016	TC	Utilizando Representações Multi-semânticas para Mapeamento Topológico em Robótica Móvel	FIGUEIREDO, M. ; HAFFELE, C. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; OLIVEIRA, G. L.	2012		30	4016	4
4184	TC	Utilizando Representações Multi-semânticas para Mapeamento Topológico em Robótica Móvel	FIGUEIREDO, M. ; Botelho, Silvia S. C. ; Drews, Paulo L. ; da Rocha, C. ; OLIVEIRA, G. L.	2012	1-6	37	4016	4
4017	TC	Modelando Head Direction Cells para Estimativa de Orientacão Idiotética de Robôs Móveis	SILVEIRA, Luan ; GUTH, F. A. ; FIGUEIREDO, M. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J.	2012		30	4017	4
4185	TC	Modelando Head Direction Cells para Estimativa de Orientacão Idiotética de Robôs Móveis	Silveira, Luan ; Botelho, Silvia S. C. ; Drews, Paulo L. ; GUTH, F. ; FIGUEIREDO, M.	2012	1-6	37	4017	4
4020	TC	Spatial and Perceptive Mapping using Semantically Self-Organizing Maps applied to Mobile Robots	FIGUEIREDO, M. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; HAFFELE, C.	2012		30	4020	4
4188	TC	Spatial and Perceptive Mapping using Semantically Self-Organizing Maps applied to Mobile Robots	FIGUEIREDO, M. ; Botelho, Silvia S. C. ; DREWS, P. ; da Rocha, C.	2012	1-6	37	4020	4
4189	TC	Using Space D* for Crowded Real Robots Environments	Almeida, F ; Botelho, Silvia S. C. ; SILVEIRA, L. ; DREWS, P. ; Maffei, R. Q. ; DUARTE, N. ; BICHO, A. ; LONGARAY, M.	2012	1-6	37	3340	4
4196	TC	Space D*: Um Algoritmo para Path Planning Multi-Robôs	Silveira, L. ; R. maffei ; BOTELHO, S. S. C. ; DREWS, P. ; DUARTE, N. ; BICHO, A. ; Almeida, F ; LONGARAY, M.	2011	1-6	37	3342	4
4024	TC	Analyzing and Exploring Feature Detectors in Images	DREWS JR, P. L. J. ; BEM, R. A. ; MELO, A. S.	2011		30	4024	4
4113	TC	Analyzing and exploring feature detectors in images	DREWS JR, P. L. J. ; DE BEM, Rodrigo Andrade ; MELO, A. S.	2011	305-310	35	4024	4
4025	TC	Controle automático de um ROV para inspeção de estruturas submersas	KUHN, V. N. ; DREWS JR, P. L. J. ; GOMES, S. C. P. ; BOTELHO, S. S. C. ; CUNHA, M. A. B.	2011		30	4025	4
4198	TC	Controle automático de um ROV para inspeção de estruturas submersas	KUHN ; DREWS, P. ; Gomes ; BOTELHO, S. S. C. ; Cunha	2011		37	4025	4
4199	TC	D*-Space: planejando caminhos para sistemas multi-robôs	Silveira, L. ; R. maffei ; BOTELHO, S. S. C. ; DREWS, P. ; DUARTE, N. ; BICHO, A. ; LONGARAY, M. ; ALMEIDA	2011		37	3343	4
4031	TC	Sensor Fusion based on Multi-Self-Organizing Maps for SLAM	OLIVEIRA, G. L. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; FIGUEIREDO, M. ; HAFFELE, C.	2010	1-5	30	4031	4
4208	TC	Sensor Fusion based on Multi-Self-Organizing Maps for SLAM	m, figueiredo ; LEIVAS, G ; BOTELHO, S. S. C. ; DREWS, P. ; da Rocha, C.	2010	1-6	37	4031	4
4032	TC	Fusao Sensorial de Mapas Auto-Organizáveis para SLAM	OLIVEIRA, G. L. ; FIGUEIREDO, M. ; BOTELHO, S. S. C. ; DREWS JR, P. L. J. ; HAFFELE, C.	2010	1-6	30	4032	4
4203	TC	Fusão sensorial de mapas auto-organizáveis para SLAM	LEIVAS, G ; DREWS, P. ; BOTELHO, S. S. C. ; m, figueiredo ; da Rocha, C.	2010	1-6	37	4032	4
4042	TC	Localização de um Robô Subterrâneo Para Inspeção de Linhas de Transmissão	DREWS JR, P. L. J. ; BOTELHO, S. S. C. ; CAMPOS, M. F. M.	2009	1-6	30	4042	4
4219	TC	Localização de um Robô Subterrâneo Para Inspeção de Linhas de Transmissão	DREWS, P. ; BOTELHO, S. S. C. ; Campos, M.	2009	1-6	37	4042	4
4043	TC	Visual Odometry and Mapping for Underwater Autonomous Vehicles	BOTELHO, S. S. C. ; OLIVEIRA, G. L. ; DREWS JR, P. L. J. ; FIGUEIREDO, M.	2009	1-6	30	4043	4
4223	TC	Visual Odometry and Mapping for Underwater Autonomous Vehicles	BOTELHO, S. S. C. ; LEIVAS, G ; DREWS, P. ; m, figueiredo	2009	1-6	37	4043	4
4046	TC	A new approach for Visual Underwater Mapping using Topological Shell Maps	BOTELHO, S. S. C. ; OLIVEIRA, G. L. ; DREWS JR, P. L. J.	2009		30	4046	4
4217	TC	A new approach for Visual Underwater Mapping using Topological Shell Maps	LEIVAS, G ; DREWS, P. ; BOTELHO, S. S. C.	2009	1-8	37	4046	4
4224	TC	TATUBOT Sistema Robótico de Inspeção para Linhas de Distribuição Elétrica Subterrâneas	BOTELHO, S. S. C. ; OLIVEIRA, V. ; DUARTE, N. ; MELLO, C. ; Estrada, E. ; Galeriano, M. ; DREWS, P. ; CORREA, U. B.	2008	100-106	37	3469	4
4048	TC	Uma Abordagem Baseada em Visão Computacionalpara Localização e Mapeamento Simultâneos de Robôs Subaquáticos	DREWS JR, P. L. J. ; BOTELHO, S. S. C.	2008	81-90	30	4048	4
4229	TC	Uma Abordagem Baseada em Visão Computacional para Localização e Mapeamento Simultâneos de Robôs Subaquáticos	DREWS, P. ; BOTELHO, S. S. C.	2008	1-6	37	4048	4
4226	TC	SIFT and Topologic Maps applied to robotic SLAM in Underwater Environment	DREWS, P. ; MEDEIROS, M. M. ; GONCALVES, E. ; BOTELHO, S. S. C.	2008	1-6	37	3664	4
4050	TC	NLMAP - Visual-based Self Localization and Mapping for Autonomous Underwater Vehicles	DREWS JR, P. L. J. ; BOTELHO, S. S. C. ; OLIVEIRA, G. L.	2008	2050-2055	30	4050	4
4231	TC	NLMAP - Visual-based Self Localization and Mapping for Autonomous Underwater Vehicles	BOTELHO, S. S. C. ; DREWS, P. ; LEIVAS, G	2008	1-6	37	4050	4
4051	TC	Visão Computacional aplicada à Localização e Mapeamento Simultâneos de Robôs Subaquáticos	DREWS JR, P. L. J. ; BOTELHO, S. S. C.	2008	1-4	30	4051	4
4230	TC	Visão Computacional aplicada à Localização e Mapeamento Simultâneos de Robôs Subaquáticos	DREWS, P. ; BOTELHO, S. S. C.	2008	1-6	37	4051	4
4053	TC	SLAM in Underwater Environment using SIFT and Topologic Maps	DREWS JR, P. L. J. ; BOTELHO, S. S. C. ; GOMES, S. C. P.	2008	91-96	30	4053	4
4227	TC	SLAM in Underwater Environment using SIFT and Topologic Maps Accepted	DREWS, P. ; BOTELHO, S. S. C. ; GOMES, S.	2008	1-6	37	4053	4
4200	TC	Hyper-Environments: A Different Way to Think about IoT	Tyska, j. ; PENNA, R. ; Botelho, Silvia S. C. ; Duarte Filho, Nelson L. ; R. Oliveira ; SANTOS, E.	2011	25-32	37	3829	4
4070	AP	DESENVOLVIMENTO DE UMA PLATAFORMA MULTIDISCIPLINAR PARA AUTORIA DE JOGOS 3D INTERATIVOS E EDUCATIVOS	PINTO, I. M. ; BOTELHO, S. S. C. ; SOUZA, R. S. ; GOULART, T. S. ; COLARES, R. G. ; CAMPOS, R. L.	2009	1-8	32	4070	4
4159	AP	DESENVOLVIMENTO DE UMA PLATAFORMA MULTIDISCIPLINAR PARA AUTORIA DE JOGOS 3D INTERATIVOS E EDUCATIVOS	PINTO, Ivete ; BOTELHO, S. S. C. ; Souza, R. ; Sonego, T. ; COLARES, R. ; CAMPOS, R. L.	2009	1-8	37	4070	4
4235	TC	Saberlândia: plataforma lúdica integrando robótica e multimídia para educação	PINTO, Ivete ; BOTELHO, S. S. C. ; Souza, R. ; Sonego, T. ; COLARES, R.	2008	1-8	37	3825	4
4234	TC	Plataforma Saberlândia: Integrando Robótica e Multimídia no Desenvolvimento de Jogos Educacionais	PINTO, Ivete ; BOTELHO, S. S. C. ; Souza, R. ; COLARES, R. ; CAMPOS, R. L.	2008	177-186	37	3826	4
4106	TC	Exploring Creativity and Sociability with an Accessible Educational Robotic Kit	BOTELHO, S. S. C. ; BRAZ, L. G. ; Rodrigues, Ricardo N.	2012		34	4106	4
4195	TC	Exploring Creativity and Sociability with an Accessible Educational Robotic Kit	Botelho, Silvia S. C. ; Braz, L. ; NAGEL, R.	2012	1-6	37	4106	4
4115	TC	3D Motion Tracking Based on Probabilistic Volumetric Reconstruction and Optical Flow	SIMAS, Gisele ; FICKEL, G. ; NOVELO, Lucas ; DE BEM, Rodrigo Andrade ; BOTELHO, Silvia Silva da Costa	2010	279-286	35	4115	4
4202	TC	3D Motion Tracking Based on Probabilistic Volumetric Reconstruction and Optical Flow	SIMAS, G. ; FICKEL, G. ; l, novello ; BEM, R. ; BOTELHO, S. S. C.	2010	1-6	37	4115	4
4116	TC	Reconstrução Probabilística 3D Aplicada à Análise de Movimento: um Enfoque na Tele-Operação	SIMAS, Gisele ; FICKEL, G. ; NOVELO, Lucas ; DE BEM, Rodrigo Andrade ; BOTELHO, Silvia Silva da Costa	2010	3800-3807	35	4116	4
4205	TC	Reconstrução Probabilística 3D Aplicada à Análise de Movimento: um Enfoque na Tele-operação	SIMAS, G. ; FICKEL, G. ; l, novello ; BEM, R. DE ; BOTELHO, S. S. C.	2010	1-6	37	4116	4
4295	AP	An immersive and collaborative visualization system for digital manufacturing	Duarte Filho, Nelson ; Costa Botelho, Silvia ; Tyska Carvalho, Jonata ; Botelho Marcos, Pedro ; Queiroz Maffei, Renan ; Ruas Oliveira, Rodrigo ; HAX, V. A. ; Remor Oliveira, Rodrigo	2010	1253-1261	41	3827	4
4163	AP	A general purpose cave-like system for visualization of animated and 4D cad modeling	DUARTE, N. ; BOTELHO, S. S. C. ; Tyska, j. ; P. botelho ; R. maffei ; R. Oliveira ; v. hax	2008	5-19	37	4163	4
4296	AP	A general purpose cave-like system for visualization of animated and 4D cad modeling	BOTELHO, S. S. C. ; DUARTE FILHO, N. L. ; TYSKA, J. C. ; MAFFEI, R. Q. ; OLIVEIRA, R. R. ; HAX, V. A. ; MARCOS, P. B.	2008	5-19	41	4163	4
4276	AP	Arquitetura de navegação autônoma de linhas subterrâneas de distribuição de energia	Estrada, E. ; Silveira L. ; BOTELHO, S. S. C. ; OLIVEIRA, V. M.	2008	32-45	40	3690	4
4297	CL	A General Purpose Cave-like System for Visualization of Animated and 4D CAD Modeling	DUARTE FILHO, N. L. ; BOTELHO, S. S. C. ; TYSKA, J. C. ; OLIVEIRA, R. R. ; MAFFEI, R. Q. ; Botelho Marcos, Pedro ; HAX, V. A.	2010	82-87	41	3892	4
4298	CL	An Automated Platform for Immersive and Collaborative Visualization of Industrial Models. Engineering of Complex Computer Systems. 1ed	DUARTE FILHO, N. L. ; BOTELHO, S. S. C. ; TYSKA, J. C. ; Botelho Marcos, Pedro ; MAFFEI, R. Q. ; OLIVEIRA, R. R. ; HAX, V. A.	2009	258-264	41	3894	4
4303	TC	A Multi-Cave Visualization System for Digital Manufacturing	BOTELHO, S. S. C. ; DUARTE FILHO, N. L. ; HAX, V. A. ; MAFFEI, R. Q. ; MARCOS, P. B. ; OLIVEIRA, R. R. ; TYSKA, J. C.	2009		41	3831	4
4281	TC	Uma arquitetura para navegação autônoma de robôs reais e simulados para inspeção de linhas de distribuição de energia subterrâneas	Estrada, E. ; Gonçalves, E. N. ; BOTELHO, S. S. C. ; OLIVEIRA, V. M. ; ALMEIDA, R. ; Gules R. ; Silveira L.	2009		40	3663	4
4284	TC	Tatubot - Sistema Robótico de Inspeção para Linhas de Distribuição Elétrica Subterrâneas	BOTELHO, S. S. C. ; DUARTE FILHO, N. L. ; OLIVEIRA, V. M. ; Mello Jr., C. D. ; Estrada, E. ; Galeriano, M. ; LILLES, P. D. ; CORREA, U. B.	2008	100-106	40	3469	4
4285	TC	TATUBOT ROBOTIC SYSTEM FOR INSPECTION OF UNDERGROUNDED CABLE SYSTEM	BOTELHO, S. S. C. ; OLIVEIRA, V. M. ; Gonçalves, E. N. ; Estrada, E. ; Mello Jr., C. D. ; LILLES, P. D. ; ALMEIDA, R. ; SOUTO JR., H. ; Santos, T.	2008	1-6	40	3470	4
4286	TC	TATUBOT - Robotic System for Inspection of Undergrounded Cable System	BOTELHO, S. S. C. ; OLIVEIRA, V. M. ; Mello Jr., C. D. ; Gonçalves, E. N. ; Estrada, E. ; ALMEIDA, R. ; Santos, T. ; SOUTO JR., H. ; OLIVEIRA, G.	2008	1-6	40	3471	4
4251	TC	Aquisição e Análise de Modos de Vibração em Estruturas Flexíveis	SOARES, L. B. ; GOMES, S. C. P. ; GERVINI, V. I. ; ROSA, V. S. ; BELLICANTA, L. S. ; ZEILMANN, A. P ; GOMES, S. S.	2010	1-4	38	4251	4
3320	LP	Anais do IV Workshop- Escola de Sistemas de Agentes, seus Ambientes e apliCações. Rio Grande: FURG	Adamatti, D. F. (Org.) ; LUGO, G.G (Org.) ; Emmendorfer, L. R. (Org.) ; WERHLI, A. V. (Org.)	2010		0	3320	4
3563	LP	Anais do IV Workshop- Escola de Sistemas de Agentes, seus Ambientes e apliCações. Rio Grande: FURG	ADAMATTI, D. F. (Org.) ; LUGO, G. G. (Org.) ; EMMENDORFER, L. R. (Org.) ; WERHLI, A. V. (Org.)	2010		10	3320	4
\.
...
3330		Mostra de Produção Universitária, 2011, Rio Grande. Mostra de Produção Universitária			4
3331		Mostra de Produção Universitária - FURG, 2011, Rio Grande. Mostra de Produção Universitária - FURG			4
3332		Mostra de Produção Universitária - FURG, 2011, Rio Grande. Mostra de Produção Universitária - FURG			4
3333		9th European Conference on Computational Biology, 2010, Ghent. 9th European Conference on Computational Biology			4
3334		9th European Conference on Computational Biology, 2010, Ghent. 9th European Conference on Computational Biology			4
3345		X Mostra da Produção Universitária - FURG, 2011, Rio Grande/RS, Brasil. Anais da X Mostra da Produção Universitária - FURG. Rio Grande/RS: FURG			4
3346		10th International Conference on Intelligent Virtual Agents - IVA, 2010, Philadelphia/Pennsylvania-USA. Booklet of short/poster papers of 10th International Conference on Intelligent Virtual Agents	U		4
3367		I Encontro Internacional de Educação e IV Encontro Municipal de Educação, 2011, Piratini - RS. Escola:espaço de sonhos,construção e possibilidades			4
3368		VIII Mostra de Produção Universitária, 2009, Rio Grande. XI ENCONTRO DE PÓS-GRADUAÇÃO. Rio Grande	1		4
3374		MPU - Mostra da Produção Universitária, 2012, Rio Grande. MPU - Mostra da Produção Universitária			4
3375		XI Mostra de Produção Universitária da FURG, 2012, Rio Grande - RS. Anais da XI MPU / FURG	2012		4
3376		XI Mostra de Produção Universitária da FURG, 2012, Rio Grande - RS. Anais da XI MPU / FURG	2012		4
3377		XI Mostra de Produção Universitária da FURG, 2012, Rio Grande - RS. Anais da XI MPU / FURG			4
3378		XI Mostra de Produção Universitária da FURG, 2012, Rio Grande - RS. Anais da XI MPU / FURG			4
3379		X Mostra de Produção Universitária da FURG, 2011, Rio Grande - RS. Anais da X MPU / FURG			4
3380		X Mostra de Produção Universitária da FURG, 2011, Rio Grande - RS. Anais da X MPU / FURG	2011		4
3381		X Mostra de Produção Universitária da FURG, 2011, Rio Grande - RS. Anais da X MPU / FURG	2011		4
3467		WESAAC 2010: Workshop-Escola de Sistemas Multiagentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	1		4
3468		WESAAC 2010: Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	1		4
3492		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3493		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3494		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3495		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3496		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3497		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3498		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3499		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3500		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3501		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3502		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Mostra de Produção Universitária - MPU FURG. Rio Grande: FURG			4
3503		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Mostra de Produção Universitária - MPU FURG. Rio Grande: FURG			4
3504		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Mostra de Produção Universitária - MPU FURG. Rio Grande: FURG			4
3505		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Mostra de Produção Universitária - MPU FURG. Rio Grande: FURG			4
3506		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Mostra de Produção Universitária - MPU FURG. Rio Grande: FURG			4
3507		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Mostra de Produção Universitária - MPU FURG. Rio Grande: FURG			4
3508		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Mostra de Produção Universitária - MPU FURG. Rio Grande: FURG			4
3509		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Mostra de Produção Universitária - MPU FURG. Rio Grande: FURG			4
3510		MPU - Mostra de Produção Universitaria, 2010, Rio Grande. MPU 2010			4
3511		MPU - Mostra de Produção Universitaria, 2010, Rio Grande. MPU 2010			4
3512		MPU - Mostra de Produção Universitaria, 2010, Rio Grande. MPU 2010			4
3513		SForum, 2008, Gramado - Brasil. SForum			4
3528		XVIII CONGRESSO BRASILEIRO DE AUTOMATICA CBA 2010, 2010, Bonito. Anais do XVIII CONGRESSO BRASILEIRO DE AUTOMATICA CBA 2010			4
3529		Proceedings of The 7th ACM SIGGRAPH International Conference on Virtual-Reality Continuum and Its Applications in Industry, 2008, Biopolis-Singapore. Proceedings of The 7th ACM SIGGRAPH International Conference on Virtual-Reality Continuum and Its Applications in Industry. Biopolis: ACM SIGGRAPH	1		4
3550		Design, Automation and Test in Europe, 2009, Nice. Proceedings of DATE 2009			4
3626		International Conference on Health and Social Care Information Systems and Technologies, 2012, Algarve / Portugal. HCIST 2012. Algarve / Portugal: HCSIT			4
3627		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3628		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3629		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3630		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3631		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3632		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3633		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3634		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3635		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3636		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3637		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3638		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3639		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3640		Mostra de Produção Universitária, 2012, Rio Grande / RS. MPU 2012. Rio Grande / RS: Editora FURG			4
3641		Mostra de Produção Universitária, 2011, Rio Grande RS. MPU 2011. Rio Grande RS: FURG			4
3642		Mostra de Produção Universitária, 2011, Rio Grande RS. MPU 2011. Rio Grande RS: FURG			4
3643		Mostra de Produção Universitária, 2011, Rio Grande RS. MPU 2011. Rio Grande RS: FURG			4
3644		Mostra de Produção Universitária, 2011, Rio Grande RS. MPU 2011. Rio Grande RS: FURG			4
3645		Mostra de Produção Universitária, 2011, Rio Grande RS. MPU 2011. Rio Grande RS: FURG			4
3646		Mostra de Produção Universitária, 2011, Rio Grande RS. MPU 2011. Rio Grande RS: FURG			4
3647		Mostra de Produção Universitária, 2011, Rio Grande RS. MPU 2011. Rio Grande RS: FURG			4
3648		Mostra de Produção Universitária, 2011, Rio Grande RS. MPU 2011. Rio Grande RS: FURG			4
3649		Mostra de Produção Universitária, 2011, Rio Grande RS. MPU 2011. Rio Grande RS: FURG			4
3650		Salão de Iniciação Científica da UFRGS, 2010, Porto Alegre/RS. SIC UFRGS			4
3651		Mostra de Produção Universitária, 2010, Rio Grande / RS. MPU 2010. Rio Grande			4
3652		Mostra de Produção Universitária, 2010, Rio Grande / RS. MPU 2010. Rio Grande			4
3653		Mostra de Produção Universitária, 2010, Rio Grande / RS. MPU 2010. Rio Grande			4
3654		Mostra de Produção Universitária, 2010, Rio Grande / RS. MPU 2010. Rio Grande			4
3655		Congresso de Iniciação Científica UCPel, 2008, Pelotas. CIC UCPel			4
3682		XI Mostra de Produção Universitária da FURG, 2012, Rio Grande. Anais da XI MPU / FURG			4
3683		XI Mostra de Produção Universitária da FURG, 2012, Rio Grande. Anais da XI MPU / FURG			4
3684		XI Mostra de Produção Universitária da FURG, 2012, Rio Grande. Anais da XI MPU / FURG			4
3685		XI Mostra de Produção Universitária da FURG, 2012, Rio Grande. Anais da XI MPU / FURG			4
3686		X Mostra de Produção Universitária da FURG, 2011, Rio Grande. Anais da X MPU / FURG			4
3687		X Mostra de Produção Universitária da FURG, 2011, Rio Grande. Anais da X MPU / FURG			4
3688		X Mostra de Produção Universitária da FURG, 2011, Rio Grande. Anais da X MPU / FURG			4
3689		Salão de Iniciação Científica, 2009, Porto Alegre. Anais do XXI Salão de Iniciação Científica			4
3704		Mostra de Produção Universitária, 2011, Rio Grande. 10a Mostra de Produção Universitária			4
3711		Mostra de Produção Universitária, 2010, Rio Grande / RS. Mostra de Produção Universitária			4
3820		XI Mostra da Produção Universitária - Encontro de Pós-Graduação - MPU/FURG, 2012, Rio Grande - RS. XI Mostra da Produção Universitária - Encontro de Pós-Graduação - MPU/FURG			4
3821		XI Mostra da Produção Universitária - XXI Congresso de Iniciação Científica - MPU/FURG, 2012, Rio Grande - RS. XI Mostra da Produção Universitária - XXI Congresso de Iniciação Científica - MPU/FURG			4
3822		X Mostra da Produção Universitária MPU - XIV Seminário de Extensão - MPU/FURG, 2011, Rio Grande - RS. X Mostra da Produção Universitária MPU - XIV Seminário de Extensão - MPU/FURG			4
3823		X Mostra da Produção Universitária MPU - XX Congresso de Iniciação Cientifica - MPU/FURG, 2011, Rio Grande. X Mostra da Produção Universitária MPU - XX Congresso de Iniciação Cientifica - MPU/FURG			4
3850		8th International Conference of the Brazilian Association for Bioinformatics and Computational Biology, 2012, Campinhas-SP. X-Meeting 2012 -			4
3851		Xmeeting, 2011, Florianópolis. 2011 Abstract book			4
3852		10º Mostra da Produção Universitária, 2011, Rio Grande. 10º Mostra da Produção Universitária			4
3853		ISCB Latin America 2010, 2010, Montevideo. International Society for Computational Biology Latin America Conference			4
3854		ISCB Latin America 2010, 2010, Montevideo. International Society for Computational Biology Latin America Conference			4
3855		ISCB Latin America, 2010, Montevideo. International Society for Computational Biology Latin America Conference			4
3856		ISCB Latin America, 2010, Montevideo. International Society for Computational Biology Latin America Conference			4
3857		6th International Conference of the Brazilian Association for Bioinformatics and Computational Biology, 2010, Ouro Preto, MG. Abstracts Book			4
3858		6th International Conference of the Brazilian Association for Bioinformatics and Computational Biology, 2010, Ouro Preto. Abstracts Book			4
3871		XVII Encontro Regional de Estudantes de Matemática do Sul, 2011, Curitiba. Anais do XVII Encontro Regional de Estudantes de Matemática do Sul			4
3872		10a Mostra de Produção Universitária - MPU, 2011, Rio Grande. Anais			4
3873		MPU - Mostra de produção universitária, 2010, Rio Grande. Mostra de Produção Universitária 2010			4
3915		IEEE RFID 2011, 2011, Orlando. Anais do IEEE RFID 2011			4
3944		XI Congreso Argentino de Meteorologia, 2012, Mendoza. XI Congremet. Buenos Aires: Centro Argentino de Meteorologos	1		4
3945		IX Simpósio de Ondas, Marés, Engenharia Oceânica e Oceanografia por Satélite, 2011, Arraial do Cabo. Anais do IX OMAR-SAT. Arraial do Cabo: Instituto de Estudos do Mar Almirante Paulo Moreira	1		4
3946		AGU Fall Meeting 2010, 2010, San Francisco, Estados Unidos. 2010 Fall Meeting, AGU. San Francisco, Califoria: AGU	1		4
3947		AGU 2010 Meeting of the Americas, 2010, Foz do Iguaçu. Eos Trans. AGU	91		4
3948		2009 Joint Assembly - American Geophysical Union, 2009, Toronto. Eos Trans. AGU Jt. Assem. Suppl. Washington: AGU	90		4
3949		2009 Joint Assembly - American Geophysical Union, 2009, Toronto. Eos Trans. AGU Jt. Assem. Suppl. Washington: AGU	90		4
3950		VI Workshop Brasileiro de Micrometeorologia, 2009, Santa Maria. Anais. Santa Maria	1		4
3951		VI Workshop Brasileiro de Micrometeorologia, 2009, Santa Maria. Anais. Santa Maria	1`		4
3956		MPU - Mostra da Produção Universitária, 2012, Rio Grande. MPU - Mostra da Produção Universitária			4
3957		MPU - Mostra da Produção Universitária, 2012, Rio Grande. MPU - Mostra da Produção Universitária			4
3958		MPU - Mostra da Produção Universitária, 2012, Rio Grande. MPU - Mostra da Produção Universitária			4
3959		10ª Mostra de Produção Universitária, 2011, Rio Grande. 10ª Mostra de Produção Universitária			4
3960		10ª Mostra de Produção Universitária, 2011, Rio Grande. 10ª Mostra de Produção Universitária			4
3961		10ª Mostra de Produção Universitária, 2011, Rio Grande. 10ª Mostra de Produção Universitária			4
3984		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3985		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3986		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3987		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3988		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3989		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3990		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3991		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3992		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3993		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3994		11ª Mostra da Produção Universitária MPU, 2012, Rio Grande. 11ª Mostra da Produção Universitária MPU			4
3995		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Anais da Mostra de Produção Universitária - MPU FURG			4
3996		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Anais da Mostra de Produção Universitária - MPU FURG			4
3997		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Anais da Mostra de Produção Universitária - MPU FURG			4
3998		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Anais da Mostra de Produção Universitária - MPU FURG			4
3999		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Anais da Mostra de Produção Universitária - MPU FURG			4
4000		Mostra de Produção Universitária - MPU FURG, 2011, Rio Grande. Anais da Mostra de Produção Universitária - MPU FURG			4
4001		Mostra de Produção Universitária - FURG, 2011, Rio Grande. Anais da Mostra de Produção Universitária - FURG			4
4002		IX Student Forum on Microelectronics, 2009, Natal. IX Student Forum on Microelectronics. Natal			4
4003		VIII Student Forum on Microelectronics, 2008, Gramado. VIII Student Forum on Microelectronics. Porto Alegre: SBC			4
4004		VIII Student Forum on Microelectronics, 2008, Gramado. VIII Student Forum on Microelectronics. Porto Alegre: SBC			4
4054		5th International Conference on Spatial Cognition, 2012, Roma, Italy. Proceedings of 5th International Conference on Spatial Cognition			4
4055		5th International Conference on Spatial Cognition, 2012, Roma, Italy. Proceedings of 5th International Conference on Spatial Cognition			4
4056		XI Mostra de Produção Universitária FURG, 2012, Rio Grande. Anais da XI Mostra de Produção Universitária FURG			4
4057		XI Mostra de Produção Universitária FURG, 2012, Rio Grande. Anais da XI Mostra de Produção Universitária FURG			4
4058		XI Mostra de Produção Universitária FURG, 2012, Rio Grande. Anais da XI Mostra de Produção Universitária FURG			4
4059		XI Mostra de Produção Universitária FURG, 2012, Rio Grande. Anais da XI Mostra de Produção Universitária FURG			4
4060		XI Mostra de Produção Universitária FURG, 2012, Rio Grande. Anais da XI Mostra de Produção Universitária FURG			4
4061		X Mostra de Produção Universitária, 2011, Rio Grande, Brazil. X Mostra de Produção Universitária - FURG			4
4062		X Mostra de Produção Universitária, 2011, Rio Grande, Brazil. X Mostra de Produção Universitária			4
4063		X Mostra de Produção Universitária, 2011, Rio Grande, Brazil. X Mostra de Produção Universitária - FURG			4
4064		X Mostra de Produção Universitária, 2011, Rio Grande, Brazil. X Mostra de Produção Universitária - FURG			4
4065		X Mostra de Produção Universitária, 2011, Rio Grande, Brazil. X Mostra de Produção Universitária - FURG			4
4085		Congresso Brasileiro de Extensão Universitária, 2009, Dourados-MS. Congresso Brasileiro de Extensão Universitária			4
4086		27º Seminário de Extensão Universitária da Região Sul, 2009, Santa Maria. 27º Seminário de Extensão Universitária da Região Sul			4
4087		VII Mostra de Produção Universitária - XVII Congresso de Iniciação Científica, 2008, Rio Grande. XVII Congresso de Iniciação Científica			4
4099		International Conference on Health and Social Care Information Systems and Technologies, 2012, Algarve / PortugaL. HCIST 2012			4
4100		MPU 2012, 2012, Rio Grande, RS. Mostra de Produção Universitária. Rio Grande - RS: Editora FURG			4
4101		Mostra de Produção Universitária, 2012, Rio Grande, RS. MPU 2012. Rio Grande - RS: Editora FURG			4
4102		Mostra de Produção Universitária, 2012, Rio Grande, RS. MPU 2012. Rio Grande - RS: Editora FURG			4
4103		Mostra de Produção Universitária, 2012, Rio Grande, RS. MPU 2012			4
4104		X Mostra de Produção Universitária, 2011, Rio Grande. MPU 2011			4
4122		X Mostra de Produção Universitária - MPU 2011, 2011, Rio Grande. Anais da X Mostra de Produção Universitária. Rio Grande: FURG			4
4123		X Mostra de Produção Universitária - MPU 2011, 2011, Rio Grande. Anais da X Mostra de Produção Universitária. Rio Grande: Furg			4
4293		10a. Mostra da Produção Universitária da FURG, 2011, Rio Grande. Anais da 10a. Mostra da Produção Universitária da FURG			4
4294		XXIII Congresso Regional de Iniciação Científica e Tecnológica em Engenharia, 2009, Joinville. Anais do XXIII Congresso Regional de Iniciação Científica e Tecnológica em Engenharia			4
4309		10ª Mostra da Produção Universitária FURG, 2011, Rio Grande. Anais da X Mostra de Produção Universitária FURG			4
4310		10ª Mostra da Produção Universitária FURG, 2011, Rio Grande. Anais da X Mostra de Produção Universitária FURG			4
4311		10ª Mostra da Produção Universitária FURG, 2011, Rio Grande. Anais da X Mostra de Produção Universitária FURG			4
4312		10ª Mostra da Produção Universitária FURG, 2011, Rio Grande. Anais da X Mostra de Produção Universitária FURG			4
4313		10ª Mostra da Produção Universitária FURG, 2011, Rio Grande. Anais da X Mostra de Produção Universitária FURG			4
4314		10ª Mostra da Produção Universitária FURG, 2011, Rio Grande. Anais da X Mostra de Produção Universitária FURG			4
4315		Gerência Dinâmica de Máquinas Virtuais para Computação em Nuvem, 2011, Rio Grande. Anais da X Mostra de Produção Universitária FURG			4
4316		9ª Mostra de Produção Universitária da FURG, 2010, Rio Grande. Anais da IX Mostra de Produção Universitária FURG			4
4317		XVII Congresso de Iniciação Científica da VII Mostra de Produção Universitária, 2008, Rio Grande. Realismo em ambientes virtuais de manufatura usando RayTracing			4
\.
...
4084		VIII Mostra de Produção Universitária, 2009, Rio Grande. VII Mostra de Produção Universitária XII Seminário de Extensão		4
...
3329		XIX Seminário de Iniciação Científica da UNIJUÍ, 2011, Ijuí. Salão do Conhecimento - XIX Seminário de Iniciação Científica		4
3461		V Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2011, Curitiba. Anais do WESAAC 2011. Curitiba: UTFPR	1	4
3462		Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações - WESAAC 2010, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	1	4
3463		4th Southern Conference on Computational Modeling/IX Encontro Regional de Matemática Aplicada e Computacional, 2010, Rio Grande. Anais do 4MCSUL/IX ERMAC. Rio Grande: FURG	1	4
3464		The 8th International Conference on Autonomous Agents and Multiagent Systems, 2009, Budapest. Proceedings of AAMAS 2009. Richland: IFAAMAS	1	4
3465		3rd Southern Conference on Computational Modeling, 2009, Rio Grande. Proceedings of MCSUL 2009. Rio Grande: FURG	1	4
3466		7th International Joint Conference on Autonomous Agents and Multiagent Systems (AAMAS 2008), 2008, Estoril. Proceedings of AAMAS 2008. Estoril: IFAMAS	3	4
3526		Workshop em Sistemas Embarcados para Indústria de Óleo, Gás e Energia, 2012, Rio Grande. Proceedings of Workshop em Sistemas Embarcados para Indústria de Óleo, Gás e Energia	1	4
3527		X Symposium on Virtual and Augmented Reality, 2008, Joao Pessoa. Proceedings of the X Symposium on Virtual and Augmented Reality. Porto Alegre: Sociedade Brasileira de Computação	1	4
3548		XXVII South Symposium on Microeletronics, 2012, Ijuí e São Miguel da Missões. Proceedings of XXVII South Symposium on Microeletronics		4
3549		XXVII South Symposium on Microeletronics, 2012, Ijuí e São Miguel da Missões. Proceedings of XXVII South Symposium on Microeletronics		4
3615		1o. Seminário Nacional de Inclusão Digital e Software Livre, 2012, Passo Fundo / RS. SENID 2012. Passo Fundo / RS: Editora UPF		4
3616		1o. Seminário Nacional de Inclusão Digital e Software Livre, 2012, Passo Fundo / RS. SENID 2012. Passo Fundo / RS: Editora UPF		4
3617		1o. Seminário Nacional de Inclusão Digital e Software Livre, 2012, Passo Fundo / RS. SENID 2012. Passo Fundo / RS: Editora UPF		4
3618		IADIS International Conference on Cognition and Exploratory Learning in Digital Age 2012, 2012, Madrid / Espanha. CELDA 2012. Madrid / Espanha: IADIS		4
4097		Sintec 2012, 2012, Rio Grande, RS. II Seminário Internacional de Educação em Ciências		4
4098		V Seminário Nacional sobre Educação e Inclusão Social de Pessoas com Necessidades Educacionais Especiais, 2012		4
3619		V Seminário Nacional sobre Educação e Inclusão Social de Pessoas com Necessidades Educacionais Especiais, 2012, Natal / RN. V Seminário Nacional sobre Educação e Inclusão Social de Pessoas com Necessidades Educacionais Especiais. Natal / RN: Editora UFRN		4
3620		Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações, 2011, Curitiba / PR. WESAAC 2011		4
3621		Seminário Internacional de Educação em Ciências, 2011, Rio Grande RS. SINTEC 2011. Rio Grande RS: FURG		4
3622		Seminário Internacional de Educação em Ciências, 2011, Rio Grande RS. SINTEC 2011. Rio Grande RS: FURG		4
3623		Applications to Provide Learning and Teaching Support - APPLETS, 2011, Aracaju / SE. Simpósio Brasileiro de Informática na Educação - Workshop APPLETS. Aracaju / SE: SBIE		4
3624		IV Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações, 2010, Rio Grande. WESAAC 2010. Rio Grande: FURG		4
3625		IV Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações, 2010, Rio Grande. WESAAC 2010. Rio Grande: FURG		4
3668		4 Workshop de Visão Computacional, 2008, Bauru - SP. Anais do WVC´08		4
3679		Congresso Regional de Iniciação Científica e Tecnológica em Engenharia - CRICTE, 2010, Rio Grande. Anais do XXIV CRICTE		4
3680		IX Mostra de Produção Universitária da FURG, 2010, Rio Grande. Anais da IX MPU / FURG		4
3681		IX Mostra de Produção Universitária da FURG, 2010, Rio Grande. Anais da IX MPU / FURG		4
3703		The 3rd Southern Conference on Computational Modeling, 2009, Rio Grande. III MCSul		4
3707		Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações, 2011, Curitiba / PR. Workshop-Escola de Sistemas de Agentes, seus Ambientes e apliCações		4
3708		Congresso Regional de Iniciação Científica e Tecnológica em Engenharia,, 2010, Rio Grande / RS. Congresso Regional de Iniciação Científica e Tecnológica em Engenharia,		4
3709		MCSul 2010 - Simpósio de Modelagem Computacional do Sul, 2010, Rio Grande / RS. MCSul 2010 - Simpósio de Modelagem Computacional do Sul		4
3710		Escola Regional de Redes de Computadores - ERRC 2010, 2010, Alegrete / RS. Escola Regional de Redes de Computadores - ERRC 2010		4
3803		CNMAC 2012 - XXXIV Congresso Brasileiro de Matemática Aplicada e Computacional, 2012, Águas de Lindóia. Anais do XXXIV CNMAC. São Carlos: SBMAC	1	4
3804		CNMAC 2012 - XXXIV Congresso Brasileiro de Matemática Aplicada e Computacional, 2012, Águas de Lindóia. Anais do XXXIV CNMAC. São Carlos: SBMAC	1	4
3805		2012 CONFERÊNCIA SUL EM MODELAGEM COMPUTACIONAL - MCSUL, 2012, Rio Grande. Anais do MCSUL 2012. Rio Grande: FURG	1	4
3806		V Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2011, Curitiba. Gustavo A. G. Lugo, Jomi F- Hübner, Cesar A. Tacla (Eds.) Anais do WESAAC 2011. Curitiba: UTFPR	1	4
3807		WEIT 2011 - Workshop-Escola de Informática Teórica, 2011, Pelotas. G.P. Dimuro, L. Foss, M.S. Aguiar, S. Costa, A.C.R. Costa (Eds.) Anais do WEIT 2011. Rio Grande: FURG	1	4
3808		Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	1	4
3809		Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	1	4
3810		Workshop-Escola de Sistemas de Agentes, seus Ambientes e Aplicações, 2010, Rio Grande. Anais do WESAAC 2010. Rio Grande: FURG	1	4
3811		The 8th International Conference on Autonomous Agents and Multiagent Systems, 2009, Budapest. Proceedings of AAMAS 2009. Richland: IFAAMAS	1	4
3812		XXXII Congresso Nacional de Matemática Aplicada e Computacional, 2009, Cuiabá. Anais do CNMAC 2009. São Carlos: SBMAC	1	4
3813		XXXII Congresso Nacional de Matemática Aplicada e Computacional, 2009, Cuiabá. A. L. Bortoli et al. (Eds.) Anais do CNMAC. São Carlos: SBMAC	2	4
3814		The 3rd Southern Conference on Computational Modeling, 2009, Rio Grande. Proceedings of MCSUL 2009. Rio Grande: FURG	1	4
3815		The 3rd Southern Conference on Computational Modeling, 2009, Rio Grande. Proceedings of MCSUL 2009. Rio Grande: FURG	1	4
3816		13th GAMM - IMACS International Symposium on Scientific Computing, Computer Arithmetic and Verified Numerical Computations, 2008, El Paso. Proceedings of SCAN 2008. El Paso: University of Texas at El Paso	1	4
3835		Simpósio Brasileiro de Games - SBGAMES, 2010, Florianópolis - SC. Anais do SBGAMES		4
3847		XIII Simpósio em Sistemas Computacionais (WSCAD-SSC), 2012, Petrópolis, RJ. Anais do XIII Simpósio em Sistemas Computacionais		4
3848		Brazilian Symposium on Bioinformatics, 2010, Búzios. LNBI-LNCS. Advances in Bioinformatics and Computational Biology.. Berlin: Springer-Verlag	6268	4
3849		IV Brasilian Symposium on Bioinformatics, 2009, Porto Alegre. LNBI-LNCS. Advances in Bioinformatics and Computational Biology.. Berlin: Springer-Verlag	5676	4
3869		XIX Seminário de Iniciação Científica, 2011, Ijuí. Anais do XIX Seminário de Iniciação Científica		4
3870		International Conference on Evolutionary Computation, 2010, Valencia, Espanha. Proceedings		4
3911		WES - Workshop on Embedded Systems for Oil, Gas and Energy Industry, 2012, Rio Grande. Anais WES 2012	1	4
3912		WES - Workshop on Embedded Systems for Oil, Gas and Energy Industry, 2012, Rio Grande. Anais WES 2012	1	4
3913		EuroITV 2010		4
3914		EuroSys 2008, 2008, Glasgow. Anais do 2nd Workshop on Dependable Distributed Data (WDDDM'08)		4
4069		Simpósio Brasileiro de Games - SBGAMES, 2010, Florianópolis. Anais do SBGAMES		4
4077		Seminário Internacional de Educação em Ciências, 2011, Rio Grande. Anais do I Seminário Internacional de Educação em Ciências. Rio Grande: FURG/NUEPEC	1	4
4078		X Simpósio Brasileiro de Games, 2011, Salvador. SBGAMES 2011		4
4079		10ª Mostra de Produção Universitária, 2011, Rio Grande. 10ª Mostra de Produção Universitária		4
4080		29º Seminário de Extensão Universitária da Região Sul, 2011, Foz do Iguaçu. 29º Seminário de Extensão Universitária da Região Sul		4
4081		IX Mostra de Produção Universitária, 2010, Rio Grande. IX Mostra de Produção Universitária	01	4
4082		IV Workshop-Escola de Sistemas de Agentes, 2010, Rio Grande. IV Workshop-Escola de Sistemas de Agentes		4
4083		VIII Mostra de Produção Universitária, 2009, Rio Grande. VII Mostra de Produção Universitária XII Seminário de Extensão		4
4118		IX Mostra de Produção Universitária da FURG - MPU, 2010, Rio Grande, Brasil. Anais da IX Mostra de Produção Universitária da FURG - MPU. Rio Grande, Brasil: FURG		4
4119		IX Mostra de Produção Universitária da FURG - MPU, 2010, Rio Grande, Brasil. Anais da IX Mostra de Produção Universitária da FURG - MPU. Rio Grande, Brasil: FURG		4
4120		XI Encontro de Pós-Graduação, 2009, Rio Grande. Anais da IX Mostra de produção universitária. Rio Grande: FURG		4
4121		VII Mostra de Produção Universitária, 2008, Rio Grande. Anais da VII Mostra de Produção Universitária. Rio Grande: FURG		4
4236		Escola Regional de Redes de Computadores, 2012. Escola Regional de Redes de Computadores	1	4
4237		IEEE RFID, 2011. IEEE RFID		4
4238		Seminário Internacional de Educação em Ciências, 2011. Seminário Internacional de Educação em Ciências		4
4239		29º Seminário de Extensão Universitária da Região Sul, 2011, Foz do Iguaçu. 29º Seminário de Extensão Universitária da Região Sul		4
4240		European Conference in Interative Tv and Video		4
4241		IX Mostra de Produção Universitária, 2010. 2010		4
4273		VIII Mostra da Produção Universitária da FURG, 2009, Rio Grande. VIII Mostra da Produção Universitária da FURG		4
4274		VIII Mostra da Produção Universitária da FUR, 2009, Rio Grande. VIII Mostra da Produção Universitária da FUR		4
4287		XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE, 2010, Rio Grande. Anais do XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE		4
4288		XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE, 2010, Rio Grande. Anais do XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE		4
4289		XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE, 2010, Rio Grande. Anais do XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE		4
4290		XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE, 2010, Rio Grande. Anais do XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE		4
4291		XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE, 2010, Rio Grande. Anais do XXIV Congresso Regional de Iniciação Científica e Tecnológica em Engenharia -- CRICTE		4
4292		The 3rd Southern Conference on Comutational Modeling, 2009, Rio Grande. Annals of the 3rd Southern Conference on Comutational Modeling		4
4306		1o. Seminário Nacional de Inclusão Digital e Software Livre, 2012, Passo Fundo. Multiplicadores de Conhecimento em Projeto de Inclusão Digital. Passo Fundo: Editora UPF		4
4307		1o. Seminário Nacional de Inclusão Digital e Software Livre, 2012, Passo Fundo. Inclusão Digital Dentro da Universidade. Passo Fundo: Editora UPF		4
4308		1o. Seminário Nacional de Inclusão Digital e Software Livre, 2012, Passo Fundo. Redes Sociais em Projeto de Inclusão Digital.. Passo Fundo: Editora UPF		4
\.
...
http://dx.doi.org/10.1007/978-3-540-74972-1_55	Advances in Soft Computing	44		3185	3
	...
	BMC Genomics	13		3318	4
http://dx.doi.org/10.1142/S0219720008003539	Journal of Bioinformatics and Computational Biology (Print)	06		3319	4
http://dx.doi.org/10.1016/j.cag.2011.12.004	Computers Graphics	36		3335	4
http://dx.doi.org/10.1007/s13173-012-0071-9	Journal of The Brazilian Computer Society (Online)	18		3336	4
http://dx.doi.org/10.1080/08839514.2010.492167	Applied Artificial Intelligence	24		3337	4
http://dx.doi.org/10.1007/978-3-642-04380-2_39	Lecture Notes in Computer Science	5773		3338	4
	Online)	1		3347	4
	Revista de Informática Teórica e Aplicada (Impresso)	17		3382	4
	Revista de Informática Teórica e Aplicada (Impresso)	7		3383	4
	Journal of the Brazilian Computer Society (Impresso)	17		3384	4
	Pueblos y Fronteras Digital	6		3385	4
	Tendências em Matemática Aplicada e Computacional	10		3386	4
	Tendências em Matemática Aplicada e Computacional	9		3387	4
	Revista do CCEI	12		3388	4
	Electronic Notes in Theoretical Computer Science	210		3389	4
	ICCEEg - Revista Jr de Iniciação Científica em Ciências Exatas e Engenharia	4		3472	4
http://dx.doi.org/10.1109/TIE.2011.2134054	Print)	58		3473	4
http://dx.doi.org/10.1109/INDIN.2011.6034928	IEEE Transactions on Industrial Informatics	1		3514	4
http://dx.doi.org/10.1016/j.microrel.2008.07.002	Microelectronics and Reliability	48		3530	4
http://dx.doi.org/10.1016/j.microrel.2008.07.016	Microelectronics and Reliability	48		3531	4
	Revista Jr de Iniciação Científica em Ciências Exatas e Engenharia (ICCEEg)	4		3551	4
	Journal of Information Systems Management	2		3552	4
	Revista do CCEI	16		3553	4
	Revista Jr de Iniciação Científica em Ciências Exatas e Engenharia	5		3554	4
	Revista Brasileira de Informação na Educação	19		3555	4
	Revista Novas Tecnologias na Educação	9		3556	4
	Journal of Information Systems Management	1		3557	4
	Cadernos de Simulação Social e Ambiental	1		3558	4
	Journal of Artificial Societies and Social Simulation	12		3559	4
	Informática Pública	10		3560	4
	Journal of Software	7		3656	4
http://dx.doi.org/10.1016/j.ipm.2011.01.009	Information Processing Management	47		3669	4
	Vetor (FURG)	18		3690	4
http://dx.doi.org/10.1016/j.ins.2011.05.003	Information Sciences	181		3712	4
http://dx.doi.org/10.1007/s13173-011-0035-5	Journal of the Brazilian Computer Society (Impresso)	17		3713	4
http://dx.doi.org/10.1016/j.ins.2009.11.035	Information Sciences	180		3714	4
	Tendências em Matemática Aplicada e Computacional	11		3715	4
	Revista de Informática Teórica e Aplicada (Impresso)	17		3716	4
http://dx.doi.org/10.1016/j.entcs.2009.07.045	Electronic Notes in Theoretical Computer Science	247		3717	4
	Tendências em Matemática Aplicada e Computacional	10		3718	4
	Tendências em Matemática Aplicada e Computacional	9		3719	4
	Tendências em Matemática Aplicada e Computacional	9		3720	4
	Tendências em Matemática Aplicada e Computacional	9		3721	4
http://dx.doi.org/10.1007/s00170-010-2548-z	International Journal, Advanced Manufacturing Technology,			3827	4
	Vetor (FURG)	22		3828	4
http://dx.doi.org/10.1002/widm.46	Wiley Interdisciplinary Reviews: Data Mining and Knowledge Discovery,			3836	4
http://dx.doi.org/10.1186/1471-2164-12-S4-S6	BMC Genomics	12		3837	4
http://dx.doi.org/10.1186/1471-2164-12-S4-S7	BMC Genomics	12		3838	4
http://dx.doi.org/10.1186/1471-2164-11-S5-S6	BMC Genomics	11		3839	4
	ICCEEg - Revista Jr de Iniciação Científica em Ciências Exatas e Engenharia,	1		3859	4
	Revista Jr de Iniciação Científica em Ciências Exatas e Engenharia	1		3860	4
http://dx.doi.org/10.1109/TEVC.2009.2025455	IEEE Transactions on Evolutionary Computation	13		3861	4
	Revista Eletrônica de Administração e Turismo	1		3874	4
	Anuário da Produção Científica dos Cursos de Pós-Graduação	4		3875	4
	Revista ANGRAD	9		3876	4
http://dx.doi.org/10.1007/s13173-012-0071-9	Journal of the Brazilian Computer Society (Impresso)	18		3886	4
http://dx.doi.org/10.1007/s00170-010-2548-z	International Journal, Advanced Manufacturing Technology	50		3887	4
	Vetor (FURG)	18		3888	4
	Vetor (FURG)	20		3889	4
http://dx.doi.org/10.3354/cr01065	Climate Research	52		3916	4
	Terrae Didatica (Impresso)	8		3917	4
	Geosul (UFSC)	25		3918	4
	Ciência e Natura	suplem		3919	4
	Ciência e Natura	suplem		3920	4
	Brazilian Journal of Oceanography (Impresso)	57		3921	4
	Revista Junior de Iniciação Científica em Ciências Exatas e Engenharia	1		3962	4
http://dx.doi.org/10.1016/j.microrel.2012.06.092	Microelectronics and Reliability	52		3963	4
http://dx.doi.org/10.1109/TVLSI.2010.2041258	IEEE Transactions on Very Large Scale Integration (VLSI) Systems (Print)	19		3964	4
http://dx.doi.org/10.1166/jolpe.2010.1070	Journal of Low Power Electronics (Print)	6		3965	4
http://dx.doi.org/10.1016/j.mejo.2010.03.003	Microelectronics Journal	41		3966	4
http://dx.doi.org/10.1016/j.microrel.2010.07.140	Microelectronics and Reliability	50		3967	4
http://dx.doi.org/10.1007/s13173-012-0071-9	Journal of the Brazilian Computer Society (Impresso)	18		4005	4
	Vetor (FURG)	18		4006	4
	Sea Technology	50		4007	4
http://dx.doi.org/10.1590/S0104-65002009000300005	Journal of the Brazilian Computer Society (Impresso)	15		4008	4
	Revista Eletrônica de Iniciação Científica	VIII		4009	4
http://dx.doi.org/10.1016/j.compmedimag.2008.03.001	Computerized Medical Imaging and Graphics	32		4066	4
	Enseñanza de las Ciencias	Extra		4070	4
	Revista Novas Tecnologias na Educação	06		4088	4
http://dx.doi.org/10.1016/j.jvlc.2009.01.010	Journal of Visual Languages and Computing	20		4105	4
	Controle Automação (Impresso)	23		4124	4
	IET Electric Power Applications (Print)	1		4125	4
	Pesquisa Naval (SDM)	24		4146	4
http://dx.doi.org/10.1007/s13173-012-0071-9	Journal of The Brazilian Computer Society (Online)	18		4147	4
	Revista Novas Tecnologias na Educação	10		4148	4
	IEEE Transactions on Industrial Informatics	1		4149	4
	Tecnologia Educacional	40		4150	4
http://dx.doi.org/10.1007/s00170-010-2548-z	International Journal, Advanced Manufacturing Technology	48		4151	4
	Ciências Cognição (UFRJ)	15		4152	4
	International Journal of Artificial Intelligence and Expert Systems (IJAE)	1		4153	4
	Vetor (FURG)	20		4154	4
	Vetor (FURG)	19		4155	4
	Vetor (FURG)	22		4156	4
	Vetor (FURG)	18		4157	4
	Sea Technology	50		4158	4
	Enseñanza de las Ciencias	Extra		4159	4
	Journal of the Brazilian Computer Society (Impresso)	15		4160	4
	Vetor (FURG)	19		4161	4
http://dx.doi.org/10.1007/978-3-540-74972-1_55	Advances in Soft Computing	44		4162	4
	Vetor (FURG)	18		4163	4
	Vetor (FURG)	18		4164	4
	Revista Eletrônica de Iniciação Científica	VIII		4165	4
	Vetor (FURG)	18		4242	4
	Vetor (FURG)	20		4275	4
	Vetor (FURG)	18		4276	4
http://dx.doi.org/10.1007/s00170-010-2548-z	International Journal, Advanced Manufacturing Technology	50		4295	4
	Vetor (FURG)	18		4296	4
\.
...
COPY revista_aceito (doi, revista, numero, id_publicacao, versao) FROM stdin;
	...
	Vetor (FURG)		3287	3
	Vetor (FURG)		3288	3
	Journal of Logic and Computation (Print)		3390	4
	Computers in Industry		3515	4
	Revista de Informática Teórica e Aplicada: RITA		3691	4
	BMC Bioinformatics		3840	4
	Revista Jr de Iniciação Científica em Ciências Exatas e Engenharia		3952	4
	Revista Novas Tecnologias na Educação		4166	4
	Computers in Industry		4167	4
	International Journal: Computational Intelligence in Bioinformatics and Systems Biology		4168	4
	Vetor (FURG)		4264	4
	Vetor (FURG)		4265	4
\.
...
--
-- Name: publicacao_tipo_fkey; Type: FK CONSTRAINT; Schema: versionado; Owner: postgres
--

ALTER TABLE ONLY publicacao
    ADD CONSTRAINT publicacao_tipo_fkey FOREIGN KEY (tipo) REFERENCES public.tipo(id_tipo);
